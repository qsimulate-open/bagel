...
NewMOFile::NewMOFile(const shared_ptr<const Reference> ref, const int nstart, const int nfence, const string method)
...
NewMOFile::NewMOFile(const shared_ptr<const Reference> ref, const int nstart, const int nfence, const shared_ptr<const Coeff> c, const string method)
