...
class SuperCI : public CASSCF {
  ...
  public:
    SuperCI(const boost::property_tree::ptree& idat, const std::shared_ptr<const Geometry> geom, const std::shared_ptr<const Reference> ref = std::shared_ptr<const Reference>())
