...
class Matrix : public Matrix_base<double>, public std::enable_shared_from_this<Matrix> {
  ...
  public:
    ...
    bool is_symmetric(const double thresh = 1.0e-6) const override;
    bool is_antisymmetric(const double thresh = 1.0e-6) const override;
    bool is_hermitian(const double thresh = 1.0e-6) const override { return is_symmetric(thresh); }
    bool is_identity(const double thresh = 1.0e-6) const override;
