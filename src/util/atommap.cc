...
//angmap.insert(make_pair("l", 9));
  ...
  nopen.insert(make_pair("la", make_tuple(0,0,1,0)));
  nopen.insert(make_pair("ce", make_tuple(0,0,1,1)));
  ...
  nopen.insert(make_pair("gd", make_tuple(0,0,1,7)));
  ...
  nopen.insert(make_pair("ac", make_tuple(0,0,1,0)));
  nopen.insert(make_pair("th", make_tuple(0,0,2,0)));
  nopen.insert(make_pair("pa", make_tuple(0,0,1,2)));
  nopen.insert(make_pair("u",  make_tuple(0,0,1,3)));
  nopen.insert(make_pair("np", make_tuple(0,0,1,4)));
  nopen.insert(make_pair("pu", make_tuple(0,0,0,6)));
  nopen.insert(make_pair("am", make_tuple(0,0,0,7)));
  nopen.insert(make_pair("cm", make_tuple(0,0,1,7)));
  ...
  nopen.insert(make_pair("lr", make_tuple(0,1,0,0)));
