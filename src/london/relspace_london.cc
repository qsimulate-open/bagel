...
//BOOST_CLASS_EXPORT_IMPLEMENT(bagel::RelSpace_London)

using namespace std;
using namespace bagel;

RelSpace_London::RelSpace_London(const int norb, const int nele, const bool mute, const bool linkup) {
