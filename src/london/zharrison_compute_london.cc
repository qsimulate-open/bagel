...
// Filename: zharrison_compute_london.cc
...
shared_ptr<RelZDvec_London> ZHarrison_London::form_sigma(shared_ptr<const RelZDvec_London> ccvec, shared_ptr<const RelMOFile_London> jop, const vector<int>& conv) const {
  auto sigmavec = make_shared<RelZDvec_London>(space_, nstate_);
...
void ZHarrison_London::sigma_one(shared_ptr<const ZCivec> cc, shared_ptr<RelZDvec_London> sigmavec, shared_ptr<const RelMOFile_London> jop,
...
void ZHarrison_London::sigma_aa(shared_ptr<const ZCivec> cc, shared_ptr<ZCivec> sigma, shared_ptr<const RelMOFile_London> jop, const bool trans) const {
...
void ZHarrison_London::sigma_1e_ab(shared_ptr<const ZCivec> cc, shared_ptr<ZCivec> sigma, shared_ptr<const RelMOFile_London> jop, const bool trans) const {
...
void ZHarrison_London::sigma_2e_annih_aa(shared_ptr<const ZCivec> cc, shared_ptr<ZDvec> d) const {
...
void ZHarrison_London::sigma_2e_annih_ab(shared_ptr<const ZCivec> cc, shared_ptr<ZDvec> d) const {
...
void ZHarrison_London::sigma_2e_create_ab(shared_ptr<ZCivec> sigma, shared_ptr<const ZDvec> e) const {
...
void ZHarrison_London::sigma_2e_create_bb(shared_ptr<ZCivec> sigma, shared_ptr<const ZDvec> e) const {
...
void ZHarrison_London::sigma_2e_h0101_h1001(shared_ptr<const ZDvec> d, shared_ptr<ZDvec> e, shared_ptr<const RelMOFile_London> jop) const {
  const int ij = d->ij();
