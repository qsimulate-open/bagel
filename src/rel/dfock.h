...
class DFock : public ZMatrix {
  protected:
    ...
    void add_Jop_block(std::shared_ptr<const DFData>, std::list<std::shared_ptr<const CDMatrix>>, bool gaunt, bool breit);
    void add_Exop_block(std::shared_ptr<DFHalfComplex>, std::shared_ptr<DFHalfComplex>, const double ecale_exch, bool gaunt, bool breit);
