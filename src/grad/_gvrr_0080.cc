...
void GVRRList::_gvrr_0080(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[32] = D00_[0] * data_[28] + B01_current[0] * data_[24];
  data_[33] = D00_[1] * data_[29] + B01_current[1] * data_[25];
  data_[34] = D00_[2] * data_[30] + B01_current[2] * data_[26];
  data_[35] = D00_[3] * data_[31] + B01_current[3] * data_[27];
}
