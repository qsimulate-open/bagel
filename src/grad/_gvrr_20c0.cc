...
void GVRRList::_gvrr_20c0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[231] = D00_[0] * data_[210] + B01_current[0] * data_[189];
  data_[232] = D00_[1] * data_[211] + B01_current[1] * data_[190];
  data_[233] = D00_[2] * data_[212] + B01_current[2] * data_[191];
  data_[234] = D00_[3] * data_[213] + B01_current[3] * data_[192];
  data_[235] = D00_[4] * data_[214] + B01_current[4] * data_[193];
  data_[236] = D00_[5] * data_[215] + B01_current[5] * data_[194];
  data_[237] = D00_[6] * data_[216] + B01_current[6] * data_[195];
  ...
  data_[238] = C00_[0] * data_[231] + cB00_current[0] * data_[210];
  data_[239] = C00_[1] * data_[232] + cB00_current[1] * data_[211];
  data_[240] = C00_[2] * data_[233] + cB00_current[2] * data_[212];
  data_[241] = C00_[3] * data_[234] + cB00_current[3] * data_[213];
  data_[242] = C00_[4] * data_[235] + cB00_current[4] * data_[214];
  data_[243] = C00_[5] * data_[236] + cB00_current[5] * data_[215];
  data_[244] = C00_[6] * data_[237] + cB00_current[6] * data_[216];

  data_[245] = C00_[0] * data_[238] + B10_[0] * data_[231] + cB00_current[0] * data_[217];
  data_[246] = C00_[1] * data_[239] + B10_[1] * data_[232] + cB00_current[1] * data_[218];
  data_[247] = C00_[2] * data_[240] + B10_[2] * data_[233] + cB00_current[2] * data_[219];
  data_[248] = C00_[3] * data_[241] + B10_[3] * data_[234] + cB00_current[3] * data_[220];
  data_[249] = C00_[4] * data_[242] + B10_[4] * data_[235] + cB00_current[4] * data_[221];
  data_[250] = C00_[5] * data_[243] + B10_[5] * data_[236] + cB00_current[5] * data_[222];
  data_[251] = C00_[6] * data_[244] + B10_[6] * data_[237] + cB00_current[6] * data_[223];
  ...
  data_[252] = D00_[0] * data_[231] + B01_current[0] * data_[210];
  data_[253] = D00_[1] * data_[232] + B01_current[1] * data_[211];
  data_[254] = D00_[2] * data_[233] + B01_current[2] * data_[212];
  data_[255] = D00_[3] * data_[234] + B01_current[3] * data_[213];
  data_[256] = D00_[4] * data_[235] + B01_current[4] * data_[214];
  data_[257] = D00_[5] * data_[236] + B01_current[5] * data_[215];
  data_[258] = D00_[6] * data_[237] + B01_current[6] * data_[216];
  ...
  data_[259] = C00_[0] * data_[252] + cB00_current[0] * data_[231];
  data_[260] = C00_[1] * data_[253] + cB00_current[1] * data_[232];
  data_[261] = C00_[2] * data_[254] + cB00_current[2] * data_[233];
  data_[262] = C00_[3] * data_[255] + cB00_current[3] * data_[234];
  data_[263] = C00_[4] * data_[256] + cB00_current[4] * data_[235];
  data_[264] = C00_[5] * data_[257] + cB00_current[5] * data_[236];
  data_[265] = C00_[6] * data_[258] + cB00_current[6] * data_[237];

  data_[266] = C00_[0] * data_[259] + B10_[0] * data_[252] + cB00_current[0] * data_[238];
  data_[267] = C00_[1] * data_[260] + B10_[1] * data_[253] + cB00_current[1] * data_[239];
  data_[268] = C00_[2] * data_[261] + B10_[2] * data_[254] + cB00_current[2] * data_[240];
  data_[269] = C00_[3] * data_[262] + B10_[3] * data_[255] + cB00_current[3] * data_[241];
  data_[270] = C00_[4] * data_[263] + B10_[4] * data_[256] + cB00_current[4] * data_[242];
  data_[271] = C00_[5] * data_[264] + B10_[5] * data_[257] + cB00_current[5] * data_[243];
  data_[272] = C00_[6] * data_[265] + B10_[6] * data_[258] + cB00_current[6] * data_[244];
}
