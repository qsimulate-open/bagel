...
void GVRRList::_gvrr_20a0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[162] = D00_[0] * data_[144] + B01_current[0] * data_[126];
  data_[163] = D00_[1] * data_[145] + B01_current[1] * data_[127];
  data_[164] = D00_[2] * data_[146] + B01_current[2] * data_[128];
  data_[165] = D00_[3] * data_[147] + B01_current[3] * data_[129];
  data_[166] = D00_[4] * data_[148] + B01_current[4] * data_[130];
  data_[167] = D00_[5] * data_[149] + B01_current[5] * data_[131];
  ...
  data_[168] = C00_[0] * data_[162] + cB00_current[0] * data_[144];
  data_[169] = C00_[1] * data_[163] + cB00_current[1] * data_[145];
  data_[170] = C00_[2] * data_[164] + cB00_current[2] * data_[146];
  data_[171] = C00_[3] * data_[165] + cB00_current[3] * data_[147];
  data_[172] = C00_[4] * data_[166] + cB00_current[4] * data_[148];
  data_[173] = C00_[5] * data_[167] + cB00_current[5] * data_[149];

  data_[174] = C00_[0] * data_[168] + B10_[0] * data_[162] + cB00_current[0] * data_[150];
  data_[175] = C00_[1] * data_[169] + B10_[1] * data_[163] + cB00_current[1] * data_[151];
  data_[176] = C00_[2] * data_[170] + B10_[2] * data_[164] + cB00_current[2] * data_[152];
  data_[177] = C00_[3] * data_[171] + B10_[3] * data_[165] + cB00_current[3] * data_[153];
  data_[178] = C00_[4] * data_[172] + B10_[4] * data_[166] + cB00_current[4] * data_[154];
  data_[179] = C00_[5] * data_[173] + B10_[5] * data_[167] + cB00_current[5] * data_[155];
  ...
  data_[180] = D00_[0] * data_[162] + B01_current[0] * data_[144];
  data_[181] = D00_[1] * data_[163] + B01_current[1] * data_[145];
  data_[182] = D00_[2] * data_[164] + B01_current[2] * data_[146];
  data_[183] = D00_[3] * data_[165] + B01_current[3] * data_[147];
  data_[184] = D00_[4] * data_[166] + B01_current[4] * data_[148];
  data_[185] = D00_[5] * data_[167] + B01_current[5] * data_[149];
  ...
  data_[186] = C00_[0] * data_[180] + cB00_current[0] * data_[162];
  data_[187] = C00_[1] * data_[181] + cB00_current[1] * data_[163];
  data_[188] = C00_[2] * data_[182] + cB00_current[2] * data_[164];
  data_[189] = C00_[3] * data_[183] + cB00_current[3] * data_[165];
  data_[190] = C00_[4] * data_[184] + cB00_current[4] * data_[166];
  data_[191] = C00_[5] * data_[185] + cB00_current[5] * data_[167];

  data_[192] = C00_[0] * data_[186] + B10_[0] * data_[180] + cB00_current[0] * data_[168];
  data_[193] = C00_[1] * data_[187] + B10_[1] * data_[181] + cB00_current[1] * data_[169];
  data_[194] = C00_[2] * data_[188] + B10_[2] * data_[182] + cB00_current[2] * data_[170];
  data_[195] = C00_[3] * data_[189] + B10_[3] * data_[183] + cB00_current[3] * data_[171];
  data_[196] = C00_[4] * data_[190] + B10_[4] * data_[184] + cB00_current[4] * data_[172];
  data_[197] = C00_[5] * data_[191] + B10_[5] * data_[185] + cB00_current[5] * data_[173];
}
