...
void GVRRList::_gvrr_20d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[288] = D00_[0] * data_[264] + B01_current[0] * data_[240];
  data_[289] = D00_[1] * data_[265] + B01_current[1] * data_[241];
  data_[290] = D00_[2] * data_[266] + B01_current[2] * data_[242];
  data_[291] = D00_[3] * data_[267] + B01_current[3] * data_[243];
  data_[292] = D00_[4] * data_[268] + B01_current[4] * data_[244];
  data_[293] = D00_[5] * data_[269] + B01_current[5] * data_[245];
  data_[294] = D00_[6] * data_[270] + B01_current[6] * data_[246];
  data_[295] = D00_[7] * data_[271] + B01_current[7] * data_[247];
  ...
  data_[296] = C00_[0] * data_[288] + cB00_current[0] * data_[264];
  data_[297] = C00_[1] * data_[289] + cB00_current[1] * data_[265];
  data_[298] = C00_[2] * data_[290] + cB00_current[2] * data_[266];
  data_[299] = C00_[3] * data_[291] + cB00_current[3] * data_[267];
  data_[300] = C00_[4] * data_[292] + cB00_current[4] * data_[268];
  data_[301] = C00_[5] * data_[293] + cB00_current[5] * data_[269];
  data_[302] = C00_[6] * data_[294] + cB00_current[6] * data_[270];
  data_[303] = C00_[7] * data_[295] + cB00_current[7] * data_[271];

  data_[304] = C00_[0] * data_[296] + B10_[0] * data_[288] + cB00_current[0] * data_[272];
  data_[305] = C00_[1] * data_[297] + B10_[1] * data_[289] + cB00_current[1] * data_[273];
  data_[306] = C00_[2] * data_[298] + B10_[2] * data_[290] + cB00_current[2] * data_[274];
  data_[307] = C00_[3] * data_[299] + B10_[3] * data_[291] + cB00_current[3] * data_[275];
  data_[308] = C00_[4] * data_[300] + B10_[4] * data_[292] + cB00_current[4] * data_[276];
  data_[309] = C00_[5] * data_[301] + B10_[5] * data_[293] + cB00_current[5] * data_[277];
  data_[310] = C00_[6] * data_[302] + B10_[6] * data_[294] + cB00_current[6] * data_[278];
  data_[311] = C00_[7] * data_[303] + B10_[7] * data_[295] + cB00_current[7] * data_[279];
  ...
  data_[312] = D00_[0] * data_[288] + B01_current[0] * data_[264];
  data_[313] = D00_[1] * data_[289] + B01_current[1] * data_[265];
  data_[314] = D00_[2] * data_[290] + B01_current[2] * data_[266];
  data_[315] = D00_[3] * data_[291] + B01_current[3] * data_[267];
  data_[316] = D00_[4] * data_[292] + B01_current[4] * data_[268];
  data_[317] = D00_[5] * data_[293] + B01_current[5] * data_[269];
  data_[318] = D00_[6] * data_[294] + B01_current[6] * data_[270];
  data_[319] = D00_[7] * data_[295] + B01_current[7] * data_[271];
  ...
  data_[320] = C00_[0] * data_[312] + cB00_current[0] * data_[288];
  data_[321] = C00_[1] * data_[313] + cB00_current[1] * data_[289];
  data_[322] = C00_[2] * data_[314] + cB00_current[2] * data_[290];
  data_[323] = C00_[3] * data_[315] + cB00_current[3] * data_[291];
  data_[324] = C00_[4] * data_[316] + cB00_current[4] * data_[292];
  data_[325] = C00_[5] * data_[317] + cB00_current[5] * data_[293];
  data_[326] = C00_[6] * data_[318] + cB00_current[6] * data_[294];
  data_[327] = C00_[7] * data_[319] + cB00_current[7] * data_[295];

  data_[328] = C00_[0] * data_[320] + B10_[0] * data_[312] + cB00_current[0] * data_[296];
  data_[329] = C00_[1] * data_[321] + B10_[1] * data_[313] + cB00_current[1] * data_[297];
  data_[330] = C00_[2] * data_[322] + B10_[2] * data_[314] + cB00_current[2] * data_[298];
  data_[331] = C00_[3] * data_[323] + B10_[3] * data_[315] + cB00_current[3] * data_[299];
  data_[332] = C00_[4] * data_[324] + B10_[4] * data_[316] + cB00_current[4] * data_[300];
  data_[333] = C00_[5] * data_[325] + B10_[5] * data_[317] + cB00_current[5] * data_[301];
  data_[334] = C00_[6] * data_[326] + B10_[6] * data_[318] + cB00_current[6] * data_[302];
  data_[335] = C00_[7] * data_[327] + B10_[7] * data_[319] + cB00_current[7] * data_[303];
}
