...
class NacmType {
  ...
  public:
    ...
    bool full() const { return type_ == Nacms::full; }
    bool interstate() const { return type_ == Nacms::interstate; }
    bool etf() const { return type_ == Nacms::etf; }
    bool noweight() const { return type_ == Nacms::noweight; }
};
