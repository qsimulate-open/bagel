...
void GVRRList::_gvrr_1050(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  ...
  data_[33] = C00_[0] * data_[30] + cB00_current[0] * data_[24];
  data_[34] = C00_[1] * data_[31] + cB00_current[1] * data_[25];
  data_[35] = C00_[2] * data_[32] + cB00_current[2] * data_[26];
}
