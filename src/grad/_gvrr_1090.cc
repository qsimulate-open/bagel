...
void GVRRList::_gvrr_1090(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[80] = D00_[0] * data_[70] + B01_current[0] * data_[60];
  data_[81] = D00_[1] * data_[71] + B01_current[1] * data_[61];
  data_[82] = D00_[2] * data_[72] + B01_current[2] * data_[62];
  data_[83] = D00_[3] * data_[73] + B01_current[3] * data_[63];
  data_[84] = D00_[4] * data_[74] + B01_current[4] * data_[64];
  ...
  data_[85] = C00_[0] * data_[80] + cB00_current[0] * data_[70];
  data_[86] = C00_[1] * data_[81] + cB00_current[1] * data_[71];
  data_[87] = C00_[2] * data_[82] + cB00_current[2] * data_[72];
  data_[88] = C00_[3] * data_[83] + cB00_current[3] * data_[73];
  data_[89] = C00_[4] * data_[84] + cB00_current[4] * data_[74];
  ...
  data_[90] = D00_[0] * data_[80] + B01_current[0] * data_[70];
  data_[91] = D00_[1] * data_[81] + B01_current[1] * data_[71];
  data_[92] = D00_[2] * data_[82] + B01_current[2] * data_[72];
  data_[93] = D00_[3] * data_[83] + B01_current[3] * data_[73];
  data_[94] = D00_[4] * data_[84] + B01_current[4] * data_[74];
  ...
  data_[95] = C00_[0] * data_[90] + cB00_current[0] * data_[80];
  data_[96] = C00_[1] * data_[91] + cB00_current[1] * data_[81];
  data_[97] = C00_[2] * data_[92] + cB00_current[2] * data_[82];
  data_[98] = C00_[3] * data_[93] + cB00_current[3] * data_[83];
  data_[99] = C00_[4] * data_[94] + cB00_current[4] * data_[84];
}
