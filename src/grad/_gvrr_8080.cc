...
void GVRRList::_gvrr_8080(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[440] = C00_[0] * data_[432] + cB00_current[0] * data_[360];
  data_[441] = C00_[1] * data_[433] + cB00_current[1] * data_[361];
  data_[442] = C00_[2] * data_[434] + cB00_current[2] * data_[362];
  data_[443] = C00_[3] * data_[435] + cB00_current[3] * data_[363];
  data_[444] = C00_[4] * data_[436] + cB00_current[4] * data_[364];
  data_[445] = C00_[5] * data_[437] + cB00_current[5] * data_[365];
  data_[446] = C00_[6] * data_[438] + cB00_current[6] * data_[366];
  data_[447] = C00_[7] * data_[439] + cB00_current[7] * data_[367];
  ...
  data_[448] = C00_[0] * data_[440] + B10_current[0] * data_[432] + cB00_current[0] * data_[368];
  data_[449] = C00_[1] * data_[441] + B10_current[1] * data_[433] + cB00_current[1] * data_[369];
  data_[450] = C00_[2] * data_[442] + B10_current[2] * data_[434] + cB00_current[2] * data_[370];
  data_[451] = C00_[3] * data_[443] + B10_current[3] * data_[435] + cB00_current[3] * data_[371];
  data_[452] = C00_[4] * data_[444] + B10_current[4] * data_[436] + cB00_current[4] * data_[372];
  data_[453] = C00_[5] * data_[445] + B10_current[5] * data_[437] + cB00_current[5] * data_[373];
  data_[454] = C00_[6] * data_[446] + B10_current[6] * data_[438] + cB00_current[6] * data_[374];
  data_[455] = C00_[7] * data_[447] + B10_current[7] * data_[439] + cB00_current[7] * data_[375];
  ...
  data_[456] = C00_[0] * data_[448] + B10_current[0] * data_[440] + cB00_current[0] * data_[376];
  data_[457] = C00_[1] * data_[449] + B10_current[1] * data_[441] + cB00_current[1] * data_[377];
  data_[458] = C00_[2] * data_[450] + B10_current[2] * data_[442] + cB00_current[2] * data_[378];
  data_[459] = C00_[3] * data_[451] + B10_current[3] * data_[443] + cB00_current[3] * data_[379];
  data_[460] = C00_[4] * data_[452] + B10_current[4] * data_[444] + cB00_current[4] * data_[380];
  data_[461] = C00_[5] * data_[453] + B10_current[5] * data_[445] + cB00_current[5] * data_[381];
  data_[462] = C00_[6] * data_[454] + B10_current[6] * data_[446] + cB00_current[6] * data_[382];
  data_[463] = C00_[7] * data_[455] + B10_current[7] * data_[447] + cB00_current[7] * data_[383];
  ...
  data_[464] = C00_[0] * data_[456] + B10_current[0] * data_[448] + cB00_current[0] * data_[384];
  data_[465] = C00_[1] * data_[457] + B10_current[1] * data_[449] + cB00_current[1] * data_[385];
  data_[466] = C00_[2] * data_[458] + B10_current[2] * data_[450] + cB00_current[2] * data_[386];
  data_[467] = C00_[3] * data_[459] + B10_current[3] * data_[451] + cB00_current[3] * data_[387];
  data_[468] = C00_[4] * data_[460] + B10_current[4] * data_[452] + cB00_current[4] * data_[388];
  data_[469] = C00_[5] * data_[461] + B10_current[5] * data_[453] + cB00_current[5] * data_[389];
  data_[470] = C00_[6] * data_[462] + B10_current[6] * data_[454] + cB00_current[6] * data_[390];
  data_[471] = C00_[7] * data_[463] + B10_current[7] * data_[455] + cB00_current[7] * data_[391];
  ...
  data_[472] = C00_[0] * data_[464] + B10_current[0] * data_[456] + cB00_current[0] * data_[392];
  data_[473] = C00_[1] * data_[465] + B10_current[1] * data_[457] + cB00_current[1] * data_[393];
  data_[474] = C00_[2] * data_[466] + B10_current[2] * data_[458] + cB00_current[2] * data_[394];
  data_[475] = C00_[3] * data_[467] + B10_current[3] * data_[459] + cB00_current[3] * data_[395];
  data_[476] = C00_[4] * data_[468] + B10_current[4] * data_[460] + cB00_current[4] * data_[396];
  data_[477] = C00_[5] * data_[469] + B10_current[5] * data_[461] + cB00_current[5] * data_[397];
  data_[478] = C00_[6] * data_[470] + B10_current[6] * data_[462] + cB00_current[6] * data_[398];
  data_[479] = C00_[7] * data_[471] + B10_current[7] * data_[463] + cB00_current[7] * data_[399];
  ...
  data_[480] = C00_[0] * data_[472] + B10_current[0] * data_[464] + cB00_current[0] * data_[400];
  data_[481] = C00_[1] * data_[473] + B10_current[1] * data_[465] + cB00_current[1] * data_[401];
  data_[482] = C00_[2] * data_[474] + B10_current[2] * data_[466] + cB00_current[2] * data_[402];
  data_[483] = C00_[3] * data_[475] + B10_current[3] * data_[467] + cB00_current[3] * data_[403];
  data_[484] = C00_[4] * data_[476] + B10_current[4] * data_[468] + cB00_current[4] * data_[404];
  data_[485] = C00_[5] * data_[477] + B10_current[5] * data_[469] + cB00_current[5] * data_[405];
  data_[486] = C00_[6] * data_[478] + B10_current[6] * data_[470] + cB00_current[6] * data_[406];
  data_[487] = C00_[7] * data_[479] + B10_current[7] * data_[471] + cB00_current[7] * data_[407];
  ...
  data_[488] = C00_[0] * data_[480] + B10_current[0] * data_[472] + cB00_current[0] * data_[408];
  data_[489] = C00_[1] * data_[481] + B10_current[1] * data_[473] + cB00_current[1] * data_[409];
  data_[490] = C00_[2] * data_[482] + B10_current[2] * data_[474] + cB00_current[2] * data_[410];
  data_[491] = C00_[3] * data_[483] + B10_current[3] * data_[475] + cB00_current[3] * data_[411];
  data_[492] = C00_[4] * data_[484] + B10_current[4] * data_[476] + cB00_current[4] * data_[412];
  data_[493] = C00_[5] * data_[485] + B10_current[5] * data_[477] + cB00_current[5] * data_[413];
  data_[494] = C00_[6] * data_[486] + B10_current[6] * data_[478] + cB00_current[6] * data_[414];
  data_[495] = C00_[7] * data_[487] + B10_current[7] * data_[479] + cB00_current[7] * data_[415];
  ...
  data_[496] = C00_[0] * data_[488] + B10_current[0] * data_[480] + cB00_current[0] * data_[416];
  data_[497] = C00_[1] * data_[489] + B10_current[1] * data_[481] + cB00_current[1] * data_[417];
  data_[498] = C00_[2] * data_[490] + B10_current[2] * data_[482] + cB00_current[2] * data_[418];
  data_[499] = C00_[3] * data_[491] + B10_current[3] * data_[483] + cB00_current[3] * data_[419];
  data_[500] = C00_[4] * data_[492] + B10_current[4] * data_[484] + cB00_current[4] * data_[420];
  data_[501] = C00_[5] * data_[493] + B10_current[5] * data_[485] + cB00_current[5] * data_[421];
  data_[502] = C00_[6] * data_[494] + B10_current[6] * data_[486] + cB00_current[6] * data_[422];
  data_[503] = C00_[7] * data_[495] + B10_current[7] * data_[487] + cB00_current[7] * data_[423];
  ...
  data_[512] = C00_[0] * data_[504] + cB00_current[0] * data_[432];
  data_[513] = C00_[1] * data_[505] + cB00_current[1] * data_[433];
  data_[514] = C00_[2] * data_[506] + cB00_current[2] * data_[434];
  data_[515] = C00_[3] * data_[507] + cB00_current[3] * data_[435];
  data_[516] = C00_[4] * data_[508] + cB00_current[4] * data_[436];
  data_[517] = C00_[5] * data_[509] + cB00_current[5] * data_[437];
  data_[518] = C00_[6] * data_[510] + cB00_current[6] * data_[438];
  data_[519] = C00_[7] * data_[511] + cB00_current[7] * data_[439];
  ...
  data_[520] = C00_[0] * data_[512] + B10_current[0] * data_[504] + cB00_current[0] * data_[440];
  data_[521] = C00_[1] * data_[513] + B10_current[1] * data_[505] + cB00_current[1] * data_[441];
  data_[522] = C00_[2] * data_[514] + B10_current[2] * data_[506] + cB00_current[2] * data_[442];
  data_[523] = C00_[3] * data_[515] + B10_current[3] * data_[507] + cB00_current[3] * data_[443];
  data_[524] = C00_[4] * data_[516] + B10_current[4] * data_[508] + cB00_current[4] * data_[444];
  data_[525] = C00_[5] * data_[517] + B10_current[5] * data_[509] + cB00_current[5] * data_[445];
  data_[526] = C00_[6] * data_[518] + B10_current[6] * data_[510] + cB00_current[6] * data_[446];
  data_[527] = C00_[7] * data_[519] + B10_current[7] * data_[511] + cB00_current[7] * data_[447];
  ...
  data_[528] = C00_[0] * data_[520] + B10_current[0] * data_[512] + cB00_current[0] * data_[448];
  data_[529] = C00_[1] * data_[521] + B10_current[1] * data_[513] + cB00_current[1] * data_[449];
  data_[530] = C00_[2] * data_[522] + B10_current[2] * data_[514] + cB00_current[2] * data_[450];
  data_[531] = C00_[3] * data_[523] + B10_current[3] * data_[515] + cB00_current[3] * data_[451];
  data_[532] = C00_[4] * data_[524] + B10_current[4] * data_[516] + cB00_current[4] * data_[452];
  data_[533] = C00_[5] * data_[525] + B10_current[5] * data_[517] + cB00_current[5] * data_[453];
  data_[534] = C00_[6] * data_[526] + B10_current[6] * data_[518] + cB00_current[6] * data_[454];
  data_[535] = C00_[7] * data_[527] + B10_current[7] * data_[519] + cB00_current[7] * data_[455];
  ...
  data_[536] = C00_[0] * data_[528] + B10_current[0] * data_[520] + cB00_current[0] * data_[456];
  data_[537] = C00_[1] * data_[529] + B10_current[1] * data_[521] + cB00_current[1] * data_[457];
  data_[538] = C00_[2] * data_[530] + B10_current[2] * data_[522] + cB00_current[2] * data_[458];
  data_[539] = C00_[3] * data_[531] + B10_current[3] * data_[523] + cB00_current[3] * data_[459];
  data_[540] = C00_[4] * data_[532] + B10_current[4] * data_[524] + cB00_current[4] * data_[460];
  data_[541] = C00_[5] * data_[533] + B10_current[5] * data_[525] + cB00_current[5] * data_[461];
  data_[542] = C00_[6] * data_[534] + B10_current[6] * data_[526] + cB00_current[6] * data_[462];
  data_[543] = C00_[7] * data_[535] + B10_current[7] * data_[527] + cB00_current[7] * data_[463];
  ...
  data_[544] = C00_[0] * data_[536] + B10_current[0] * data_[528] + cB00_current[0] * data_[464];
  data_[545] = C00_[1] * data_[537] + B10_current[1] * data_[529] + cB00_current[1] * data_[465];
  data_[546] = C00_[2] * data_[538] + B10_current[2] * data_[530] + cB00_current[2] * data_[466];
  data_[547] = C00_[3] * data_[539] + B10_current[3] * data_[531] + cB00_current[3] * data_[467];
  data_[548] = C00_[4] * data_[540] + B10_current[4] * data_[532] + cB00_current[4] * data_[468];
  data_[549] = C00_[5] * data_[541] + B10_current[5] * data_[533] + cB00_current[5] * data_[469];
  data_[550] = C00_[6] * data_[542] + B10_current[6] * data_[534] + cB00_current[6] * data_[470];
  data_[551] = C00_[7] * data_[543] + B10_current[7] * data_[535] + cB00_current[7] * data_[471];
  ...
  data_[552] = C00_[0] * data_[544] + B10_current[0] * data_[536] + cB00_current[0] * data_[472];
  data_[553] = C00_[1] * data_[545] + B10_current[1] * data_[537] + cB00_current[1] * data_[473];
  data_[554] = C00_[2] * data_[546] + B10_current[2] * data_[538] + cB00_current[2] * data_[474];
  data_[555] = C00_[3] * data_[547] + B10_current[3] * data_[539] + cB00_current[3] * data_[475];
  data_[556] = C00_[4] * data_[548] + B10_current[4] * data_[540] + cB00_current[4] * data_[476];
  data_[557] = C00_[5] * data_[549] + B10_current[5] * data_[541] + cB00_current[5] * data_[477];
  data_[558] = C00_[6] * data_[550] + B10_current[6] * data_[542] + cB00_current[6] * data_[478];
  data_[559] = C00_[7] * data_[551] + B10_current[7] * data_[543] + cB00_current[7] * data_[479];
  ...
  data_[560] = C00_[0] * data_[552] + B10_current[0] * data_[544] + cB00_current[0] * data_[480];
  data_[561] = C00_[1] * data_[553] + B10_current[1] * data_[545] + cB00_current[1] * data_[481];
  data_[562] = C00_[2] * data_[554] + B10_current[2] * data_[546] + cB00_current[2] * data_[482];
  data_[563] = C00_[3] * data_[555] + B10_current[3] * data_[547] + cB00_current[3] * data_[483];
  data_[564] = C00_[4] * data_[556] + B10_current[4] * data_[548] + cB00_current[4] * data_[484];
  data_[565] = C00_[5] * data_[557] + B10_current[5] * data_[549] + cB00_current[5] * data_[485];
  data_[566] = C00_[6] * data_[558] + B10_current[6] * data_[550] + cB00_current[6] * data_[486];
  data_[567] = C00_[7] * data_[559] + B10_current[7] * data_[551] + cB00_current[7] * data_[487];
  ...
  data_[568] = C00_[0] * data_[560] + B10_current[0] * data_[552] + cB00_current[0] * data_[488];
  data_[569] = C00_[1] * data_[561] + B10_current[1] * data_[553] + cB00_current[1] * data_[489];
  data_[570] = C00_[2] * data_[562] + B10_current[2] * data_[554] + cB00_current[2] * data_[490];
  data_[571] = C00_[3] * data_[563] + B10_current[3] * data_[555] + cB00_current[3] * data_[491];
  data_[572] = C00_[4] * data_[564] + B10_current[4] * data_[556] + cB00_current[4] * data_[492];
  data_[573] = C00_[5] * data_[565] + B10_current[5] * data_[557] + cB00_current[5] * data_[493];
  data_[574] = C00_[6] * data_[566] + B10_current[6] * data_[558] + cB00_current[6] * data_[494];
  data_[575] = C00_[7] * data_[567] + B10_current[7] * data_[559] + cB00_current[7] * data_[495];
  ...
  data_[584] = C00_[0] * data_[576] + cB00_current[0] * data_[504];
  data_[585] = C00_[1] * data_[577] + cB00_current[1] * data_[505];
  data_[586] = C00_[2] * data_[578] + cB00_current[2] * data_[506];
  data_[587] = C00_[3] * data_[579] + cB00_current[3] * data_[507];
  data_[588] = C00_[4] * data_[580] + cB00_current[4] * data_[508];
  data_[589] = C00_[5] * data_[581] + cB00_current[5] * data_[509];
  data_[590] = C00_[6] * data_[582] + cB00_current[6] * data_[510];
  data_[591] = C00_[7] * data_[583] + cB00_current[7] * data_[511];
  ...
  data_[592] = C00_[0] * data_[584] + B10_current[0] * data_[576] + cB00_current[0] * data_[512];
  data_[593] = C00_[1] * data_[585] + B10_current[1] * data_[577] + cB00_current[1] * data_[513];
  data_[594] = C00_[2] * data_[586] + B10_current[2] * data_[578] + cB00_current[2] * data_[514];
  data_[595] = C00_[3] * data_[587] + B10_current[3] * data_[579] + cB00_current[3] * data_[515];
  data_[596] = C00_[4] * data_[588] + B10_current[4] * data_[580] + cB00_current[4] * data_[516];
  data_[597] = C00_[5] * data_[589] + B10_current[5] * data_[581] + cB00_current[5] * data_[517];
  data_[598] = C00_[6] * data_[590] + B10_current[6] * data_[582] + cB00_current[6] * data_[518];
  data_[599] = C00_[7] * data_[591] + B10_current[7] * data_[583] + cB00_current[7] * data_[519];
  ...
  data_[600] = C00_[0] * data_[592] + B10_current[0] * data_[584] + cB00_current[0] * data_[520];
  data_[601] = C00_[1] * data_[593] + B10_current[1] * data_[585] + cB00_current[1] * data_[521];
  data_[602] = C00_[2] * data_[594] + B10_current[2] * data_[586] + cB00_current[2] * data_[522];
  data_[603] = C00_[3] * data_[595] + B10_current[3] * data_[587] + cB00_current[3] * data_[523];
  data_[604] = C00_[4] * data_[596] + B10_current[4] * data_[588] + cB00_current[4] * data_[524];
  data_[605] = C00_[5] * data_[597] + B10_current[5] * data_[589] + cB00_current[5] * data_[525];
  data_[606] = C00_[6] * data_[598] + B10_current[6] * data_[590] + cB00_current[6] * data_[526];
  data_[607] = C00_[7] * data_[599] + B10_current[7] * data_[591] + cB00_current[7] * data_[527];
  ...
  data_[608] = C00_[0] * data_[600] + B10_current[0] * data_[592] + cB00_current[0] * data_[528];
  data_[609] = C00_[1] * data_[601] + B10_current[1] * data_[593] + cB00_current[1] * data_[529];
  data_[610] = C00_[2] * data_[602] + B10_current[2] * data_[594] + cB00_current[2] * data_[530];
  data_[611] = C00_[3] * data_[603] + B10_current[3] * data_[595] + cB00_current[3] * data_[531];
  data_[612] = C00_[4] * data_[604] + B10_current[4] * data_[596] + cB00_current[4] * data_[532];
  data_[613] = C00_[5] * data_[605] + B10_current[5] * data_[597] + cB00_current[5] * data_[533];
  data_[614] = C00_[6] * data_[606] + B10_current[6] * data_[598] + cB00_current[6] * data_[534];
  data_[615] = C00_[7] * data_[607] + B10_current[7] * data_[599] + cB00_current[7] * data_[535];
  ...
  data_[616] = C00_[0] * data_[608] + B10_current[0] * data_[600] + cB00_current[0] * data_[536];
  data_[617] = C00_[1] * data_[609] + B10_current[1] * data_[601] + cB00_current[1] * data_[537];
  data_[618] = C00_[2] * data_[610] + B10_current[2] * data_[602] + cB00_current[2] * data_[538];
  data_[619] = C00_[3] * data_[611] + B10_current[3] * data_[603] + cB00_current[3] * data_[539];
  data_[620] = C00_[4] * data_[612] + B10_current[4] * data_[604] + cB00_current[4] * data_[540];
  data_[621] = C00_[5] * data_[613] + B10_current[5] * data_[605] + cB00_current[5] * data_[541];
  data_[622] = C00_[6] * data_[614] + B10_current[6] * data_[606] + cB00_current[6] * data_[542];
  data_[623] = C00_[7] * data_[615] + B10_current[7] * data_[607] + cB00_current[7] * data_[543];
  ...
  data_[624] = C00_[0] * data_[616] + B10_current[0] * data_[608] + cB00_current[0] * data_[544];
  data_[625] = C00_[1] * data_[617] + B10_current[1] * data_[609] + cB00_current[1] * data_[545];
  data_[626] = C00_[2] * data_[618] + B10_current[2] * data_[610] + cB00_current[2] * data_[546];
  data_[627] = C00_[3] * data_[619] + B10_current[3] * data_[611] + cB00_current[3] * data_[547];
  data_[628] = C00_[4] * data_[620] + B10_current[4] * data_[612] + cB00_current[4] * data_[548];
  data_[629] = C00_[5] * data_[621] + B10_current[5] * data_[613] + cB00_current[5] * data_[549];
  data_[630] = C00_[6] * data_[622] + B10_current[6] * data_[614] + cB00_current[6] * data_[550];
  data_[631] = C00_[7] * data_[623] + B10_current[7] * data_[615] + cB00_current[7] * data_[551];
  ...
  data_[632] = C00_[0] * data_[624] + B10_current[0] * data_[616] + cB00_current[0] * data_[552];
  data_[633] = C00_[1] * data_[625] + B10_current[1] * data_[617] + cB00_current[1] * data_[553];
  data_[634] = C00_[2] * data_[626] + B10_current[2] * data_[618] + cB00_current[2] * data_[554];
  data_[635] = C00_[3] * data_[627] + B10_current[3] * data_[619] + cB00_current[3] * data_[555];
  data_[636] = C00_[4] * data_[628] + B10_current[4] * data_[620] + cB00_current[4] * data_[556];
  data_[637] = C00_[5] * data_[629] + B10_current[5] * data_[621] + cB00_current[5] * data_[557];
  data_[638] = C00_[6] * data_[630] + B10_current[6] * data_[622] + cB00_current[6] * data_[558];
  data_[639] = C00_[7] * data_[631] + B10_current[7] * data_[623] + cB00_current[7] * data_[559];
  ...
  data_[640] = C00_[0] * data_[632] + B10_current[0] * data_[624] + cB00_current[0] * data_[560];
  data_[641] = C00_[1] * data_[633] + B10_current[1] * data_[625] + cB00_current[1] * data_[561];
  data_[642] = C00_[2] * data_[634] + B10_current[2] * data_[626] + cB00_current[2] * data_[562];
  data_[643] = C00_[3] * data_[635] + B10_current[3] * data_[627] + cB00_current[3] * data_[563];
  data_[644] = C00_[4] * data_[636] + B10_current[4] * data_[628] + cB00_current[4] * data_[564];
  data_[645] = C00_[5] * data_[637] + B10_current[5] * data_[629] + cB00_current[5] * data_[565];
  data_[646] = C00_[6] * data_[638] + B10_current[6] * data_[630] + cB00_current[6] * data_[566];
  data_[647] = C00_[7] * data_[639] + B10_current[7] * data_[631] + cB00_current[7] * data_[567];
}
