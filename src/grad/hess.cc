...
//TODO Fix this code and incoroprate the "if statement" into the analytical gradient part... don't need so much repition... just different ways to compute gradient...

// section to compute reference enrgy is only needed for numforce
#if 0
  if (numforce_) {
