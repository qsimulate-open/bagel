...
void GVRRList::_gvrr_6080(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[294] = D00_[0] * data_[245] + B01_current[0] * data_[196];
  data_[295] = D00_[1] * data_[246] + B01_current[1] * data_[197];
  data_[296] = D00_[2] * data_[247] + B01_current[2] * data_[198];
  data_[297] = D00_[3] * data_[248] + B01_current[3] * data_[199];
  data_[298] = D00_[4] * data_[249] + B01_current[4] * data_[200];
  data_[299] = D00_[5] * data_[250] + B01_current[5] * data_[201];
  data_[300] = D00_[6] * data_[251] + B01_current[6] * data_[202];
  ...
  data_[301] = C00_[0] * data_[294] + cB00_current[0] * data_[245];
  data_[302] = C00_[1] * data_[295] + cB00_current[1] * data_[246];
  data_[303] = C00_[2] * data_[296] + cB00_current[2] * data_[247];
  data_[304] = C00_[3] * data_[297] + cB00_current[3] * data_[248];
  data_[305] = C00_[4] * data_[298] + cB00_current[4] * data_[249];
  data_[306] = C00_[5] * data_[299] + cB00_current[5] * data_[250];
  data_[307] = C00_[6] * data_[300] + cB00_current[6] * data_[251];
  ...
  data_[308] = C00_[0] * data_[301] + B10_current[0] * data_[294] + cB00_current[0] * data_[252];
  data_[309] = C00_[1] * data_[302] + B10_current[1] * data_[295] + cB00_current[1] * data_[253];
  data_[310] = C00_[2] * data_[303] + B10_current[2] * data_[296] + cB00_current[2] * data_[254];
  data_[311] = C00_[3] * data_[304] + B10_current[3] * data_[297] + cB00_current[3] * data_[255];
  data_[312] = C00_[4] * data_[305] + B10_current[4] * data_[298] + cB00_current[4] * data_[256];
  data_[313] = C00_[5] * data_[306] + B10_current[5] * data_[299] + cB00_current[5] * data_[257];
  data_[314] = C00_[6] * data_[307] + B10_current[6] * data_[300] + cB00_current[6] * data_[258];
  ...
  data_[315] = C00_[0] * data_[308] + B10_current[0] * data_[301] + cB00_current[0] * data_[259];
  data_[316] = C00_[1] * data_[309] + B10_current[1] * data_[302] + cB00_current[1] * data_[260];
  data_[317] = C00_[2] * data_[310] + B10_current[2] * data_[303] + cB00_current[2] * data_[261];
  data_[318] = C00_[3] * data_[311] + B10_current[3] * data_[304] + cB00_current[3] * data_[262];
  data_[319] = C00_[4] * data_[312] + B10_current[4] * data_[305] + cB00_current[4] * data_[263];
  data_[320] = C00_[5] * data_[313] + B10_current[5] * data_[306] + cB00_current[5] * data_[264];
  data_[321] = C00_[6] * data_[314] + B10_current[6] * data_[307] + cB00_current[6] * data_[265];
  ...
  data_[322] = C00_[0] * data_[315] + B10_current[0] * data_[308] + cB00_current[0] * data_[266];
  data_[323] = C00_[1] * data_[316] + B10_current[1] * data_[309] + cB00_current[1] * data_[267];
  data_[324] = C00_[2] * data_[317] + B10_current[2] * data_[310] + cB00_current[2] * data_[268];
  data_[325] = C00_[3] * data_[318] + B10_current[3] * data_[311] + cB00_current[3] * data_[269];
  data_[326] = C00_[4] * data_[319] + B10_current[4] * data_[312] + cB00_current[4] * data_[270];
  data_[327] = C00_[5] * data_[320] + B10_current[5] * data_[313] + cB00_current[5] * data_[271];
  data_[328] = C00_[6] * data_[321] + B10_current[6] * data_[314] + cB00_current[6] * data_[272];
  ...
  data_[329] = C00_[0] * data_[322] + B10_current[0] * data_[315] + cB00_current[0] * data_[273];
  data_[330] = C00_[1] * data_[323] + B10_current[1] * data_[316] + cB00_current[1] * data_[274];
  data_[331] = C00_[2] * data_[324] + B10_current[2] * data_[317] + cB00_current[2] * data_[275];
  data_[332] = C00_[3] * data_[325] + B10_current[3] * data_[318] + cB00_current[3] * data_[276];
  data_[333] = C00_[4] * data_[326] + B10_current[4] * data_[319] + cB00_current[4] * data_[277];
  data_[334] = C00_[5] * data_[327] + B10_current[5] * data_[320] + cB00_current[5] * data_[278];
  data_[335] = C00_[6] * data_[328] + B10_current[6] * data_[321] + cB00_current[6] * data_[279];
  ...
  data_[336] = C00_[0] * data_[329] + B10_current[0] * data_[322] + cB00_current[0] * data_[280];
  data_[337] = C00_[1] * data_[330] + B10_current[1] * data_[323] + cB00_current[1] * data_[281];
  data_[338] = C00_[2] * data_[331] + B10_current[2] * data_[324] + cB00_current[2] * data_[282];
  data_[339] = C00_[3] * data_[332] + B10_current[3] * data_[325] + cB00_current[3] * data_[283];
  data_[340] = C00_[4] * data_[333] + B10_current[4] * data_[326] + cB00_current[4] * data_[284];
  data_[341] = C00_[5] * data_[334] + B10_current[5] * data_[327] + cB00_current[5] * data_[285];
  data_[342] = C00_[6] * data_[335] + B10_current[6] * data_[328] + cB00_current[6] * data_[286];
  ...
  data_[343] = D00_[0] * data_[294] + B01_current[0] * data_[245];
  data_[344] = D00_[1] * data_[295] + B01_current[1] * data_[246];
  data_[345] = D00_[2] * data_[296] + B01_current[2] * data_[247];
  data_[346] = D00_[3] * data_[297] + B01_current[3] * data_[248];
  data_[347] = D00_[4] * data_[298] + B01_current[4] * data_[249];
  data_[348] = D00_[5] * data_[299] + B01_current[5] * data_[250];
  data_[349] = D00_[6] * data_[300] + B01_current[6] * data_[251];
  ...
  data_[350] = C00_[0] * data_[343] + cB00_current[0] * data_[294];
  data_[351] = C00_[1] * data_[344] + cB00_current[1] * data_[295];
  data_[352] = C00_[2] * data_[345] + cB00_current[2] * data_[296];
  data_[353] = C00_[3] * data_[346] + cB00_current[3] * data_[297];
  data_[354] = C00_[4] * data_[347] + cB00_current[4] * data_[298];
  data_[355] = C00_[5] * data_[348] + cB00_current[5] * data_[299];
  data_[356] = C00_[6] * data_[349] + cB00_current[6] * data_[300];
  ...
  data_[357] = C00_[0] * data_[350] + B10_current[0] * data_[343] + cB00_current[0] * data_[301];
  data_[358] = C00_[1] * data_[351] + B10_current[1] * data_[344] + cB00_current[1] * data_[302];
  data_[359] = C00_[2] * data_[352] + B10_current[2] * data_[345] + cB00_current[2] * data_[303];
  data_[360] = C00_[3] * data_[353] + B10_current[3] * data_[346] + cB00_current[3] * data_[304];
  data_[361] = C00_[4] * data_[354] + B10_current[4] * data_[347] + cB00_current[4] * data_[305];
  data_[362] = C00_[5] * data_[355] + B10_current[5] * data_[348] + cB00_current[5] * data_[306];
  data_[363] = C00_[6] * data_[356] + B10_current[6] * data_[349] + cB00_current[6] * data_[307];
  ...
  data_[364] = C00_[0] * data_[357] + B10_current[0] * data_[350] + cB00_current[0] * data_[308];
  data_[365] = C00_[1] * data_[358] + B10_current[1] * data_[351] + cB00_current[1] * data_[309];
  data_[366] = C00_[2] * data_[359] + B10_current[2] * data_[352] + cB00_current[2] * data_[310];
  data_[367] = C00_[3] * data_[360] + B10_current[3] * data_[353] + cB00_current[3] * data_[311];
  data_[368] = C00_[4] * data_[361] + B10_current[4] * data_[354] + cB00_current[4] * data_[312];
  data_[369] = C00_[5] * data_[362] + B10_current[5] * data_[355] + cB00_current[5] * data_[313];
  data_[370] = C00_[6] * data_[363] + B10_current[6] * data_[356] + cB00_current[6] * data_[314];
  ...
  data_[371] = C00_[0] * data_[364] + B10_current[0] * data_[357] + cB00_current[0] * data_[315];
  data_[372] = C00_[1] * data_[365] + B10_current[1] * data_[358] + cB00_current[1] * data_[316];
  data_[373] = C00_[2] * data_[366] + B10_current[2] * data_[359] + cB00_current[2] * data_[317];
  data_[374] = C00_[3] * data_[367] + B10_current[3] * data_[360] + cB00_current[3] * data_[318];
  data_[375] = C00_[4] * data_[368] + B10_current[4] * data_[361] + cB00_current[4] * data_[319];
  data_[376] = C00_[5] * data_[369] + B10_current[5] * data_[362] + cB00_current[5] * data_[320];
  data_[377] = C00_[6] * data_[370] + B10_current[6] * data_[363] + cB00_current[6] * data_[321];
  ...
  data_[378] = C00_[0] * data_[371] + B10_current[0] * data_[364] + cB00_current[0] * data_[322];
  data_[379] = C00_[1] * data_[372] + B10_current[1] * data_[365] + cB00_current[1] * data_[323];
  data_[380] = C00_[2] * data_[373] + B10_current[2] * data_[366] + cB00_current[2] * data_[324];
  data_[381] = C00_[3] * data_[374] + B10_current[3] * data_[367] + cB00_current[3] * data_[325];
  data_[382] = C00_[4] * data_[375] + B10_current[4] * data_[368] + cB00_current[4] * data_[326];
  data_[383] = C00_[5] * data_[376] + B10_current[5] * data_[369] + cB00_current[5] * data_[327];
  data_[384] = C00_[6] * data_[377] + B10_current[6] * data_[370] + cB00_current[6] * data_[328];
  ...
  data_[385] = C00_[0] * data_[378] + B10_current[0] * data_[371] + cB00_current[0] * data_[329];
  data_[386] = C00_[1] * data_[379] + B10_current[1] * data_[372] + cB00_current[1] * data_[330];
  data_[387] = C00_[2] * data_[380] + B10_current[2] * data_[373] + cB00_current[2] * data_[331];
  data_[388] = C00_[3] * data_[381] + B10_current[3] * data_[374] + cB00_current[3] * data_[332];
  data_[389] = C00_[4] * data_[382] + B10_current[4] * data_[375] + cB00_current[4] * data_[333];
  data_[390] = C00_[5] * data_[383] + B10_current[5] * data_[376] + cB00_current[5] * data_[334];
  data_[391] = C00_[6] * data_[384] + B10_current[6] * data_[377] + cB00_current[6] * data_[335];
  ...
  data_[392] = D00_[0] * data_[343] + B01_current[0] * data_[294];
  data_[393] = D00_[1] * data_[344] + B01_current[1] * data_[295];
  data_[394] = D00_[2] * data_[345] + B01_current[2] * data_[296];
  data_[395] = D00_[3] * data_[346] + B01_current[3] * data_[297];
  data_[396] = D00_[4] * data_[347] + B01_current[4] * data_[298];
  data_[397] = D00_[5] * data_[348] + B01_current[5] * data_[299];
  data_[398] = D00_[6] * data_[349] + B01_current[6] * data_[300];
  ...
  data_[399] = C00_[0] * data_[392] + cB00_current[0] * data_[343];
  data_[400] = C00_[1] * data_[393] + cB00_current[1] * data_[344];
  data_[401] = C00_[2] * data_[394] + cB00_current[2] * data_[345];
  data_[402] = C00_[3] * data_[395] + cB00_current[3] * data_[346];
  data_[403] = C00_[4] * data_[396] + cB00_current[4] * data_[347];
  data_[404] = C00_[5] * data_[397] + cB00_current[5] * data_[348];
  data_[405] = C00_[6] * data_[398] + cB00_current[6] * data_[349];
  ...
  data_[406] = C00_[0] * data_[399] + B10_current[0] * data_[392] + cB00_current[0] * data_[350];
  data_[407] = C00_[1] * data_[400] + B10_current[1] * data_[393] + cB00_current[1] * data_[351];
  data_[408] = C00_[2] * data_[401] + B10_current[2] * data_[394] + cB00_current[2] * data_[352];
  data_[409] = C00_[3] * data_[402] + B10_current[3] * data_[395] + cB00_current[3] * data_[353];
  data_[410] = C00_[4] * data_[403] + B10_current[4] * data_[396] + cB00_current[4] * data_[354];
  data_[411] = C00_[5] * data_[404] + B10_current[5] * data_[397] + cB00_current[5] * data_[355];
  data_[412] = C00_[6] * data_[405] + B10_current[6] * data_[398] + cB00_current[6] * data_[356];
  ...
  data_[413] = C00_[0] * data_[406] + B10_current[0] * data_[399] + cB00_current[0] * data_[357];
  data_[414] = C00_[1] * data_[407] + B10_current[1] * data_[400] + cB00_current[1] * data_[358];
  data_[415] = C00_[2] * data_[408] + B10_current[2] * data_[401] + cB00_current[2] * data_[359];
  data_[416] = C00_[3] * data_[409] + B10_current[3] * data_[402] + cB00_current[3] * data_[360];
  data_[417] = C00_[4] * data_[410] + B10_current[4] * data_[403] + cB00_current[4] * data_[361];
  data_[418] = C00_[5] * data_[411] + B10_current[5] * data_[404] + cB00_current[5] * data_[362];
  data_[419] = C00_[6] * data_[412] + B10_current[6] * data_[405] + cB00_current[6] * data_[363];
  ...
  data_[420] = C00_[0] * data_[413] + B10_current[0] * data_[406] + cB00_current[0] * data_[364];
  data_[421] = C00_[1] * data_[414] + B10_current[1] * data_[407] + cB00_current[1] * data_[365];
  data_[422] = C00_[2] * data_[415] + B10_current[2] * data_[408] + cB00_current[2] * data_[366];
  data_[423] = C00_[3] * data_[416] + B10_current[3] * data_[409] + cB00_current[3] * data_[367];
  data_[424] = C00_[4] * data_[417] + B10_current[4] * data_[410] + cB00_current[4] * data_[368];
  data_[425] = C00_[5] * data_[418] + B10_current[5] * data_[411] + cB00_current[5] * data_[369];
  data_[426] = C00_[6] * data_[419] + B10_current[6] * data_[412] + cB00_current[6] * data_[370];
  ...
  data_[427] = C00_[0] * data_[420] + B10_current[0] * data_[413] + cB00_current[0] * data_[371];
  data_[428] = C00_[1] * data_[421] + B10_current[1] * data_[414] + cB00_current[1] * data_[372];
  data_[429] = C00_[2] * data_[422] + B10_current[2] * data_[415] + cB00_current[2] * data_[373];
  data_[430] = C00_[3] * data_[423] + B10_current[3] * data_[416] + cB00_current[3] * data_[374];
  data_[431] = C00_[4] * data_[424] + B10_current[4] * data_[417] + cB00_current[4] * data_[375];
  data_[432] = C00_[5] * data_[425] + B10_current[5] * data_[418] + cB00_current[5] * data_[376];
  data_[433] = C00_[6] * data_[426] + B10_current[6] * data_[419] + cB00_current[6] * data_[377];
  ...
  data_[434] = C00_[0] * data_[427] + B10_current[0] * data_[420] + cB00_current[0] * data_[378];
  data_[435] = C00_[1] * data_[428] + B10_current[1] * data_[421] + cB00_current[1] * data_[379];
  data_[436] = C00_[2] * data_[429] + B10_current[2] * data_[422] + cB00_current[2] * data_[380];
  data_[437] = C00_[3] * data_[430] + B10_current[3] * data_[423] + cB00_current[3] * data_[381];
  data_[438] = C00_[4] * data_[431] + B10_current[4] * data_[424] + cB00_current[4] * data_[382];
  data_[439] = C00_[5] * data_[432] + B10_current[5] * data_[425] + cB00_current[5] * data_[383];
  data_[440] = C00_[6] * data_[433] + B10_current[6] * data_[426] + cB00_current[6] * data_[384];
}
