...
// returns double array of length 175
void GVRRList::_gvrr_6040(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[110] = C00_[0] * data_[105] + cB00_current[0] * data_[70];
  data_[111] = C00_[1] * data_[106] + cB00_current[1] * data_[71];
  data_[112] = C00_[2] * data_[107] + cB00_current[2] * data_[72];
  data_[113] = C00_[3] * data_[108] + cB00_current[3] * data_[73];
  data_[114] = C00_[4] * data_[109] + cB00_current[4] * data_[74];
  ...
  data_[115] = C00_[0] * data_[110] + B10_current[0] * data_[105] + cB00_current[0] * data_[75];
  data_[116] = C00_[1] * data_[111] + B10_current[1] * data_[106] + cB00_current[1] * data_[76];
  data_[117] = C00_[2] * data_[112] + B10_current[2] * data_[107] + cB00_current[2] * data_[77];
  data_[118] = C00_[3] * data_[113] + B10_current[3] * data_[108] + cB00_current[3] * data_[78];
  data_[119] = C00_[4] * data_[114] + B10_current[4] * data_[109] + cB00_current[4] * data_[79];
  ...
  data_[120] = C00_[0] * data_[115] + B10_current[0] * data_[110] + cB00_current[0] * data_[80];
  data_[121] = C00_[1] * data_[116] + B10_current[1] * data_[111] + cB00_current[1] * data_[81];
  data_[122] = C00_[2] * data_[117] + B10_current[2] * data_[112] + cB00_current[2] * data_[82];
  data_[123] = C00_[3] * data_[118] + B10_current[3] * data_[113] + cB00_current[3] * data_[83];
  data_[124] = C00_[4] * data_[119] + B10_current[4] * data_[114] + cB00_current[4] * data_[84];
  ...
  data_[125] = C00_[0] * data_[120] + B10_current[0] * data_[115] + cB00_current[0] * data_[85];
  data_[126] = C00_[1] * data_[121] + B10_current[1] * data_[116] + cB00_current[1] * data_[86];
  data_[127] = C00_[2] * data_[122] + B10_current[2] * data_[117] + cB00_current[2] * data_[87];
  data_[128] = C00_[3] * data_[123] + B10_current[3] * data_[118] + cB00_current[3] * data_[88];
  data_[129] = C00_[4] * data_[124] + B10_current[4] * data_[119] + cB00_current[4] * data_[89];
  ...
  data_[130] = C00_[0] * data_[125] + B10_current[0] * data_[120] + cB00_current[0] * data_[90];
  data_[131] = C00_[1] * data_[126] + B10_current[1] * data_[121] + cB00_current[1] * data_[91];
  data_[132] = C00_[2] * data_[127] + B10_current[2] * data_[122] + cB00_current[2] * data_[92];
  data_[133] = C00_[3] * data_[128] + B10_current[3] * data_[123] + cB00_current[3] * data_[93];
  data_[134] = C00_[4] * data_[129] + B10_current[4] * data_[124] + cB00_current[4] * data_[94];
  ...
  data_[135] = C00_[0] * data_[130] + B10_current[0] * data_[125] + cB00_current[0] * data_[95];
  data_[136] = C00_[1] * data_[131] + B10_current[1] * data_[126] + cB00_current[1] * data_[96];
  data_[137] = C00_[2] * data_[132] + B10_current[2] * data_[127] + cB00_current[2] * data_[97];
  data_[138] = C00_[3] * data_[133] + B10_current[3] * data_[128] + cB00_current[3] * data_[98];
  data_[139] = C00_[4] * data_[134] + B10_current[4] * data_[129] + cB00_current[4] * data_[99];
  ...
  data_[145] = C00_[0] * data_[140] + cB00_current[0] * data_[105];
  data_[146] = C00_[1] * data_[141] + cB00_current[1] * data_[106];
  data_[147] = C00_[2] * data_[142] + cB00_current[2] * data_[107];
  data_[148] = C00_[3] * data_[143] + cB00_current[3] * data_[108];
  data_[149] = C00_[4] * data_[144] + cB00_current[4] * data_[109];
  ...
  data_[150] = C00_[0] * data_[145] + B10_current[0] * data_[140] + cB00_current[0] * data_[110];
  data_[151] = C00_[1] * data_[146] + B10_current[1] * data_[141] + cB00_current[1] * data_[111];
  data_[152] = C00_[2] * data_[147] + B10_current[2] * data_[142] + cB00_current[2] * data_[112];
  data_[153] = C00_[3] * data_[148] + B10_current[3] * data_[143] + cB00_current[3] * data_[113];
  data_[154] = C00_[4] * data_[149] + B10_current[4] * data_[144] + cB00_current[4] * data_[114];
  ...
  data_[155] = C00_[0] * data_[150] + B10_current[0] * data_[145] + cB00_current[0] * data_[115];
  data_[156] = C00_[1] * data_[151] + B10_current[1] * data_[146] + cB00_current[1] * data_[116];
  data_[157] = C00_[2] * data_[152] + B10_current[2] * data_[147] + cB00_current[2] * data_[117];
  data_[158] = C00_[3] * data_[153] + B10_current[3] * data_[148] + cB00_current[3] * data_[118];
  data_[159] = C00_[4] * data_[154] + B10_current[4] * data_[149] + cB00_current[4] * data_[119];
  ...
  data_[160] = C00_[0] * data_[155] + B10_current[0] * data_[150] + cB00_current[0] * data_[120];
  data_[161] = C00_[1] * data_[156] + B10_current[1] * data_[151] + cB00_current[1] * data_[121];
  data_[162] = C00_[2] * data_[157] + B10_current[2] * data_[152] + cB00_current[2] * data_[122];
  data_[163] = C00_[3] * data_[158] + B10_current[3] * data_[153] + cB00_current[3] * data_[123];
  data_[164] = C00_[4] * data_[159] + B10_current[4] * data_[154] + cB00_current[4] * data_[124];
  ...
  data_[165] = C00_[0] * data_[160] + B10_current[0] * data_[155] + cB00_current[0] * data_[125];
  data_[166] = C00_[1] * data_[161] + B10_current[1] * data_[156] + cB00_current[1] * data_[126];
  data_[167] = C00_[2] * data_[162] + B10_current[2] * data_[157] + cB00_current[2] * data_[127];
  data_[168] = C00_[3] * data_[163] + B10_current[3] * data_[158] + cB00_current[3] * data_[128];
  data_[169] = C00_[4] * data_[164] + B10_current[4] * data_[159] + cB00_current[4] * data_[129];
  ...
  data_[170] = C00_[0] * data_[165] + B10_current[0] * data_[160] + cB00_current[0] * data_[130];
  data_[171] = C00_[1] * data_[166] + B10_current[1] * data_[161] + cB00_current[1] * data_[131];
  data_[172] = C00_[2] * data_[167] + B10_current[2] * data_[162] + cB00_current[2] * data_[132];
  data_[173] = C00_[3] * data_[168] + B10_current[3] * data_[163] + cB00_current[3] * data_[133];
  data_[174] = C00_[4] * data_[169] + B10_current[4] * data_[164] + cB00_current[4] * data_[134];
}
