...
void GVRRList::_gvrr_70b0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[792] = D00_[0] * data_[720] + B01_current[0] * data_[648];
  data_[793] = D00_[1] * data_[721] + B01_current[1] * data_[649];
  data_[794] = D00_[2] * data_[722] + B01_current[2] * data_[650];
  data_[795] = D00_[3] * data_[723] + B01_current[3] * data_[651];
  data_[796] = D00_[4] * data_[724] + B01_current[4] * data_[652];
  data_[797] = D00_[5] * data_[725] + B01_current[5] * data_[653];
  data_[798] = D00_[6] * data_[726] + B01_current[6] * data_[654];
  data_[799] = D00_[7] * data_[727] + B01_current[7] * data_[655];
  data_[800] = D00_[8] * data_[728] + B01_current[8] * data_[656];
  ...
  data_[801] = C00_[0] * data_[792] + cB00_current[0] * data_[720];
  data_[802] = C00_[1] * data_[793] + cB00_current[1] * data_[721];
  data_[803] = C00_[2] * data_[794] + cB00_current[2] * data_[722];
  data_[804] = C00_[3] * data_[795] + cB00_current[3] * data_[723];
  data_[805] = C00_[4] * data_[796] + cB00_current[4] * data_[724];
  data_[806] = C00_[5] * data_[797] + cB00_current[5] * data_[725];
  data_[807] = C00_[6] * data_[798] + cB00_current[6] * data_[726];
  data_[808] = C00_[7] * data_[799] + cB00_current[7] * data_[727];
  data_[809] = C00_[8] * data_[800] + cB00_current[8] * data_[728];
  ...
  data_[810] = C00_[0] * data_[801] + B10_current[0] * data_[792] + cB00_current[0] * data_[729];
  data_[811] = C00_[1] * data_[802] + B10_current[1] * data_[793] + cB00_current[1] * data_[730];
  data_[812] = C00_[2] * data_[803] + B10_current[2] * data_[794] + cB00_current[2] * data_[731];
  data_[813] = C00_[3] * data_[804] + B10_current[3] * data_[795] + cB00_current[3] * data_[732];
  data_[814] = C00_[4] * data_[805] + B10_current[4] * data_[796] + cB00_current[4] * data_[733];
  data_[815] = C00_[5] * data_[806] + B10_current[5] * data_[797] + cB00_current[5] * data_[734];
  data_[816] = C00_[6] * data_[807] + B10_current[6] * data_[798] + cB00_current[6] * data_[735];
  data_[817] = C00_[7] * data_[808] + B10_current[7] * data_[799] + cB00_current[7] * data_[736];
  data_[818] = C00_[8] * data_[809] + B10_current[8] * data_[800] + cB00_current[8] * data_[737];
  ...
  data_[819] = C00_[0] * data_[810] + B10_current[0] * data_[801] + cB00_current[0] * data_[738];
  data_[820] = C00_[1] * data_[811] + B10_current[1] * data_[802] + cB00_current[1] * data_[739];
  data_[821] = C00_[2] * data_[812] + B10_current[2] * data_[803] + cB00_current[2] * data_[740];
  data_[822] = C00_[3] * data_[813] + B10_current[3] * data_[804] + cB00_current[3] * data_[741];
  data_[823] = C00_[4] * data_[814] + B10_current[4] * data_[805] + cB00_current[4] * data_[742];
  data_[824] = C00_[5] * data_[815] + B10_current[5] * data_[806] + cB00_current[5] * data_[743];
  data_[825] = C00_[6] * data_[816] + B10_current[6] * data_[807] + cB00_current[6] * data_[744];
  data_[826] = C00_[7] * data_[817] + B10_current[7] * data_[808] + cB00_current[7] * data_[745];
  data_[827] = C00_[8] * data_[818] + B10_current[8] * data_[809] + cB00_current[8] * data_[746];
  ...
  data_[828] = C00_[0] * data_[819] + B10_current[0] * data_[810] + cB00_current[0] * data_[747];
  data_[829] = C00_[1] * data_[820] + B10_current[1] * data_[811] + cB00_current[1] * data_[748];
  data_[830] = C00_[2] * data_[821] + B10_current[2] * data_[812] + cB00_current[2] * data_[749];
  data_[831] = C00_[3] * data_[822] + B10_current[3] * data_[813] + cB00_current[3] * data_[750];
  data_[832] = C00_[4] * data_[823] + B10_current[4] * data_[814] + cB00_current[4] * data_[751];
  data_[833] = C00_[5] * data_[824] + B10_current[5] * data_[815] + cB00_current[5] * data_[752];
  data_[834] = C00_[6] * data_[825] + B10_current[6] * data_[816] + cB00_current[6] * data_[753];
  data_[835] = C00_[7] * data_[826] + B10_current[7] * data_[817] + cB00_current[7] * data_[754];
  data_[836] = C00_[8] * data_[827] + B10_current[8] * data_[818] + cB00_current[8] * data_[755];
  ...
  data_[837] = C00_[0] * data_[828] + B10_current[0] * data_[819] + cB00_current[0] * data_[756];
  data_[838] = C00_[1] * data_[829] + B10_current[1] * data_[820] + cB00_current[1] * data_[757];
  data_[839] = C00_[2] * data_[830] + B10_current[2] * data_[821] + cB00_current[2] * data_[758];
  data_[840] = C00_[3] * data_[831] + B10_current[3] * data_[822] + cB00_current[3] * data_[759];
  data_[841] = C00_[4] * data_[832] + B10_current[4] * data_[823] + cB00_current[4] * data_[760];
  data_[842] = C00_[5] * data_[833] + B10_current[5] * data_[824] + cB00_current[5] * data_[761];
  data_[843] = C00_[6] * data_[834] + B10_current[6] * data_[825] + cB00_current[6] * data_[762];
  data_[844] = C00_[7] * data_[835] + B10_current[7] * data_[826] + cB00_current[7] * data_[763];
  data_[845] = C00_[8] * data_[836] + B10_current[8] * data_[827] + cB00_current[8] * data_[764];
  ...
  data_[846] = C00_[0] * data_[837] + B10_current[0] * data_[828] + cB00_current[0] * data_[765];
  data_[847] = C00_[1] * data_[838] + B10_current[1] * data_[829] + cB00_current[1] * data_[766];
  data_[848] = C00_[2] * data_[839] + B10_current[2] * data_[830] + cB00_current[2] * data_[767];
  data_[849] = C00_[3] * data_[840] + B10_current[3] * data_[831] + cB00_current[3] * data_[768];
  data_[850] = C00_[4] * data_[841] + B10_current[4] * data_[832] + cB00_current[4] * data_[769];
  data_[851] = C00_[5] * data_[842] + B10_current[5] * data_[833] + cB00_current[5] * data_[770];
  data_[852] = C00_[6] * data_[843] + B10_current[6] * data_[834] + cB00_current[6] * data_[771];
  data_[853] = C00_[7] * data_[844] + B10_current[7] * data_[835] + cB00_current[7] * data_[772];
  data_[854] = C00_[8] * data_[845] + B10_current[8] * data_[836] + cB00_current[8] * data_[773];
  ...
  data_[855] = C00_[0] * data_[846] + B10_current[0] * data_[837] + cB00_current[0] * data_[774];
  data_[856] = C00_[1] * data_[847] + B10_current[1] * data_[838] + cB00_current[1] * data_[775];
  data_[857] = C00_[2] * data_[848] + B10_current[2] * data_[839] + cB00_current[2] * data_[776];
  data_[858] = C00_[3] * data_[849] + B10_current[3] * data_[840] + cB00_current[3] * data_[777];
  data_[859] = C00_[4] * data_[850] + B10_current[4] * data_[841] + cB00_current[4] * data_[778];
  data_[860] = C00_[5] * data_[851] + B10_current[5] * data_[842] + cB00_current[5] * data_[779];
  data_[861] = C00_[6] * data_[852] + B10_current[6] * data_[843] + cB00_current[6] * data_[780];
  data_[862] = C00_[7] * data_[853] + B10_current[7] * data_[844] + cB00_current[7] * data_[781];
  data_[863] = C00_[8] * data_[854] + B10_current[8] * data_[845] + cB00_current[8] * data_[782];
}
