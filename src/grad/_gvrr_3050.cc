...
void GVRRList::_gvrr_3050(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[84] = C00_[0] * data_[80] + cB00_current[0] * data_[64];
  data_[85] = C00_[1] * data_[81] + cB00_current[1] * data_[65];
  data_[86] = C00_[2] * data_[82] + cB00_current[2] * data_[66];
  data_[87] = C00_[3] * data_[83] + cB00_current[3] * data_[67];
  ...
  data_[88] = C00_[0] * data_[84] + B10_current[0] * data_[80] + cB00_current[0] * data_[68];
  data_[89] = C00_[1] * data_[85] + B10_current[1] * data_[81] + cB00_current[1] * data_[69];
  data_[90] = C00_[2] * data_[86] + B10_current[2] * data_[82] + cB00_current[2] * data_[70];
  data_[91] = C00_[3] * data_[87] + B10_current[3] * data_[83] + cB00_current[3] * data_[71];
  ...
  data_[92] = C00_[0] * data_[88] + B10_current[0] * data_[84] + cB00_current[0] * data_[72];
  data_[93] = C00_[1] * data_[89] + B10_current[1] * data_[85] + cB00_current[1] * data_[73];
  data_[94] = C00_[2] * data_[90] + B10_current[2] * data_[86] + cB00_current[2] * data_[74];
  data_[95] = C00_[3] * data_[91] + B10_current[3] * data_[87] + cB00_current[3] * data_[75];
}
