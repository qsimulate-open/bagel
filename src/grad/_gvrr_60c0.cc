...
void GVRRList::_gvrr_60c0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[693] = D00_[0] * data_[630] + B01_current[0] * data_[567];
  data_[694] = D00_[1] * data_[631] + B01_current[1] * data_[568];
  data_[695] = D00_[2] * data_[632] + B01_current[2] * data_[569];
  data_[696] = D00_[3] * data_[633] + B01_current[3] * data_[570];
  data_[697] = D00_[4] * data_[634] + B01_current[4] * data_[571];
  data_[698] = D00_[5] * data_[635] + B01_current[5] * data_[572];
  data_[699] = D00_[6] * data_[636] + B01_current[6] * data_[573];
  data_[700] = D00_[7] * data_[637] + B01_current[7] * data_[574];
  data_[701] = D00_[8] * data_[638] + B01_current[8] * data_[575];
  ...
  data_[702] = C00_[0] * data_[693] + cB00_current[0] * data_[630];
  data_[703] = C00_[1] * data_[694] + cB00_current[1] * data_[631];
  data_[704] = C00_[2] * data_[695] + cB00_current[2] * data_[632];
  data_[705] = C00_[3] * data_[696] + cB00_current[3] * data_[633];
  data_[706] = C00_[4] * data_[697] + cB00_current[4] * data_[634];
  data_[707] = C00_[5] * data_[698] + cB00_current[5] * data_[635];
  data_[708] = C00_[6] * data_[699] + cB00_current[6] * data_[636];
  data_[709] = C00_[7] * data_[700] + cB00_current[7] * data_[637];
  data_[710] = C00_[8] * data_[701] + cB00_current[8] * data_[638];
  ...
  data_[711] = C00_[0] * data_[702] + B10_current[0] * data_[693] + cB00_current[0] * data_[639];
  data_[712] = C00_[1] * data_[703] + B10_current[1] * data_[694] + cB00_current[1] * data_[640];
  data_[713] = C00_[2] * data_[704] + B10_current[2] * data_[695] + cB00_current[2] * data_[641];
  data_[714] = C00_[3] * data_[705] + B10_current[3] * data_[696] + cB00_current[3] * data_[642];
  data_[715] = C00_[4] * data_[706] + B10_current[4] * data_[697] + cB00_current[4] * data_[643];
  data_[716] = C00_[5] * data_[707] + B10_current[5] * data_[698] + cB00_current[5] * data_[644];
  data_[717] = C00_[6] * data_[708] + B10_current[6] * data_[699] + cB00_current[6] * data_[645];
  data_[718] = C00_[7] * data_[709] + B10_current[7] * data_[700] + cB00_current[7] * data_[646];
  data_[719] = C00_[8] * data_[710] + B10_current[8] * data_[701] + cB00_current[8] * data_[647];
  ...
  data_[720] = C00_[0] * data_[711] + B10_current[0] * data_[702] + cB00_current[0] * data_[648];
  data_[721] = C00_[1] * data_[712] + B10_current[1] * data_[703] + cB00_current[1] * data_[649];
  data_[722] = C00_[2] * data_[713] + B10_current[2] * data_[704] + cB00_current[2] * data_[650];
  data_[723] = C00_[3] * data_[714] + B10_current[3] * data_[705] + cB00_current[3] * data_[651];
  data_[724] = C00_[4] * data_[715] + B10_current[4] * data_[706] + cB00_current[4] * data_[652];
  data_[725] = C00_[5] * data_[716] + B10_current[5] * data_[707] + cB00_current[5] * data_[653];
  data_[726] = C00_[6] * data_[717] + B10_current[6] * data_[708] + cB00_current[6] * data_[654];
  data_[727] = C00_[7] * data_[718] + B10_current[7] * data_[709] + cB00_current[7] * data_[655];
  data_[728] = C00_[8] * data_[719] + B10_current[8] * data_[710] + cB00_current[8] * data_[656];
  ...
  data_[729] = C00_[0] * data_[720] + B10_current[0] * data_[711] + cB00_current[0] * data_[657];
  data_[730] = C00_[1] * data_[721] + B10_current[1] * data_[712] + cB00_current[1] * data_[658];
  data_[731] = C00_[2] * data_[722] + B10_current[2] * data_[713] + cB00_current[2] * data_[659];
  data_[732] = C00_[3] * data_[723] + B10_current[3] * data_[714] + cB00_current[3] * data_[660];
  data_[733] = C00_[4] * data_[724] + B10_current[4] * data_[715] + cB00_current[4] * data_[661];
  data_[734] = C00_[5] * data_[725] + B10_current[5] * data_[716] + cB00_current[5] * data_[662];
  data_[735] = C00_[6] * data_[726] + B10_current[6] * data_[717] + cB00_current[6] * data_[663];
  data_[736] = C00_[7] * data_[727] + B10_current[7] * data_[718] + cB00_current[7] * data_[664];
  data_[737] = C00_[8] * data_[728] + B10_current[8] * data_[719] + cB00_current[8] * data_[665];
  ...
  data_[738] = C00_[0] * data_[729] + B10_current[0] * data_[720] + cB00_current[0] * data_[666];
  data_[739] = C00_[1] * data_[730] + B10_current[1] * data_[721] + cB00_current[1] * data_[667];
  data_[740] = C00_[2] * data_[731] + B10_current[2] * data_[722] + cB00_current[2] * data_[668];
  data_[741] = C00_[3] * data_[732] + B10_current[3] * data_[723] + cB00_current[3] * data_[669];
  data_[742] = C00_[4] * data_[733] + B10_current[4] * data_[724] + cB00_current[4] * data_[670];
  data_[743] = C00_[5] * data_[734] + B10_current[5] * data_[725] + cB00_current[5] * data_[671];
  data_[744] = C00_[6] * data_[735] + B10_current[6] * data_[726] + cB00_current[6] * data_[672];
  data_[745] = C00_[7] * data_[736] + B10_current[7] * data_[727] + cB00_current[7] * data_[673];
  data_[746] = C00_[8] * data_[737] + B10_current[8] * data_[728] + cB00_current[8] * data_[674];
  ...
  data_[747] = C00_[0] * data_[738] + B10_current[0] * data_[729] + cB00_current[0] * data_[675];
  data_[748] = C00_[1] * data_[739] + B10_current[1] * data_[730] + cB00_current[1] * data_[676];
  data_[749] = C00_[2] * data_[740] + B10_current[2] * data_[731] + cB00_current[2] * data_[677];
  data_[750] = C00_[3] * data_[741] + B10_current[3] * data_[732] + cB00_current[3] * data_[678];
  data_[751] = C00_[4] * data_[742] + B10_current[4] * data_[733] + cB00_current[4] * data_[679];
  data_[752] = C00_[5] * data_[743] + B10_current[5] * data_[734] + cB00_current[5] * data_[680];
  data_[753] = C00_[6] * data_[744] + B10_current[6] * data_[735] + cB00_current[6] * data_[681];
  data_[754] = C00_[7] * data_[745] + B10_current[7] * data_[736] + cB00_current[7] * data_[682];
  data_[755] = C00_[8] * data_[746] + B10_current[8] * data_[737] + cB00_current[8] * data_[683];
  ...
  data_[756] = D00_[0] * data_[693] + B01_current[0] * data_[630];
  data_[757] = D00_[1] * data_[694] + B01_current[1] * data_[631];
  data_[758] = D00_[2] * data_[695] + B01_current[2] * data_[632];
  data_[759] = D00_[3] * data_[696] + B01_current[3] * data_[633];
  data_[760] = D00_[4] * data_[697] + B01_current[4] * data_[634];
  data_[761] = D00_[5] * data_[698] + B01_current[5] * data_[635];
  data_[762] = D00_[6] * data_[699] + B01_current[6] * data_[636];
  data_[763] = D00_[7] * data_[700] + B01_current[7] * data_[637];
  data_[764] = D00_[8] * data_[701] + B01_current[8] * data_[638];
  ...
  data_[765] = C00_[0] * data_[756] + cB00_current[0] * data_[693];
  data_[766] = C00_[1] * data_[757] + cB00_current[1] * data_[694];
  data_[767] = C00_[2] * data_[758] + cB00_current[2] * data_[695];
  data_[768] = C00_[3] * data_[759] + cB00_current[3] * data_[696];
  data_[769] = C00_[4] * data_[760] + cB00_current[4] * data_[697];
  data_[770] = C00_[5] * data_[761] + cB00_current[5] * data_[698];
  data_[771] = C00_[6] * data_[762] + cB00_current[6] * data_[699];
  data_[772] = C00_[7] * data_[763] + cB00_current[7] * data_[700];
  data_[773] = C00_[8] * data_[764] + cB00_current[8] * data_[701];
  ...
  data_[774] = C00_[0] * data_[765] + B10_current[0] * data_[756] + cB00_current[0] * data_[702];
  data_[775] = C00_[1] * data_[766] + B10_current[1] * data_[757] + cB00_current[1] * data_[703];
  data_[776] = C00_[2] * data_[767] + B10_current[2] * data_[758] + cB00_current[2] * data_[704];
  data_[777] = C00_[3] * data_[768] + B10_current[3] * data_[759] + cB00_current[3] * data_[705];
  data_[778] = C00_[4] * data_[769] + B10_current[4] * data_[760] + cB00_current[4] * data_[706];
  data_[779] = C00_[5] * data_[770] + B10_current[5] * data_[761] + cB00_current[5] * data_[707];
  data_[780] = C00_[6] * data_[771] + B10_current[6] * data_[762] + cB00_current[6] * data_[708];
  data_[781] = C00_[7] * data_[772] + B10_current[7] * data_[763] + cB00_current[7] * data_[709];
  data_[782] = C00_[8] * data_[773] + B10_current[8] * data_[764] + cB00_current[8] * data_[710];
  ...
  data_[783] = C00_[0] * data_[774] + B10_current[0] * data_[765] + cB00_current[0] * data_[711];
  data_[784] = C00_[1] * data_[775] + B10_current[1] * data_[766] + cB00_current[1] * data_[712];
  data_[785] = C00_[2] * data_[776] + B10_current[2] * data_[767] + cB00_current[2] * data_[713];
  data_[786] = C00_[3] * data_[777] + B10_current[3] * data_[768] + cB00_current[3] * data_[714];
  data_[787] = C00_[4] * data_[778] + B10_current[4] * data_[769] + cB00_current[4] * data_[715];
  data_[788] = C00_[5] * data_[779] + B10_current[5] * data_[770] + cB00_current[5] * data_[716];
  data_[789] = C00_[6] * data_[780] + B10_current[6] * data_[771] + cB00_current[6] * data_[717];
  data_[790] = C00_[7] * data_[781] + B10_current[7] * data_[772] + cB00_current[7] * data_[718];
  data_[791] = C00_[8] * data_[782] + B10_current[8] * data_[773] + cB00_current[8] * data_[719];
  ...
  data_[792] = C00_[0] * data_[783] + B10_current[0] * data_[774] + cB00_current[0] * data_[720];
  data_[793] = C00_[1] * data_[784] + B10_current[1] * data_[775] + cB00_current[1] * data_[721];
  data_[794] = C00_[2] * data_[785] + B10_current[2] * data_[776] + cB00_current[2] * data_[722];
  data_[795] = C00_[3] * data_[786] + B10_current[3] * data_[777] + cB00_current[3] * data_[723];
  data_[796] = C00_[4] * data_[787] + B10_current[4] * data_[778] + cB00_current[4] * data_[724];
  data_[797] = C00_[5] * data_[788] + B10_current[5] * data_[779] + cB00_current[5] * data_[725];
  data_[798] = C00_[6] * data_[789] + B10_current[6] * data_[780] + cB00_current[6] * data_[726];
  data_[799] = C00_[7] * data_[790] + B10_current[7] * data_[781] + cB00_current[7] * data_[727];
  data_[800] = C00_[8] * data_[791] + B10_current[8] * data_[782] + cB00_current[8] * data_[728];
  ...
  data_[801] = C00_[0] * data_[792] + B10_current[0] * data_[783] + cB00_current[0] * data_[729];
  data_[802] = C00_[1] * data_[793] + B10_current[1] * data_[784] + cB00_current[1] * data_[730];
  data_[803] = C00_[2] * data_[794] + B10_current[2] * data_[785] + cB00_current[2] * data_[731];
  data_[804] = C00_[3] * data_[795] + B10_current[3] * data_[786] + cB00_current[3] * data_[732];
  data_[805] = C00_[4] * data_[796] + B10_current[4] * data_[787] + cB00_current[4] * data_[733];
  data_[806] = C00_[5] * data_[797] + B10_current[5] * data_[788] + cB00_current[5] * data_[734];
  data_[807] = C00_[6] * data_[798] + B10_current[6] * data_[789] + cB00_current[6] * data_[735];
  data_[808] = C00_[7] * data_[799] + B10_current[7] * data_[790] + cB00_current[7] * data_[736];
  data_[809] = C00_[8] * data_[800] + B10_current[8] * data_[791] + cB00_current[8] * data_[737];
  ...
  data_[810] = C00_[0] * data_[801] + B10_current[0] * data_[792] + cB00_current[0] * data_[738];
  data_[811] = C00_[1] * data_[802] + B10_current[1] * data_[793] + cB00_current[1] * data_[739];
  data_[812] = C00_[2] * data_[803] + B10_current[2] * data_[794] + cB00_current[2] * data_[740];
  data_[813] = C00_[3] * data_[804] + B10_current[3] * data_[795] + cB00_current[3] * data_[741];
  data_[814] = C00_[4] * data_[805] + B10_current[4] * data_[796] + cB00_current[4] * data_[742];
  data_[815] = C00_[5] * data_[806] + B10_current[5] * data_[797] + cB00_current[5] * data_[743];
  data_[816] = C00_[6] * data_[807] + B10_current[6] * data_[798] + cB00_current[6] * data_[744];
  data_[817] = C00_[7] * data_[808] + B10_current[7] * data_[799] + cB00_current[7] * data_[745];
  data_[818] = C00_[8] * data_[809] + B10_current[8] * data_[800] + cB00_current[8] * data_[746];
}
