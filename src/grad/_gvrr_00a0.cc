...
void GVRRList::_gvrr_00a0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[45] = D00_[0] * data_[40] + B01_current[0] * data_[35];
  data_[46] = D00_[1] * data_[41] + B01_current[1] * data_[36];
  data_[47] = D00_[2] * data_[42] + B01_current[2] * data_[37];
  data_[48] = D00_[3] * data_[43] + B01_current[3] * data_[38];
  data_[49] = D00_[4] * data_[44] + B01_current[4] * data_[39];
  ...
  data_[50] = D00_[0] * data_[45] + B01_current[0] * data_[40];
  data_[51] = D00_[1] * data_[46] + B01_current[1] * data_[41];
  data_[52] = D00_[2] * data_[47] + B01_current[2] * data_[42];
  data_[53] = D00_[3] * data_[48] + B01_current[3] * data_[43];
  data_[54] = D00_[4] * data_[49] + B01_current[4] * data_[44];
}
