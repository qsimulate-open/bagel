...
void GVRRList::_gvrr_4060(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[125] = D00_[0] * data_[100] + B01_current[0] * data_[75];
  data_[126] = D00_[1] * data_[101] + B01_current[1] * data_[76];
  data_[127] = D00_[2] * data_[102] + B01_current[2] * data_[77];
  data_[128] = D00_[3] * data_[103] + B01_current[3] * data_[78];
  data_[129] = D00_[4] * data_[104] + B01_current[4] * data_[79];
  ...
  data_[130] = C00_[0] * data_[125] + cB00_current[0] * data_[100];
  data_[131] = C00_[1] * data_[126] + cB00_current[1] * data_[101];
  data_[132] = C00_[2] * data_[127] + cB00_current[2] * data_[102];
  data_[133] = C00_[3] * data_[128] + cB00_current[3] * data_[103];
  data_[134] = C00_[4] * data_[129] + cB00_current[4] * data_[104];
  ...
  data_[135] = C00_[0] * data_[130] + B10_current[0] * data_[125] + cB00_current[0] * data_[105];
  data_[136] = C00_[1] * data_[131] + B10_current[1] * data_[126] + cB00_current[1] * data_[106];
  data_[137] = C00_[2] * data_[132] + B10_current[2] * data_[127] + cB00_current[2] * data_[107];
  data_[138] = C00_[3] * data_[133] + B10_current[3] * data_[128] + cB00_current[3] * data_[108];
  data_[139] = C00_[4] * data_[134] + B10_current[4] * data_[129] + cB00_current[4] * data_[109];
  ...
  data_[140] = C00_[0] * data_[135] + B10_current[0] * data_[130] + cB00_current[0] * data_[110];
  data_[141] = C00_[1] * data_[136] + B10_current[1] * data_[131] + cB00_current[1] * data_[111];
  data_[142] = C00_[2] * data_[137] + B10_current[2] * data_[132] + cB00_current[2] * data_[112];
  data_[143] = C00_[3] * data_[138] + B10_current[3] * data_[133] + cB00_current[3] * data_[113];
  data_[144] = C00_[4] * data_[139] + B10_current[4] * data_[134] + cB00_current[4] * data_[114];
  ...
  data_[145] = C00_[0] * data_[140] + B10_current[0] * data_[135] + cB00_current[0] * data_[115];
  data_[146] = C00_[1] * data_[141] + B10_current[1] * data_[136] + cB00_current[1] * data_[116];
  data_[147] = C00_[2] * data_[142] + B10_current[2] * data_[137] + cB00_current[2] * data_[117];
  data_[148] = C00_[3] * data_[143] + B10_current[3] * data_[138] + cB00_current[3] * data_[118];
  data_[149] = C00_[4] * data_[144] + B10_current[4] * data_[139] + cB00_current[4] * data_[119];
  ...
  data_[150] = D00_[0] * data_[125] + B01_current[0] * data_[100];
  data_[151] = D00_[1] * data_[126] + B01_current[1] * data_[101];
  data_[152] = D00_[2] * data_[127] + B01_current[2] * data_[102];
  data_[153] = D00_[3] * data_[128] + B01_current[3] * data_[103];
  data_[154] = D00_[4] * data_[129] + B01_current[4] * data_[104];
  ...
  data_[155] = C00_[0] * data_[150] + cB00_current[0] * data_[125];
  data_[156] = C00_[1] * data_[151] + cB00_current[1] * data_[126];
  data_[157] = C00_[2] * data_[152] + cB00_current[2] * data_[127];
  data_[158] = C00_[3] * data_[153] + cB00_current[3] * data_[128];
  data_[159] = C00_[4] * data_[154] + cB00_current[4] * data_[129];
  ...
  data_[160] = C00_[0] * data_[155] + B10_current[0] * data_[150] + cB00_current[0] * data_[130];
  data_[161] = C00_[1] * data_[156] + B10_current[1] * data_[151] + cB00_current[1] * data_[131];
  data_[162] = C00_[2] * data_[157] + B10_current[2] * data_[152] + cB00_current[2] * data_[132];
  data_[163] = C00_[3] * data_[158] + B10_current[3] * data_[153] + cB00_current[3] * data_[133];
  data_[164] = C00_[4] * data_[159] + B10_current[4] * data_[154] + cB00_current[4] * data_[134];
  ...
  data_[165] = C00_[0] * data_[160] + B10_current[0] * data_[155] + cB00_current[0] * data_[135];
  data_[166] = C00_[1] * data_[161] + B10_current[1] * data_[156] + cB00_current[1] * data_[136];
  data_[167] = C00_[2] * data_[162] + B10_current[2] * data_[157] + cB00_current[2] * data_[137];
  data_[168] = C00_[3] * data_[163] + B10_current[3] * data_[158] + cB00_current[3] * data_[138];
  data_[169] = C00_[4] * data_[164] + B10_current[4] * data_[159] + cB00_current[4] * data_[139];
  ...
  data_[170] = C00_[0] * data_[165] + B10_current[0] * data_[160] + cB00_current[0] * data_[140];
  data_[171] = C00_[1] * data_[166] + B10_current[1] * data_[161] + cB00_current[1] * data_[141];
  data_[172] = C00_[2] * data_[167] + B10_current[2] * data_[162] + cB00_current[2] * data_[142];
  data_[173] = C00_[3] * data_[168] + B10_current[3] * data_[163] + cB00_current[3] * data_[143];
  data_[174] = C00_[4] * data_[169] + B10_current[4] * data_[164] + cB00_current[4] * data_[144];
}
