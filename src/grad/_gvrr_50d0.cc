...
void GVRRList::_gvrr_50d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[648] = D00_[0] * data_[594] + B01_current[0] * data_[540];
  data_[649] = D00_[1] * data_[595] + B01_current[1] * data_[541];
  data_[650] = D00_[2] * data_[596] + B01_current[2] * data_[542];
  data_[651] = D00_[3] * data_[597] + B01_current[3] * data_[543];
  data_[652] = D00_[4] * data_[598] + B01_current[4] * data_[544];
  data_[653] = D00_[5] * data_[599] + B01_current[5] * data_[545];
  data_[654] = D00_[6] * data_[600] + B01_current[6] * data_[546];
  data_[655] = D00_[7] * data_[601] + B01_current[7] * data_[547];
  data_[656] = D00_[8] * data_[602] + B01_current[8] * data_[548];
  ...
  data_[657] = C00_[0] * data_[648] + cB00_current[0] * data_[594];
  data_[658] = C00_[1] * data_[649] + cB00_current[1] * data_[595];
  data_[659] = C00_[2] * data_[650] + cB00_current[2] * data_[596];
  data_[660] = C00_[3] * data_[651] + cB00_current[3] * data_[597];
  data_[661] = C00_[4] * data_[652] + cB00_current[4] * data_[598];
  data_[662] = C00_[5] * data_[653] + cB00_current[5] * data_[599];
  data_[663] = C00_[6] * data_[654] + cB00_current[6] * data_[600];
  data_[664] = C00_[7] * data_[655] + cB00_current[7] * data_[601];
  data_[665] = C00_[8] * data_[656] + cB00_current[8] * data_[602];
  ...
  data_[666] = C00_[0] * data_[657] + B10_current[0] * data_[648] + cB00_current[0] * data_[603];
  data_[667] = C00_[1] * data_[658] + B10_current[1] * data_[649] + cB00_current[1] * data_[604];
  data_[668] = C00_[2] * data_[659] + B10_current[2] * data_[650] + cB00_current[2] * data_[605];
  data_[669] = C00_[3] * data_[660] + B10_current[3] * data_[651] + cB00_current[3] * data_[606];
  data_[670] = C00_[4] * data_[661] + B10_current[4] * data_[652] + cB00_current[4] * data_[607];
  data_[671] = C00_[5] * data_[662] + B10_current[5] * data_[653] + cB00_current[5] * data_[608];
  data_[672] = C00_[6] * data_[663] + B10_current[6] * data_[654] + cB00_current[6] * data_[609];
  data_[673] = C00_[7] * data_[664] + B10_current[7] * data_[655] + cB00_current[7] * data_[610];
  data_[674] = C00_[8] * data_[665] + B10_current[8] * data_[656] + cB00_current[8] * data_[611];
  ...
  data_[675] = C00_[0] * data_[666] + B10_current[0] * data_[657] + cB00_current[0] * data_[612];
  data_[676] = C00_[1] * data_[667] + B10_current[1] * data_[658] + cB00_current[1] * data_[613];
  data_[677] = C00_[2] * data_[668] + B10_current[2] * data_[659] + cB00_current[2] * data_[614];
  data_[678] = C00_[3] * data_[669] + B10_current[3] * data_[660] + cB00_current[3] * data_[615];
  data_[679] = C00_[4] * data_[670] + B10_current[4] * data_[661] + cB00_current[4] * data_[616];
  data_[680] = C00_[5] * data_[671] + B10_current[5] * data_[662] + cB00_current[5] * data_[617];
  data_[681] = C00_[6] * data_[672] + B10_current[6] * data_[663] + cB00_current[6] * data_[618];
  data_[682] = C00_[7] * data_[673] + B10_current[7] * data_[664] + cB00_current[7] * data_[619];
  data_[683] = C00_[8] * data_[674] + B10_current[8] * data_[665] + cB00_current[8] * data_[620];
  ...
  data_[684] = C00_[0] * data_[675] + B10_current[0] * data_[666] + cB00_current[0] * data_[621];
  data_[685] = C00_[1] * data_[676] + B10_current[1] * data_[667] + cB00_current[1] * data_[622];
  data_[686] = C00_[2] * data_[677] + B10_current[2] * data_[668] + cB00_current[2] * data_[623];
  data_[687] = C00_[3] * data_[678] + B10_current[3] * data_[669] + cB00_current[3] * data_[624];
  data_[688] = C00_[4] * data_[679] + B10_current[4] * data_[670] + cB00_current[4] * data_[625];
  data_[689] = C00_[5] * data_[680] + B10_current[5] * data_[671] + cB00_current[5] * data_[626];
  data_[690] = C00_[6] * data_[681] + B10_current[6] * data_[672] + cB00_current[6] * data_[627];
  data_[691] = C00_[7] * data_[682] + B10_current[7] * data_[673] + cB00_current[7] * data_[628];
  data_[692] = C00_[8] * data_[683] + B10_current[8] * data_[674] + cB00_current[8] * data_[629];
  ...
  data_[693] = C00_[0] * data_[684] + B10_current[0] * data_[675] + cB00_current[0] * data_[630];
  data_[694] = C00_[1] * data_[685] + B10_current[1] * data_[676] + cB00_current[1] * data_[631];
  data_[695] = C00_[2] * data_[686] + B10_current[2] * data_[677] + cB00_current[2] * data_[632];
  data_[696] = C00_[3] * data_[687] + B10_current[3] * data_[678] + cB00_current[3] * data_[633];
  data_[697] = C00_[4] * data_[688] + B10_current[4] * data_[679] + cB00_current[4] * data_[634];
  data_[698] = C00_[5] * data_[689] + B10_current[5] * data_[680] + cB00_current[5] * data_[635];
  data_[699] = C00_[6] * data_[690] + B10_current[6] * data_[681] + cB00_current[6] * data_[636];
  data_[700] = C00_[7] * data_[691] + B10_current[7] * data_[682] + cB00_current[7] * data_[637];
  data_[701] = C00_[8] * data_[692] + B10_current[8] * data_[683] + cB00_current[8] * data_[638];
  ...
  data_[702] = D00_[0] * data_[648] + B01_current[0] * data_[594];
  data_[703] = D00_[1] * data_[649] + B01_current[1] * data_[595];
  data_[704] = D00_[2] * data_[650] + B01_current[2] * data_[596];
  data_[705] = D00_[3] * data_[651] + B01_current[3] * data_[597];
  data_[706] = D00_[4] * data_[652] + B01_current[4] * data_[598];
  data_[707] = D00_[5] * data_[653] + B01_current[5] * data_[599];
  data_[708] = D00_[6] * data_[654] + B01_current[6] * data_[600];
  data_[709] = D00_[7] * data_[655] + B01_current[7] * data_[601];
  data_[710] = D00_[8] * data_[656] + B01_current[8] * data_[602];
  ...
  data_[711] = C00_[0] * data_[702] + cB00_current[0] * data_[648];
  data_[712] = C00_[1] * data_[703] + cB00_current[1] * data_[649];
  data_[713] = C00_[2] * data_[704] + cB00_current[2] * data_[650];
  data_[714] = C00_[3] * data_[705] + cB00_current[3] * data_[651];
  data_[715] = C00_[4] * data_[706] + cB00_current[4] * data_[652];
  data_[716] = C00_[5] * data_[707] + cB00_current[5] * data_[653];
  data_[717] = C00_[6] * data_[708] + cB00_current[6] * data_[654];
  data_[718] = C00_[7] * data_[709] + cB00_current[7] * data_[655];
  data_[719] = C00_[8] * data_[710] + cB00_current[8] * data_[656];
  ...
  data_[720] = C00_[0] * data_[711] + B10_current[0] * data_[702] + cB00_current[0] * data_[657];
  data_[721] = C00_[1] * data_[712] + B10_current[1] * data_[703] + cB00_current[1] * data_[658];
  data_[722] = C00_[2] * data_[713] + B10_current[2] * data_[704] + cB00_current[2] * data_[659];
  data_[723] = C00_[3] * data_[714] + B10_current[3] * data_[705] + cB00_current[3] * data_[660];
  data_[724] = C00_[4] * data_[715] + B10_current[4] * data_[706] + cB00_current[4] * data_[661];
  data_[725] = C00_[5] * data_[716] + B10_current[5] * data_[707] + cB00_current[5] * data_[662];
  data_[726] = C00_[6] * data_[717] + B10_current[6] * data_[708] + cB00_current[6] * data_[663];
  data_[727] = C00_[7] * data_[718] + B10_current[7] * data_[709] + cB00_current[7] * data_[664];
  data_[728] = C00_[8] * data_[719] + B10_current[8] * data_[710] + cB00_current[8] * data_[665];
  ...
  data_[729] = C00_[0] * data_[720] + B10_current[0] * data_[711] + cB00_current[0] * data_[666];
  data_[730] = C00_[1] * data_[721] + B10_current[1] * data_[712] + cB00_current[1] * data_[667];
  data_[731] = C00_[2] * data_[722] + B10_current[2] * data_[713] + cB00_current[2] * data_[668];
  data_[732] = C00_[3] * data_[723] + B10_current[3] * data_[714] + cB00_current[3] * data_[669];
  data_[733] = C00_[4] * data_[724] + B10_current[4] * data_[715] + cB00_current[4] * data_[670];
  data_[734] = C00_[5] * data_[725] + B10_current[5] * data_[716] + cB00_current[5] * data_[671];
  data_[735] = C00_[6] * data_[726] + B10_current[6] * data_[717] + cB00_current[6] * data_[672];
  data_[736] = C00_[7] * data_[727] + B10_current[7] * data_[718] + cB00_current[7] * data_[673];
  data_[737] = C00_[8] * data_[728] + B10_current[8] * data_[719] + cB00_current[8] * data_[674];
  ...
  data_[738] = C00_[0] * data_[729] + B10_current[0] * data_[720] + cB00_current[0] * data_[675];
  data_[739] = C00_[1] * data_[730] + B10_current[1] * data_[721] + cB00_current[1] * data_[676];
  data_[740] = C00_[2] * data_[731] + B10_current[2] * data_[722] + cB00_current[2] * data_[677];
  data_[741] = C00_[3] * data_[732] + B10_current[3] * data_[723] + cB00_current[3] * data_[678];
  data_[742] = C00_[4] * data_[733] + B10_current[4] * data_[724] + cB00_current[4] * data_[679];
  data_[743] = C00_[5] * data_[734] + B10_current[5] * data_[725] + cB00_current[5] * data_[680];
  data_[744] = C00_[6] * data_[735] + B10_current[6] * data_[726] + cB00_current[6] * data_[681];
  data_[745] = C00_[7] * data_[736] + B10_current[7] * data_[727] + cB00_current[7] * data_[682];
  data_[746] = C00_[8] * data_[737] + B10_current[8] * data_[728] + cB00_current[8] * data_[683];
  ...
  data_[747] = C00_[0] * data_[738] + B10_current[0] * data_[729] + cB00_current[0] * data_[684];
  data_[748] = C00_[1] * data_[739] + B10_current[1] * data_[730] + cB00_current[1] * data_[685];
  data_[749] = C00_[2] * data_[740] + B10_current[2] * data_[731] + cB00_current[2] * data_[686];
  data_[750] = C00_[3] * data_[741] + B10_current[3] * data_[732] + cB00_current[3] * data_[687];
  data_[751] = C00_[4] * data_[742] + B10_current[4] * data_[733] + cB00_current[4] * data_[688];
  data_[752] = C00_[5] * data_[743] + B10_current[5] * data_[734] + cB00_current[5] * data_[689];
  data_[753] = C00_[6] * data_[744] + B10_current[6] * data_[735] + cB00_current[6] * data_[690];
  data_[754] = C00_[7] * data_[745] + B10_current[7] * data_[736] + cB00_current[7] * data_[691];
  data_[755] = C00_[8] * data_[746] + B10_current[8] * data_[737] + cB00_current[8] * data_[692];
}
