...
void GVRRList::_gvrr_30d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[416] = D00_[0] * data_[384] + B01_current[0] * data_[352];
  data_[417] = D00_[1] * data_[385] + B01_current[1] * data_[353];
  data_[418] = D00_[2] * data_[386] + B01_current[2] * data_[354];
  data_[419] = D00_[3] * data_[387] + B01_current[3] * data_[355];
  data_[420] = D00_[4] * data_[388] + B01_current[4] * data_[356];
  data_[421] = D00_[5] * data_[389] + B01_current[5] * data_[357];
  data_[422] = D00_[6] * data_[390] + B01_current[6] * data_[358];
  data_[423] = D00_[7] * data_[391] + B01_current[7] * data_[359];
  ...
  data_[424] = C00_[0] * data_[416] + cB00_current[0] * data_[384];
  data_[425] = C00_[1] * data_[417] + cB00_current[1] * data_[385];
  data_[426] = C00_[2] * data_[418] + cB00_current[2] * data_[386];
  data_[427] = C00_[3] * data_[419] + cB00_current[3] * data_[387];
  data_[428] = C00_[4] * data_[420] + cB00_current[4] * data_[388];
  data_[429] = C00_[5] * data_[421] + cB00_current[5] * data_[389];
  data_[430] = C00_[6] * data_[422] + cB00_current[6] * data_[390];
  data_[431] = C00_[7] * data_[423] + cB00_current[7] * data_[391];
  ...
  data_[432] = C00_[0] * data_[424] + B10_current[0] * data_[416] + cB00_current[0] * data_[392];
  data_[433] = C00_[1] * data_[425] + B10_current[1] * data_[417] + cB00_current[1] * data_[393];
  data_[434] = C00_[2] * data_[426] + B10_current[2] * data_[418] + cB00_current[2] * data_[394];
  data_[435] = C00_[3] * data_[427] + B10_current[3] * data_[419] + cB00_current[3] * data_[395];
  data_[436] = C00_[4] * data_[428] + B10_current[4] * data_[420] + cB00_current[4] * data_[396];
  data_[437] = C00_[5] * data_[429] + B10_current[5] * data_[421] + cB00_current[5] * data_[397];
  data_[438] = C00_[6] * data_[430] + B10_current[6] * data_[422] + cB00_current[6] * data_[398];
  data_[439] = C00_[7] * data_[431] + B10_current[7] * data_[423] + cB00_current[7] * data_[399];
  ...
  data_[440] = C00_[0] * data_[432] + B10_current[0] * data_[424] + cB00_current[0] * data_[400];
  data_[441] = C00_[1] * data_[433] + B10_current[1] * data_[425] + cB00_current[1] * data_[401];
  data_[442] = C00_[2] * data_[434] + B10_current[2] * data_[426] + cB00_current[2] * data_[402];
  data_[443] = C00_[3] * data_[435] + B10_current[3] * data_[427] + cB00_current[3] * data_[403];
  data_[444] = C00_[4] * data_[436] + B10_current[4] * data_[428] + cB00_current[4] * data_[404];
  data_[445] = C00_[5] * data_[437] + B10_current[5] * data_[429] + cB00_current[5] * data_[405];
  data_[446] = C00_[6] * data_[438] + B10_current[6] * data_[430] + cB00_current[6] * data_[406];
  data_[447] = C00_[7] * data_[439] + B10_current[7] * data_[431] + cB00_current[7] * data_[407];
}
