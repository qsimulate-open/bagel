...
void GVRRList::_gvrr_2060(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[64] = C00_[0] * data_[60] + cB00_current[0] * data_[48];
  data_[65] = C00_[1] * data_[61] + cB00_current[1] * data_[49];
  data_[66] = C00_[2] * data_[62] + cB00_current[2] * data_[50];
  data_[67] = C00_[3] * data_[63] + cB00_current[3] * data_[51];

  data_[68] = C00_[0] * data_[64] + B10_[0] * data_[60] + cB00_current[0] * data_[52];
  data_[69] = C00_[1] * data_[65] + B10_[1] * data_[61] + cB00_current[1] * data_[53];
  data_[70] = C00_[2] * data_[66] + B10_[2] * data_[62] + cB00_current[2] * data_[54];
  data_[71] = C00_[3] * data_[67] + B10_[3] * data_[63] + cB00_current[3] * data_[55];
  ...
  data_[76] = C00_[0] * data_[72] + cB00_current[0] * data_[60];
  data_[77] = C00_[1] * data_[73] + cB00_current[1] * data_[61];
  data_[78] = C00_[2] * data_[74] + cB00_current[2] * data_[62];
  data_[79] = C00_[3] * data_[75] + cB00_current[3] * data_[63];

  data_[80] = C00_[0] * data_[76] + B10_[0] * data_[72] + cB00_current[0] * data_[64];
  data_[81] = C00_[1] * data_[77] + B10_[1] * data_[73] + cB00_current[1] * data_[65];
  data_[82] = C00_[2] * data_[78] + B10_[2] * data_[74] + cB00_current[2] * data_[66];
  data_[83] = C00_[3] * data_[79] + B10_[3] * data_[75] + cB00_current[3] * data_[67];
}
