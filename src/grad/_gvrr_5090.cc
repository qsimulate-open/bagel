...
void GVRRList::_gvrr_5090(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[378] = D00_[0] * data_[336] + B01_current[0] * data_[294];
  data_[379] = D00_[1] * data_[337] + B01_current[1] * data_[295];
  data_[380] = D00_[2] * data_[338] + B01_current[2] * data_[296];
  data_[381] = D00_[3] * data_[339] + B01_current[3] * data_[297];
  data_[382] = D00_[4] * data_[340] + B01_current[4] * data_[298];
  data_[383] = D00_[5] * data_[341] + B01_current[5] * data_[299];
  data_[384] = D00_[6] * data_[342] + B01_current[6] * data_[300];
  ...
  data_[385] = C00_[0] * data_[378] + cB00_current[0] * data_[336];
  data_[386] = C00_[1] * data_[379] + cB00_current[1] * data_[337];
  data_[387] = C00_[2] * data_[380] + cB00_current[2] * data_[338];
  data_[388] = C00_[3] * data_[381] + cB00_current[3] * data_[339];
  data_[389] = C00_[4] * data_[382] + cB00_current[4] * data_[340];
  data_[390] = C00_[5] * data_[383] + cB00_current[5] * data_[341];
  data_[391] = C00_[6] * data_[384] + cB00_current[6] * data_[342];
  ...
  data_[392] = C00_[0] * data_[385] + B10_current[0] * data_[378] + cB00_current[0] * data_[343];
  data_[393] = C00_[1] * data_[386] + B10_current[1] * data_[379] + cB00_current[1] * data_[344];
  data_[394] = C00_[2] * data_[387] + B10_current[2] * data_[380] + cB00_current[2] * data_[345];
  data_[395] = C00_[3] * data_[388] + B10_current[3] * data_[381] + cB00_current[3] * data_[346];
  data_[396] = C00_[4] * data_[389] + B10_current[4] * data_[382] + cB00_current[4] * data_[347];
  data_[397] = C00_[5] * data_[390] + B10_current[5] * data_[383] + cB00_current[5] * data_[348];
  data_[398] = C00_[6] * data_[391] + B10_current[6] * data_[384] + cB00_current[6] * data_[349];
  ...
  data_[399] = C00_[0] * data_[392] + B10_current[0] * data_[385] + cB00_current[0] * data_[350];
  data_[400] = C00_[1] * data_[393] + B10_current[1] * data_[386] + cB00_current[1] * data_[351];
  data_[401] = C00_[2] * data_[394] + B10_current[2] * data_[387] + cB00_current[2] * data_[352];
  data_[402] = C00_[3] * data_[395] + B10_current[3] * data_[388] + cB00_current[3] * data_[353];
  data_[403] = C00_[4] * data_[396] + B10_current[4] * data_[389] + cB00_current[4] * data_[354];
  data_[404] = C00_[5] * data_[397] + B10_current[5] * data_[390] + cB00_current[5] * data_[355];
  data_[405] = C00_[6] * data_[398] + B10_current[6] * data_[391] + cB00_current[6] * data_[356];
  ...
  data_[406] = C00_[0] * data_[399] + B10_current[0] * data_[392] + cB00_current[0] * data_[357];
  data_[407] = C00_[1] * data_[400] + B10_current[1] * data_[393] + cB00_current[1] * data_[358];
  data_[408] = C00_[2] * data_[401] + B10_current[2] * data_[394] + cB00_current[2] * data_[359];
  data_[409] = C00_[3] * data_[402] + B10_current[3] * data_[395] + cB00_current[3] * data_[360];
  data_[410] = C00_[4] * data_[403] + B10_current[4] * data_[396] + cB00_current[4] * data_[361];
  data_[411] = C00_[5] * data_[404] + B10_current[5] * data_[397] + cB00_current[5] * data_[362];
  data_[412] = C00_[6] * data_[405] + B10_current[6] * data_[398] + cB00_current[6] * data_[363];
  ...
  data_[413] = C00_[0] * data_[406] + B10_current[0] * data_[399] + cB00_current[0] * data_[364];
  data_[414] = C00_[1] * data_[407] + B10_current[1] * data_[400] + cB00_current[1] * data_[365];
  data_[415] = C00_[2] * data_[408] + B10_current[2] * data_[401] + cB00_current[2] * data_[366];
  data_[416] = C00_[3] * data_[409] + B10_current[3] * data_[402] + cB00_current[3] * data_[367];
  data_[417] = C00_[4] * data_[410] + B10_current[4] * data_[403] + cB00_current[4] * data_[368];
  data_[418] = C00_[5] * data_[411] + B10_current[5] * data_[404] + cB00_current[5] * data_[369];
  data_[419] = C00_[6] * data_[412] + B10_current[6] * data_[405] + cB00_current[6] * data_[370];
}
