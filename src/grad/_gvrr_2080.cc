...
void GVRRList::_gvrr_2080(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[120] = D00_[0] * data_[105] + B01_current[0] * data_[90];
  data_[121] = D00_[1] * data_[106] + B01_current[1] * data_[91];
  data_[122] = D00_[2] * data_[107] + B01_current[2] * data_[92];
  data_[123] = D00_[3] * data_[108] + B01_current[3] * data_[93];
  data_[124] = D00_[4] * data_[109] + B01_current[4] * data_[94];
  ...
  data_[125] = C00_[0] * data_[120] + cB00_current[0] * data_[105];
  data_[126] = C00_[1] * data_[121] + cB00_current[1] * data_[106];
  data_[127] = C00_[2] * data_[122] + cB00_current[2] * data_[107];
  data_[128] = C00_[3] * data_[123] + cB00_current[3] * data_[108];
  data_[129] = C00_[4] * data_[124] + cB00_current[4] * data_[109];

  data_[130] = C00_[0] * data_[125] + B10_[0] * data_[120] + cB00_current[0] * data_[110];
  data_[131] = C00_[1] * data_[126] + B10_[1] * data_[121] + cB00_current[1] * data_[111];
  data_[132] = C00_[2] * data_[127] + B10_[2] * data_[122] + cB00_current[2] * data_[112];
  data_[133] = C00_[3] * data_[128] + B10_[3] * data_[123] + cB00_current[3] * data_[113];
  data_[134] = C00_[4] * data_[129] + B10_[4] * data_[124] + cB00_current[4] * data_[114];
}
