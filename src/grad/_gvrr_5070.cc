...
void GVRRList::_gvrr_5070(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[186] = C00_[0] * data_[180] + cB00_current[0] * data_[144];
  data_[187] = C00_[1] * data_[181] + cB00_current[1] * data_[145];
  data_[188] = C00_[2] * data_[182] + cB00_current[2] * data_[146];
  data_[189] = C00_[3] * data_[183] + cB00_current[3] * data_[147];
  data_[190] = C00_[4] * data_[184] + cB00_current[4] * data_[148];
  data_[191] = C00_[5] * data_[185] + cB00_current[5] * data_[149];
  ...
  data_[192] = C00_[0] * data_[186] + B10_current[0] * data_[180] + cB00_current[0] * data_[150];
  data_[193] = C00_[1] * data_[187] + B10_current[1] * data_[181] + cB00_current[1] * data_[151];
  data_[194] = C00_[2] * data_[188] + B10_current[2] * data_[182] + cB00_current[2] * data_[152];
  data_[195] = C00_[3] * data_[189] + B10_current[3] * data_[183] + cB00_current[3] * data_[153];
  data_[196] = C00_[4] * data_[190] + B10_current[4] * data_[184] + cB00_current[4] * data_[154];
  data_[197] = C00_[5] * data_[191] + B10_current[5] * data_[185] + cB00_current[5] * data_[155];
  ...
  data_[198] = C00_[0] * data_[192] + B10_current[0] * data_[186] + cB00_current[0] * data_[156];
  data_[199] = C00_[1] * data_[193] + B10_current[1] * data_[187] + cB00_current[1] * data_[157];
  data_[200] = C00_[2] * data_[194] + B10_current[2] * data_[188] + cB00_current[2] * data_[158];
  data_[201] = C00_[3] * data_[195] + B10_current[3] * data_[189] + cB00_current[3] * data_[159];
  data_[202] = C00_[4] * data_[196] + B10_current[4] * data_[190] + cB00_current[4] * data_[160];
  data_[203] = C00_[5] * data_[197] + B10_current[5] * data_[191] + cB00_current[5] * data_[161];
  ...
  data_[204] = C00_[0] * data_[198] + B10_current[0] * data_[192] + cB00_current[0] * data_[162];
  data_[205] = C00_[1] * data_[199] + B10_current[1] * data_[193] + cB00_current[1] * data_[163];
  data_[206] = C00_[2] * data_[200] + B10_current[2] * data_[194] + cB00_current[2] * data_[164];
  data_[207] = C00_[3] * data_[201] + B10_current[3] * data_[195] + cB00_current[3] * data_[165];
  data_[208] = C00_[4] * data_[202] + B10_current[4] * data_[196] + cB00_current[4] * data_[166];
  data_[209] = C00_[5] * data_[203] + B10_current[5] * data_[197] + cB00_current[5] * data_[167];
  ...
  data_[210] = C00_[0] * data_[204] + B10_current[0] * data_[198] + cB00_current[0] * data_[168];
  data_[211] = C00_[1] * data_[205] + B10_current[1] * data_[199] + cB00_current[1] * data_[169];
  data_[212] = C00_[2] * data_[206] + B10_current[2] * data_[200] + cB00_current[2] * data_[170];
  data_[213] = C00_[3] * data_[207] + B10_current[3] * data_[201] + cB00_current[3] * data_[171];
  data_[214] = C00_[4] * data_[208] + B10_current[4] * data_[202] + cB00_current[4] * data_[172];
  data_[215] = C00_[5] * data_[209] + B10_current[5] * data_[203] + cB00_current[5] * data_[173];
  ...
  data_[222] = C00_[0] * data_[216] + cB00_current[0] * data_[180];
  data_[223] = C00_[1] * data_[217] + cB00_current[1] * data_[181];
  data_[224] = C00_[2] * data_[218] + cB00_current[2] * data_[182];
  data_[225] = C00_[3] * data_[219] + cB00_current[3] * data_[183];
  data_[226] = C00_[4] * data_[220] + cB00_current[4] * data_[184];
  data_[227] = C00_[5] * data_[221] + cB00_current[5] * data_[185];
  ...
  data_[228] = C00_[0] * data_[222] + B10_current[0] * data_[216] + cB00_current[0] * data_[186];
  data_[229] = C00_[1] * data_[223] + B10_current[1] * data_[217] + cB00_current[1] * data_[187];
  data_[230] = C00_[2] * data_[224] + B10_current[2] * data_[218] + cB00_current[2] * data_[188];
  data_[231] = C00_[3] * data_[225] + B10_current[3] * data_[219] + cB00_current[3] * data_[189];
  data_[232] = C00_[4] * data_[226] + B10_current[4] * data_[220] + cB00_current[4] * data_[190];
  data_[233] = C00_[5] * data_[227] + B10_current[5] * data_[221] + cB00_current[5] * data_[191];
  ...
  data_[234] = C00_[0] * data_[228] + B10_current[0] * data_[222] + cB00_current[0] * data_[192];
  data_[235] = C00_[1] * data_[229] + B10_current[1] * data_[223] + cB00_current[1] * data_[193];
  data_[236] = C00_[2] * data_[230] + B10_current[2] * data_[224] + cB00_current[2] * data_[194];
  data_[237] = C00_[3] * data_[231] + B10_current[3] * data_[225] + cB00_current[3] * data_[195];
  data_[238] = C00_[4] * data_[232] + B10_current[4] * data_[226] + cB00_current[4] * data_[196];
  data_[239] = C00_[5] * data_[233] + B10_current[5] * data_[227] + cB00_current[5] * data_[197];
  ...
  data_[240] = C00_[0] * data_[234] + B10_current[0] * data_[228] + cB00_current[0] * data_[198];
  data_[241] = C00_[1] * data_[235] + B10_current[1] * data_[229] + cB00_current[1] * data_[199];
  data_[242] = C00_[2] * data_[236] + B10_current[2] * data_[230] + cB00_current[2] * data_[200];
  data_[243] = C00_[3] * data_[237] + B10_current[3] * data_[231] + cB00_current[3] * data_[201];
  data_[244] = C00_[4] * data_[238] + B10_current[4] * data_[232] + cB00_current[4] * data_[202];
  data_[245] = C00_[5] * data_[239] + B10_current[5] * data_[233] + cB00_current[5] * data_[203];
  ...
  data_[246] = C00_[0] * data_[240] + B10_current[0] * data_[234] + cB00_current[0] * data_[204];
  data_[247] = C00_[1] * data_[241] + B10_current[1] * data_[235] + cB00_current[1] * data_[205];
  data_[248] = C00_[2] * data_[242] + B10_current[2] * data_[236] + cB00_current[2] * data_[206];
  data_[249] = C00_[3] * data_[243] + B10_current[3] * data_[237] + cB00_current[3] * data_[207];
  data_[250] = C00_[4] * data_[244] + B10_current[4] * data_[238] + cB00_current[4] * data_[208];
  data_[251] = C00_[5] * data_[245] + B10_current[5] * data_[239] + cB00_current[5] * data_[209];
  ...
  data_[258] = C00_[0] * data_[252] + cB00_current[0] * data_[216];
  data_[259] = C00_[1] * data_[253] + cB00_current[1] * data_[217];
  data_[260] = C00_[2] * data_[254] + cB00_current[2] * data_[218];
  data_[261] = C00_[3] * data_[255] + cB00_current[3] * data_[219];
  data_[262] = C00_[4] * data_[256] + cB00_current[4] * data_[220];
  data_[263] = C00_[5] * data_[257] + cB00_current[5] * data_[221];
  ...
  data_[264] = C00_[0] * data_[258] + B10_current[0] * data_[252] + cB00_current[0] * data_[222];
  data_[265] = C00_[1] * data_[259] + B10_current[1] * data_[253] + cB00_current[1] * data_[223];
  data_[266] = C00_[2] * data_[260] + B10_current[2] * data_[254] + cB00_current[2] * data_[224];
  data_[267] = C00_[3] * data_[261] + B10_current[3] * data_[255] + cB00_current[3] * data_[225];
  data_[268] = C00_[4] * data_[262] + B10_current[4] * data_[256] + cB00_current[4] * data_[226];
  data_[269] = C00_[5] * data_[263] + B10_current[5] * data_[257] + cB00_current[5] * data_[227];
  ...
  data_[270] = C00_[0] * data_[264] + B10_current[0] * data_[258] + cB00_current[0] * data_[228];
  data_[271] = C00_[1] * data_[265] + B10_current[1] * data_[259] + cB00_current[1] * data_[229];
  data_[272] = C00_[2] * data_[266] + B10_current[2] * data_[260] + cB00_current[2] * data_[230];
  data_[273] = C00_[3] * data_[267] + B10_current[3] * data_[261] + cB00_current[3] * data_[231];
  data_[274] = C00_[4] * data_[268] + B10_current[4] * data_[262] + cB00_current[4] * data_[232];
  data_[275] = C00_[5] * data_[269] + B10_current[5] * data_[263] + cB00_current[5] * data_[233];
  ...
  data_[276] = C00_[0] * data_[270] + B10_current[0] * data_[264] + cB00_current[0] * data_[234];
  data_[277] = C00_[1] * data_[271] + B10_current[1] * data_[265] + cB00_current[1] * data_[235];
  data_[278] = C00_[2] * data_[272] + B10_current[2] * data_[266] + cB00_current[2] * data_[236];
  data_[279] = C00_[3] * data_[273] + B10_current[3] * data_[267] + cB00_current[3] * data_[237];
  data_[280] = C00_[4] * data_[274] + B10_current[4] * data_[268] + cB00_current[4] * data_[238];
  data_[281] = C00_[5] * data_[275] + B10_current[5] * data_[269] + cB00_current[5] * data_[239];
  ...
  data_[282] = C00_[0] * data_[276] + B10_current[0] * data_[270] + cB00_current[0] * data_[240];
  data_[283] = C00_[1] * data_[277] + B10_current[1] * data_[271] + cB00_current[1] * data_[241];
  data_[284] = C00_[2] * data_[278] + B10_current[2] * data_[272] + cB00_current[2] * data_[242];
  data_[285] = C00_[3] * data_[279] + B10_current[3] * data_[273] + cB00_current[3] * data_[243];
  data_[286] = C00_[4] * data_[280] + B10_current[4] * data_[274] + cB00_current[4] * data_[244];
  data_[287] = C00_[5] * data_[281] + B10_current[5] * data_[275] + cB00_current[5] * data_[245];
}
