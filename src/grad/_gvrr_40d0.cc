...
void GVRRList::_gvrr_40d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[585] = D00_[0] * data_[540] + B01_current[0] * data_[495];
  data_[586] = D00_[1] * data_[541] + B01_current[1] * data_[496];
  data_[587] = D00_[2] * data_[542] + B01_current[2] * data_[497];
  data_[588] = D00_[3] * data_[543] + B01_current[3] * data_[498];
  data_[589] = D00_[4] * data_[544] + B01_current[4] * data_[499];
  data_[590] = D00_[5] * data_[545] + B01_current[5] * data_[500];
  data_[591] = D00_[6] * data_[546] + B01_current[6] * data_[501];
  data_[592] = D00_[7] * data_[547] + B01_current[7] * data_[502];
  data_[593] = D00_[8] * data_[548] + B01_current[8] * data_[503];
  ...
  data_[594] = C00_[0] * data_[585] + cB00_current[0] * data_[540];
  data_[595] = C00_[1] * data_[586] + cB00_current[1] * data_[541];
  data_[596] = C00_[2] * data_[587] + cB00_current[2] * data_[542];
  data_[597] = C00_[3] * data_[588] + cB00_current[3] * data_[543];
  data_[598] = C00_[4] * data_[589] + cB00_current[4] * data_[544];
  data_[599] = C00_[5] * data_[590] + cB00_current[5] * data_[545];
  data_[600] = C00_[6] * data_[591] + cB00_current[6] * data_[546];
  data_[601] = C00_[7] * data_[592] + cB00_current[7] * data_[547];
  data_[602] = C00_[8] * data_[593] + cB00_current[8] * data_[548];
  ...
  data_[603] = C00_[0] * data_[594] + B10_current[0] * data_[585] + cB00_current[0] * data_[549];
  data_[604] = C00_[1] * data_[595] + B10_current[1] * data_[586] + cB00_current[1] * data_[550];
  data_[605] = C00_[2] * data_[596] + B10_current[2] * data_[587] + cB00_current[2] * data_[551];
  data_[606] = C00_[3] * data_[597] + B10_current[3] * data_[588] + cB00_current[3] * data_[552];
  data_[607] = C00_[4] * data_[598] + B10_current[4] * data_[589] + cB00_current[4] * data_[553];
  data_[608] = C00_[5] * data_[599] + B10_current[5] * data_[590] + cB00_current[5] * data_[554];
  data_[609] = C00_[6] * data_[600] + B10_current[6] * data_[591] + cB00_current[6] * data_[555];
  data_[610] = C00_[7] * data_[601] + B10_current[7] * data_[592] + cB00_current[7] * data_[556];
  data_[611] = C00_[8] * data_[602] + B10_current[8] * data_[593] + cB00_current[8] * data_[557];
  ...
  data_[612] = C00_[0] * data_[603] + B10_current[0] * data_[594] + cB00_current[0] * data_[558];
  data_[613] = C00_[1] * data_[604] + B10_current[1] * data_[595] + cB00_current[1] * data_[559];
  data_[614] = C00_[2] * data_[605] + B10_current[2] * data_[596] + cB00_current[2] * data_[560];
  data_[615] = C00_[3] * data_[606] + B10_current[3] * data_[597] + cB00_current[3] * data_[561];
  data_[616] = C00_[4] * data_[607] + B10_current[4] * data_[598] + cB00_current[4] * data_[562];
  data_[617] = C00_[5] * data_[608] + B10_current[5] * data_[599] + cB00_current[5] * data_[563];
  data_[618] = C00_[6] * data_[609] + B10_current[6] * data_[600] + cB00_current[6] * data_[564];
  data_[619] = C00_[7] * data_[610] + B10_current[7] * data_[601] + cB00_current[7] * data_[565];
  data_[620] = C00_[8] * data_[611] + B10_current[8] * data_[602] + cB00_current[8] * data_[566];
  ...
  data_[621] = C00_[0] * data_[612] + B10_current[0] * data_[603] + cB00_current[0] * data_[567];
  data_[622] = C00_[1] * data_[613] + B10_current[1] * data_[604] + cB00_current[1] * data_[568];
  data_[623] = C00_[2] * data_[614] + B10_current[2] * data_[605] + cB00_current[2] * data_[569];
  data_[624] = C00_[3] * data_[615] + B10_current[3] * data_[606] + cB00_current[3] * data_[570];
  data_[625] = C00_[4] * data_[616] + B10_current[4] * data_[607] + cB00_current[4] * data_[571];
  data_[626] = C00_[5] * data_[617] + B10_current[5] * data_[608] + cB00_current[5] * data_[572];
  data_[627] = C00_[6] * data_[618] + B10_current[6] * data_[609] + cB00_current[6] * data_[573];
  data_[628] = C00_[7] * data_[619] + B10_current[7] * data_[610] + cB00_current[7] * data_[574];
  data_[629] = C00_[8] * data_[620] + B10_current[8] * data_[611] + cB00_current[8] * data_[575];
}
