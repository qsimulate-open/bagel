...
void GVRRList::_gvrr_4040(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[64] = C00_[0] * data_[60] + cB00_current[0] * data_[40];
  data_[65] = C00_[1] * data_[61] + cB00_current[1] * data_[41];
  data_[66] = C00_[2] * data_[62] + cB00_current[2] * data_[42];
  data_[67] = C00_[3] * data_[63] + cB00_current[3] * data_[43];
  ...
  data_[68] = C00_[0] * data_[64] + B10_current[0] * data_[60] + cB00_current[0] * data_[44];
  data_[69] = C00_[1] * data_[65] + B10_current[1] * data_[61] + cB00_current[1] * data_[45];
  data_[70] = C00_[2] * data_[66] + B10_current[2] * data_[62] + cB00_current[2] * data_[46];
  data_[71] = C00_[3] * data_[67] + B10_current[3] * data_[63] + cB00_current[3] * data_[47];
  ...
  data_[72] = C00_[0] * data_[68] + B10_current[0] * data_[64] + cB00_current[0] * data_[48];
  data_[73] = C00_[1] * data_[69] + B10_current[1] * data_[65] + cB00_current[1] * data_[49];
  data_[74] = C00_[2] * data_[70] + B10_current[2] * data_[66] + cB00_current[2] * data_[50];
  data_[75] = C00_[3] * data_[71] + B10_current[3] * data_[67] + cB00_current[3] * data_[51];
  ...
  data_[76] = C00_[0] * data_[72] + B10_current[0] * data_[68] + cB00_current[0] * data_[52];
  data_[77] = C00_[1] * data_[73] + B10_current[1] * data_[69] + cB00_current[1] * data_[53];
  data_[78] = C00_[2] * data_[74] + B10_current[2] * data_[70] + cB00_current[2] * data_[54];
  data_[79] = C00_[3] * data_[75] + B10_current[3] * data_[71] + cB00_current[3] * data_[55];
  ...
  data_[84] = C00_[0] * data_[80] + cB00_current[0] * data_[60];
  data_[85] = C00_[1] * data_[81] + cB00_current[1] * data_[61];
  data_[86] = C00_[2] * data_[82] + cB00_current[2] * data_[62];
  data_[87] = C00_[3] * data_[83] + cB00_current[3] * data_[63];
  ...
  data_[88] = C00_[0] * data_[84] + B10_current[0] * data_[80] + cB00_current[0] * data_[64];
  data_[89] = C00_[1] * data_[85] + B10_current[1] * data_[81] + cB00_current[1] * data_[65];
  data_[90] = C00_[2] * data_[86] + B10_current[2] * data_[82] + cB00_current[2] * data_[66];
  data_[91] = C00_[3] * data_[87] + B10_current[3] * data_[83] + cB00_current[3] * data_[67];
  ...
  data_[92] = C00_[0] * data_[88] + B10_current[0] * data_[84] + cB00_current[0] * data_[68];
  data_[93] = C00_[1] * data_[89] + B10_current[1] * data_[85] + cB00_current[1] * data_[69];
  data_[94] = C00_[2] * data_[90] + B10_current[2] * data_[86] + cB00_current[2] * data_[70];
  data_[95] = C00_[3] * data_[91] + B10_current[3] * data_[87] + cB00_current[3] * data_[71];
  ...
  data_[96] = C00_[0] * data_[92] + B10_current[0] * data_[88] + cB00_current[0] * data_[72];
  data_[97] = C00_[1] * data_[93] + B10_current[1] * data_[89] + cB00_current[1] * data_[73];
  data_[98] = C00_[2] * data_[94] + B10_current[2] * data_[90] + cB00_current[2] * data_[74];
  data_[99] = C00_[3] * data_[95] + B10_current[3] * data_[91] + cB00_current[3] * data_[75];
}
