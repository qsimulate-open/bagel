...
void GVRRList::_gvrr_c000(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[72] = C00_[0] * data_[66] + B10_current[0] * data_[60];
  data_[73] = C00_[1] * data_[67] + B10_current[1] * data_[61];
  data_[74] = C00_[2] * data_[68] + B10_current[2] * data_[62];
  data_[75] = C00_[3] * data_[69] + B10_current[3] * data_[63];
  data_[76] = C00_[4] * data_[70] + B10_current[4] * data_[64];
  data_[77] = C00_[5] * data_[71] + B10_current[5] * data_[65];
}
