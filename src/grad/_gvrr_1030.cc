...
void GVRRList::_gvrr_1030(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  ...
  data_[14] = C00_[0] * data_[12] + cB00_current[0] * data_[8];
  data_[15] = C00_[1] * data_[13] + cB00_current[1] * data_[9];
}
