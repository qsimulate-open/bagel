...
void GVRRList::_gvrr_40c0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[440] = D00_[0] * data_[400] + B01_current[0] * data_[360];
  data_[441] = D00_[1] * data_[401] + B01_current[1] * data_[361];
  data_[442] = D00_[2] * data_[402] + B01_current[2] * data_[362];
  data_[443] = D00_[3] * data_[403] + B01_current[3] * data_[363];
  data_[444] = D00_[4] * data_[404] + B01_current[4] * data_[364];
  data_[445] = D00_[5] * data_[405] + B01_current[5] * data_[365];
  data_[446] = D00_[6] * data_[406] + B01_current[6] * data_[366];
  data_[447] = D00_[7] * data_[407] + B01_current[7] * data_[367];
  ...
  data_[448] = C00_[0] * data_[440] + cB00_current[0] * data_[400];
  data_[449] = C00_[1] * data_[441] + cB00_current[1] * data_[401];
  data_[450] = C00_[2] * data_[442] + cB00_current[2] * data_[402];
  data_[451] = C00_[3] * data_[443] + cB00_current[3] * data_[403];
  data_[452] = C00_[4] * data_[444] + cB00_current[4] * data_[404];
  data_[453] = C00_[5] * data_[445] + cB00_current[5] * data_[405];
  data_[454] = C00_[6] * data_[446] + cB00_current[6] * data_[406];
  data_[455] = C00_[7] * data_[447] + cB00_current[7] * data_[407];
  ...
  data_[456] = C00_[0] * data_[448] + B10_current[0] * data_[440] + cB00_current[0] * data_[408];
  data_[457] = C00_[1] * data_[449] + B10_current[1] * data_[441] + cB00_current[1] * data_[409];
  data_[458] = C00_[2] * data_[450] + B10_current[2] * data_[442] + cB00_current[2] * data_[410];
  data_[459] = C00_[3] * data_[451] + B10_current[3] * data_[443] + cB00_current[3] * data_[411];
  data_[460] = C00_[4] * data_[452] + B10_current[4] * data_[444] + cB00_current[4] * data_[412];
  data_[461] = C00_[5] * data_[453] + B10_current[5] * data_[445] + cB00_current[5] * data_[413];
  data_[462] = C00_[6] * data_[454] + B10_current[6] * data_[446] + cB00_current[6] * data_[414];
  data_[463] = C00_[7] * data_[455] + B10_current[7] * data_[447] + cB00_current[7] * data_[415];
  ...
  data_[464] = C00_[0] * data_[456] + B10_current[0] * data_[448] + cB00_current[0] * data_[416];
  data_[465] = C00_[1] * data_[457] + B10_current[1] * data_[449] + cB00_current[1] * data_[417];
  data_[466] = C00_[2] * data_[458] + B10_current[2] * data_[450] + cB00_current[2] * data_[418];
  data_[467] = C00_[3] * data_[459] + B10_current[3] * data_[451] + cB00_current[3] * data_[419];
  data_[468] = C00_[4] * data_[460] + B10_current[4] * data_[452] + cB00_current[4] * data_[420];
  data_[469] = C00_[5] * data_[461] + B10_current[5] * data_[453] + cB00_current[5] * data_[421];
  data_[470] = C00_[6] * data_[462] + B10_current[6] * data_[454] + cB00_current[6] * data_[422];
  data_[471] = C00_[7] * data_[463] + B10_current[7] * data_[455] + cB00_current[7] * data_[423];
  ...
  data_[472] = C00_[0] * data_[464] + B10_current[0] * data_[456] + cB00_current[0] * data_[424];
  data_[473] = C00_[1] * data_[465] + B10_current[1] * data_[457] + cB00_current[1] * data_[425];
  data_[474] = C00_[2] * data_[466] + B10_current[2] * data_[458] + cB00_current[2] * data_[426];
  data_[475] = C00_[3] * data_[467] + B10_current[3] * data_[459] + cB00_current[3] * data_[427];
  data_[476] = C00_[4] * data_[468] + B10_current[4] * data_[460] + cB00_current[4] * data_[428];
  data_[477] = C00_[5] * data_[469] + B10_current[5] * data_[461] + cB00_current[5] * data_[429];
  data_[478] = C00_[6] * data_[470] + B10_current[6] * data_[462] + cB00_current[6] * data_[430];
  data_[479] = C00_[7] * data_[471] + B10_current[7] * data_[463] + cB00_current[7] * data_[431];
  ...
  data_[480] = D00_[0] * data_[440] + B01_current[0] * data_[400];
  data_[481] = D00_[1] * data_[441] + B01_current[1] * data_[401];
  data_[482] = D00_[2] * data_[442] + B01_current[2] * data_[402];
  data_[483] = D00_[3] * data_[443] + B01_current[3] * data_[403];
  data_[484] = D00_[4] * data_[444] + B01_current[4] * data_[404];
  data_[485] = D00_[5] * data_[445] + B01_current[5] * data_[405];
  data_[486] = D00_[6] * data_[446] + B01_current[6] * data_[406];
  data_[487] = D00_[7] * data_[447] + B01_current[7] * data_[407];
  ...
  data_[488] = C00_[0] * data_[480] + cB00_current[0] * data_[440];
  data_[489] = C00_[1] * data_[481] + cB00_current[1] * data_[441];
  data_[490] = C00_[2] * data_[482] + cB00_current[2] * data_[442];
  data_[491] = C00_[3] * data_[483] + cB00_current[3] * data_[443];
  data_[492] = C00_[4] * data_[484] + cB00_current[4] * data_[444];
  data_[493] = C00_[5] * data_[485] + cB00_current[5] * data_[445];
  data_[494] = C00_[6] * data_[486] + cB00_current[6] * data_[446];
  data_[495] = C00_[7] * data_[487] + cB00_current[7] * data_[447];
  ...
  data_[496] = C00_[0] * data_[488] + B10_current[0] * data_[480] + cB00_current[0] * data_[448];
  data_[497] = C00_[1] * data_[489] + B10_current[1] * data_[481] + cB00_current[1] * data_[449];
  data_[498] = C00_[2] * data_[490] + B10_current[2] * data_[482] + cB00_current[2] * data_[450];
  data_[499] = C00_[3] * data_[491] + B10_current[3] * data_[483] + cB00_current[3] * data_[451];
  data_[500] = C00_[4] * data_[492] + B10_current[4] * data_[484] + cB00_current[4] * data_[452];
  data_[501] = C00_[5] * data_[493] + B10_current[5] * data_[485] + cB00_current[5] * data_[453];
  data_[502] = C00_[6] * data_[494] + B10_current[6] * data_[486] + cB00_current[6] * data_[454];
  data_[503] = C00_[7] * data_[495] + B10_current[7] * data_[487] + cB00_current[7] * data_[455];
  ...
  data_[504] = C00_[0] * data_[496] + B10_current[0] * data_[488] + cB00_current[0] * data_[456];
  data_[505] = C00_[1] * data_[497] + B10_current[1] * data_[489] + cB00_current[1] * data_[457];
  data_[506] = C00_[2] * data_[498] + B10_current[2] * data_[490] + cB00_current[2] * data_[458];
  data_[507] = C00_[3] * data_[499] + B10_current[3] * data_[491] + cB00_current[3] * data_[459];
  data_[508] = C00_[4] * data_[500] + B10_current[4] * data_[492] + cB00_current[4] * data_[460];
  data_[509] = C00_[5] * data_[501] + B10_current[5] * data_[493] + cB00_current[5] * data_[461];
  data_[510] = C00_[6] * data_[502] + B10_current[6] * data_[494] + cB00_current[6] * data_[462];
  data_[511] = C00_[7] * data_[503] + B10_current[7] * data_[495] + cB00_current[7] * data_[463];
  ...
  data_[512] = C00_[0] * data_[504] + B10_current[0] * data_[496] + cB00_current[0] * data_[464];
  data_[513] = C00_[1] * data_[505] + B10_current[1] * data_[497] + cB00_current[1] * data_[465];
  data_[514] = C00_[2] * data_[506] + B10_current[2] * data_[498] + cB00_current[2] * data_[466];
  data_[515] = C00_[3] * data_[507] + B10_current[3] * data_[499] + cB00_current[3] * data_[467];
  data_[516] = C00_[4] * data_[508] + B10_current[4] * data_[500] + cB00_current[4] * data_[468];
  data_[517] = C00_[5] * data_[509] + B10_current[5] * data_[501] + cB00_current[5] * data_[469];
  data_[518] = C00_[6] * data_[510] + B10_current[6] * data_[502] + cB00_current[6] * data_[470];
  data_[519] = C00_[7] * data_[511] + B10_current[7] * data_[503] + cB00_current[7] * data_[471];
}
