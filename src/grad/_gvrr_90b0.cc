...
void GVRRList::_gvrr_90b0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[1100] = D00_[0] * data_[1000] + B01_current[0] * data_[900];
  data_[1101] = D00_[1] * data_[1001] + B01_current[1] * data_[901];
  data_[1102] = D00_[2] * data_[1002] + B01_current[2] * data_[902];
  data_[1103] = D00_[3] * data_[1003] + B01_current[3] * data_[903];
  data_[1104] = D00_[4] * data_[1004] + B01_current[4] * data_[904];
  data_[1105] = D00_[5] * data_[1005] + B01_current[5] * data_[905];
  data_[1106] = D00_[6] * data_[1006] + B01_current[6] * data_[906];
  data_[1107] = D00_[7] * data_[1007] + B01_current[7] * data_[907];
  data_[1108] = D00_[8] * data_[1008] + B01_current[8] * data_[908];
  data_[1109] = D00_[9] * data_[1009] + B01_current[9] * data_[909];
  ...
  data_[1110] = C00_[0] * data_[1100] + cB00_current[0] * data_[1000];
  data_[1111] = C00_[1] * data_[1101] + cB00_current[1] * data_[1001];
  data_[1112] = C00_[2] * data_[1102] + cB00_current[2] * data_[1002];
  data_[1113] = C00_[3] * data_[1103] + cB00_current[3] * data_[1003];
  data_[1114] = C00_[4] * data_[1104] + cB00_current[4] * data_[1004];
  data_[1115] = C00_[5] * data_[1105] + cB00_current[5] * data_[1005];
  data_[1116] = C00_[6] * data_[1106] + cB00_current[6] * data_[1006];
  data_[1117] = C00_[7] * data_[1107] + cB00_current[7] * data_[1007];
  data_[1118] = C00_[8] * data_[1108] + cB00_current[8] * data_[1008];
  data_[1119] = C00_[9] * data_[1109] + cB00_current[9] * data_[1009];
  ...
  data_[1120] = C00_[0] * data_[1110] + B10_current[0] * data_[1100] + cB00_current[0] * data_[1010];
  data_[1121] = C00_[1] * data_[1111] + B10_current[1] * data_[1101] + cB00_current[1] * data_[1011];
  data_[1122] = C00_[2] * data_[1112] + B10_current[2] * data_[1102] + cB00_current[2] * data_[1012];
  data_[1123] = C00_[3] * data_[1113] + B10_current[3] * data_[1103] + cB00_current[3] * data_[1013];
  data_[1124] = C00_[4] * data_[1114] + B10_current[4] * data_[1104] + cB00_current[4] * data_[1014];
  data_[1125] = C00_[5] * data_[1115] + B10_current[5] * data_[1105] + cB00_current[5] * data_[1015];
  data_[1126] = C00_[6] * data_[1116] + B10_current[6] * data_[1106] + cB00_current[6] * data_[1016];
  data_[1127] = C00_[7] * data_[1117] + B10_current[7] * data_[1107] + cB00_current[7] * data_[1017];
  data_[1128] = C00_[8] * data_[1118] + B10_current[8] * data_[1108] + cB00_current[8] * data_[1018];
  data_[1129] = C00_[9] * data_[1119] + B10_current[9] * data_[1109] + cB00_current[9] * data_[1019];
  ...
  data_[1130] = C00_[0] * data_[1120] + B10_current[0] * data_[1110] + cB00_current[0] * data_[1020];
  data_[1131] = C00_[1] * data_[1121] + B10_current[1] * data_[1111] + cB00_current[1] * data_[1021];
  data_[1132] = C00_[2] * data_[1122] + B10_current[2] * data_[1112] + cB00_current[2] * data_[1022];
  data_[1133] = C00_[3] * data_[1123] + B10_current[3] * data_[1113] + cB00_current[3] * data_[1023];
  data_[1134] = C00_[4] * data_[1124] + B10_current[4] * data_[1114] + cB00_current[4] * data_[1024];
  data_[1135] = C00_[5] * data_[1125] + B10_current[5] * data_[1115] + cB00_current[5] * data_[1025];
  data_[1136] = C00_[6] * data_[1126] + B10_current[6] * data_[1116] + cB00_current[6] * data_[1026];
  data_[1137] = C00_[7] * data_[1127] + B10_current[7] * data_[1117] + cB00_current[7] * data_[1027];
  data_[1138] = C00_[8] * data_[1128] + B10_current[8] * data_[1118] + cB00_current[8] * data_[1028];
  data_[1139] = C00_[9] * data_[1129] + B10_current[9] * data_[1119] + cB00_current[9] * data_[1029];
  ...
  data_[1140] = C00_[0] * data_[1130] + B10_current[0] * data_[1120] + cB00_current[0] * data_[1030];
  data_[1141] = C00_[1] * data_[1131] + B10_current[1] * data_[1121] + cB00_current[1] * data_[1031];
  data_[1142] = C00_[2] * data_[1132] + B10_current[2] * data_[1122] + cB00_current[2] * data_[1032];
  data_[1143] = C00_[3] * data_[1133] + B10_current[3] * data_[1123] + cB00_current[3] * data_[1033];
  data_[1144] = C00_[4] * data_[1134] + B10_current[4] * data_[1124] + cB00_current[4] * data_[1034];
  data_[1145] = C00_[5] * data_[1135] + B10_current[5] * data_[1125] + cB00_current[5] * data_[1035];
  data_[1146] = C00_[6] * data_[1136] + B10_current[6] * data_[1126] + cB00_current[6] * data_[1036];
  data_[1147] = C00_[7] * data_[1137] + B10_current[7] * data_[1127] + cB00_current[7] * data_[1037];
  data_[1148] = C00_[8] * data_[1138] + B10_current[8] * data_[1128] + cB00_current[8] * data_[1038];
  data_[1149] = C00_[9] * data_[1139] + B10_current[9] * data_[1129] + cB00_current[9] * data_[1039];
  ...
  data_[1150] = C00_[0] * data_[1140] + B10_current[0] * data_[1130] + cB00_current[0] * data_[1040];
  data_[1151] = C00_[1] * data_[1141] + B10_current[1] * data_[1131] + cB00_current[1] * data_[1041];
  data_[1152] = C00_[2] * data_[1142] + B10_current[2] * data_[1132] + cB00_current[2] * data_[1042];
  data_[1153] = C00_[3] * data_[1143] + B10_current[3] * data_[1133] + cB00_current[3] * data_[1043];
  data_[1154] = C00_[4] * data_[1144] + B10_current[4] * data_[1134] + cB00_current[4] * data_[1044];
  data_[1155] = C00_[5] * data_[1145] + B10_current[5] * data_[1135] + cB00_current[5] * data_[1045];
  data_[1156] = C00_[6] * data_[1146] + B10_current[6] * data_[1136] + cB00_current[6] * data_[1046];
  data_[1157] = C00_[7] * data_[1147] + B10_current[7] * data_[1137] + cB00_current[7] * data_[1047];
  data_[1158] = C00_[8] * data_[1148] + B10_current[8] * data_[1138] + cB00_current[8] * data_[1048];
  data_[1159] = C00_[9] * data_[1149] + B10_current[9] * data_[1139] + cB00_current[9] * data_[1049];
  ...
  data_[1160] = C00_[0] * data_[1150] + B10_current[0] * data_[1140] + cB00_current[0] * data_[1050];
  data_[1161] = C00_[1] * data_[1151] + B10_current[1] * data_[1141] + cB00_current[1] * data_[1051];
  data_[1162] = C00_[2] * data_[1152] + B10_current[2] * data_[1142] + cB00_current[2] * data_[1052];
  data_[1163] = C00_[3] * data_[1153] + B10_current[3] * data_[1143] + cB00_current[3] * data_[1053];
  data_[1164] = C00_[4] * data_[1154] + B10_current[4] * data_[1144] + cB00_current[4] * data_[1054];
  data_[1165] = C00_[5] * data_[1155] + B10_current[5] * data_[1145] + cB00_current[5] * data_[1055];
  data_[1166] = C00_[6] * data_[1156] + B10_current[6] * data_[1146] + cB00_current[6] * data_[1056];
  data_[1167] = C00_[7] * data_[1157] + B10_current[7] * data_[1147] + cB00_current[7] * data_[1057];
  data_[1168] = C00_[8] * data_[1158] + B10_current[8] * data_[1148] + cB00_current[8] * data_[1058];
  data_[1169] = C00_[9] * data_[1159] + B10_current[9] * data_[1149] + cB00_current[9] * data_[1059];
  ...
  data_[1170] = C00_[0] * data_[1160] + B10_current[0] * data_[1150] + cB00_current[0] * data_[1060];
  data_[1171] = C00_[1] * data_[1161] + B10_current[1] * data_[1151] + cB00_current[1] * data_[1061];
  data_[1172] = C00_[2] * data_[1162] + B10_current[2] * data_[1152] + cB00_current[2] * data_[1062];
  data_[1173] = C00_[3] * data_[1163] + B10_current[3] * data_[1153] + cB00_current[3] * data_[1063];
  data_[1174] = C00_[4] * data_[1164] + B10_current[4] * data_[1154] + cB00_current[4] * data_[1064];
  data_[1175] = C00_[5] * data_[1165] + B10_current[5] * data_[1155] + cB00_current[5] * data_[1065];
  data_[1176] = C00_[6] * data_[1166] + B10_current[6] * data_[1156] + cB00_current[6] * data_[1066];
  data_[1177] = C00_[7] * data_[1167] + B10_current[7] * data_[1157] + cB00_current[7] * data_[1067];
  data_[1178] = C00_[8] * data_[1168] + B10_current[8] * data_[1158] + cB00_current[8] * data_[1068];
  data_[1179] = C00_[9] * data_[1169] + B10_current[9] * data_[1159] + cB00_current[9] * data_[1069];
  ...
  data_[1180] = C00_[0] * data_[1170] + B10_current[0] * data_[1160] + cB00_current[0] * data_[1070];
  data_[1181] = C00_[1] * data_[1171] + B10_current[1] * data_[1161] + cB00_current[1] * data_[1071];
  data_[1182] = C00_[2] * data_[1172] + B10_current[2] * data_[1162] + cB00_current[2] * data_[1072];
  data_[1183] = C00_[3] * data_[1173] + B10_current[3] * data_[1163] + cB00_current[3] * data_[1073];
  data_[1184] = C00_[4] * data_[1174] + B10_current[4] * data_[1164] + cB00_current[4] * data_[1074];
  data_[1185] = C00_[5] * data_[1175] + B10_current[5] * data_[1165] + cB00_current[5] * data_[1075];
  data_[1186] = C00_[6] * data_[1176] + B10_current[6] * data_[1166] + cB00_current[6] * data_[1076];
  data_[1187] = C00_[7] * data_[1177] + B10_current[7] * data_[1167] + cB00_current[7] * data_[1077];
  data_[1188] = C00_[8] * data_[1178] + B10_current[8] * data_[1168] + cB00_current[8] * data_[1078];
  data_[1189] = C00_[9] * data_[1179] + B10_current[9] * data_[1169] + cB00_current[9] * data_[1079];
  ...
  data_[1190] = C00_[0] * data_[1180] + B10_current[0] * data_[1170] + cB00_current[0] * data_[1080];
  data_[1191] = C00_[1] * data_[1181] + B10_current[1] * data_[1171] + cB00_current[1] * data_[1081];
  data_[1192] = C00_[2] * data_[1182] + B10_current[2] * data_[1172] + cB00_current[2] * data_[1082];
  data_[1193] = C00_[3] * data_[1183] + B10_current[3] * data_[1173] + cB00_current[3] * data_[1083];
  data_[1194] = C00_[4] * data_[1184] + B10_current[4] * data_[1174] + cB00_current[4] * data_[1084];
  data_[1195] = C00_[5] * data_[1185] + B10_current[5] * data_[1175] + cB00_current[5] * data_[1085];
  data_[1196] = C00_[6] * data_[1186] + B10_current[6] * data_[1176] + cB00_current[6] * data_[1086];
  data_[1197] = C00_[7] * data_[1187] + B10_current[7] * data_[1177] + cB00_current[7] * data_[1087];
  data_[1198] = C00_[8] * data_[1188] + B10_current[8] * data_[1178] + cB00_current[8] * data_[1088];
  data_[1199] = C00_[9] * data_[1189] + B10_current[9] * data_[1179] + cB00_current[9] * data_[1089];
}
