...
void GVRRList::_gvrr_9070(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[568] = C00_[0] * data_[560] + cB00_current[0] * data_[480];
  data_[569] = C00_[1] * data_[561] + cB00_current[1] * data_[481];
  data_[570] = C00_[2] * data_[562] + cB00_current[2] * data_[482];
  data_[571] = C00_[3] * data_[563] + cB00_current[3] * data_[483];
  data_[572] = C00_[4] * data_[564] + cB00_current[4] * data_[484];
  data_[573] = C00_[5] * data_[565] + cB00_current[5] * data_[485];
  data_[574] = C00_[6] * data_[566] + cB00_current[6] * data_[486];
  data_[575] = C00_[7] * data_[567] + cB00_current[7] * data_[487];
  ...
  data_[576] = C00_[0] * data_[568] + B10_current[0] * data_[560] + cB00_current[0] * data_[488];
  data_[577] = C00_[1] * data_[569] + B10_current[1] * data_[561] + cB00_current[1] * data_[489];
  data_[578] = C00_[2] * data_[570] + B10_current[2] * data_[562] + cB00_current[2] * data_[490];
  data_[579] = C00_[3] * data_[571] + B10_current[3] * data_[563] + cB00_current[3] * data_[491];
  data_[580] = C00_[4] * data_[572] + B10_current[4] * data_[564] + cB00_current[4] * data_[492];
  data_[581] = C00_[5] * data_[573] + B10_current[5] * data_[565] + cB00_current[5] * data_[493];
  data_[582] = C00_[6] * data_[574] + B10_current[6] * data_[566] + cB00_current[6] * data_[494];
  data_[583] = C00_[7] * data_[575] + B10_current[7] * data_[567] + cB00_current[7] * data_[495];
  ...
  data_[584] = C00_[0] * data_[576] + B10_current[0] * data_[568] + cB00_current[0] * data_[496];
  data_[585] = C00_[1] * data_[577] + B10_current[1] * data_[569] + cB00_current[1] * data_[497];
  data_[586] = C00_[2] * data_[578] + B10_current[2] * data_[570] + cB00_current[2] * data_[498];
  data_[587] = C00_[3] * data_[579] + B10_current[3] * data_[571] + cB00_current[3] * data_[499];
  data_[588] = C00_[4] * data_[580] + B10_current[4] * data_[572] + cB00_current[4] * data_[500];
  data_[589] = C00_[5] * data_[581] + B10_current[5] * data_[573] + cB00_current[5] * data_[501];
  data_[590] = C00_[6] * data_[582] + B10_current[6] * data_[574] + cB00_current[6] * data_[502];
  data_[591] = C00_[7] * data_[583] + B10_current[7] * data_[575] + cB00_current[7] * data_[503];
  ...
  data_[592] = C00_[0] * data_[584] + B10_current[0] * data_[576] + cB00_current[0] * data_[504];
  data_[593] = C00_[1] * data_[585] + B10_current[1] * data_[577] + cB00_current[1] * data_[505];
  data_[594] = C00_[2] * data_[586] + B10_current[2] * data_[578] + cB00_current[2] * data_[506];
  data_[595] = C00_[3] * data_[587] + B10_current[3] * data_[579] + cB00_current[3] * data_[507];
  data_[596] = C00_[4] * data_[588] + B10_current[4] * data_[580] + cB00_current[4] * data_[508];
  data_[597] = C00_[5] * data_[589] + B10_current[5] * data_[581] + cB00_current[5] * data_[509];
  data_[598] = C00_[6] * data_[590] + B10_current[6] * data_[582] + cB00_current[6] * data_[510];
  data_[599] = C00_[7] * data_[591] + B10_current[7] * data_[583] + cB00_current[7] * data_[511];
  ...
  data_[600] = C00_[0] * data_[592] + B10_current[0] * data_[584] + cB00_current[0] * data_[512];
  data_[601] = C00_[1] * data_[593] + B10_current[1] * data_[585] + cB00_current[1] * data_[513];
  data_[602] = C00_[2] * data_[594] + B10_current[2] * data_[586] + cB00_current[2] * data_[514];
  data_[603] = C00_[3] * data_[595] + B10_current[3] * data_[587] + cB00_current[3] * data_[515];
  data_[604] = C00_[4] * data_[596] + B10_current[4] * data_[588] + cB00_current[4] * data_[516];
  data_[605] = C00_[5] * data_[597] + B10_current[5] * data_[589] + cB00_current[5] * data_[517];
  data_[606] = C00_[6] * data_[598] + B10_current[6] * data_[590] + cB00_current[6] * data_[518];
  data_[607] = C00_[7] * data_[599] + B10_current[7] * data_[591] + cB00_current[7] * data_[519];
  ...
  data_[608] = C00_[0] * data_[600] + B10_current[0] * data_[592] + cB00_current[0] * data_[520];
  data_[609] = C00_[1] * data_[601] + B10_current[1] * data_[593] + cB00_current[1] * data_[521];
  data_[610] = C00_[2] * data_[602] + B10_current[2] * data_[594] + cB00_current[2] * data_[522];
  data_[611] = C00_[3] * data_[603] + B10_current[3] * data_[595] + cB00_current[3] * data_[523];
  data_[612] = C00_[4] * data_[604] + B10_current[4] * data_[596] + cB00_current[4] * data_[524];
  data_[613] = C00_[5] * data_[605] + B10_current[5] * data_[597] + cB00_current[5] * data_[525];
  data_[614] = C00_[6] * data_[606] + B10_current[6] * data_[598] + cB00_current[6] * data_[526];
  data_[615] = C00_[7] * data_[607] + B10_current[7] * data_[599] + cB00_current[7] * data_[527];
  ...
  data_[616] = C00_[0] * data_[608] + B10_current[0] * data_[600] + cB00_current[0] * data_[528];
  data_[617] = C00_[1] * data_[609] + B10_current[1] * data_[601] + cB00_current[1] * data_[529];
  data_[618] = C00_[2] * data_[610] + B10_current[2] * data_[602] + cB00_current[2] * data_[530];
  data_[619] = C00_[3] * data_[611] + B10_current[3] * data_[603] + cB00_current[3] * data_[531];
  data_[620] = C00_[4] * data_[612] + B10_current[4] * data_[604] + cB00_current[4] * data_[532];
  data_[621] = C00_[5] * data_[613] + B10_current[5] * data_[605] + cB00_current[5] * data_[533];
  data_[622] = C00_[6] * data_[614] + B10_current[6] * data_[606] + cB00_current[6] * data_[534];
  data_[623] = C00_[7] * data_[615] + B10_current[7] * data_[607] + cB00_current[7] * data_[535];
  ...
  data_[624] = C00_[0] * data_[616] + B10_current[0] * data_[608] + cB00_current[0] * data_[536];
  data_[625] = C00_[1] * data_[617] + B10_current[1] * data_[609] + cB00_current[1] * data_[537];
  data_[626] = C00_[2] * data_[618] + B10_current[2] * data_[610] + cB00_current[2] * data_[538];
  data_[627] = C00_[3] * data_[619] + B10_current[3] * data_[611] + cB00_current[3] * data_[539];
  data_[628] = C00_[4] * data_[620] + B10_current[4] * data_[612] + cB00_current[4] * data_[540];
  data_[629] = C00_[5] * data_[621] + B10_current[5] * data_[613] + cB00_current[5] * data_[541];
  data_[630] = C00_[6] * data_[622] + B10_current[6] * data_[614] + cB00_current[6] * data_[542];
  data_[631] = C00_[7] * data_[623] + B10_current[7] * data_[615] + cB00_current[7] * data_[543];
  ...
  data_[632] = C00_[0] * data_[624] + B10_current[0] * data_[616] + cB00_current[0] * data_[544];
  data_[633] = C00_[1] * data_[625] + B10_current[1] * data_[617] + cB00_current[1] * data_[545];
  data_[634] = C00_[2] * data_[626] + B10_current[2] * data_[618] + cB00_current[2] * data_[546];
  data_[635] = C00_[3] * data_[627] + B10_current[3] * data_[619] + cB00_current[3] * data_[547];
  data_[636] = C00_[4] * data_[628] + B10_current[4] * data_[620] + cB00_current[4] * data_[548];
  data_[637] = C00_[5] * data_[629] + B10_current[5] * data_[621] + cB00_current[5] * data_[549];
  data_[638] = C00_[6] * data_[630] + B10_current[6] * data_[622] + cB00_current[6] * data_[550];
  data_[639] = C00_[7] * data_[631] + B10_current[7] * data_[623] + cB00_current[7] * data_[551];
}
