...
void GVRRList::_gvrr_10b0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[132] = D00_[0] * data_[120] + B01_current[0] * data_[108];
  data_[133] = D00_[1] * data_[121] + B01_current[1] * data_[109];
  data_[134] = D00_[2] * data_[122] + B01_current[2] * data_[110];
  data_[135] = D00_[3] * data_[123] + B01_current[3] * data_[111];
  data_[136] = D00_[4] * data_[124] + B01_current[4] * data_[112];
  data_[137] = D00_[5] * data_[125] + B01_current[5] * data_[113];
  ...
  data_[138] = C00_[0] * data_[132] + cB00_current[0] * data_[120];
  data_[139] = C00_[1] * data_[133] + cB00_current[1] * data_[121];
  data_[140] = C00_[2] * data_[134] + cB00_current[2] * data_[122];
  data_[141] = C00_[3] * data_[135] + cB00_current[3] * data_[123];
  data_[142] = C00_[4] * data_[136] + cB00_current[4] * data_[124];
  data_[143] = C00_[5] * data_[137] + cB00_current[5] * data_[125];
}
