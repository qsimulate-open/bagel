...
void GVRRList::_gvrr_70d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[960] = D00_[0] * data_[880] + B01_current[0] * data_[800];
  data_[961] = D00_[1] * data_[881] + B01_current[1] * data_[801];
  data_[962] = D00_[2] * data_[882] + B01_current[2] * data_[802];
  data_[963] = D00_[3] * data_[883] + B01_current[3] * data_[803];
  data_[964] = D00_[4] * data_[884] + B01_current[4] * data_[804];
  data_[965] = D00_[5] * data_[885] + B01_current[5] * data_[805];
  data_[966] = D00_[6] * data_[886] + B01_current[6] * data_[806];
  data_[967] = D00_[7] * data_[887] + B01_current[7] * data_[807];
  data_[968] = D00_[8] * data_[888] + B01_current[8] * data_[808];
  data_[969] = D00_[9] * data_[889] + B01_current[9] * data_[809];
  ...
  data_[970] = C00_[0] * data_[960] + cB00_current[0] * data_[880];
  data_[971] = C00_[1] * data_[961] + cB00_current[1] * data_[881];
  data_[972] = C00_[2] * data_[962] + cB00_current[2] * data_[882];
  data_[973] = C00_[3] * data_[963] + cB00_current[3] * data_[883];
  data_[974] = C00_[4] * data_[964] + cB00_current[4] * data_[884];
  data_[975] = C00_[5] * data_[965] + cB00_current[5] * data_[885];
  data_[976] = C00_[6] * data_[966] + cB00_current[6] * data_[886];
  data_[977] = C00_[7] * data_[967] + cB00_current[7] * data_[887];
  data_[978] = C00_[8] * data_[968] + cB00_current[8] * data_[888];
  data_[979] = C00_[9] * data_[969] + cB00_current[9] * data_[889];
  ...
  data_[980] = C00_[0] * data_[970] + B10_current[0] * data_[960] + cB00_current[0] * data_[890];
  data_[981] = C00_[1] * data_[971] + B10_current[1] * data_[961] + cB00_current[1] * data_[891];
  data_[982] = C00_[2] * data_[972] + B10_current[2] * data_[962] + cB00_current[2] * data_[892];
  data_[983] = C00_[3] * data_[973] + B10_current[3] * data_[963] + cB00_current[3] * data_[893];
  data_[984] = C00_[4] * data_[974] + B10_current[4] * data_[964] + cB00_current[4] * data_[894];
  data_[985] = C00_[5] * data_[975] + B10_current[5] * data_[965] + cB00_current[5] * data_[895];
  data_[986] = C00_[6] * data_[976] + B10_current[6] * data_[966] + cB00_current[6] * data_[896];
  data_[987] = C00_[7] * data_[977] + B10_current[7] * data_[967] + cB00_current[7] * data_[897];
  data_[988] = C00_[8] * data_[978] + B10_current[8] * data_[968] + cB00_current[8] * data_[898];
  data_[989] = C00_[9] * data_[979] + B10_current[9] * data_[969] + cB00_current[9] * data_[899];
  ...
  data_[990] = C00_[0] * data_[980] + B10_current[0] * data_[970] + cB00_current[0] * data_[900];
  data_[991] = C00_[1] * data_[981] + B10_current[1] * data_[971] + cB00_current[1] * data_[901];
  data_[992] = C00_[2] * data_[982] + B10_current[2] * data_[972] + cB00_current[2] * data_[902];
  data_[993] = C00_[3] * data_[983] + B10_current[3] * data_[973] + cB00_current[3] * data_[903];
  data_[994] = C00_[4] * data_[984] + B10_current[4] * data_[974] + cB00_current[4] * data_[904];
  data_[995] = C00_[5] * data_[985] + B10_current[5] * data_[975] + cB00_current[5] * data_[905];
  data_[996] = C00_[6] * data_[986] + B10_current[6] * data_[976] + cB00_current[6] * data_[906];
  data_[997] = C00_[7] * data_[987] + B10_current[7] * data_[977] + cB00_current[7] * data_[907];
  data_[998] = C00_[8] * data_[988] + B10_current[8] * data_[978] + cB00_current[8] * data_[908];
  data_[999] = C00_[9] * data_[989] + B10_current[9] * data_[979] + cB00_current[9] * data_[909];
  ...
  data_[1000] = C00_[0] * data_[990] + B10_current[0] * data_[980] + cB00_current[0] * data_[910];
  data_[1001] = C00_[1] * data_[991] + B10_current[1] * data_[981] + cB00_current[1] * data_[911];
  data_[1002] = C00_[2] * data_[992] + B10_current[2] * data_[982] + cB00_current[2] * data_[912];
  data_[1003] = C00_[3] * data_[993] + B10_current[3] * data_[983] + cB00_current[3] * data_[913];
  data_[1004] = C00_[4] * data_[994] + B10_current[4] * data_[984] + cB00_current[4] * data_[914];
  data_[1005] = C00_[5] * data_[995] + B10_current[5] * data_[985] + cB00_current[5] * data_[915];
  data_[1006] = C00_[6] * data_[996] + B10_current[6] * data_[986] + cB00_current[6] * data_[916];
  data_[1007] = C00_[7] * data_[997] + B10_current[7] * data_[987] + cB00_current[7] * data_[917];
  data_[1008] = C00_[8] * data_[998] + B10_current[8] * data_[988] + cB00_current[8] * data_[918];
  data_[1009] = C00_[9] * data_[999] + B10_current[9] * data_[989] + cB00_current[9] * data_[919];
  ...
  data_[1010] = C00_[0] * data_[1000] + B10_current[0] * data_[990] + cB00_current[0] * data_[920];
  data_[1011] = C00_[1] * data_[1001] + B10_current[1] * data_[991] + cB00_current[1] * data_[921];
  data_[1012] = C00_[2] * data_[1002] + B10_current[2] * data_[992] + cB00_current[2] * data_[922];
  data_[1013] = C00_[3] * data_[1003] + B10_current[3] * data_[993] + cB00_current[3] * data_[923];
  data_[1014] = C00_[4] * data_[1004] + B10_current[4] * data_[994] + cB00_current[4] * data_[924];
  data_[1015] = C00_[5] * data_[1005] + B10_current[5] * data_[995] + cB00_current[5] * data_[925];
  data_[1016] = C00_[6] * data_[1006] + B10_current[6] * data_[996] + cB00_current[6] * data_[926];
  data_[1017] = C00_[7] * data_[1007] + B10_current[7] * data_[997] + cB00_current[7] * data_[927];
  data_[1018] = C00_[8] * data_[1008] + B10_current[8] * data_[998] + cB00_current[8] * data_[928];
  data_[1019] = C00_[9] * data_[1009] + B10_current[9] * data_[999] + cB00_current[9] * data_[929];
  ...
  data_[1020] = C00_[0] * data_[1010] + B10_current[0] * data_[1000] + cB00_current[0] * data_[930];
  data_[1021] = C00_[1] * data_[1011] + B10_current[1] * data_[1001] + cB00_current[1] * data_[931];
  data_[1022] = C00_[2] * data_[1012] + B10_current[2] * data_[1002] + cB00_current[2] * data_[932];
  data_[1023] = C00_[3] * data_[1013] + B10_current[3] * data_[1003] + cB00_current[3] * data_[933];
  data_[1024] = C00_[4] * data_[1014] + B10_current[4] * data_[1004] + cB00_current[4] * data_[934];
  data_[1025] = C00_[5] * data_[1015] + B10_current[5] * data_[1005] + cB00_current[5] * data_[935];
  data_[1026] = C00_[6] * data_[1016] + B10_current[6] * data_[1006] + cB00_current[6] * data_[936];
  data_[1027] = C00_[7] * data_[1017] + B10_current[7] * data_[1007] + cB00_current[7] * data_[937];
  data_[1028] = C00_[8] * data_[1018] + B10_current[8] * data_[1008] + cB00_current[8] * data_[938];
  data_[1029] = C00_[9] * data_[1019] + B10_current[9] * data_[1009] + cB00_current[9] * data_[939];
  ...
  data_[1030] = C00_[0] * data_[1020] + B10_current[0] * data_[1010] + cB00_current[0] * data_[940];
  data_[1031] = C00_[1] * data_[1021] + B10_current[1] * data_[1011] + cB00_current[1] * data_[941];
  data_[1032] = C00_[2] * data_[1022] + B10_current[2] * data_[1012] + cB00_current[2] * data_[942];
  data_[1033] = C00_[3] * data_[1023] + B10_current[3] * data_[1013] + cB00_current[3] * data_[943];
  data_[1034] = C00_[4] * data_[1024] + B10_current[4] * data_[1014] + cB00_current[4] * data_[944];
  data_[1035] = C00_[5] * data_[1025] + B10_current[5] * data_[1015] + cB00_current[5] * data_[945];
  data_[1036] = C00_[6] * data_[1026] + B10_current[6] * data_[1016] + cB00_current[6] * data_[946];
  data_[1037] = C00_[7] * data_[1027] + B10_current[7] * data_[1017] + cB00_current[7] * data_[947];
  data_[1038] = C00_[8] * data_[1028] + B10_current[8] * data_[1018] + cB00_current[8] * data_[948];
  data_[1039] = C00_[9] * data_[1029] + B10_current[9] * data_[1019] + cB00_current[9] * data_[949];
  ...
  data_[1040] = D00_[0] * data_[960] + B01_current[0] * data_[880];
  data_[1041] = D00_[1] * data_[961] + B01_current[1] * data_[881];
  data_[1042] = D00_[2] * data_[962] + B01_current[2] * data_[882];
  data_[1043] = D00_[3] * data_[963] + B01_current[3] * data_[883];
  data_[1044] = D00_[4] * data_[964] + B01_current[4] * data_[884];
  data_[1045] = D00_[5] * data_[965] + B01_current[5] * data_[885];
  data_[1046] = D00_[6] * data_[966] + B01_current[6] * data_[886];
  data_[1047] = D00_[7] * data_[967] + B01_current[7] * data_[887];
  data_[1048] = D00_[8] * data_[968] + B01_current[8] * data_[888];
  data_[1049] = D00_[9] * data_[969] + B01_current[9] * data_[889];
  ...
  data_[1050] = C00_[0] * data_[1040] + cB00_current[0] * data_[960];
  data_[1051] = C00_[1] * data_[1041] + cB00_current[1] * data_[961];
  data_[1052] = C00_[2] * data_[1042] + cB00_current[2] * data_[962];
  data_[1053] = C00_[3] * data_[1043] + cB00_current[3] * data_[963];
  data_[1054] = C00_[4] * data_[1044] + cB00_current[4] * data_[964];
  data_[1055] = C00_[5] * data_[1045] + cB00_current[5] * data_[965];
  data_[1056] = C00_[6] * data_[1046] + cB00_current[6] * data_[966];
  data_[1057] = C00_[7] * data_[1047] + cB00_current[7] * data_[967];
  data_[1058] = C00_[8] * data_[1048] + cB00_current[8] * data_[968];
  data_[1059] = C00_[9] * data_[1049] + cB00_current[9] * data_[969];
  ...
  data_[1060] = C00_[0] * data_[1050] + B10_current[0] * data_[1040] + cB00_current[0] * data_[970];
  data_[1061] = C00_[1] * data_[1051] + B10_current[1] * data_[1041] + cB00_current[1] * data_[971];
  data_[1062] = C00_[2] * data_[1052] + B10_current[2] * data_[1042] + cB00_current[2] * data_[972];
  data_[1063] = C00_[3] * data_[1053] + B10_current[3] * data_[1043] + cB00_current[3] * data_[973];
  data_[1064] = C00_[4] * data_[1054] + B10_current[4] * data_[1044] + cB00_current[4] * data_[974];
  data_[1065] = C00_[5] * data_[1055] + B10_current[5] * data_[1045] + cB00_current[5] * data_[975];
  data_[1066] = C00_[6] * data_[1056] + B10_current[6] * data_[1046] + cB00_current[6] * data_[976];
  data_[1067] = C00_[7] * data_[1057] + B10_current[7] * data_[1047] + cB00_current[7] * data_[977];
  data_[1068] = C00_[8] * data_[1058] + B10_current[8] * data_[1048] + cB00_current[8] * data_[978];
  data_[1069] = C00_[9] * data_[1059] + B10_current[9] * data_[1049] + cB00_current[9] * data_[979];
  ...
  data_[1070] = C00_[0] * data_[1060] + B10_current[0] * data_[1050] + cB00_current[0] * data_[980];
  data_[1071] = C00_[1] * data_[1061] + B10_current[1] * data_[1051] + cB00_current[1] * data_[981];
  data_[1072] = C00_[2] * data_[1062] + B10_current[2] * data_[1052] + cB00_current[2] * data_[982];
  data_[1073] = C00_[3] * data_[1063] + B10_current[3] * data_[1053] + cB00_current[3] * data_[983];
  data_[1074] = C00_[4] * data_[1064] + B10_current[4] * data_[1054] + cB00_current[4] * data_[984];
  data_[1075] = C00_[5] * data_[1065] + B10_current[5] * data_[1055] + cB00_current[5] * data_[985];
  data_[1076] = C00_[6] * data_[1066] + B10_current[6] * data_[1056] + cB00_current[6] * data_[986];
  data_[1077] = C00_[7] * data_[1067] + B10_current[7] * data_[1057] + cB00_current[7] * data_[987];
  data_[1078] = C00_[8] * data_[1068] + B10_current[8] * data_[1058] + cB00_current[8] * data_[988];
  data_[1079] = C00_[9] * data_[1069] + B10_current[9] * data_[1059] + cB00_current[9] * data_[989];
  ...
  data_[1080] = C00_[0] * data_[1070] + B10_current[0] * data_[1060] + cB00_current[0] * data_[990];
  data_[1081] = C00_[1] * data_[1071] + B10_current[1] * data_[1061] + cB00_current[1] * data_[991];
  data_[1082] = C00_[2] * data_[1072] + B10_current[2] * data_[1062] + cB00_current[2] * data_[992];
  data_[1083] = C00_[3] * data_[1073] + B10_current[3] * data_[1063] + cB00_current[3] * data_[993];
  data_[1084] = C00_[4] * data_[1074] + B10_current[4] * data_[1064] + cB00_current[4] * data_[994];
  data_[1085] = C00_[5] * data_[1075] + B10_current[5] * data_[1065] + cB00_current[5] * data_[995];
  data_[1086] = C00_[6] * data_[1076] + B10_current[6] * data_[1066] + cB00_current[6] * data_[996];
  data_[1087] = C00_[7] * data_[1077] + B10_current[7] * data_[1067] + cB00_current[7] * data_[997];
  data_[1088] = C00_[8] * data_[1078] + B10_current[8] * data_[1068] + cB00_current[8] * data_[998];
  data_[1089] = C00_[9] * data_[1079] + B10_current[9] * data_[1069] + cB00_current[9] * data_[999];
  ...
  data_[1090] = C00_[0] * data_[1080] + B10_current[0] * data_[1070] + cB00_current[0] * data_[1000];
  data_[1091] = C00_[1] * data_[1081] + B10_current[1] * data_[1071] + cB00_current[1] * data_[1001];
  data_[1092] = C00_[2] * data_[1082] + B10_current[2] * data_[1072] + cB00_current[2] * data_[1002];
  data_[1093] = C00_[3] * data_[1083] + B10_current[3] * data_[1073] + cB00_current[3] * data_[1003];
  data_[1094] = C00_[4] * data_[1084] + B10_current[4] * data_[1074] + cB00_current[4] * data_[1004];
  data_[1095] = C00_[5] * data_[1085] + B10_current[5] * data_[1075] + cB00_current[5] * data_[1005];
  data_[1096] = C00_[6] * data_[1086] + B10_current[6] * data_[1076] + cB00_current[6] * data_[1006];
  data_[1097] = C00_[7] * data_[1087] + B10_current[7] * data_[1077] + cB00_current[7] * data_[1007];
  data_[1098] = C00_[8] * data_[1088] + B10_current[8] * data_[1078] + cB00_current[8] * data_[1008];
  data_[1099] = C00_[9] * data_[1089] + B10_current[9] * data_[1079] + cB00_current[9] * data_[1009];
  ...
  data_[1100] = C00_[0] * data_[1090] + B10_current[0] * data_[1080] + cB00_current[0] * data_[1010];
  data_[1101] = C00_[1] * data_[1091] + B10_current[1] * data_[1081] + cB00_current[1] * data_[1011];
  data_[1102] = C00_[2] * data_[1092] + B10_current[2] * data_[1082] + cB00_current[2] * data_[1012];
  data_[1103] = C00_[3] * data_[1093] + B10_current[3] * data_[1083] + cB00_current[3] * data_[1013];
  data_[1104] = C00_[4] * data_[1094] + B10_current[4] * data_[1084] + cB00_current[4] * data_[1014];
  data_[1105] = C00_[5] * data_[1095] + B10_current[5] * data_[1085] + cB00_current[5] * data_[1015];
  data_[1106] = C00_[6] * data_[1096] + B10_current[6] * data_[1086] + cB00_current[6] * data_[1016];
  data_[1107] = C00_[7] * data_[1097] + B10_current[7] * data_[1087] + cB00_current[7] * data_[1017];
  data_[1108] = C00_[8] * data_[1098] + B10_current[8] * data_[1088] + cB00_current[8] * data_[1018];
  data_[1109] = C00_[9] * data_[1099] + B10_current[9] * data_[1089] + cB00_current[9] * data_[1019];
  ...
  data_[1110] = C00_[0] * data_[1100] + B10_current[0] * data_[1090] + cB00_current[0] * data_[1020];
  data_[1111] = C00_[1] * data_[1101] + B10_current[1] * data_[1091] + cB00_current[1] * data_[1021];
  data_[1112] = C00_[2] * data_[1102] + B10_current[2] * data_[1092] + cB00_current[2] * data_[1022];
  data_[1113] = C00_[3] * data_[1103] + B10_current[3] * data_[1093] + cB00_current[3] * data_[1023];
  data_[1114] = C00_[4] * data_[1104] + B10_current[4] * data_[1094] + cB00_current[4] * data_[1024];
  data_[1115] = C00_[5] * data_[1105] + B10_current[5] * data_[1095] + cB00_current[5] * data_[1025];
  data_[1116] = C00_[6] * data_[1106] + B10_current[6] * data_[1096] + cB00_current[6] * data_[1026];
  data_[1117] = C00_[7] * data_[1107] + B10_current[7] * data_[1097] + cB00_current[7] * data_[1027];
  data_[1118] = C00_[8] * data_[1108] + B10_current[8] * data_[1098] + cB00_current[8] * data_[1028];
  data_[1119] = C00_[9] * data_[1109] + B10_current[9] * data_[1099] + cB00_current[9] * data_[1029];
}
