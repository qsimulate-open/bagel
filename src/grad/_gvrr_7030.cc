...
void GVRRList::_gvrr_7030(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[125] = C00_[0] * data_[120] + cB00_current[0] * data_[80];
  data_[126] = C00_[1] * data_[121] + cB00_current[1] * data_[81];
  data_[127] = C00_[2] * data_[122] + cB00_current[2] * data_[82];
  data_[128] = C00_[3] * data_[123] + cB00_current[3] * data_[83];
  data_[129] = C00_[4] * data_[124] + cB00_current[4] * data_[84];
  ...
  data_[130] = C00_[0] * data_[125] + B10_current[0] * data_[120] + cB00_current[0] * data_[85];
  data_[131] = C00_[1] * data_[126] + B10_current[1] * data_[121] + cB00_current[1] * data_[86];
  data_[132] = C00_[2] * data_[127] + B10_current[2] * data_[122] + cB00_current[2] * data_[87];
  data_[133] = C00_[3] * data_[128] + B10_current[3] * data_[123] + cB00_current[3] * data_[88];
  data_[134] = C00_[4] * data_[129] + B10_current[4] * data_[124] + cB00_current[4] * data_[89];
  ...
  data_[135] = C00_[0] * data_[130] + B10_current[0] * data_[125] + cB00_current[0] * data_[90];
  data_[136] = C00_[1] * data_[131] + B10_current[1] * data_[126] + cB00_current[1] * data_[91];
  data_[137] = C00_[2] * data_[132] + B10_current[2] * data_[127] + cB00_current[2] * data_[92];
  data_[138] = C00_[3] * data_[133] + B10_current[3] * data_[128] + cB00_current[3] * data_[93];
  data_[139] = C00_[4] * data_[134] + B10_current[4] * data_[129] + cB00_current[4] * data_[94];
  ...
  data_[140] = C00_[0] * data_[135] + B10_current[0] * data_[130] + cB00_current[0] * data_[95];
  data_[141] = C00_[1] * data_[136] + B10_current[1] * data_[131] + cB00_current[1] * data_[96];
  data_[142] = C00_[2] * data_[137] + B10_current[2] * data_[132] + cB00_current[2] * data_[97];
  data_[143] = C00_[3] * data_[138] + B10_current[3] * data_[133] + cB00_current[3] * data_[98];
  data_[144] = C00_[4] * data_[139] + B10_current[4] * data_[134] + cB00_current[4] * data_[99];
  ...
  data_[145] = C00_[0] * data_[140] + B10_current[0] * data_[135] + cB00_current[0] * data_[100];
  data_[146] = C00_[1] * data_[141] + B10_current[1] * data_[136] + cB00_current[1] * data_[101];
  data_[147] = C00_[2] * data_[142] + B10_current[2] * data_[137] + cB00_current[2] * data_[102];
  data_[148] = C00_[3] * data_[143] + B10_current[3] * data_[138] + cB00_current[3] * data_[103];
  data_[149] = C00_[4] * data_[144] + B10_current[4] * data_[139] + cB00_current[4] * data_[104];
  ...
  data_[150] = C00_[0] * data_[145] + B10_current[0] * data_[140] + cB00_current[0] * data_[105];
  data_[151] = C00_[1] * data_[146] + B10_current[1] * data_[141] + cB00_current[1] * data_[106];
  data_[152] = C00_[2] * data_[147] + B10_current[2] * data_[142] + cB00_current[2] * data_[107];
  data_[153] = C00_[3] * data_[148] + B10_current[3] * data_[143] + cB00_current[3] * data_[108];
  data_[154] = C00_[4] * data_[149] + B10_current[4] * data_[144] + cB00_current[4] * data_[109];
  ...
  data_[155] = C00_[0] * data_[150] + B10_current[0] * data_[145] + cB00_current[0] * data_[110];
  data_[156] = C00_[1] * data_[151] + B10_current[1] * data_[146] + cB00_current[1] * data_[111];
  data_[157] = C00_[2] * data_[152] + B10_current[2] * data_[147] + cB00_current[2] * data_[112];
  data_[158] = C00_[3] * data_[153] + B10_current[3] * data_[148] + cB00_current[3] * data_[113];
  data_[159] = C00_[4] * data_[154] + B10_current[4] * data_[149] + cB00_current[4] * data_[114];
}
