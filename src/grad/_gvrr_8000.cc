...
void GVRRList::_gvrr_8000(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[32] = C00_[0] * data_[28] + B10_current[0] * data_[24];
  data_[33] = C00_[1] * data_[29] + B10_current[1] * data_[25];
  data_[34] = C00_[2] * data_[30] + B10_current[2] * data_[26];
  data_[35] = C00_[3] * data_[31] + B10_current[3] * data_[27];
}
