...
void GVRRList::_gvrr_b030(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[168] = D00_[0] * data_[84] + B01_current[0];
  data_[169] = D00_[1] * data_[85] + B01_current[1];
  data_[170] = D00_[2] * data_[86] + B01_current[2];
  data_[171] = D00_[3] * data_[87] + B01_current[3];
  data_[172] = D00_[4] * data_[88] + B01_current[4];
  data_[173] = D00_[5] * data_[89] + B01_current[5];
  data_[174] = D00_[6] * data_[90] + B01_current[6];
  ...
  data_[252] = D00_[0] * data_[168] + B01_current[0] * data_[84];
  data_[253] = D00_[1] * data_[169] + B01_current[1] * data_[85];
  data_[254] = D00_[2] * data_[170] + B01_current[2] * data_[86];
  data_[255] = D00_[3] * data_[171] + B01_current[3] * data_[87];
  data_[256] = D00_[4] * data_[172] + B01_current[4] * data_[88];
  data_[257] = D00_[5] * data_[173] + B01_current[5] * data_[89];
  data_[258] = D00_[6] * data_[174] + B01_current[6] * data_[90];
  ...
  data_[259] = C00_[0] * data_[252] + cB00_current[0] * data_[168];
  data_[260] = C00_[1] * data_[253] + cB00_current[1] * data_[169];
  data_[261] = C00_[2] * data_[254] + cB00_current[2] * data_[170];
  data_[262] = C00_[3] * data_[255] + cB00_current[3] * data_[171];
  data_[263] = C00_[4] * data_[256] + cB00_current[4] * data_[172];
  data_[264] = C00_[5] * data_[257] + cB00_current[5] * data_[173];
  data_[265] = C00_[6] * data_[258] + cB00_current[6] * data_[174];
  ...
  data_[266] = C00_[0] * data_[259] + B10_current[0] * data_[252] + cB00_current[0] * data_[175];
  data_[267] = C00_[1] * data_[260] + B10_current[1] * data_[253] + cB00_current[1] * data_[176];
  data_[268] = C00_[2] * data_[261] + B10_current[2] * data_[254] + cB00_current[2] * data_[177];
  data_[269] = C00_[3] * data_[262] + B10_current[3] * data_[255] + cB00_current[3] * data_[178];
  data_[270] = C00_[4] * data_[263] + B10_current[4] * data_[256] + cB00_current[4] * data_[179];
  data_[271] = C00_[5] * data_[264] + B10_current[5] * data_[257] + cB00_current[5] * data_[180];
  data_[272] = C00_[6] * data_[265] + B10_current[6] * data_[258] + cB00_current[6] * data_[181];
  ...
  data_[273] = C00_[0] * data_[266] + B10_current[0] * data_[259] + cB00_current[0] * data_[182];
  data_[274] = C00_[1] * data_[267] + B10_current[1] * data_[260] + cB00_current[1] * data_[183];
  data_[275] = C00_[2] * data_[268] + B10_current[2] * data_[261] + cB00_current[2] * data_[184];
  data_[276] = C00_[3] * data_[269] + B10_current[3] * data_[262] + cB00_current[3] * data_[185];
  data_[277] = C00_[4] * data_[270] + B10_current[4] * data_[263] + cB00_current[4] * data_[186];
  data_[278] = C00_[5] * data_[271] + B10_current[5] * data_[264] + cB00_current[5] * data_[187];
  data_[279] = C00_[6] * data_[272] + B10_current[6] * data_[265] + cB00_current[6] * data_[188];
  ...
  data_[280] = C00_[0] * data_[273] + B10_current[0] * data_[266] + cB00_current[0] * data_[189];
  data_[281] = C00_[1] * data_[274] + B10_current[1] * data_[267] + cB00_current[1] * data_[190];
  data_[282] = C00_[2] * data_[275] + B10_current[2] * data_[268] + cB00_current[2] * data_[191];
  data_[283] = C00_[3] * data_[276] + B10_current[3] * data_[269] + cB00_current[3] * data_[192];
  data_[284] = C00_[4] * data_[277] + B10_current[4] * data_[270] + cB00_current[4] * data_[193];
  data_[285] = C00_[5] * data_[278] + B10_current[5] * data_[271] + cB00_current[5] * data_[194];
  data_[286] = C00_[6] * data_[279] + B10_current[6] * data_[272] + cB00_current[6] * data_[195];
  ...
  data_[287] = C00_[0] * data_[280] + B10_current[0] * data_[273] + cB00_current[0] * data_[196];
  data_[288] = C00_[1] * data_[281] + B10_current[1] * data_[274] + cB00_current[1] * data_[197];
  data_[289] = C00_[2] * data_[282] + B10_current[2] * data_[275] + cB00_current[2] * data_[198];
  data_[290] = C00_[3] * data_[283] + B10_current[3] * data_[276] + cB00_current[3] * data_[199];
  data_[291] = C00_[4] * data_[284] + B10_current[4] * data_[277] + cB00_current[4] * data_[200];
  data_[292] = C00_[5] * data_[285] + B10_current[5] * data_[278] + cB00_current[5] * data_[201];
  data_[293] = C00_[6] * data_[286] + B10_current[6] * data_[279] + cB00_current[6] * data_[202];
  ...
  data_[294] = C00_[0] * data_[287] + B10_current[0] * data_[280] + cB00_current[0] * data_[203];
  data_[295] = C00_[1] * data_[288] + B10_current[1] * data_[281] + cB00_current[1] * data_[204];
  data_[296] = C00_[2] * data_[289] + B10_current[2] * data_[282] + cB00_current[2] * data_[205];
  data_[297] = C00_[3] * data_[290] + B10_current[3] * data_[283] + cB00_current[3] * data_[206];
  data_[298] = C00_[4] * data_[291] + B10_current[4] * data_[284] + cB00_current[4] * data_[207];
  data_[299] = C00_[5] * data_[292] + B10_current[5] * data_[285] + cB00_current[5] * data_[208];
  data_[300] = C00_[6] * data_[293] + B10_current[6] * data_[286] + cB00_current[6] * data_[209];
  ...
  data_[301] = C00_[0] * data_[294] + B10_current[0] * data_[287] + cB00_current[0] * data_[210];
  data_[302] = C00_[1] * data_[295] + B10_current[1] * data_[288] + cB00_current[1] * data_[211];
  data_[303] = C00_[2] * data_[296] + B10_current[2] * data_[289] + cB00_current[2] * data_[212];
  data_[304] = C00_[3] * data_[297] + B10_current[3] * data_[290] + cB00_current[3] * data_[213];
  data_[305] = C00_[4] * data_[298] + B10_current[4] * data_[291] + cB00_current[4] * data_[214];
  data_[306] = C00_[5] * data_[299] + B10_current[5] * data_[292] + cB00_current[5] * data_[215];
  data_[307] = C00_[6] * data_[300] + B10_current[6] * data_[293] + cB00_current[6] * data_[216];
  ...
  data_[308] = C00_[0] * data_[301] + B10_current[0] * data_[294] + cB00_current[0] * data_[217];
  data_[309] = C00_[1] * data_[302] + B10_current[1] * data_[295] + cB00_current[1] * data_[218];
  data_[310] = C00_[2] * data_[303] + B10_current[2] * data_[296] + cB00_current[2] * data_[219];
  data_[311] = C00_[3] * data_[304] + B10_current[3] * data_[297] + cB00_current[3] * data_[220];
  data_[312] = C00_[4] * data_[305] + B10_current[4] * data_[298] + cB00_current[4] * data_[221];
  data_[313] = C00_[5] * data_[306] + B10_current[5] * data_[299] + cB00_current[5] * data_[222];
  data_[314] = C00_[6] * data_[307] + B10_current[6] * data_[300] + cB00_current[6] * data_[223];
  ...
  data_[315] = C00_[0] * data_[308] + B10_current[0] * data_[301] + cB00_current[0] * data_[224];
  data_[316] = C00_[1] * data_[309] + B10_current[1] * data_[302] + cB00_current[1] * data_[225];
  data_[317] = C00_[2] * data_[310] + B10_current[2] * data_[303] + cB00_current[2] * data_[226];
  data_[318] = C00_[3] * data_[311] + B10_current[3] * data_[304] + cB00_current[3] * data_[227];
  data_[319] = C00_[4] * data_[312] + B10_current[4] * data_[305] + cB00_current[4] * data_[228];
  data_[320] = C00_[5] * data_[313] + B10_current[5] * data_[306] + cB00_current[5] * data_[229];
  data_[321] = C00_[6] * data_[314] + B10_current[6] * data_[307] + cB00_current[6] * data_[230];
  ...
  data_[322] = C00_[0] * data_[315] + B10_current[0] * data_[308] + cB00_current[0] * data_[231];
  data_[323] = C00_[1] * data_[316] + B10_current[1] * data_[309] + cB00_current[1] * data_[232];
  data_[324] = C00_[2] * data_[317] + B10_current[2] * data_[310] + cB00_current[2] * data_[233];
  data_[325] = C00_[3] * data_[318] + B10_current[3] * data_[311] + cB00_current[3] * data_[234];
  data_[326] = C00_[4] * data_[319] + B10_current[4] * data_[312] + cB00_current[4] * data_[235];
  data_[327] = C00_[5] * data_[320] + B10_current[5] * data_[313] + cB00_current[5] * data_[236];
  data_[328] = C00_[6] * data_[321] + B10_current[6] * data_[314] + cB00_current[6] * data_[237];
  ...
  data_[329] = C00_[0] * data_[322] + B10_current[0] * data_[315] + cB00_current[0] * data_[238];
  data_[330] = C00_[1] * data_[323] + B10_current[1] * data_[316] + cB00_current[1] * data_[239];
  data_[331] = C00_[2] * data_[324] + B10_current[2] * data_[317] + cB00_current[2] * data_[240];
  data_[332] = C00_[3] * data_[325] + B10_current[3] * data_[318] + cB00_current[3] * data_[241];
  data_[333] = C00_[4] * data_[326] + B10_current[4] * data_[319] + cB00_current[4] * data_[242];
  data_[334] = C00_[5] * data_[327] + B10_current[5] * data_[320] + cB00_current[5] * data_[243];
  data_[335] = C00_[6] * data_[328] + B10_current[6] * data_[321] + cB00_current[6] * data_[244];
}
