...
void GVRRList::_gvrr_00d0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[84] = D00_[0] * data_[77] + B01_current[0] * data_[70];
  data_[85] = D00_[1] * data_[78] + B01_current[1] * data_[71];
  data_[86] = D00_[2] * data_[79] + B01_current[2] * data_[72];
  data_[87] = D00_[3] * data_[80] + B01_current[3] * data_[73];
  data_[88] = D00_[4] * data_[81] + B01_current[4] * data_[74];
  data_[89] = D00_[5] * data_[82] + B01_current[5] * data_[75];
  data_[90] = D00_[6] * data_[83] + B01_current[6] * data_[76];
  ...
  data_[91] = D00_[0] * data_[84] + B01_current[0] * data_[77];
  data_[92] = D00_[1] * data_[85] + B01_current[1] * data_[78];
  data_[93] = D00_[2] * data_[86] + B01_current[2] * data_[79];
  data_[94] = D00_[3] * data_[87] + B01_current[3] * data_[80];
  data_[95] = D00_[4] * data_[88] + B01_current[4] * data_[81];
  data_[96] = D00_[5] * data_[89] + B01_current[5] * data_[82];
  data_[97] = D00_[6] * data_[90] + B01_current[6] * data_[83];
}
