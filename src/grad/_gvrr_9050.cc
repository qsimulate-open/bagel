...
// returns double array of length 420
void GVRRList::_gvrr_9050(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[287] = C00_[0] * data_[280] + cB00_current[0] * data_[210];
  data_[288] = C00_[1] * data_[281] + cB00_current[1] * data_[211];
  data_[289] = C00_[2] * data_[282] + cB00_current[2] * data_[212];
  data_[290] = C00_[3] * data_[283] + cB00_current[3] * data_[213];
  data_[291] = C00_[4] * data_[284] + cB00_current[4] * data_[214];
  data_[292] = C00_[5] * data_[285] + cB00_current[5] * data_[215];
  data_[293] = C00_[6] * data_[286] + cB00_current[6] * data_[216];
  ...
  data_[294] = C00_[0] * data_[287] + B10_current[0] * data_[280] + cB00_current[0] * data_[217];
  data_[295] = C00_[1] * data_[288] + B10_current[1] * data_[281] + cB00_current[1] * data_[218];
  data_[296] = C00_[2] * data_[289] + B10_current[2] * data_[282] + cB00_current[2] * data_[219];
  data_[297] = C00_[3] * data_[290] + B10_current[3] * data_[283] + cB00_current[3] * data_[220];
  data_[298] = C00_[4] * data_[291] + B10_current[4] * data_[284] + cB00_current[4] * data_[221];
  data_[299] = C00_[5] * data_[292] + B10_current[5] * data_[285] + cB00_current[5] * data_[222];
  data_[300] = C00_[6] * data_[293] + B10_current[6] * data_[286] + cB00_current[6] * data_[223];
  ...
  data_[301] = C00_[0] * data_[294] + B10_current[0] * data_[287] + cB00_current[0] * data_[224];
  data_[302] = C00_[1] * data_[295] + B10_current[1] * data_[288] + cB00_current[1] * data_[225];
  data_[303] = C00_[2] * data_[296] + B10_current[2] * data_[289] + cB00_current[2] * data_[226];
  data_[304] = C00_[3] * data_[297] + B10_current[3] * data_[290] + cB00_current[3] * data_[227];
  data_[305] = C00_[4] * data_[298] + B10_current[4] * data_[291] + cB00_current[4] * data_[228];
  data_[306] = C00_[5] * data_[299] + B10_current[5] * data_[292] + cB00_current[5] * data_[229];
  data_[307] = C00_[6] * data_[300] + B10_current[6] * data_[293] + cB00_current[6] * data_[230];
  ...
  data_[308] = C00_[0] * data_[301] + B10_current[0] * data_[294] + cB00_current[0] * data_[231];
  data_[309] = C00_[1] * data_[302] + B10_current[1] * data_[295] + cB00_current[1] * data_[232];
  data_[310] = C00_[2] * data_[303] + B10_current[2] * data_[296] + cB00_current[2] * data_[233];
  data_[311] = C00_[3] * data_[304] + B10_current[3] * data_[297] + cB00_current[3] * data_[234];
  data_[312] = C00_[4] * data_[305] + B10_current[4] * data_[298] + cB00_current[4] * data_[235];
  data_[313] = C00_[5] * data_[306] + B10_current[5] * data_[299] + cB00_current[5] * data_[236];
  data_[314] = C00_[6] * data_[307] + B10_current[6] * data_[300] + cB00_current[6] * data_[237];
  ...
  data_[315] = C00_[0] * data_[308] + B10_current[0] * data_[301] + cB00_current[0] * data_[238];
  data_[316] = C00_[1] * data_[309] + B10_current[1] * data_[302] + cB00_current[1] * data_[239];
  data_[317] = C00_[2] * data_[310] + B10_current[2] * data_[303] + cB00_current[2] * data_[240];
  data_[318] = C00_[3] * data_[311] + B10_current[3] * data_[304] + cB00_current[3] * data_[241];
  data_[319] = C00_[4] * data_[312] + B10_current[4] * data_[305] + cB00_current[4] * data_[242];
  data_[320] = C00_[5] * data_[313] + B10_current[5] * data_[306] + cB00_current[5] * data_[243];
  data_[321] = C00_[6] * data_[314] + B10_current[6] * data_[307] + cB00_current[6] * data_[244];
  ...
  data_[322] = C00_[0] * data_[315] + B10_current[0] * data_[308] + cB00_current[0] * data_[245];
  data_[323] = C00_[1] * data_[316] + B10_current[1] * data_[309] + cB00_current[1] * data_[246];
  data_[324] = C00_[2] * data_[317] + B10_current[2] * data_[310] + cB00_current[2] * data_[247];
  data_[325] = C00_[3] * data_[318] + B10_current[3] * data_[311] + cB00_current[3] * data_[248];
  data_[326] = C00_[4] * data_[319] + B10_current[4] * data_[312] + cB00_current[4] * data_[249];
  data_[327] = C00_[5] * data_[320] + B10_current[5] * data_[313] + cB00_current[5] * data_[250];
  data_[328] = C00_[6] * data_[321] + B10_current[6] * data_[314] + cB00_current[6] * data_[251];
  ...
  data_[329] = C00_[0] * data_[322] + B10_current[0] * data_[315] + cB00_current[0] * data_[252];
  data_[330] = C00_[1] * data_[323] + B10_current[1] * data_[316] + cB00_current[1] * data_[253];
  data_[331] = C00_[2] * data_[324] + B10_current[2] * data_[317] + cB00_current[2] * data_[254];
  data_[332] = C00_[3] * data_[325] + B10_current[3] * data_[318] + cB00_current[3] * data_[255];
  data_[333] = C00_[4] * data_[326] + B10_current[4] * data_[319] + cB00_current[4] * data_[256];
  data_[334] = C00_[5] * data_[327] + B10_current[5] * data_[320] + cB00_current[5] * data_[257];
  data_[335] = C00_[6] * data_[328] + B10_current[6] * data_[321] + cB00_current[6] * data_[258];
  ...
  data_[336] = C00_[0] * data_[329] + B10_current[0] * data_[322] + cB00_current[0] * data_[259];
  data_[337] = C00_[1] * data_[330] + B10_current[1] * data_[323] + cB00_current[1] * data_[260];
  data_[338] = C00_[2] * data_[331] + B10_current[2] * data_[324] + cB00_current[2] * data_[261];
  data_[339] = C00_[3] * data_[332] + B10_current[3] * data_[325] + cB00_current[3] * data_[262];
  data_[340] = C00_[4] * data_[333] + B10_current[4] * data_[326] + cB00_current[4] * data_[263];
  data_[341] = C00_[5] * data_[334] + B10_current[5] * data_[327] + cB00_current[5] * data_[264];
  data_[342] = C00_[6] * data_[335] + B10_current[6] * data_[328] + cB00_current[6] * data_[265];
  ...
  data_[343] = C00_[0] * data_[336] + B10_current[0] * data_[329] + cB00_current[0] * data_[266];
  data_[344] = C00_[1] * data_[337] + B10_current[1] * data_[330] + cB00_current[1] * data_[267];
  data_[345] = C00_[2] * data_[338] + B10_current[2] * data_[331] + cB00_current[2] * data_[268];
  data_[346] = C00_[3] * data_[339] + B10_current[3] * data_[332] + cB00_current[3] * data_[269];
  data_[347] = C00_[4] * data_[340] + B10_current[4] * data_[333] + cB00_current[4] * data_[270];
  data_[348] = C00_[5] * data_[341] + B10_current[5] * data_[334] + cB00_current[5] * data_[271];
  data_[349] = C00_[6] * data_[342] + B10_current[6] * data_[335] + cB00_current[6] * data_[272];
  ...
  data_[357] = C00_[0] * data_[350] + cB00_current[0] * data_[280];
  data_[358] = C00_[1] * data_[351] + cB00_current[1] * data_[281];
  data_[359] = C00_[2] * data_[352] + cB00_current[2] * data_[282];
  data_[360] = C00_[3] * data_[353] + cB00_current[3] * data_[283];
  data_[361] = C00_[4] * data_[354] + cB00_current[4] * data_[284];
  data_[362] = C00_[5] * data_[355] + cB00_current[5] * data_[285];
  data_[363] = C00_[6] * data_[356] + cB00_current[6] * data_[286];
  ...
  data_[364] = C00_[0] * data_[357] + B10_current[0] * data_[350] + cB00_current[0] * data_[287];
  data_[365] = C00_[1] * data_[358] + B10_current[1] * data_[351] + cB00_current[1] * data_[288];
  data_[366] = C00_[2] * data_[359] + B10_current[2] * data_[352] + cB00_current[2] * data_[289];
  data_[367] = C00_[3] * data_[360] + B10_current[3] * data_[353] + cB00_current[3] * data_[290];
  data_[368] = C00_[4] * data_[361] + B10_current[4] * data_[354] + cB00_current[4] * data_[291];
  data_[369] = C00_[5] * data_[362] + B10_current[5] * data_[355] + cB00_current[5] * data_[292];
  data_[370] = C00_[6] * data_[363] + B10_current[6] * data_[356] + cB00_current[6] * data_[293];
  ...
  data_[371] = C00_[0] * data_[364] + B10_current[0] * data_[357] + cB00_current[0] * data_[294];
  data_[372] = C00_[1] * data_[365] + B10_current[1] * data_[358] + cB00_current[1] * data_[295];
  data_[373] = C00_[2] * data_[366] + B10_current[2] * data_[359] + cB00_current[2] * data_[296];
  data_[374] = C00_[3] * data_[367] + B10_current[3] * data_[360] + cB00_current[3] * data_[297];
  data_[375] = C00_[4] * data_[368] + B10_current[4] * data_[361] + cB00_current[4] * data_[298];
  data_[376] = C00_[5] * data_[369] + B10_current[5] * data_[362] + cB00_current[5] * data_[299];
  data_[377] = C00_[6] * data_[370] + B10_current[6] * data_[363] + cB00_current[6] * data_[300];
  ...
  data_[378] = C00_[0] * data_[371] + B10_current[0] * data_[364] + cB00_current[0] * data_[301];
  data_[379] = C00_[1] * data_[372] + B10_current[1] * data_[365] + cB00_current[1] * data_[302];
  data_[380] = C00_[2] * data_[373] + B10_current[2] * data_[366] + cB00_current[2] * data_[303];
  data_[381] = C00_[3] * data_[374] + B10_current[3] * data_[367] + cB00_current[3] * data_[304];
  data_[382] = C00_[4] * data_[375] + B10_current[4] * data_[368] + cB00_current[4] * data_[305];
  data_[383] = C00_[5] * data_[376] + B10_current[5] * data_[369] + cB00_current[5] * data_[306];
  data_[384] = C00_[6] * data_[377] + B10_current[6] * data_[370] + cB00_current[6] * data_[307];
  ...
  data_[385] = C00_[0] * data_[378] + B10_current[0] * data_[371] + cB00_current[0] * data_[308];
  data_[386] = C00_[1] * data_[379] + B10_current[1] * data_[372] + cB00_current[1] * data_[309];
  data_[387] = C00_[2] * data_[380] + B10_current[2] * data_[373] + cB00_current[2] * data_[310];
  data_[388] = C00_[3] * data_[381] + B10_current[3] * data_[374] + cB00_current[3] * data_[311];
  data_[389] = C00_[4] * data_[382] + B10_current[4] * data_[375] + cB00_current[4] * data_[312];
  data_[390] = C00_[5] * data_[383] + B10_current[5] * data_[376] + cB00_current[5] * data_[313];
  data_[391] = C00_[6] * data_[384] + B10_current[6] * data_[377] + cB00_current[6] * data_[314];
  ...
  data_[392] = C00_[0] * data_[385] + B10_current[0] * data_[378] + cB00_current[0] * data_[315];
  data_[393] = C00_[1] * data_[386] + B10_current[1] * data_[379] + cB00_current[1] * data_[316];
  data_[394] = C00_[2] * data_[387] + B10_current[2] * data_[380] + cB00_current[2] * data_[317];
  data_[395] = C00_[3] * data_[388] + B10_current[3] * data_[381] + cB00_current[3] * data_[318];
  data_[396] = C00_[4] * data_[389] + B10_current[4] * data_[382] + cB00_current[4] * data_[319];
  data_[397] = C00_[5] * data_[390] + B10_current[5] * data_[383] + cB00_current[5] * data_[320];
  data_[398] = C00_[6] * data_[391] + B10_current[6] * data_[384] + cB00_current[6] * data_[321];
  ...
  data_[399] = C00_[0] * data_[392] + B10_current[0] * data_[385] + cB00_current[0] * data_[322];
  data_[400] = C00_[1] * data_[393] + B10_current[1] * data_[386] + cB00_current[1] * data_[323];
  data_[401] = C00_[2] * data_[394] + B10_current[2] * data_[387] + cB00_current[2] * data_[324];
  data_[402] = C00_[3] * data_[395] + B10_current[3] * data_[388] + cB00_current[3] * data_[325];
  data_[403] = C00_[4] * data_[396] + B10_current[4] * data_[389] + cB00_current[4] * data_[326];
  data_[404] = C00_[5] * data_[397] + B10_current[5] * data_[390] + cB00_current[5] * data_[327];
  data_[405] = C00_[6] * data_[398] + B10_current[6] * data_[391] + cB00_current[6] * data_[328];
  ...
  data_[406] = C00_[0] * data_[399] + B10_current[0] * data_[392] + cB00_current[0] * data_[329];
  data_[407] = C00_[1] * data_[400] + B10_current[1] * data_[393] + cB00_current[1] * data_[330];
  data_[408] = C00_[2] * data_[401] + B10_current[2] * data_[394] + cB00_current[2] * data_[331];
  data_[409] = C00_[3] * data_[402] + B10_current[3] * data_[395] + cB00_current[3] * data_[332];
  data_[410] = C00_[4] * data_[403] + B10_current[4] * data_[396] + cB00_current[4] * data_[333];
  data_[411] = C00_[5] * data_[404] + B10_current[5] * data_[397] + cB00_current[5] * data_[334];
  data_[412] = C00_[6] * data_[405] + B10_current[6] * data_[398] + cB00_current[6] * data_[335];
  ...
  data_[413] = C00_[0] * data_[406] + B10_current[0] * data_[399] + cB00_current[0] * data_[336];
  data_[414] = C00_[1] * data_[407] + B10_current[1] * data_[400] + cB00_current[1] * data_[337];
  data_[415] = C00_[2] * data_[408] + B10_current[2] * data_[401] + cB00_current[2] * data_[338];
  data_[416] = C00_[3] * data_[409] + B10_current[3] * data_[402] + cB00_current[3] * data_[339];
  data_[417] = C00_[4] * data_[410] + B10_current[4] * data_[403] + cB00_current[4] * data_[340];
  data_[418] = C00_[5] * data_[411] + B10_current[5] * data_[404] + cB00_current[5] * data_[341];
  data_[419] = C00_[6] * data_[412] + B10_current[6] * data_[405] + cB00_current[6] * data_[342];
}
