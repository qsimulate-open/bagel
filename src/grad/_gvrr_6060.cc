...
void GVRRList::_gvrr_6060(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[258] = C00_[0] * data_[252] + cB00_current[0] * data_[210];
  data_[259] = C00_[1] * data_[253] + cB00_current[1] * data_[211];
  data_[260] = C00_[2] * data_[254] + cB00_current[2] * data_[212];
  data_[261] = C00_[3] * data_[255] + cB00_current[3] * data_[213];
  data_[262] = C00_[4] * data_[256] + cB00_current[4] * data_[214];
  data_[263] = C00_[5] * data_[257] + cB00_current[5] * data_[215];
  ...
  data_[264] = C00_[0] * data_[258] + B10_current[0] * data_[252] + cB00_current[0] * data_[216];
  data_[265] = C00_[1] * data_[259] + B10_current[1] * data_[253] + cB00_current[1] * data_[217];
  data_[266] = C00_[2] * data_[260] + B10_current[2] * data_[254] + cB00_current[2] * data_[218];
  data_[267] = C00_[3] * data_[261] + B10_current[3] * data_[255] + cB00_current[3] * data_[219];
  data_[268] = C00_[4] * data_[262] + B10_current[4] * data_[256] + cB00_current[4] * data_[220];
  data_[269] = C00_[5] * data_[263] + B10_current[5] * data_[257] + cB00_current[5] * data_[221];
  ...
  data_[270] = C00_[0] * data_[264] + B10_current[0] * data_[258] + cB00_current[0] * data_[222];
  data_[271] = C00_[1] * data_[265] + B10_current[1] * data_[259] + cB00_current[1] * data_[223];
  data_[272] = C00_[2] * data_[266] + B10_current[2] * data_[260] + cB00_current[2] * data_[224];
  data_[273] = C00_[3] * data_[267] + B10_current[3] * data_[261] + cB00_current[3] * data_[225];
  data_[274] = C00_[4] * data_[268] + B10_current[4] * data_[262] + cB00_current[4] * data_[226];
  data_[275] = C00_[5] * data_[269] + B10_current[5] * data_[263] + cB00_current[5] * data_[227];
  ...
  data_[276] = C00_[0] * data_[270] + B10_current[0] * data_[264] + cB00_current[0] * data_[228];
  data_[277] = C00_[1] * data_[271] + B10_current[1] * data_[265] + cB00_current[1] * data_[229];
  data_[278] = C00_[2] * data_[272] + B10_current[2] * data_[266] + cB00_current[2] * data_[230];
  data_[279] = C00_[3] * data_[273] + B10_current[3] * data_[267] + cB00_current[3] * data_[231];
  data_[280] = C00_[4] * data_[274] + B10_current[4] * data_[268] + cB00_current[4] * data_[232];
  data_[281] = C00_[5] * data_[275] + B10_current[5] * data_[269] + cB00_current[5] * data_[233];
  ...
  data_[282] = C00_[0] * data_[276] + B10_current[0] * data_[270] + cB00_current[0] * data_[234];
  data_[283] = C00_[1] * data_[277] + B10_current[1] * data_[271] + cB00_current[1] * data_[235];
  data_[284] = C00_[2] * data_[278] + B10_current[2] * data_[272] + cB00_current[2] * data_[236];
  data_[285] = C00_[3] * data_[279] + B10_current[3] * data_[273] + cB00_current[3] * data_[237];
  data_[286] = C00_[4] * data_[280] + B10_current[4] * data_[274] + cB00_current[4] * data_[238];
  data_[287] = C00_[5] * data_[281] + B10_current[5] * data_[275] + cB00_current[5] * data_[239];
  ...
  data_[288] = C00_[0] * data_[282] + B10_current[0] * data_[276] + cB00_current[0] * data_[240];
  data_[289] = C00_[1] * data_[283] + B10_current[1] * data_[277] + cB00_current[1] * data_[241];
  data_[290] = C00_[2] * data_[284] + B10_current[2] * data_[278] + cB00_current[2] * data_[242];
  data_[291] = C00_[3] * data_[285] + B10_current[3] * data_[279] + cB00_current[3] * data_[243];
  data_[292] = C00_[4] * data_[286] + B10_current[4] * data_[280] + cB00_current[4] * data_[244];
  data_[293] = C00_[5] * data_[287] + B10_current[5] * data_[281] + cB00_current[5] * data_[245];
}
