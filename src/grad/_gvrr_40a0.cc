...
void GVRRList::_gvrr_40a0(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[315] = D00_[0] * data_[280] + B01_current[0] * data_[245];
  data_[316] = D00_[1] * data_[281] + B01_current[1] * data_[246];
  data_[317] = D00_[2] * data_[282] + B01_current[2] * data_[247];
  data_[318] = D00_[3] * data_[283] + B01_current[3] * data_[248];
  data_[319] = D00_[4] * data_[284] + B01_current[4] * data_[249];
  data_[320] = D00_[5] * data_[285] + B01_current[5] * data_[250];
  data_[321] = D00_[6] * data_[286] + B01_current[6] * data_[251];
  ...
  data_[322] = C00_[0] * data_[315] + cB00_current[0] * data_[280];
  data_[323] = C00_[1] * data_[316] + cB00_current[1] * data_[281];
  data_[324] = C00_[2] * data_[317] + cB00_current[2] * data_[282];
  data_[325] = C00_[3] * data_[318] + cB00_current[3] * data_[283];
  data_[326] = C00_[4] * data_[319] + cB00_current[4] * data_[284];
  data_[327] = C00_[5] * data_[320] + cB00_current[5] * data_[285];
  data_[328] = C00_[6] * data_[321] + cB00_current[6] * data_[286];
  ...
  data_[329] = C00_[0] * data_[322] + B10_current[0] * data_[315] + cB00_current[0] * data_[287];
  data_[330] = C00_[1] * data_[323] + B10_current[1] * data_[316] + cB00_current[1] * data_[288];
  data_[331] = C00_[2] * data_[324] + B10_current[2] * data_[317] + cB00_current[2] * data_[289];
  data_[332] = C00_[3] * data_[325] + B10_current[3] * data_[318] + cB00_current[3] * data_[290];
  data_[333] = C00_[4] * data_[326] + B10_current[4] * data_[319] + cB00_current[4] * data_[291];
  data_[334] = C00_[5] * data_[327] + B10_current[5] * data_[320] + cB00_current[5] * data_[292];
  data_[335] = C00_[6] * data_[328] + B10_current[6] * data_[321] + cB00_current[6] * data_[293];
  ...
  data_[336] = C00_[0] * data_[329] + B10_current[0] * data_[322] + cB00_current[0] * data_[294];
  data_[337] = C00_[1] * data_[330] + B10_current[1] * data_[323] + cB00_current[1] * data_[295];
  data_[338] = C00_[2] * data_[331] + B10_current[2] * data_[324] + cB00_current[2] * data_[296];
  data_[339] = C00_[3] * data_[332] + B10_current[3] * data_[325] + cB00_current[3] * data_[297];
  data_[340] = C00_[4] * data_[333] + B10_current[4] * data_[326] + cB00_current[4] * data_[298];
  data_[341] = C00_[5] * data_[334] + B10_current[5] * data_[327] + cB00_current[5] * data_[299];
  data_[342] = C00_[6] * data_[335] + B10_current[6] * data_[328] + cB00_current[6] * data_[300];
  ...
  data_[343] = C00_[0] * data_[336] + B10_current[0] * data_[329] + cB00_current[0] * data_[301];
  data_[344] = C00_[1] * data_[337] + B10_current[1] * data_[330] + cB00_current[1] * data_[302];
  data_[345] = C00_[2] * data_[338] + B10_current[2] * data_[331] + cB00_current[2] * data_[303];
  data_[346] = C00_[3] * data_[339] + B10_current[3] * data_[332] + cB00_current[3] * data_[304];
  data_[347] = C00_[4] * data_[340] + B10_current[4] * data_[333] + cB00_current[4] * data_[305];
  data_[348] = C00_[5] * data_[341] + B10_current[5] * data_[334] + cB00_current[5] * data_[306];
  data_[349] = C00_[6] * data_[342] + B10_current[6] * data_[335] + cB00_current[6] * data_[307];
  ...
  data_[350] = D00_[0] * data_[315] + B01_current[0] * data_[280];
  data_[351] = D00_[1] * data_[316] + B01_current[1] * data_[281];
  data_[352] = D00_[2] * data_[317] + B01_current[2] * data_[282];
  data_[353] = D00_[3] * data_[318] + B01_current[3] * data_[283];
  data_[354] = D00_[4] * data_[319] + B01_current[4] * data_[284];
  data_[355] = D00_[5] * data_[320] + B01_current[5] * data_[285];
  data_[356] = D00_[6] * data_[321] + B01_current[6] * data_[286];
  ...
  data_[357] = C00_[0] * data_[350] + cB00_current[0] * data_[315];
  data_[358] = C00_[1] * data_[351] + cB00_current[1] * data_[316];
  data_[359] = C00_[2] * data_[352] + cB00_current[2] * data_[317];
  data_[360] = C00_[3] * data_[353] + cB00_current[3] * data_[318];
  data_[361] = C00_[4] * data_[354] + cB00_current[4] * data_[319];
  data_[362] = C00_[5] * data_[355] + cB00_current[5] * data_[320];
  data_[363] = C00_[6] * data_[356] + cB00_current[6] * data_[321];
  ...
  data_[364] = C00_[0] * data_[357] + B10_current[0] * data_[350] + cB00_current[0] * data_[322];
  data_[365] = C00_[1] * data_[358] + B10_current[1] * data_[351] + cB00_current[1] * data_[323];
  data_[366] = C00_[2] * data_[359] + B10_current[2] * data_[352] + cB00_current[2] * data_[324];
  data_[367] = C00_[3] * data_[360] + B10_current[3] * data_[353] + cB00_current[3] * data_[325];
  data_[368] = C00_[4] * data_[361] + B10_current[4] * data_[354] + cB00_current[4] * data_[326];
  data_[369] = C00_[5] * data_[362] + B10_current[5] * data_[355] + cB00_current[5] * data_[327];
  data_[370] = C00_[6] * data_[363] + B10_current[6] * data_[356] + cB00_current[6] * data_[328];
  ...
  data_[371] = C00_[0] * data_[364] + B10_current[0] * data_[357] + cB00_current[0] * data_[329];
  data_[372] = C00_[1] * data_[365] + B10_current[1] * data_[358] + cB00_current[1] * data_[330];
  data_[373] = C00_[2] * data_[366] + B10_current[2] * data_[359] + cB00_current[2] * data_[331];
  data_[374] = C00_[3] * data_[367] + B10_current[3] * data_[360] + cB00_current[3] * data_[332];
  data_[375] = C00_[4] * data_[368] + B10_current[4] * data_[361] + cB00_current[4] * data_[333];
  data_[376] = C00_[5] * data_[369] + B10_current[5] * data_[362] + cB00_current[5] * data_[334];
  data_[377] = C00_[6] * data_[370] + B10_current[6] * data_[363] + cB00_current[6] * data_[335];
  ...
  data_[378] = C00_[0] * data_[371] + B10_current[0] * data_[364] + cB00_current[0] * data_[336];
  data_[379] = C00_[1] * data_[372] + B10_current[1] * data_[365] + cB00_current[1] * data_[337];
  data_[380] = C00_[2] * data_[373] + B10_current[2] * data_[366] + cB00_current[2] * data_[338];
  data_[381] = C00_[3] * data_[374] + B10_current[3] * data_[367] + cB00_current[3] * data_[339];
  data_[382] = C00_[4] * data_[375] + B10_current[4] * data_[368] + cB00_current[4] * data_[340];
  data_[383] = C00_[5] * data_[376] + B10_current[5] * data_[369] + cB00_current[5] * data_[341];
  data_[384] = C00_[6] * data_[377] + B10_current[6] * data_[370] + cB00_current[6] * data_[342];
}
