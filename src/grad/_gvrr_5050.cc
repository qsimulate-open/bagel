...
void GVRRList::_gvrr_5050(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[155] = C00_[0] * data_[150] + cB00_current[0] * data_[120];
  data_[156] = C00_[1] * data_[151] + cB00_current[1] * data_[121];
  data_[157] = C00_[2] * data_[152] + cB00_current[2] * data_[122];
  data_[158] = C00_[3] * data_[153] + cB00_current[3] * data_[123];
  data_[159] = C00_[4] * data_[154] + cB00_current[4] * data_[124];
  ...
  data_[160] = C00_[0] * data_[155] + B10_current[0] * data_[150] + cB00_current[0] * data_[125];
  data_[161] = C00_[1] * data_[156] + B10_current[1] * data_[151] + cB00_current[1] * data_[126];
  data_[162] = C00_[2] * data_[157] + B10_current[2] * data_[152] + cB00_current[2] * data_[127];
  data_[163] = C00_[3] * data_[158] + B10_current[3] * data_[153] + cB00_current[3] * data_[128];
  data_[164] = C00_[4] * data_[159] + B10_current[4] * data_[154] + cB00_current[4] * data_[129];
  ...
  data_[165] = C00_[0] * data_[160] + B10_current[0] * data_[155] + cB00_current[0] * data_[130];
  data_[166] = C00_[1] * data_[161] + B10_current[1] * data_[156] + cB00_current[1] * data_[131];
  data_[167] = C00_[2] * data_[162] + B10_current[2] * data_[157] + cB00_current[2] * data_[132];
  data_[168] = C00_[3] * data_[163] + B10_current[3] * data_[158] + cB00_current[3] * data_[133];
  data_[169] = C00_[4] * data_[164] + B10_current[4] * data_[159] + cB00_current[4] * data_[134];
  ...
  data_[170] = C00_[0] * data_[165] + B10_current[0] * data_[160] + cB00_current[0] * data_[135];
  data_[171] = C00_[1] * data_[166] + B10_current[1] * data_[161] + cB00_current[1] * data_[136];
  data_[172] = C00_[2] * data_[167] + B10_current[2] * data_[162] + cB00_current[2] * data_[137];
  data_[173] = C00_[3] * data_[168] + B10_current[3] * data_[163] + cB00_current[3] * data_[138];
  data_[174] = C00_[4] * data_[169] + B10_current[4] * data_[164] + cB00_current[4] * data_[139];
  ...
  data_[175] = C00_[0] * data_[170] + B10_current[0] * data_[165] + cB00_current[0] * data_[140];
  data_[176] = C00_[1] * data_[171] + B10_current[1] * data_[166] + cB00_current[1] * data_[141];
  data_[177] = C00_[2] * data_[172] + B10_current[2] * data_[167] + cB00_current[2] * data_[142];
  data_[178] = C00_[3] * data_[173] + B10_current[3] * data_[168] + cB00_current[3] * data_[143];
  data_[179] = C00_[4] * data_[174] + B10_current[4] * data_[169] + cB00_current[4] * data_[144];
}
