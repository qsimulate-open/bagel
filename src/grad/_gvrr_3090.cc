...
void GVRRList::_gvrr_3090(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  ...
  data_[222] = C00_[0] * data_[216] + cB00_current[0] * data_[192];
  data_[223] = C00_[1] * data_[217] + cB00_current[1] * data_[193];
  data_[224] = C00_[2] * data_[218] + cB00_current[2] * data_[194];
  data_[225] = C00_[3] * data_[219] + cB00_current[3] * data_[195];
  data_[226] = C00_[4] * data_[220] + cB00_current[4] * data_[196];
  data_[227] = C00_[5] * data_[221] + cB00_current[5] * data_[197];
  ...
  data_[228] = C00_[0] * data_[222] + B10_current[0] * data_[216] + cB00_current[0] * data_[198];
  data_[229] = C00_[1] * data_[223] + B10_current[1] * data_[217] + cB00_current[1] * data_[199];
  data_[230] = C00_[2] * data_[224] + B10_current[2] * data_[218] + cB00_current[2] * data_[200];
  data_[231] = C00_[3] * data_[225] + B10_current[3] * data_[219] + cB00_current[3] * data_[201];
  data_[232] = C00_[4] * data_[226] + B10_current[4] * data_[220] + cB00_current[4] * data_[202];
  data_[233] = C00_[5] * data_[227] + B10_current[5] * data_[221] + cB00_current[5] * data_[203];
  ...
  data_[234] = C00_[0] * data_[228] + B10_current[0] * data_[222] + cB00_current[0] * data_[204];
  data_[235] = C00_[1] * data_[229] + B10_current[1] * data_[223] + cB00_current[1] * data_[205];
  data_[236] = C00_[2] * data_[230] + B10_current[2] * data_[224] + cB00_current[2] * data_[206];
  data_[237] = C00_[3] * data_[231] + B10_current[3] * data_[225] + cB00_current[3] * data_[207];
  data_[238] = C00_[4] * data_[232] + B10_current[4] * data_[226] + cB00_current[4] * data_[208];
  data_[239] = C00_[5] * data_[233] + B10_current[5] * data_[227] + cB00_current[5] * data_[209];
}
