...
void GVRRList::_gvrr_c080(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[1040] = D00_[0] * data_[910] + B01_current[0] * data_[780];
  data_[1041] = D00_[1] * data_[911] + B01_current[1] * data_[781];
  data_[1042] = D00_[2] * data_[912] + B01_current[2] * data_[782];
  data_[1043] = D00_[3] * data_[913] + B01_current[3] * data_[783];
  data_[1044] = D00_[4] * data_[914] + B01_current[4] * data_[784];
  data_[1045] = D00_[5] * data_[915] + B01_current[5] * data_[785];
  data_[1046] = D00_[6] * data_[916] + B01_current[6] * data_[786];
  data_[1047] = D00_[7] * data_[917] + B01_current[7] * data_[787];
  data_[1048] = D00_[8] * data_[918] + B01_current[8] * data_[788];
  data_[1049] = D00_[9] * data_[919] + B01_current[9] * data_[789];
  ...
  data_[1050] = C00_[0] * data_[1040] + cB00_current[0] * data_[910];
  data_[1051] = C00_[1] * data_[1041] + cB00_current[1] * data_[911];
  data_[1052] = C00_[2] * data_[1042] + cB00_current[2] * data_[912];
  data_[1053] = C00_[3] * data_[1043] + cB00_current[3] * data_[913];
  data_[1054] = C00_[4] * data_[1044] + cB00_current[4] * data_[914];
  data_[1055] = C00_[5] * data_[1045] + cB00_current[5] * data_[915];
  data_[1056] = C00_[6] * data_[1046] + cB00_current[6] * data_[916];
  data_[1057] = C00_[7] * data_[1047] + cB00_current[7] * data_[917];
  data_[1058] = C00_[8] * data_[1048] + cB00_current[8] * data_[918];
  data_[1059] = C00_[9] * data_[1049] + cB00_current[9] * data_[919];
  ...
  data_[1060] = C00_[0] * data_[1050] + B10_current[0] * data_[1040] + cB00_current[0] * data_[920];
  data_[1061] = C00_[1] * data_[1051] + B10_current[1] * data_[1041] + cB00_current[1] * data_[921];
  data_[1062] = C00_[2] * data_[1052] + B10_current[2] * data_[1042] + cB00_current[2] * data_[922];
  data_[1063] = C00_[3] * data_[1053] + B10_current[3] * data_[1043] + cB00_current[3] * data_[923];
  data_[1064] = C00_[4] * data_[1054] + B10_current[4] * data_[1044] + cB00_current[4] * data_[924];
  data_[1065] = C00_[5] * data_[1055] + B10_current[5] * data_[1045] + cB00_current[5] * data_[925];
  data_[1066] = C00_[6] * data_[1056] + B10_current[6] * data_[1046] + cB00_current[6] * data_[926];
  data_[1067] = C00_[7] * data_[1057] + B10_current[7] * data_[1047] + cB00_current[7] * data_[927];
  data_[1068] = C00_[8] * data_[1058] + B10_current[8] * data_[1048] + cB00_current[8] * data_[928];
  data_[1069] = C00_[9] * data_[1059] + B10_current[9] * data_[1049] + cB00_current[9] * data_[929];
  ...
  data_[1070] = C00_[0] * data_[1060] + B10_current[0] * data_[1050] + cB00_current[0] * data_[930];
  data_[1071] = C00_[1] * data_[1061] + B10_current[1] * data_[1051] + cB00_current[1] * data_[931];
  data_[1072] = C00_[2] * data_[1062] + B10_current[2] * data_[1052] + cB00_current[2] * data_[932];
  data_[1073] = C00_[3] * data_[1063] + B10_current[3] * data_[1053] + cB00_current[3] * data_[933];
  data_[1074] = C00_[4] * data_[1064] + B10_current[4] * data_[1054] + cB00_current[4] * data_[934];
  data_[1075] = C00_[5] * data_[1065] + B10_current[5] * data_[1055] + cB00_current[5] * data_[935];
  data_[1076] = C00_[6] * data_[1066] + B10_current[6] * data_[1056] + cB00_current[6] * data_[936];
  data_[1077] = C00_[7] * data_[1067] + B10_current[7] * data_[1057] + cB00_current[7] * data_[937];
  data_[1078] = C00_[8] * data_[1068] + B10_current[8] * data_[1058] + cB00_current[8] * data_[938];
  data_[1079] = C00_[9] * data_[1069] + B10_current[9] * data_[1059] + cB00_current[9] * data_[939];
  ...
  data_[1080] = C00_[0] * data_[1070] + B10_current[0] * data_[1060] + cB00_current[0] * data_[940];
  data_[1081] = C00_[1] * data_[1071] + B10_current[1] * data_[1061] + cB00_current[1] * data_[941];
  data_[1082] = C00_[2] * data_[1072] + B10_current[2] * data_[1062] + cB00_current[2] * data_[942];
  data_[1083] = C00_[3] * data_[1073] + B10_current[3] * data_[1063] + cB00_current[3] * data_[943];
  data_[1084] = C00_[4] * data_[1074] + B10_current[4] * data_[1064] + cB00_current[4] * data_[944];
  data_[1085] = C00_[5] * data_[1075] + B10_current[5] * data_[1065] + cB00_current[5] * data_[945];
  data_[1086] = C00_[6] * data_[1076] + B10_current[6] * data_[1066] + cB00_current[6] * data_[946];
  data_[1087] = C00_[7] * data_[1077] + B10_current[7] * data_[1067] + cB00_current[7] * data_[947];
  data_[1088] = C00_[8] * data_[1078] + B10_current[8] * data_[1068] + cB00_current[8] * data_[948];
  data_[1089] = C00_[9] * data_[1079] + B10_current[9] * data_[1069] + cB00_current[9] * data_[949];
  ...
  data_[1090] = C00_[0] * data_[1080] + B10_current[0] * data_[1070] + cB00_current[0] * data_[950];
  data_[1091] = C00_[1] * data_[1081] + B10_current[1] * data_[1071] + cB00_current[1] * data_[951];
  data_[1092] = C00_[2] * data_[1082] + B10_current[2] * data_[1072] + cB00_current[2] * data_[952];
  data_[1093] = C00_[3] * data_[1083] + B10_current[3] * data_[1073] + cB00_current[3] * data_[953];
  data_[1094] = C00_[4] * data_[1084] + B10_current[4] * data_[1074] + cB00_current[4] * data_[954];
  data_[1095] = C00_[5] * data_[1085] + B10_current[5] * data_[1075] + cB00_current[5] * data_[955];
  data_[1096] = C00_[6] * data_[1086] + B10_current[6] * data_[1076] + cB00_current[6] * data_[956];
  data_[1097] = C00_[7] * data_[1087] + B10_current[7] * data_[1077] + cB00_current[7] * data_[957];
  data_[1098] = C00_[8] * data_[1088] + B10_current[8] * data_[1078] + cB00_current[8] * data_[958];
  data_[1099] = C00_[9] * data_[1089] + B10_current[9] * data_[1079] + cB00_current[9] * data_[959];
  ...
  data_[1100] = C00_[0] * data_[1090] + B10_current[0] * data_[1080] + cB00_current[0] * data_[960];
  data_[1101] = C00_[1] * data_[1091] + B10_current[1] * data_[1081] + cB00_current[1] * data_[961];
  data_[1102] = C00_[2] * data_[1092] + B10_current[2] * data_[1082] + cB00_current[2] * data_[962];
  data_[1103] = C00_[3] * data_[1093] + B10_current[3] * data_[1083] + cB00_current[3] * data_[963];
  data_[1104] = C00_[4] * data_[1094] + B10_current[4] * data_[1084] + cB00_current[4] * data_[964];
  data_[1105] = C00_[5] * data_[1095] + B10_current[5] * data_[1085] + cB00_current[5] * data_[965];
  data_[1106] = C00_[6] * data_[1096] + B10_current[6] * data_[1086] + cB00_current[6] * data_[966];
  data_[1107] = C00_[7] * data_[1097] + B10_current[7] * data_[1087] + cB00_current[7] * data_[967];
  data_[1108] = C00_[8] * data_[1098] + B10_current[8] * data_[1088] + cB00_current[8] * data_[968];
  data_[1109] = C00_[9] * data_[1099] + B10_current[9] * data_[1089] + cB00_current[9] * data_[969];
  ...
  data_[1110] = C00_[0] * data_[1100] + B10_current[0] * data_[1090] + cB00_current[0] * data_[970];
  data_[1111] = C00_[1] * data_[1101] + B10_current[1] * data_[1091] + cB00_current[1] * data_[971];
  data_[1112] = C00_[2] * data_[1102] + B10_current[2] * data_[1092] + cB00_current[2] * data_[972];
  data_[1113] = C00_[3] * data_[1103] + B10_current[3] * data_[1093] + cB00_current[3] * data_[973];
  data_[1114] = C00_[4] * data_[1104] + B10_current[4] * data_[1094] + cB00_current[4] * data_[974];
  data_[1115] = C00_[5] * data_[1105] + B10_current[5] * data_[1095] + cB00_current[5] * data_[975];
  data_[1116] = C00_[6] * data_[1106] + B10_current[6] * data_[1096] + cB00_current[6] * data_[976];
  data_[1117] = C00_[7] * data_[1107] + B10_current[7] * data_[1097] + cB00_current[7] * data_[977];
  data_[1118] = C00_[8] * data_[1108] + B10_current[8] * data_[1098] + cB00_current[8] * data_[978];
  data_[1119] = C00_[9] * data_[1109] + B10_current[9] * data_[1099] + cB00_current[9] * data_[979];
  ...
  data_[1120] = C00_[0] * data_[1110] + B10_current[0] * data_[1100] + cB00_current[0] * data_[980];
  data_[1121] = C00_[1] * data_[1111] + B10_current[1] * data_[1101] + cB00_current[1] * data_[981];
  data_[1122] = C00_[2] * data_[1112] + B10_current[2] * data_[1102] + cB00_current[2] * data_[982];
  data_[1123] = C00_[3] * data_[1113] + B10_current[3] * data_[1103] + cB00_current[3] * data_[983];
  data_[1124] = C00_[4] * data_[1114] + B10_current[4] * data_[1104] + cB00_current[4] * data_[984];
  data_[1125] = C00_[5] * data_[1115] + B10_current[5] * data_[1105] + cB00_current[5] * data_[985];
  data_[1126] = C00_[6] * data_[1116] + B10_current[6] * data_[1106] + cB00_current[6] * data_[986];
  data_[1127] = C00_[7] * data_[1117] + B10_current[7] * data_[1107] + cB00_current[7] * data_[987];
  data_[1128] = C00_[8] * data_[1118] + B10_current[8] * data_[1108] + cB00_current[8] * data_[988];
  data_[1129] = C00_[9] * data_[1119] + B10_current[9] * data_[1109] + cB00_current[9] * data_[989];
  ...
  data_[1130] = C00_[0] * data_[1120] + B10_current[0] * data_[1110] + cB00_current[0] * data_[990];
  data_[1131] = C00_[1] * data_[1121] + B10_current[1] * data_[1111] + cB00_current[1] * data_[991];
  data_[1132] = C00_[2] * data_[1122] + B10_current[2] * data_[1112] + cB00_current[2] * data_[992];
  data_[1133] = C00_[3] * data_[1123] + B10_current[3] * data_[1113] + cB00_current[3] * data_[993];
  data_[1134] = C00_[4] * data_[1124] + B10_current[4] * data_[1114] + cB00_current[4] * data_[994];
  data_[1135] = C00_[5] * data_[1125] + B10_current[5] * data_[1115] + cB00_current[5] * data_[995];
  data_[1136] = C00_[6] * data_[1126] + B10_current[6] * data_[1116] + cB00_current[6] * data_[996];
  data_[1137] = C00_[7] * data_[1127] + B10_current[7] * data_[1117] + cB00_current[7] * data_[997];
  data_[1138] = C00_[8] * data_[1128] + B10_current[8] * data_[1118] + cB00_current[8] * data_[998];
  data_[1139] = C00_[9] * data_[1129] + B10_current[9] * data_[1119] + cB00_current[9] * data_[999];
  ...
  data_[1140] = C00_[0] * data_[1130] + B10_current[0] * data_[1120] + cB00_current[0] * data_[1000];
  data_[1141] = C00_[1] * data_[1131] + B10_current[1] * data_[1121] + cB00_current[1] * data_[1001];
  data_[1142] = C00_[2] * data_[1132] + B10_current[2] * data_[1122] + cB00_current[2] * data_[1002];
  data_[1143] = C00_[3] * data_[1133] + B10_current[3] * data_[1123] + cB00_current[3] * data_[1003];
  data_[1144] = C00_[4] * data_[1134] + B10_current[4] * data_[1124] + cB00_current[4] * data_[1004];
  data_[1145] = C00_[5] * data_[1135] + B10_current[5] * data_[1125] + cB00_current[5] * data_[1005];
  data_[1146] = C00_[6] * data_[1136] + B10_current[6] * data_[1126] + cB00_current[6] * data_[1006];
  data_[1147] = C00_[7] * data_[1137] + B10_current[7] * data_[1127] + cB00_current[7] * data_[1007];
  data_[1148] = C00_[8] * data_[1138] + B10_current[8] * data_[1128] + cB00_current[8] * data_[1008];
  data_[1149] = C00_[9] * data_[1139] + B10_current[9] * data_[1129] + cB00_current[9] * data_[1009];
  ...
  data_[1150] = C00_[0] * data_[1140] + B10_current[0] * data_[1130] + cB00_current[0] * data_[1010];
  data_[1151] = C00_[1] * data_[1141] + B10_current[1] * data_[1131] + cB00_current[1] * data_[1011];
  data_[1152] = C00_[2] * data_[1142] + B10_current[2] * data_[1132] + cB00_current[2] * data_[1012];
  data_[1153] = C00_[3] * data_[1143] + B10_current[3] * data_[1133] + cB00_current[3] * data_[1013];
  data_[1154] = C00_[4] * data_[1144] + B10_current[4] * data_[1134] + cB00_current[4] * data_[1014];
  data_[1155] = C00_[5] * data_[1145] + B10_current[5] * data_[1135] + cB00_current[5] * data_[1015];
  data_[1156] = C00_[6] * data_[1146] + B10_current[6] * data_[1136] + cB00_current[6] * data_[1016];
  data_[1157] = C00_[7] * data_[1147] + B10_current[7] * data_[1137] + cB00_current[7] * data_[1017];
  data_[1158] = C00_[8] * data_[1148] + B10_current[8] * data_[1138] + cB00_current[8] * data_[1018];
  data_[1159] = C00_[9] * data_[1149] + B10_current[9] * data_[1139] + cB00_current[9] * data_[1019];
  ...
  data_[1160] = C00_[0] * data_[1150] + B10_current[0] * data_[1140] + cB00_current[0] * data_[1020];
  data_[1161] = C00_[1] * data_[1151] + B10_current[1] * data_[1141] + cB00_current[1] * data_[1021];
  data_[1162] = C00_[2] * data_[1152] + B10_current[2] * data_[1142] + cB00_current[2] * data_[1022];
  data_[1163] = C00_[3] * data_[1153] + B10_current[3] * data_[1143] + cB00_current[3] * data_[1023];
  data_[1164] = C00_[4] * data_[1154] + B10_current[4] * data_[1144] + cB00_current[4] * data_[1024];
  data_[1165] = C00_[5] * data_[1155] + B10_current[5] * data_[1145] + cB00_current[5] * data_[1025];
  data_[1166] = C00_[6] * data_[1156] + B10_current[6] * data_[1146] + cB00_current[6] * data_[1026];
  data_[1167] = C00_[7] * data_[1157] + B10_current[7] * data_[1147] + cB00_current[7] * data_[1027];
  data_[1168] = C00_[8] * data_[1158] + B10_current[8] * data_[1148] + cB00_current[8] * data_[1028];
  data_[1169] = C00_[9] * data_[1159] + B10_current[9] * data_[1149] + cB00_current[9] * data_[1029];
}
