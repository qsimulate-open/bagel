...
void GVRRList::_gvrr_a000(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[50] = C00_[0] * data_[45] + B10_current[0] * data_[40];
  data_[51] = C00_[1] * data_[46] + B10_current[1] * data_[41];
  data_[52] = C00_[2] * data_[47] + B10_current[2] * data_[42];
  data_[53] = C00_[3] * data_[48] + B10_current[3] * data_[43];
  data_[54] = C00_[4] * data_[49] + B10_current[4] * data_[44];
}
