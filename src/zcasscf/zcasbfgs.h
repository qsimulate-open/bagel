...
class ZCASBFGS : public ZCASSCF {
  ...
  public:
   ...
   std::tuple<std::shared_ptr<ZRotFile>, std::shared_ptr<ZRotFile>, std::shared_ptr<ZRotFile>> optimize_subspace_rotations(std::vector<double> energy, std::shared_ptr<const ZRotFile> grad, std::shared_ptr<const ZRotFile> rot, std::shared_ptr<SRBFGS<ZRotFile>> srbfgs, bool optimize_electrons = true);
