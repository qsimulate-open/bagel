...
class RelMOFile {
  ...
  public:
    ...
    static std::shared_ptr<RelDFFull> compute_full(std::shared_ptr<const ZMatrix> coeff, std::list<std::shared_ptr<RelDFHalf>> half, const bool appj, const bool appjj = false);
};
