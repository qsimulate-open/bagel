...
#ifndef __SRC_CI_ZFCI_RELFCI_LONDON_H
#define __SRC_CI_ZFCI_RELFCI_LONDON_H

#include <src/ci/zfci/zharrison.h>

namespace bagel {

class RelFCI_London : public ZHarrison {
  protected:
    // breit and gaunt
    bool gaunt_;
    bool breit_;
  ...
  public:
    RelFCI_London(std::shared_ptr<const PTree> a, std::shared_ptr<const Geometry> g, std::shared_ptr<const Reference> b,
