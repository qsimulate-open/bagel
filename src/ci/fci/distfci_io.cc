...
std::shared_ptr<RDM<4>> DistFCI::read_external_rdm4(const int ist, const int jst, const string& file) const {
...
std::shared_ptr<RDM<3>> DistFCI::read_external_rdm4f(const int ist, const int jst, const string& file) const {
...
std::shared_ptr<RDM<3>> DistFCI::read_external_rdm3(const int ist, const int jst, const string& file) const {
  auto out = make_shared<RDM<3>>(norb_);
...
std::shared_ptr<RDM<2>> DistFCI::read_external_rdm2(const int ist, const int jst, const string& file) const {
...
std::shared_ptr<RDM<1>> DistFCI::read_external_rdm1(const int ist, const int jst, const string& file) const {
...
void DistFCI::read_external_rdm12_av(const string& file) {
  // feed RDM1
