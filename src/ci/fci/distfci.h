...
class DistFCI : public FCI_base {
  ...
  public:
    ...
    std::shared_ptr<Matrix> rdm2deriv_offset(std::shared_ptr<const Matrix> dmat, const int istate, const size_t dsize, const size_t offset, const bool parallel = true) const override;
