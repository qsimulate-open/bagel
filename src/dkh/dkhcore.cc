...
void DKHcore::init(shared_ptr<const Molecule> mol) {
  ...
  for (int i=0; i<ndim(); i++){
    A(i,i) = std::sqrt((en(i)+c__*c__)/2.0/en(i));
  }
  ...
  dkh += (-1)*B*P*Vp*P*B*E*A*Vp*A - A*Vp*A*E*B*P*V*P*B + A*Vp*A*pK2*E*A*Vp*A + B*P*Vp*P*B*E*pK2_inv*B*P*Vp*P*B 
...
//  dkh += 0.5 * ((-1)*A*P*tildeV*P*A*A*V*A + A*P*tildeV*A*A*V*P*A + A*tildeV*A*P2*A*V*A - A*tildeV*A*A*P*V*P*A 
