...
// This is a base class for various ASD_RASSCF solvers.
...
#ifndef __BAGEL_ASD_RASSCF_H
#define __BAGEL_ASD_RASSCF_H

#include <src/wfn/reference.h>
#include <src/ci/fci/knowles.h>

#include <src/multi/casscf/rotfile.h>
#include <src/asd/orbital/rasrotfile.h>
#include <src/asd/orbital/rasactiverotfile.h>
...
class ASD_RASSCF : public Method, public std::enable_shared_from_this<ASD_RASSCF> {
...
//END ADDED
  ...
  public:
    ASD_RASSCF(const std::shared_ptr<const PTree> idat, const std::shared_ptr<const Geometry> geom, const std::shared_ptr<const Reference> = nullptr);

  //ASD_RASSCF(const std::shared_ptr<const PTree> idat, const std::shared_ptr<const Geometry> geom, const std::shared_ptr<const Reference> ref,
  //           std::tuple<std::shared_ptr<RDM<1>>,
  ...
  //std::shared_ptr<const FCI> fci() const { return fci_; };
    ...
    // TODO I need this function in CP-ASD_RASSCF, but only for denominator. Should be separated.
