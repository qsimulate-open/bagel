...
// Filename: asd/orbital/bfgs_denom.cc
...
shared_ptr<const ASD_RotFile> ASD_BFGS::compute_denom(shared_ptr<const Matrix> cfock, shared_ptr<const Matrix> afock, shared_ptr<const Matrix> qxr, shared_ptr<const Matrix> rdm1, shared_ptr<const Matrix> mcfock) const {
  auto out = make_shared<ASD_RotFile>(nclosed_, nact_, nvirt_, nactA_, nactB_ );
...
shared_ptr<const RotFile> ASD_BFGS::compute_denom_large(shared_ptr<const Matrix> cfock, shared_ptr<const Matrix> afock, shared_ptr<const Matrix> qxr, shared_ptr<const Matrix> rdm1) const {
...
shared_ptr<const ASD_ActiveRotFile> ASD_BFGS::compute_denom_small(shared_ptr<const Matrix> cfock, shared_ptr<const Matrix> afock, shared_ptr<const Matrix> rdm1, shared_ptr<const Matrix> mcfock) const {
  auto out = make_shared<ASD_ActiveRotFile>(nclosed_, nact_, nvirt_, nactA_, nactB_ );
