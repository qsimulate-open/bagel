...
//***************************************************************************************************************
  ...
  if (cbra != cket) {
    ...
    sigma_2a1(cket, dket);
    sigma_2a2(cket, dket);
    //eket = <I|E_ij,kl|ket> = <I|E_ij,E_kl|0> - delta_il <I|E_jk|0>
    eket = make_shared<Dvec>(cket->det(), norb*norb*norb*norb);
    auto tmp = make_shared<Dvec>(cket->det(), norb*norb);
    ijkl = 0;
    ij = 0;
