...
class ASD_CAS : public ASD<Dvec> {
  ...
  private:
    ...
    std::tuple<std::shared_ptr<RDM<3>>, std::shared_ptr<RDM<4>>> compute_rdm34_monomer(std::pair<int,int> offset, std::array<Dvec,4>&) const override; //TODO restore override
