...
void ASDSuperCI::grad_vc(const shared_ptr<Matrix> f, shared_ptr<ASDRotFile> sigma) {
...
void ASDSuperCI::grad_va(const shared_ptr<Matrix> fact, shared_ptr<ASDRotFile> sigma) {
...
void ASDSuperCI::grad_ca(const shared_ptr<Matrix> f, shared_ptr<Matrix> fact, shared_ptr<ASDRotFile> sigma) {
