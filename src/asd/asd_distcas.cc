...
tuple<shared_ptr<RDM<1>>,shared_ptr<RDM<2>>> ASD_DistCAS::compute_rdm12_monomer(shared_ptr<const DistDvec> civec, const int i, shared_ptr<const DistDvec> cipvec, const int j) const {
  assert(false);
