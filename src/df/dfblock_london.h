...
class DFBlock_London : public DFBlock_base<std::complex<double>> {
  public:
    ...
    std::shared_ptr<DFBlock_London> transform_second(std::shared_ptr<const btas::View2<std::complex<double>>> c, const bool trans = false) const;
    std::shared_ptr<DFBlock_London> transform_third(std::shared_ptr<const btas::View2<std::complex<double>>> c, const bool trans = false) const;
