...
class DFDist_London : public ParallelDF_London {
  ...
  public:
    ...
    std::shared_ptr<DFHalfDist_London> compute_half_transform(std::shared_ptr<const btas::View2<std::complex<double>>> c) const;
    ...
    std::shared_ptr<DFHalfDist_London> compute_half_transform_swap(std::shared_ptr<const btas::View2<std::complex<double>>> c) const;
    // TODO will be deprecated
...
class DFHalfDist_London : public ParallelDF_London {
  ...
  public:
    ...
    std::shared_ptr<DFFullDist_London> compute_second_transform(std::shared_ptr<const btas::View2<std::complex<double>>> c) const;
    std::shared_ptr<DFDist_London> back_transform(std::shared_ptr<const btas::View2<std::complex<double>>> c) const;
    // TODO will be deprecated
...
class DFFullDist_London : public ParallelDF_London {
  ...
  public:
    ...
    std::shared_ptr<DFHalfDist_London> back_transform(std::shared_ptr<const btas::View2<std::complex<double>>> c) const;
    // TODO will be deprecated
