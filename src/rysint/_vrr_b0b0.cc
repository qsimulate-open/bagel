...
// returns double array of length 1728
void VRRList::_vrr_b0b0(double* data_, const double* C00, const double* D00, const double* B00, const double* B01, const double* B10) {
#ifdef __GNUC__
