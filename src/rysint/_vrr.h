...
void vrr(double* data_, const double* C00, const double* D00, const double* B00, const double* B01, const double* B10) {
  ...
  if ((a_ > 1 && c_ > 1) || (a_ == 1 && c_ >  1)) { 
    ...
    if (a_ == 2) {
      ...
      double B10_current[rank_]__attribute__((aligned(32)));
      // a == 2
      for (int t = 0; t != rank_; ++t)
    ...
    double cB00_current[rank_]__attribute__((aligned(32)));
    for (int t = 0; t != rank_; ++t)
    ...
    // c > 1
    double B01_current[rank_]__attribute__((aligned(32))) = {0.0};
    ...
    if (c_ == 2) {
      ...
      double B01_current[rank_]__attribute__((aligned(32)));
      // c == 2
      for (int t = 0; t != rank_; ++t)
        B01_current[t] = B01_[t];
      for (int t = 0; t != rank_; ++t)
