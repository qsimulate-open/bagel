...
void bagel::VRR_Driver::vrr_driver_6_0_3_0(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::vrr_driver<6,0,3,0,5>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, amap, cmap, asize_, workx, worky, workz);
}
