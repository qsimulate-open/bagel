...
void bagel::VRR_Driver::vrr_driver_3_2_0_0(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::vrr_driver<3,2,0,0,3>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, amap, cmap, asize_, workx, worky, workz);
}
