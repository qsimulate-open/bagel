...
void bagel::GVRR_Driver::gvrr_driver_1_0_5_5(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<1,0,5,5,7>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
