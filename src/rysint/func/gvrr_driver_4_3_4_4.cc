...
void bagel::GVRR_Driver::gvrr_driver_4_3_4_4(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<4,3,4,4,9>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
