...
void bagel::GVRR_Driver::gvrr_driver_0_0_5_1(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<0,0,5,1,4>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
