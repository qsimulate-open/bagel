...
void bagel::GVRR_Driver::gvrr_driver_2_1_2_1(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<2,1,2,1,4>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
