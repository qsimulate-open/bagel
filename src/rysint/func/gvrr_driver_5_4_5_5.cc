...
void bagel::GVRR_Driver::gvrr_driver_5_4_5_5(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<5,4,5,5,11>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
