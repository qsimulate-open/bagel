...
void bagel::GVRR_Driver::gvrr_driver_6_5_5_5(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<6,5,5,5,12>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
