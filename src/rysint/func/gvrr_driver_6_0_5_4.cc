...
void bagel::GVRR_Driver::gvrr_driver_6_0_5_4(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<6,0,5,4,9>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
