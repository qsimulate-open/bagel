...
void bagel::GVRR_Driver::gvrr_driver_2_0_6_2(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<2,0,6,2,6>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
