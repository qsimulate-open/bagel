...
void bagel::VRR_Driver::vrr_driver_6_3_4_3(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::vrr_driver<6,3,4,3,9>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, amap, cmap, asize_, workx, worky, workz);
}
