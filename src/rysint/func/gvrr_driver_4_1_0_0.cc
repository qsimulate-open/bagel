...
void bagel::GVRR_Driver::gvrr_driver_4_1_0_0(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<4,1,0,0,4>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
