...
void bagel::GVRR_Driver::gvrr_driver_2_2_4_2(double* out, const double* const roots, const double* const weights, const double& coeff,
  ...
  bagel::gvrr_driver<2,2,4,2,6>(out, roots, weights, coeff, a, b, c, d, p, q, xp, xq, size_block,
