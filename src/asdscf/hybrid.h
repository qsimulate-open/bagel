...
#ifndef __BAGEL_ASDSCF_ASDHybrid_H
#define __BAGEL_ASDSCF_ASDHybrid_H
...
class ASDHybrid : public Method {
  ...
  protected:
    ...
    void common_init() {
      std::cout << "    * Using a hybrid approach to ASDSCF *    " << std::endl;
  ...
  public:
    ASDHybrid(std::shared_ptr<const PTree> idat, std::shared_ptr<const Geometry> geom, std::shared_ptr<const Reference> ref = nullptr)
