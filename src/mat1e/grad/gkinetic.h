...
#ifndef __SRC_MAT1E_GRAD_GKINETIC_H
#define __SRC_MAT1E_GRAD_GKINETIC_H

#include <src/mat1e/matrix1e.h>

namespace bagel {

class GKinetic : public Matrix1e {
  protected:
  ...
  public:
    GKinetic() { }
    GKinetic(std::shared_ptr<const Molecule>);
...
BOOST_CLASS_EXPORT_KEY(bagel::GKinetic)
