...
#ifndef __SRC_MAT1E_GRAD_GOVERLAP_H
#define __SRC_MAT1E_GRAD_GOVERLAP_H

#include <src/mat1e/matrix1e.h>

namespace bagel {

class GOverlap : public Matrix1e {
  protected:
  ...
  public:
    GOverlap() { }
    GOverlap(std::shared_ptr<const Molecule>);
...
BOOST_CLASS_EXPORT_KEY(bagel::GOverlap)
