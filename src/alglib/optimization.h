...
// std::function<T> for using member functions
#include <functional>
...
void mincgoptimize(mincgstate &state,
    ...
    std::function<void(const real_1d_array &x, double func, void *ptr)> rep = NULL,
    void *ptr = NULL);
void mincgoptimize(mincgstate &state,
    std::function<void(const real_1d_array &x, double &func, real_1d_array &grad, void *ptr)> func,
    std::function<void(const real_1d_array &x, double func, void *ptr)> rep = NULL,
    void *ptr = NULL);
