...
void DistRASCI::common_init() {
  ...
  davidsonfloor_ = idata_->get<int>("davidsonfloor", 2);
  davidsonceiling_ = idata_->get<int>("davidsonceiling", 4);
...
void DistRASCI::compute() {
  ...
  // Davidson utility
  DavidsonDiag<DistRASCivec> davidson(nstate_, davidsonceiling_, davidsonfloor_);
