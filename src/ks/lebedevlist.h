...
struct LebedevList  {
  ...
  public:
    LebedevList() {
      rfunc[0] = &ld0006; map_.insert({6, 0});
      rfunc[1] = &ld0014; map_.insert({14, 1});
      rfunc[2] = &ld0026; map_.insert({26, 2});
      rfunc[3] = &ld0038; map_.insert({38, 3});
      rfunc[4] = &ld0050; map_.insert({50, 4});
      rfunc[5] = &ld0074; map_.insert({74, 5});
      rfunc[6] = &ld0086; map_.insert({86, 6});
      rfunc[7] = &ld0110; map_.insert({110, 7});
      rfunc[8] = &ld0146; map_.insert({146, 8});
      rfunc[9] = &ld0170; map_.insert({170, 9});
      rfunc[10] = &ld0194; map_.insert({194, 10});
      rfunc[11] = &ld0230; map_.insert({230, 11});
      rfunc[12] = &ld0266; map_.insert({266, 12});
      rfunc[13] = &ld0302; map_.insert({302, 13});
      rfunc[14] = &ld0350; map_.insert({350, 14});
      rfunc[15] = &ld0434; map_.insert({434, 15});
      rfunc[16] = &ld0590; map_.insert({590, 16});
      rfunc[17] = &ld0770; map_.insert({770, 17});
      rfunc[18] = &ld0974; map_.insert({974, 18});
      rfunc[19] = &ld1202; map_.insert({1202, 19});
      rfunc[20] = &ld1454; map_.insert({1454, 20});
      rfunc[21] = &ld1730; map_.insert({1730, 21});
      rfunc[22] = &ld2030; map_.insert({2030, 22});
      rfunc[23] = &ld2354; map_.insert({2354, 23});
      rfunc[24] = &ld2702; map_.insert({2702, 24});
      rfunc[25] = &ld3074; map_.insert({3074, 25});
      rfunc[26] = &ld3470; map_.insert({3470, 26});
      rfunc[27] = &ld3890; map_.insert({3890, 27});
      rfunc[28] = &ld4334; map_.insert({4334, 28});
      rfunc[29] = &ld4802; map_.insert({4802, 29});
      rfunc[30] = &ld5294; map_.insert({5294, 30});
      rfunc[31] = &ld5810; map_.insert({5810, 31});
    }
