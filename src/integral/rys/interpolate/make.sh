...
g++ -Ofast -std=c++11 -DDAWSON -lgsl -lblas -llapack -I/usr/local/include -L/opt/local/lib -lgmp -lmpfr *.cc -o gen
#g++ -Ofast -std=c++11 -lblas -llapack -L/opt/local/lib -lgmp -lmpfr *.cc -o gen
