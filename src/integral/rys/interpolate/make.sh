...
#g++ -Ofast -std=c++11 -lblas -llapack -lgmp -lmpfr *.cc *.c -o gen
#g++ -Ofast -std=c++11 -DBREIT -lblas -llapack -lgmp -lmpfr *.cc *.c -o gen
g++ -Ofast -std=c++11 -DSPIN2 -lblas -llapack -lgmp -lmpfr *.cc *.c -o gen
chmod 700 gen
