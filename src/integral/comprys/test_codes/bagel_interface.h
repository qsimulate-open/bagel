...
std::vector<std::pair<std::vector<int>,std::complex<double>>> get_comparison_orb_angular (const std::array<std::shared_ptr<const bagel::Shell>,2>& basisinfo, const std::array<double,3> magnetic_field, const std::array<double,3> Mcoord);
...
std::vector<std::pair<std::vector<int>,std::complex<double>>> get_comparison_small_orb_angular (const std::array<std::shared_ptr<const bagel::Shell>,2>& basisinfo, const std::array<double,3> magnetic_field, const std::array<double,3> Mcoord, const int ia, const int ib);
