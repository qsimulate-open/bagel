...
vector<pair<vector<int>,complex<double>>> get_comparison_smallNAI (const array<shared_ptr<const bagel::Shell>,2>& basisinfo, const std::shared_ptr<const bagel::Molecule> mol, const array<double,3> magnetic_field, const int ia, const int ib) {
