...
void OverlapBatch::compute() {
  ...
  double* intermediate_p = new double[prim0_ * prim1_ * asize_];
  perform_VRR(intermediate_p);

  double* intermediate_c = new double[cont0_ * cont1_ * asize_];
  ...
  double* intermediate_fi = new double[cont0_ * cont1_ * asize_intermediate_];
