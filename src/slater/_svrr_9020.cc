...
void SVRRList::_svrr_9020(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[140] = D00_[0] * data_[70] + B01_[0];
  data_[141] = D00_[1] * data_[71] + B01_[1];
  data_[142] = D00_[2] * data_[72] + B01_[2];
  data_[143] = D00_[3] * data_[73] + B01_[3];
  data_[144] = D00_[4] * data_[74] + B01_[4];
  data_[145] = D00_[5] * data_[75] + B01_[5];
  data_[146] = D00_[6] * data_[76] + B01_[6];
