...
void SVRRList::_svrr_5020(double* data_, const double* C00_, const double* D00_, const double* B00_, const double* B01_, const double* B10_) {
  data_[0] = 1.0;
  data_[1] = 1.0;
  data_[2] = 1.0;
  data_[3] = 1.0;
  ...
  data_[60] = D00_[0] * data_[30] + B01_[0];
  data_[61] = D00_[1] * data_[31] + B01_[1];
  data_[62] = D00_[2] * data_[32] + B01_[2];
  data_[63] = D00_[3] * data_[33] + B01_[3];
  data_[64] = D00_[4] * data_[34] + B01_[4];
