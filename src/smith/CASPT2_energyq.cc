...
shared_ptr<Queue> CASPT2::CASPT2::make_energyq(const bool reset) {
  ...
  vector<IndexRange> I338_index = {active_, active_, active_, closed_};
  ...
  vector<IndexRange> I339_index = {active_, active_, active_, active_, active_, active_};
  auto I339 = make_shared<Tensor>(I339_index);
  vector<shared_ptr<Tensor>> tensor324 = {I338, t2, I339};
  auto task324 = make_shared<Task324>(tensor324, pindex);
  task323->add_dep(task324);
  energyq->add_task(task324);

  vector<shared_ptr<Tensor>> tensor325 = {I339, Gamma105_()};
  ...
  vector<IndexRange> I369_index = {active_, virt_, closed_, active_};
  auto I369 = make_shared<Tensor>(I369_index);
  vector<shared_ptr<Tensor>> tensor341 = {I350, t2, I369};
  auto task341 = make_shared<Task341>(tensor341, pindex);
  task334->add_dep(task341);
  energyq->add_task(task341);

  vector<shared_ptr<Tensor>> tensor342 = {I369, v2_};
  ...
  vector<shared_ptr<Tensor>> tensor343 = {I334, Gamma29_(), I353};
  auto task343 = make_shared<Task343>(tensor343, pindex);
  task320->add_dep(task343);
  ...
  vector<shared_ptr<Tensor>> tensor346 = {I334, Gamma32_(), I356};
  auto task346 = make_shared<Task346>(tensor346, pindex);
  task320->add_dep(task346);
  ...
  vector<shared_ptr<Tensor>> tensor349 = {I334, Gamma7_(), I365};
  auto task349 = make_shared<Task349>(tensor349, pindex);
  task320->add_dep(task349);
  ...
  vector<shared_ptr<Tensor>> tensor352 = {I334, Gamma59_(), I374};
  auto task352 = make_shared<Task352>(tensor352, pindex);
  task320->add_dep(task352);
  energyq->add_task(task352);

  vector<IndexRange> I375_index = {active_, active_, virt_, active_};
  auto I375 = make_shared<Tensor>(I375_index);
  vector<shared_ptr<Tensor>> tensor353 = {I374, v2_, I375};
  auto task353 = make_shared<Task353>(tensor353, pindex);
  task352->add_dep(task353);
  energyq->add_task(task353);

  vector<shared_ptr<Tensor>> tensor354 = {I375, t2};
  ...
  vector<shared_ptr<Tensor>> tensor355 = {I334, Gamma57_(), I377};
  auto task355 = make_shared<Task355>(tensor355, pindex);
  task320->add_dep(task355);
  ...
  vector<shared_ptr<Tensor>> tensor358 = {I334, v2_, I380};
  auto task358 = make_shared<Task358>(tensor358, pindex);
  task320->add_dep(task358);
  energyq->add_task(task358);

  vector<shared_ptr<Tensor>> tensor359 = {I380, t2};
  ...
  vector<shared_ptr<Tensor>> tensor362 = {I334, Gamma38_(), I384};
  ...
  vector<shared_ptr<Tensor>> tensor367 = {I384, h1_, I397};
  auto task367 = make_shared<Task367>(tensor367, pindex);
  task362->add_dep(task367);
  energyq->add_task(task367);

  vector<shared_ptr<Tensor>> tensor368 = {I397, t2};
  ...
  vector<shared_ptr<Tensor>> tensor369 = {I384, h1_, I400};
  auto task369 = make_shared<Task369>(tensor369, pindex);
  task362->add_dep(task369);
  energyq->add_task(task369);

  vector<shared_ptr<Tensor>> tensor370 = {I400, t2};
  ...
  vector<shared_ptr<Tensor>> tensor376 = {I334, h1_, I393};
  auto task376 = make_shared<Task376>(tensor376, pindex);
  task320->add_dep(task376);
