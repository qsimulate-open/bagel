...
#ifndef __SRC_SMITH_CASPT2_TASKS27_H
#define __SRC_SMITH_CASPT2_TASKS27_H
...
class Task1311 : public Task {
  ...
  public:
    Task1311(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task1311() {}
};
...
class Task1315 : public Task {
  ...
  public:
    Task1315(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1315() {}
};
...
class Task1317 : public Task {
  ...
  public:
    Task1317(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1317() {}
};
...
class Task1319 : public Task {
  ...
  public:
    Task1319(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1319() {}
};
...
class Task1321 : public Task {
  ...
  public:
    Task1321(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1321() {}
};
