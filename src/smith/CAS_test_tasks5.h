...
#ifndef __SRC_SMITH_CAS_test_TASKS5_H
#define __SRC_SMITH_CAS_test_TASKS5_H
...
class Task204 : public Task {
  ...
  public:
    Task204(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task204() {}
};
...
class Task206 : public Task {
  ...
  public:
    Task206(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task206() {}
};
