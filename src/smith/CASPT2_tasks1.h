...
class Task2 : public Task {  // associated with gamma
  ...
  public:
    Task2(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task2() {}
};
...
class Task3 : public Task {
  ...
  public:
    Task3(std::vector<std::shared_ptr<Tensor>> t);
    ~Task3() {}
};
...
class Task5 : public Task {
  ...
  public:
    Task5(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task5() {}
};
...
class Task35 : public AccTask {
  ...
  public:
    Task35(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task35() {}
};
...
class Task37 : public AccTask {
  ...
  public:
    Task37(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task37() {}
};
