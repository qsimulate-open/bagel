...
shared_ptr<FutureTensor> RelCASPT2::RelCASPT2::Gamma94_() {
  vector<IndexRange> Gamma94_index = {active_, active_, active_, active_};
  auto Gamma94 = make_shared<Tensor>(Gamma94_index);
  array<shared_ptr<const IndexRange>,3> pindex = {{rclosed_, ractive_, rvirt_}};
  auto tensor1 = vector<shared_ptr<Tensor>>{Gamma94, rdm0_, rdm1_, rdm2_};
...
shared_ptr<FutureTensor> RelCASPT2::RelCASPT2::Gamma107_() {
  ...
  array<shared_ptr<const IndexRange>,3> pindex = {{rclosed_, ractive_, rvirt_}};
  auto tensor9 = vector<shared_ptr<Tensor>>{Gamma107, rdm1_, rdm2_, rdm3_};
...
shared_ptr<FutureTensor> RelCASPT2::RelCASPT2::Gamma92_() {
  ...
  array<shared_ptr<const IndexRange>,3> pindex = {{rclosed_, ractive_, rvirt_}};
  auto tensor30 = vector<shared_ptr<Tensor>>{Gamma92, rdm3_, f1_};
