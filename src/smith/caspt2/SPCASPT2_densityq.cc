...
shared_ptr<Queue> SPCASPT2::SPCASPT2::make_densityq(const bool reset, const bool diagonal) {
  ...
  auto tensor37 = vector<shared_ptr<Tensor>>{den2};
  ...
  auto tensor38 = vector<shared_ptr<Tensor>>{den2, I0};
  ...
  auto tensor43 = vector<shared_ptr<Tensor>>{I0, Gamma34_(), I103};
  auto task43 = make_shared<Task43>(tensor43, pindex);
  task38->add_dep(task43);
  task43->add_dep(task37);
  densityq->add_task(task43);

  auto tensor44 = vector<shared_ptr<Tensor>>{I103, t2};
  ...
  auto tensor45 = vector<shared_ptr<Tensor>>{I103, t2, I137};
  auto task45 = make_shared<Task45>(tensor45, pindex);
  task43->add_dep(task45);
  task45->add_dep(task37);
  densityq->add_task(task45);

  auto tensor46 = vector<shared_ptr<Tensor>>{I137, t2};
  ...
  auto tensor47 = vector<shared_ptr<Tensor>>{I0, Gamma92_(), I285};
  auto task47 = make_shared<Task47>(tensor47, pindex);
  task38->add_dep(task47);
  task47->add_dep(task37);
  densityq->add_task(task47);

  auto tensor48 = vector<shared_ptr<Tensor>>{I285, t2};
  ...
  auto tensor49 = vector<shared_ptr<Tensor>>{den2, I3};
  ...
  auto tensor54 = vector<shared_ptr<Tensor>>{I3, t2, I106};
  auto task54 = make_shared<Task54>(tensor54, pindex);
  task49->add_dep(task54);
  task54->add_dep(task37);
  densityq->add_task(task54);

  auto tensor55 = vector<shared_ptr<Tensor>>{I106, Gamma35_(), t2};
  ...
  auto tensor56 = vector<shared_ptr<Tensor>>{den2, I6};
  ...
  auto tensor59 = vector<shared_ptr<Tensor>>{I6, t2, I112};
  auto task59 = make_shared<Task59>(tensor59, pindex);
  task56->add_dep(task59);
  task59->add_dep(task37);
  densityq->add_task(task59);

  auto tensor60 = vector<shared_ptr<Tensor>>{I112, Gamma37_(), t2};
  ...
  auto tensor61 = vector<shared_ptr<Tensor>>{den2, I9};
  ...
  auto tensor68 = vector<shared_ptr<Tensor>>{I9, t2, I163};
  auto task68 = make_shared<Task68>(tensor68, pindex);
  task61->add_dep(task68);
  task68->add_dep(task37);
  densityq->add_task(task68);

  auto tensor69 = vector<shared_ptr<Tensor>>{I163, Gamma40_(), t2};
  ...
  auto tensor72 = vector<shared_ptr<Tensor>>{den2, I12};
  ...
  auto tensor79 = vector<shared_ptr<Tensor>>{den2, I15};
  ...
  auto tensor84 = vector<shared_ptr<Tensor>>{den2, I18};
  ...
  auto tensor87 = vector<shared_ptr<Tensor>>{den2, I21};
  ...
  auto tensor94 = vector<shared_ptr<Tensor>>{I21, t2, I184};
  auto task94 = make_shared<Task94>(tensor94, pindex);
  task87->add_dep(task94);
  task94->add_dep(task37);
  densityq->add_task(task94);

  auto tensor95 = vector<shared_ptr<Tensor>>{I184, Gamma61_(), t2};
  ...
  auto tensor96 = vector<shared_ptr<Tensor>>{den2, I27};
  ...
  auto tensor103 = vector<shared_ptr<Tensor>>{den2, I33};
  ...
  auto tensor106 = vector<shared_ptr<Tensor>>{den2, I36};
  ...
  auto tensor109 = vector<shared_ptr<Tensor>>{den2, I39};
  ...
  auto tensor112 = vector<shared_ptr<Tensor>>{I39, t2, I196};
  ...
  auto tensor115 = vector<shared_ptr<Tensor>>{den2, I42};
  ...
  auto tensor116 = vector<shared_ptr<Tensor>>{I42, Gamma14_(), I43};
  ...
  auto tensor119 = vector<shared_ptr<Tensor>>{I42, Gamma61_(), I252};
  ...
  auto tensor122 = vector<shared_ptr<Tensor>>{den2, I48};
  ...
  auto tensor127 = vector<shared_ptr<Tensor>>{den2, I54};
  ...
  auto tensor132 = vector<shared_ptr<Tensor>>{den2, I57};
  ...
  auto tensor137 = vector<shared_ptr<Tensor>>{den2, I66};
  ...
  auto tensor141 = vector<shared_ptr<Tensor>>{den2, I69};
  ...
  auto tensor142 = vector<shared_ptr<Tensor>>{I69, t2, I70};
  ...
  auto tensor145 = vector<shared_ptr<Tensor>>{den2, I78};
  ...
  auto tensor146 = vector<shared_ptr<Tensor>>{I78, Gamma17_(), I79};
  ...
  auto tensor149 = vector<shared_ptr<Tensor>>{den2, I84};
  ...
  auto tensor152 = vector<shared_ptr<Tensor>>{den2, I87};
  ...
  auto tensor161 = vector<shared_ptr<Tensor>>{I87, t2, I282};
  auto task161 = make_shared<Task161>(tensor161, pindex);
  task152->add_dep(task161);
  task161->add_dep(task37);
  densityq->add_task(task161);

  auto tensor162 = vector<shared_ptr<Tensor>>{I282, Gamma61_(), t2};
  ...
  auto tensor163 = vector<shared_ptr<Tensor>>{den2, I99};
  ...
  auto tensor168 = vector<shared_ptr<Tensor>>{den2, I114};
  ...
  auto tensor177 = vector<shared_ptr<Tensor>>{den2, I126};
  ...
  auto tensor180 = vector<shared_ptr<Tensor>>{I126, t2, I279};
  auto task180 = make_shared<Task180>(tensor180, pindex);
  task177->add_dep(task180);
  task180->add_dep(task37);
  densityq->add_task(task180);

  auto tensor181 = vector<shared_ptr<Tensor>>{I279, Gamma90_(), t2};
  ...
  auto tensor182 = vector<shared_ptr<Tensor>>{den2, I138};
  ...
  auto tensor185 = vector<shared_ptr<Tensor>>{I138, t2, I148};
  auto task185 = make_shared<Task185>(tensor185, pindex);
  task182->add_dep(task185);
  task185->add_dep(task37);
  densityq->add_task(task185);

  auto tensor186 = vector<shared_ptr<Tensor>>{I148, Gamma35_(), t2};
  ...
  auto tensor187 = vector<shared_ptr<Tensor>>{den2, I141};
  ...
  auto tensor194 = vector<shared_ptr<Tensor>>{den2, I153};
  ...
  auto tensor197 = vector<shared_ptr<Tensor>>{den2, I177};
  ...
  auto tensor200 = vector<shared_ptr<Tensor>>{den2, I189};
  ...
  auto tensor203 = vector<shared_ptr<Tensor>>{den2, I192};
  ...
  auto tensor206 = vector<shared_ptr<Tensor>>{den2, I198};
  ...
  auto tensor207 = vector<shared_ptr<Tensor>>{I198, t2, I199};
  ...
  if (diagonal) {
    auto tensor214 = vector<shared_ptr<Tensor>>{den2, I213};
    task214 = make_shared<Task214>(tensor214, pindex);
    task214->add_dep(task37);
  ...
  shared_ptr<Task217> task217;
  if (diagonal) {
    auto tensor217 = vector<shared_ptr<Tensor>>{den2, I217};
    task217 = make_shared<Task217>(tensor217, pindex);
    task217->add_dep(task37);
  ...
  auto tensor225 = vector<shared_ptr<Tensor>>{I227, t2, I228};
  auto task225 = make_shared<Task225>(tensor225, pindex);
  task224->add_dep(task225);
  task225->add_dep(task37);
