...
class Task519 : public Task {
  ...
  public:
    Task519(std::vector<std::shared_ptr<Tensor>> t, const bool reset);
    ~Task519() {}
};

class Task521 : public Task {  // merged with gamma
  protected:
...
class Task526 : public Task {
  ...
  public:
    Task526(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task526() {}
};
...
class Task529 : public Task {  // merged with gamma
  protected:
    std::array<std::shared_ptr<Tensor>,5> out_;
    std::array<std::shared_ptr<const Tensor>,1> in_;
...
class Task537 : public Task {  // merged with gamma
  protected:
    std::array<std::shared_ptr<Tensor>,5> out_;
    std::array<std::shared_ptr<const Tensor>,1> in_;
    class Task_local : public SubTask_Merged<6,1,5> {
...
class Task546 : public Task {
  ...
  public:
    Task546(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task546() {}
};
