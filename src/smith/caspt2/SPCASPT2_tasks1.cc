...
#include <src/smith/caspt2/SPCASPT2_tasks1.h>
...
void Task0::Task_local::compute() {
  ...
  }
  {
    ...
    if (x1 == x4 && x3 == x5 && x0 == x2) {
      std::unique_ptr<double[]> i0data = in(3)->get_block();
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            odata[i2+x0.size()*(i5+x5.size()*(i4+x1.size()*(i4+x4.size()*(i5+x3.size()*(i2)))))]  += 2.0 * i0data[0];
          }
        }
      }
    }
  ...
  {
    if (x3 == x5 && x0 == x2) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x1, x4);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
  ...
  {
    if (x0 == x2) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x4, x3, x5);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i2+x0.size()*(i5+x5.size()*(i1+x1.size()*(i4+x4.size()*(i3+x3.size()*(i2)))))]
                  += (1.0) * i0data[i1+x1.size()*(i4+x4.size()*(i3+x3.size()*(i5)))];
              }
            }
          }
        }
  ...
  }
  {
    ...
    if (x3 == x4 && x1 == x2 && x0 == x5) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            odata[i5+x0.size()*(i5+x5.size()*(i2+x1.size()*(i4+x4.size()*(i4+x3.size()*(i2)))))]  += 2.0 * i0data[0];
          }
        }
      }
    }
  ...
  {
    if (x3 == x4 && x1 == x2) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x0, x5);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
...
void Task1::Task_local::compute() {
  ...
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x3, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
  ...
  {
    if (x3 == x4 && x1 == x2) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x5, x0);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
  ...
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x3, x4);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
  ...
  {
    if (x3 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x1, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x0, x1, x4, x3, x2);
...
void Task2::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x5, x4, x1, x0, x3, x2)]);
  std::fill_n(odata.get(), out()->get_size(x5, x4, x1, x0, x3, x2), 0.0);
  {
    if (x1 == x4) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i4+x1.size()*(i0+x0.size()*(i3+x3.size()*(i2)))))]
    ...
    if (x3 == x4 && x1 == x2) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i5+x5.size()*(i4+x4.size()*(i2+x1.size()*(i0+x0.size()*(i4+x3.size()*(i2)))))]
                += (1.0) * i0data[i5+x5.size()*(i0)];
            }
          }
        }
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i2+x1.size()*(i0+x0.size()*(i3+x3.size()*(i2)))))]
  ...
  {
    if (x3 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x5, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i1+x1.size()*(i0+x0.size()*(i4+x3.size()*(i2)))))]
                  += (1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i2)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(2)->get_block(x5, x4, x1, x0, x3, x2);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x5.size(), x4.size(), x1.size(), x0.size(), x3.size(), x2.size());
  }
  out()->add_block(odata, x5, x4, x1, x0, x3, x2);
}
...
void Task4::Task_local::compute() {
  ...
  std::fill_n(odata.get(), out()->get_size(x0, x3, x1, x2), 0.0);
  {
    // rdm0 non-merged case
    if (x1 == x3 && x0 == x2) {
      std::unique_ptr<double[]> i0data = in(2)->get_block();
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
  ...
  }
  {
    ...
    if (x1 == x2 && x0 == x3) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          odata[i3+x0.size()*(i3+x3.size()*(i2+x1.size()*(i2)))]  += 2.0 * i0data[0];
        }
      }
    }
  }
  ...
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x0, x3);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task5::Task_local::compute() {
  ...
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x3, x0);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i3 = 0; i3 != x3.size(); ++i3) {
...
void Task7::Task_local::compute() {
  ...
  {
    if (x1 == x3 && x0 == x2) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x5, x4);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
  ...
  {
    if (x1 == x2 && x0 == x4) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x5, x3);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
  ...
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x5, x4, x0, x3);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
  ...
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x0, x3, x5, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i0+x0.size()*(i3+x3.size()*(i4+x1.size()*(i2)))))]
                  += (1.0) * i0data[i0+x0.size()*(i3+x3.size()*(i5+x5.size()*(i2)))];
              }
            }
          }
        }
...
void Task8::Task_local::compute() {
  ...
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x5, x0, x4, x3);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task9::Task_local::compute() {
  ...
  std::fill_n(odata.get(), out()->get_size(x1, x3, x0, x2), 0.0);
  {
    ...
    if (x1 == x3 && x0 == x2) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          odata[i3+x1.size()*(i3+x3.size()*(i2+x0.size()*(i2)))]  += -2.0 * i0data[0];
        }
      }
    }
  }
  {
    if (x0 == x2) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x1, x3);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
...
void Task10::Task_local::compute() {
  ...
  std::fill_n(odata.get(), out()->get_size(x1, x0, x3, x2), 0.0);
  {
    if (x1 == x2) {
      ...
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            odata[i2+x1.size()*(i0+x0.size()*(i3+x3.size()*(i2)))]
              += (1.0) * i0data[i3+x3.size()*(i0)];
          }
        }
      }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x3, x2);
    sort_indices<0,1,2,3,1,1,1,1>(i0data, odata, x1.size(), x0.size(), x3.size(), x2.size());
  }
...
void Task11::Task_local::compute() {
  ...
  const Index x4 = b(5);
  // tensor label: Gamma4
  std::unique_ptr<double[]> odata(new double[out()->get_size(x2, x5, x1, x0, x3, x4)]);
  std::fill_n(odata.get(), out()->get_size(x2, x5, x1, x0, x3, x4), 0.0);
  {
    if (x2 == x5 && x1 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x3, x0);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i5+x2.size()*(i5+x5.size()*(i4+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
    ...
    if (x2 == x4 && x1 == x5) {
      ...
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i4+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
                += (1.0) * i0data[i3+x3.size()*(i0)];
            }
          }
        }
    ...
    if (x3 == x5 && x1 == x4) {
      ...
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              odata[i2+x2.size()*(i5+x5.size()*(i4+x1.size()*(i0+x0.size()*(i5+x3.size()*(i4)))))]
      ...
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i5+x5.size()*(i4+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
  ...
  {
    if (x3 == x4 && x1 == x5) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x2, x0);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              odata[i2+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i4+x3.size()*(i4)))))]
                += (-1.0) * i0data[i2+x2.size()*(i0)];
            }
          }
        }
  ...
  {
    if (x1 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x2, x0, x3, x4);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
                  += (1.0) * i0data[i2+x2.size()*(i0+x0.size()*(i3+x3.size()*(i4)))];
              }
            }
          }
        }
  ...
  {
    if (x3 == x5 && x2 == x4) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x1, x0);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i4+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i5+x3.size()*(i4)))))]
  ...
  {
    if (x2 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x3, x5);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i4+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
                  += (1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i3+x3.size()*(i5)))];
              }
            }
          }
        }
    ...
    if (x3 == x4 && x2 == x5) {
      ...
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i5+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x3.size()*(i4)))))]
  ...
  {
    if (x2 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x3, x4);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))))]
                  += (-2.0) * i0data[i1+x1.size()*(i0+x0.size()*(i3+x3.size()*(i4)))];
              }
            }
          }
        }
  ...
  {
    if (x3 == x4) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x2, x5, x1, x0);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x3.size()*(i4)))))]
  ...
  {
    if (x3 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x2, x4);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i5+x3.size()*(i4)))))]
                  += (1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i2+x2.size()*(i4)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(2)->get_block(x2, x5, x1, x0, x3, x4);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x2.size(), x5.size(), x1.size(), x0.size(), x3.size(), x4.size());
  }
  out()->add_block(odata, x2, x5, x1, x0, x3, x4);
}
...
void Task12::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x5, x0, x2, x1, x3, x4)]);
  std::fill_n(odata.get(), out()->get_size(x5, x0, x2, x1, x3, x4), 0.0);
  {
    if (x2 == x4) {
      ...
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i0+x0.size()*(i4+x2.size()*(i1+x1.size()*(i3+x3.size()*(i4)))))]
  ...
  {
    if (x3 == x4) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x5, x0, x2, x1);
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i0+x0.size()*(i2+x2.size()*(i1+x1.size()*(i4+x3.size()*(i4)))))]
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x0, x2, x1, x3, x4);
    sort_indices<0,1,2,3,4,5,1,1,-1,1>(i0data, odata, x5.size(), x0.size(), x2.size(), x1.size(), x3.size(), x4.size());
  }
  out()->add_block(odata, x5, x0, x2, x1, x3, x4);
}
...
void Task13::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x5, x4, x2, x1, x3, x0)]);
  std::fill_n(odata.get(), out()->get_size(x5, x4, x2, x1, x3, x0), 0.0);
  {
    if (x2 == x4) {
      ...
      for (int i0 = 0; i0 != x0.size(); ++i0) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i4+x2.size()*(i1+x1.size()*(i3+x3.size()*(i0)))))]
  ...
  {
    if (x3 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x2, x1, x5, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i2+x2.size()*(i1+x1.size()*(i4+x3.size()*(i0)))))]
                  += (1.0) * i0data[i2+x2.size()*(i1+x1.size()*(i5+x5.size()*(i0)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x4, x2, x1, x3, x0);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x5.size(), x4.size(), x2.size(), x1.size(), x3.size(), x0.size());
  }
  out()->add_block(odata, x5, x4, x2, x1, x3, x0);
}
...
void Task14::Task_local::compute() {
  ...
  const Index x3 = b(7);
  // tensor label: Gamma5
  std::unique_ptr<double[]> odata(new double[out()->get_size(x7, x6, x2, x5, x1, x0, x4, x3)]);
  std::fill_n(odata.get(), out()->get_size(x7, x6, x2, x5, x1, x0, x4, x3), 0.0);
  {
    if (x2 == x6 && x1 == x5) {
            ...
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i6+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
        ...
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i5+x2.size()*(i5+x5.size()*(i6+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i6 = 0; i6 != x6.size(); ++i6) {
              for (int i7 = 0; i7 != x7.size(); ++i7) {
                odata[i7+x7.size()*(i6+x6.size()*(i5+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
        ...
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i5+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i6 = 0; i6 != x6.size(); ++i6) {
              for (int i7 = 0; i7 != x7.size(); ++i7) {
                odata[i7+x7.size()*(i6+x6.size()*(i6+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
        ...
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i6+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
        ...
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
  ...
  {
    if (x4 == x6 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x2, x5, x7, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                    += (-1.0) * i0data[i2+x2.size()*(i5+x5.size()*(i7+x7.size()*(i0)))];
                }
              }
            }
          }
          ...
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i3+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i6 = 0; i6 != x6.size(); ++i6) {
              for (int i7 = 0; i7 != x7.size(); ++i7) {
                odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                  += (-1.0) * i0data[i7+x7.size()*(i0)];
              }
            }
          }
        ...
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
  ...
  {
    if (x4 == x6 && x1 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x2, x0, x7, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                    += (-1.0) * i0data[i2+x2.size()*(i0+x0.size()*(i7+x7.size()*(i3)))];
                }
              }
            }
          }
  ...
  {
    if (x1 == x5) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x6, x2, x0, x4, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i5+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
                      += (-1.0) * i0data[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))];
                  }
                }
              }
            }
  ...
  }
  {
    if (x4 == x5 && x2 == x3 && x1 == x6) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x7, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i6 = 0; i6 != x6.size(); ++i6) {
              for (int i7 = 0; i7 != x7.size(); ++i7) {
                odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i6+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
                  += (1.0) * i0data[i7+x7.size()*(i0)];
              }
            }
          }
        ...
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i6+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
        ...
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i2 = 0; i2 != x2.size(); ++i2) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i6+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
          ...
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i6+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
  ...
  {
    if (x4 == x5 && x2 == x3) {
      std::unique_ptr<double[]> i0data = in(5)->get_block(x7, x6, x1, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
  ...
  {
    if (x4 == x6 && x2 == x3) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x7, x5);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                    += (-1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i7+x7.size()*(i5)))];
                }
              }
            }
          }
  ...
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x6, x1, x0, x4, x5);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i3+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
                      += (-1.0) * i0data[i7+x7.size()*(i6+x6.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i5)))))];
                  }
                }
              }
            }
  ...
  {
    if (x4 == x6 && x2 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x7, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i5+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                    += (2.0) * i0data[i1+x1.size()*(i0+x0.size()*(i7+x7.size()*(i3)))];
                }
              }
            }
          }
  ...
  {
    if (x2 == x5) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x6, x1, x0, x4, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i5+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
                      += (2.0) * i0data[i7+x7.size()*(i6+x6.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))];
                  }
                }
              }
            }
        ...
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i6+x6.size()*(i6+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
                    += (-1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i7+x7.size()*(i3)))];
                }
              }
            }
          }
  ...
  {
    if (x2 == x6) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x5, x1, x0, x4, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i6+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))))]
                      += (-1.0) * i0data[i7+x7.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i4+x4.size()*(i3)))))];
                  }
                }
              }
            }
  ...
  {
    if (x4 == x5) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x6, x1, x0, x2, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i5+x4.size()*(i3)))))))]
                      += (-1.0) * i0data[i7+x7.size()*(i6+x6.size()*(i1+x1.size()*(i0+x0.size()*(i2+x2.size()*(i3)))))];
                  }
                }
              }
            }
  ...
  {
    if (x4 == x6) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x2, x5, x1, x0, x7, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                for (int i6 = 0; i6 != x6.size(); ++i6) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i6+x6.size()*(i2+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i6+x4.size()*(i3)))))))]
                      += (-1.0) * i0data[i2+x2.size()*(i5+x5.size()*(i1+x1.size()*(i0+x0.size()*(i7+x7.size()*(i3)))))];
                  }
                }
              }
            }
  ...
  {
    std::unique_ptr<double[]> i0data = in(3)->get_block(x7, x6, x2, x5, x1, x0, x4, x3);
    sort_indices<0,1,2,3,4,5,6,7,1,1,-1,1>(i0data, odata, x7.size(), x6.size(), x2.size(), x5.size(), x1.size(), x0.size(), x4.size(), x3.size());
  }
  out()->add_block(odata, x7, x6, x2, x5, x1, x0, x4, x3);
}
...
void Task15::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x7, x0, x6, x5, x2, x1, x4, x3)]);
  std::fill_n(odata.get(), out()->get_size(x7, x0, x6, x5, x2, x1, x4, x3), 0.0);
  {
    if (x2 == x5) {
          ...
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i0 = 0; i0 != x0.size(); ++i0) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i0+x0.size()*(i6+x6.size()*(i5+x5.size()*(i5+x2.size()*(i1+x1.size()*(i4+x4.size()*(i3)))))))]
        ...
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i5 = 0; i5 != x5.size(); ++i5) {
            for (int i6 = 0; i6 != x6.size(); ++i6) {
              for (int i0 = 0; i0 != x0.size(); ++i0) {
                for (int i7 = 0; i7 != x7.size(); ++i7) {
                  odata[i7+x7.size()*(i0+x0.size()*(i6+x6.size()*(i5+x5.size()*(i3+x2.size()*(i1+x1.size()*(i5+x4.size()*(i3)))))))]
          ...
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i0 = 0; i0 != x0.size(); ++i0) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i0+x0.size()*(i6+x6.size()*(i5+x5.size()*(i3+x2.size()*(i1+x1.size()*(i4+x4.size()*(i3)))))))]
  ...
  {
    if (x4 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x7, x0, x2, x1, x6, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              for (int i6 = 0; i6 != x6.size(); ++i6) {
                for (int i0 = 0; i0 != x0.size(); ++i0) {
                  for (int i7 = 0; i7 != x7.size(); ++i7) {
                    odata[i7+x7.size()*(i0+x0.size()*(i6+x6.size()*(i5+x5.size()*(i2+x2.size()*(i1+x1.size()*(i5+x4.size()*(i3)))))))]
                      += (1.0) * i0data[i7+x7.size()*(i0+x0.size()*(i2+x2.size()*(i1+x1.size()*(i6+x6.size()*(i3)))))];
                  }
                }
              }
            }
  ...
  {
    std::unique_ptr<double[]> i0data = in(2)->get_block(x7, x0, x6, x5, x2, x1, x4, x3);
    sort_indices<0,1,2,3,4,5,6,7,1,1,1,1>(i0data, odata, x7.size(), x0.size(), x6.size(), x5.size(), x2.size(), x1.size(), x4.size(), x3.size());
  }
  out()->add_block(odata, x7, x0, x6, x5, x2, x1, x4, x3);
}
...
void Task16::Task_local::compute() {
  ...
  const Index x3 = b(5);
  // tensor label: Gamma6
  std::unique_ptr<double[]> odata(new double[out()->get_size(x5, x4, x1, x0, x2, x3)]);
  std::fill_n(odata.get(), out()->get_size(x5, x4, x1, x0, x2, x3), 0.0);
  {
    if (x2 == x4 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i5+x5.size()*(i4+x4.size()*(i3+x1.size()*(i0+x0.size()*(i4+x2.size()*(i3)))))]
                += (-1.0) * i0data[i5+x5.size()*(i0)];
            }
          }
        }
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i3+x1.size()*(i0+x0.size()*(i2+x2.size()*(i3)))))]
  ...
  {
    if (x2 == x3 && x1 == x4) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x5, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            for (int i5 = 0; i5 != x5.size(); ++i5) {
              odata[i5+x5.size()*(i4+x4.size()*(i4+x1.size()*(i0+x0.size()*(i3+x2.size()*(i3)))))]
                += (1.0) * i0data[i5+x5.size()*(i0)];
            }
          }
        }
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i4+x1.size()*(i0+x0.size()*(i2+x2.size()*(i3)))))]
  ...
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(4)->get_block(x5, x4, x1, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i1+x1.size()*(i0+x0.size()*(i3+x2.size()*(i3)))))]
  ...
  {
    if (x2 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x5, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i1+x1.size()*(i0+x0.size()*(i4+x2.size()*(i3)))))]
                  += (-1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(2)->get_block(x5, x4, x1, x0, x2, x3);
    sort_indices<0,1,2,3,4,5,1,1,-1,1>(i0data, odata, x5.size(), x4.size(), x1.size(), x0.size(), x2.size(), x3.size());
  }
  out()->add_block(odata, x5, x4, x1, x0, x2, x3);
}
...
void Task18::Task_local::compute() {
  ...
  const Index x3 = b(3);
  // tensor label: Gamma8
  std::unique_ptr<double[]> odata(new double[out()->get_size(x1, x0, x2, x3)]);
  std::fill_n(odata.get(), out()->get_size(x1, x0, x2, x3), 0.0);
  {
    if (x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x2, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            odata[i3+x1.size()*(i0+x0.size()*(i2+x2.size()*(i3)))]
              += (-1.0) * i0data[i2+x2.size()*(i0)];
          }
        }
      }
  ...
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x1, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i0 = 0; i0 != x0.size(); ++i0) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            odata[i1+x1.size()*(i0+x0.size()*(i3+x2.size()*(i3)))]
              += (1.0) * i0data[i1+x1.size()*(i0)];
          }
        }
      }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x2, x3);
    sort_indices<0,1,2,3,1,1,-1,1>(i0data, odata, x1.size(), x0.size(), x2.size(), x3.size());
  }
  out()->add_block(odata, x1, x0, x2, x3);
}
...
void Task19::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x2, x1, x3, x0)]);
  std::fill_n(odata.get(), out()->get_size(x2, x1, x3, x0), 0.0);
  {
    std::unique_ptr<double[]> i0data = in(0)->get_block(x2, x1, x3, x0);
    sort_indices<0,1,2,3,1,1,1,1>(i0data, odata, x2.size(), x1.size(), x3.size(), x0.size());
  }
  out()->add_block(odata, x2, x1, x3, x0);
}
...
void Task21::Task_local::compute() {
  ...
  const Index x3 = b(5);
  // tensor label: Gamma9
  std::unique_ptr<double[]> odata(new double[out()->get_size(x2, x4, x1, x0, x5, x3)]);
  std::fill_n(odata.get(), out()->get_size(x2, x4, x1, x0, x5, x3), 0.0);
  {
    if (x2 == x4 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              odata[i4+x2.size()*(i4+x4.size()*(i3+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
  ...
  {
    if (x1 == x3) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x2, x4, x5, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i4+x4.size()*(i3+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
                  += (1.0) * i0data[i2+x2.size()*(i4+x4.size()*(i5+x5.size()*(i0)))];
              }
            }
          }
        }
    ...
    if (x2 == x3 && x1 == x4) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              odata[i3+x2.size()*(i4+x4.size()*(i4+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
                += (1.0) * i0data[i5+x5.size()*(i0)];
            }
          }
        }
  ...
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x2, x0, x5, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i2 = 0; i2 != x2.size(); ++i2) {
                odata[i2+x2.size()*(i4+x4.size()*(i4+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
                  += (1.0) * i0data[i2+x2.size()*(i0+x0.size()*(i5+x5.size()*(i3)))];
              }
            }
          }
        }
  ...
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x0, x5, x4);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i4 = 0; i4 != x4.size(); ++i4) {
                odata[i3+x2.size()*(i4+x4.size()*(i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
                  += (1.0) * i0data[i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i4)))];
              }
            }
          }
        }
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i1 = 0; i1 != x1.size(); ++i1) {
              for (int i4 = 0; i4 != x4.size(); ++i4) {
                odata[i4+x2.size()*(i4+x4.size()*(i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))))]
                  += (-2.0) * i0data[i1+x1.size()*(i0+x0.size()*(i5+x5.size()*(i3)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(2)->get_block(x2, x4, x1, x0, x5, x3);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x2.size(), x4.size(), x1.size(), x0.size(), x5.size(), x3.size());
  }
  out()->add_block(odata, x2, x4, x1, x0, x5, x3);
}
...
void Task22::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x5, x0, x2, x1, x4, x3)]);
  std::fill_n(odata.get(), out()->get_size(x5, x0, x2, x1, x4, x3), 0.0);
  {
    if (x2 == x3) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i0 = 0; i0 != x0.size(); ++i0) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i0+x0.size()*(i3+x2.size()*(i1+x1.size()*(i4+x4.size()*(i3)))))]
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x0, x2, x1, x4, x3);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x5.size(), x0.size(), x2.size(), x1.size(), x4.size(), x3.size());
  }
  out()->add_block(odata, x5, x0, x2, x1, x4, x3);
}
...
void Task23::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x0, x2, x1, x3)]);
  std::fill_n(odata.get(), out()->get_size(x0, x2, x1, x3), 0.0);
  {
    // rdm0 non-merged case
    if (x1 == x3 && x0 == x2) {
      std::unique_ptr<double[]> i0data = in(2)->get_block();
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          odata[i2+x0.size()*(i2+x2.size()*(i3+x1.size()*(i3)))]  += -2.0 * i0data[0];
        }
      }
    }
  }
  {
    if (x0 == x2) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i2+x0.size()*(i2+x2.size()*(i1+x1.size()*(i3)))]
  ...
  }
  {
    ...
    if (x1 == x2 && x0 == x3) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          odata[i3+x0.size()*(i2+x2.size()*(i2+x1.size()*(i3)))]  += 1.0 * i0data[0];
        }
      }
    }
  }
  {
    if (x0 == x3) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i1 = 0; i1 != x1.size(); ++i1) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i3+x0.size()*(i2+x2.size()*(i1+x1.size()*(i3)))]
              += (-1.0) * i0data[i1+x1.size()*(i2)];
          }
        }
      }
  ...
  }
  {
    if (x1 == x2) {
      ...
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            odata[i0+x0.size()*(i2+x2.size()*(i2+x1.size()*(i3)))]
              += (-1.0) * i0data[i0+x0.size()*(i3)];
          }
        }
      }
  ...
  {
    if (x1 == x3) {
      std::unique_ptr<double[]> i0data = in(3)->get_block(x0, x2);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            odata[i0+x0.size()*(i2+x2.size()*(i3+x1.size()*(i3)))]
              += (1.0) * i0data[i0+x0.size()*(i2)];
          }
        }
      }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x0, x2, x1, x3);
    sort_indices<0,1,2,3,1,1,-1,1>(i0data, odata, x0.size(), x2.size(), x1.size(), x3.size());
  }
  out()->add_block(odata, x0, x2, x1, x3);
}
...
void Task25::Task_local::compute() {
  ...
  {
    if (x0 == x1) {
      std::unique_ptr<double[]> i0data = in(2)->get_block(x3, x2);
      for (int i1 = 0; i1 != x1.size(); ++i1) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i3 = 0; i3 != x3.size(); ++i3) {
            odata[i3+x3.size()*(i2+x2.size()*(i1+x0.size()*(i1)))]
...
void Task31::Task_local::compute() {
  ...
  std::fill_n(odata.get(), out()->get_size(x0, x1), 0.0);
  {
    // rdm0 non-merged case
    if (x0 == x1) {
      std::unique_ptr<double[]> i0data = in(1)->get_block();
      for (int i1 = 0; i1 != x1.size(); ++i1) {
...
void Task32::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x0, x2, x3, x1)]);
  std::fill_n(odata.get(), out()->get_size(x0, x2, x3, x1), 0.0);
  {
    if (x0 == x1) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x3, x2);
      for (int i1 = 0; i1 != x1.size(); ++i1) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i1+x0.size()*(i2+x2.size()*(i3+x3.size()*(i1)))]
              += (1.0) * i0data[i3+x3.size()*(i2)];
          }
        }
      }
  ...
  }
  {
    if (x0 == x2) {
      ...
      for (int i1 = 0; i1 != x1.size(); ++i1) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i2+x0.size()*(i2+x2.size()*(i3+x3.size()*(i1)))]
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x0, x2, x3, x1);
    sort_indices<0,1,2,3,1,1,1,1>(i0data, odata, x0.size(), x2.size(), x3.size(), x1.size());
  }
  out()->add_block(odata, x0, x2, x3, x1);
}
...
void Task33::Task_local::compute() {
  ...
  {
    if (x2 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x3, x5, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i4 = 0; i4 != x4.size(); ++i4) {
              for (int i5 = 0; i5 != x5.size(); ++i5) {
                odata[i5+x5.size()*(i4+x4.size()*(i1+x1.size()*(i3+x3.size()*(i4+x2.size()*(i0)))))]
                  += (1.0) * i0data[i1+x1.size()*(i3+x3.size()*(i5+x5.size()*(i0)))];
              }
            }
          }
        }
...
void Task35::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x1, x2, x3, x0)]);
  std::fill_n(odata.get(), out()->get_size(x1, x2, x3, x0), 0.0);
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x3, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
        for (int i3 = 0; i3 != x3.size(); ++i3) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i2+x1.size()*(i2+x2.size()*(i3+x3.size()*(i0)))]
              += (2.0) * i0data[i3+x3.size()*(i0)];
          }
        }
      }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x1, x2, x3, x0);
    sort_indices<0,1,2,3,1,1,-1,1>(i0data, odata, x1.size(), x2.size(), x3.size(), x0.size());
  }
  out()->add_block(odata, x1, x2, x3, x0);
}
...
void Task38::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x4, x3, x1, x0, x5, x2)]);
  std::fill_n(odata.get(), out()->get_size(x4, x3, x1, x0, x5, x2), 0.0);
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x4, x3, x5, x0);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i3 = 0; i3 != x3.size(); ++i3) {
              for (int i4 = 0; i4 != x4.size(); ++i4) {
                odata[i4+x4.size()*(i3+x3.size()*(i2+x1.size()*(i0+x0.size()*(i5+x5.size()*(i2)))))]
                  += (1.0) * i0data[i4+x4.size()*(i3+x3.size()*(i5+x5.size()*(i0)))];
              }
            }
          }
        }
  ...
  {
    if (x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x4, x0, x5, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i0 = 0; i0 != x0.size(); ++i0) {
            for (int i3 = 0; i3 != x3.size(); ++i3) {
              for (int i4 = 0; i4 != x4.size(); ++i4) {
                odata[i4+x4.size()*(i3+x3.size()*(i3+x1.size()*(i0+x0.size()*(i5+x5.size()*(i2)))))]
                  += (1.0) * i0data[i4+x4.size()*(i0+x0.size()*(i5+x5.size()*(i2)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x4, x3, x1, x0, x5, x2);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x4.size(), x3.size(), x1.size(), x0.size(), x5.size(), x2.size());
  }
  out()->add_block(odata, x4, x3, x1, x0, x5, x2);
}
...
void Task39::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(x4, x3, x2, x1, x5, x0)]);
  std::fill_n(odata.get(), out()->get_size(x4, x3, x2, x1, x5, x0), 0.0);
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x4, x1, x5, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
        for (int i5 = 0; i5 != x5.size(); ++i5) {
          for (int i1 = 0; i1 != x1.size(); ++i1) {
            for (int i3 = 0; i3 != x3.size(); ++i3) {
              for (int i4 = 0; i4 != x4.size(); ++i4) {
                odata[i4+x4.size()*(i3+x3.size()*(i3+x2.size()*(i1+x1.size()*(i5+x5.size()*(i0)))))]
                  += (1.0) * i0data[i4+x4.size()*(i1+x1.size()*(i5+x5.size()*(i0)))];
              }
            }
          }
        }
  ...
  {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x4, x3, x2, x1, x5, x0);
    sort_indices<0,1,2,3,4,5,1,1,1,1>(i0data, odata, x4.size(), x3.size(), x2.size(), x1.size(), x5.size(), x0.size());
  }
  out()->add_block(odata, x4, x3, x2, x1, x5, x0);
}
  ...
  for (auto& x5 : *range_[1]) {
    for (auto& x4 : *range_[1]) {
      for (auto& x1 : *range_[1]) {
        for (auto& x0 : *range_[1]) {
          // tensor label: Gamma34
          std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x4, x1, x0, x3, x2);
          std::unique_ptr<double[]> i0data_sorted(new double[in(0)->get_size(x5, x4, x1, x0, x3, x2)]);
          sort_indices<0,1,2,3,4,5,0,1,1,1>(i0data, i0data_sorted, x5.size(), x4.size(), x1.size(), x0.size(), x3.size(), x2.size());
          // tensor label: I103
          std::unique_ptr<double[]> i1data = in(1)->get_block(x5, x4, x1, x0);
          std::unique_ptr<double[]> i1data_sorted(new double[in(1)->get_size(x5, x4, x1, x0)]);
