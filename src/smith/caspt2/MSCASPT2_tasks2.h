...
#ifndef __SRC_SMITH_MSCASPT2_TASKS2_H
#define __SRC_SMITH_MSCASPT2_TASKS2_H
...
class Task60 : public Task {
  ...
  public:
    Task60(std::vector<std::shared_ptr<Tensor>> t, const bool reset);
    ~Task60() {}
};
