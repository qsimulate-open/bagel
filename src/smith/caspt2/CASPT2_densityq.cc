...
shared_ptr<Queue> CASPT2::CASPT2::make_densityq(const bool reset, const bool diagonal) {
  ...
  auto I444 = make_shared<TATensor<double,2>>({active_, active_});
  auto task301 = make_shared<Task301>(den2, I444);
  task301->add_dep(task300);
  densityq->add_task(task301);

  auto I445 = make_shared<TATensor<double,4>>({active_, active_, active_, active_});
  ...
  auto I538 = make_shared<TATensor<double,4>>({active_, active_, active_, active_});
  ...
  auto I547 = make_shared<TATensor<double,4>>({active_, active_, active_, active_});
  ...
  auto I729 = make_shared<TATensor<double,4>>({active_, active_, active_, active_});
  ...
  auto I447 = make_shared<TATensor<double,2>>({closed_, closed_});
  ...
  auto I541 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I550 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I450 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task319 = make_shared<Task319>(den2, I450);
  task319->add_dep(task300);
  densityq->add_task(task319);

  auto I451 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I556 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I454 = make_shared<TATensor<double,4>>({closed_, closed_, active_, active_});
  ...
  auto I565 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I568 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I607 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I610 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I456 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task335 = make_shared<Task335>(den2, I456);
  task335->add_dep(task300);
  densityq->add_task(task335);

  auto I457 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I613 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I616 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I459 = make_shared<TATensor<double,2>>({active_, active_});
  auto task342 = make_shared<Task342>(den2, I459);
  task342->add_dep(task300);
  densityq->add_task(task342);

  auto I460 = make_shared<TATensor<double,6>>({active_, active_, active_, active_, active_, active_});
  ...
  auto I619 = make_shared<TATensor<double,6>>({active_, active_, active_, active_, active_, active_});
  ...
  auto I462 = make_shared<TATensor<double,2>>({closed_, closed_});
  auto task347 = make_shared<Task347>(den2, I462);
  task347->add_dep(task300);
  densityq->add_task(task347);

  auto I463 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I465 = make_shared<TATensor<double,2>>({closed_, virt_});
  auto task350 = make_shared<Task350>(den2, I465);
  task350->add_dep(task300);
  densityq->add_task(task350);

  auto I466 = make_shared<TATensor<double,2>>({closed_, active_});
  ...
  auto I469 = make_shared<TATensor<double,2>>({closed_, active_});
  ...
  auto I625 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I628 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I471 = make_shared<TATensor<double,2>>({active_, virt_});
  auto task359 = make_shared<Task359>(den2, I471);
  task359->add_dep(task300);
  densityq->add_task(task359);

  auto I472 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I475 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I631 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I477 = make_shared<TATensor<double,2>>({active_, virt_});
  auto task366 = make_shared<Task366>(den2, I477);
  task366->add_dep(task300);
  densityq->add_task(task366);

  auto I478 = make_shared<TATensor<double,4>>({closed_, closed_, active_, active_});
  ...
  auto I480 = make_shared<TATensor<double,2>>({virt_, closed_});
  auto task369 = make_shared<Task369>(den2, I480);
  task369->add_dep(task300);
  densityq->add_task(task369);

  auto I481 = make_shared<TATensor<double,2>>({closed_, active_});
  ...
  auto I483 = make_shared<TATensor<double,2>>({closed_, virt_});
  auto task372 = make_shared<Task372>(den2, I483);
  task372->add_dep(task300);
  densityq->add_task(task372);

  auto I484 = make_shared<TATensor<double,2>>({closed_, active_});
  ...
  auto I640 = make_shared<TATensor<double,2>>({virt_, closed_});
  auto task375 = make_shared<Task375>(I483, t2, I640);
  task372->add_dep(task375);
  task375->add_dep(task300);
  densityq->add_task(task375);

  auto I641 = make_shared<TATensor<double,4>>({active_, virt_, closed_, active_});
  ...
  auto I486 = make_shared<TATensor<double,2>>({active_, active_});
  auto task378 = make_shared<Task378>(den2, I486);
  task378->add_dep(task300);
  densityq->add_task(task378);

  auto I487 = make_shared<TATensor<double,2>>({active_, active_});
  ...
  auto I696 = make_shared<TATensor<double,2>>({active_, active_});
  ...
  auto I492 = make_shared<TATensor<double,2>>({closed_, closed_});
  auto task385 = make_shared<Task385>(den2, I492);
  task385->add_dep(task300);
  densityq->add_task(task385);

  auto I493 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I496 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I498 = make_shared<TATensor<double,2>>({closed_, closed_});
  auto task390 = make_shared<Task390>(den2, I498);
  task390->add_dep(task300);
  densityq->add_task(task390);

  auto I499 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I505 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I501 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task395 = make_shared<Task395>(den2, I501);
  task395->add_dep(task300);
  densityq->add_task(task395);

  auto I502 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I508 = make_shared<TATensor<double,4>>({closed_, virt_, closed_, active_});
  ...
  auto I510 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task400 = make_shared<Task400>(den2, I510);
  task400->add_dep(task300);
  densityq->add_task(task400);

  auto I511 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I522 = make_shared<TATensor<double,2>>({virt_, active_});
  auto task408 = make_shared<Task408>(den2, I522);
  task408->add_dep(task300);
  densityq->add_task(task408);

  auto I523 = make_shared<TATensor<double,2>>({active_, virt_});
  ...
  auto I528 = make_shared<TATensor<double,2>>({active_, virt_});
  auto task412 = make_shared<Task412>(den2, I528);
  task412->add_dep(task300);
  densityq->add_task(task412);

  auto I529 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I531 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task415 = make_shared<Task415>(den2, I531);
  task415->add_dep(task300);
  densityq->add_task(task415);

  auto I532 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I535 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I574 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I577 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I726 = make_shared<TATensor<double,4>>({virt_, virt_, active_, active_});
  ...
  auto I543 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task426 = make_shared<Task426>(den2, I543);
  task426->add_dep(task300);
  densityq->add_task(task426);

  auto I544 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I553 = make_shared<TATensor<double,4>>({closed_, virt_, active_, active_});
  ...
  auto I558 = make_shared<TATensor<double,2>>({virt_, closed_});
  auto task431 = make_shared<Task431>(den2, I558);
  task431->add_dep(task300);
  densityq->add_task(task431);

  auto I559 = make_shared<TATensor<double,2>>({closed_, virt_});
  ...
  auto I562 = make_shared<TATensor<double,2>>({closed_, virt_});
  ...
  auto I601 = make_shared<TATensor<double,2>>({virt_, closed_});
  ...
  auto I604 = make_shared<TATensor<double,2>>({virt_, closed_});
  ...
  auto I570 = make_shared<TATensor<double,2>>({active_, virt_});
  auto task440 = make_shared<Task440>(den2, I570);
  task440->add_dep(task300);
  densityq->add_task(task440);

  auto I571 = make_shared<TATensor<double,4>>({closed_, active_, active_, active_});
  ...
  auto I723 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I582 = make_shared<TATensor<double,2>>({closed_, closed_});
  auto task445 = make_shared<Task445>(den2, I582);
  task445->add_dep(task300);
  densityq->add_task(task445);

  auto I583 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I592 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I585 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task450 = make_shared<Task450>(den2, I585);
  task450->add_dep(task300);
  densityq->add_task(task450);

  auto I586 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I595 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I732 = make_shared<TATensor<double,4>>({virt_, virt_, active_, active_});
  ...
  auto I597 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task457 = make_shared<Task457>(den2, I597);
  task457->add_dep(task300);
  densityq->add_task(task457);

  auto I598 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I621 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task460 = make_shared<Task460>(den2, I621);
  task460->add_dep(task300);
  densityq->add_task(task460);

  auto I622 = make_shared<TATensor<double,4>>({virt_, active_, active_, active_});
  ...
  auto I633 = make_shared<TATensor<double,2>>({virt_, active_});
  auto task463 = make_shared<Task463>(den2, I633);
  task463->add_dep(task300);
  densityq->add_task(task463);

  auto I634 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I636 = make_shared<TATensor<double,2>>({virt_, active_});
  auto task466 = make_shared<Task466>(den2, I636);
  task466->add_dep(task300);
  densityq->add_task(task466);

  auto I637 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I651 = make_shared<TATensor<double,2>>({active_, active_});
  auto task473 = make_shared<Task473>(den2, I651);
  task473->add_dep(task300);
  densityq->add_task(task473);

  auto I652 = make_shared<TATensor<double,0>>({});
  ...
  if (diagonal) {
    I657 = make_shared<TATensor<double,2>>({closed_, closed_});
  }
  ...
  if (diagonal) {
    I661 = make_shared<TATensor<double,2>>({virt_, virt_});
  }
  ...
  auto I665 = make_shared<TATensor<double,2>>({closed_, active_});
  auto task483 = make_shared<Task483>(den2, I665);
  task483->add_dep(task300);
  densityq->add_task(task483);

  auto I666 = make_shared<TATensor<double,2>>({closed_, active_});
  ...
  auto I674 = make_shared<TATensor<double,2>>({active_, virt_});
  auto task491 = make_shared<Task491>(den2, I674);
  task491->add_dep(task300);
  densityq->add_task(task491);

  auto I675 = make_shared<TATensor<double,4>>({virt_, closed_, active_, active_});
  ...
  auto I683 = make_shared<TATensor<double,2>>({closed_, virt_});
  auto task495 = make_shared<Task495>(den2, I683);
  task495->add_dep(task300);
  densityq->add_task(task495);

  auto I684 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I686 = make_shared<TATensor<double,2>>({virt_, closed_});
  auto task498 = make_shared<Task498>(den2, I686);
  task498->add_dep(task300);
  densityq->add_task(task498);

  auto I687 = make_shared<TATensor<double,2>>({virt_, active_});
  ...
  auto I689 = make_shared<TATensor<double,2>>({closed_, active_});
  auto task501 = make_shared<Task501>(den2, I689);
  task501->add_dep(task300);
  densityq->add_task(task501);

  auto I690 = make_shared<TATensor<double,2>>({active_, closed_});
  ...
  auto I701 = make_shared<TATensor<double,2>>({closed_, closed_});
  auto task505 = make_shared<Task505>(den2, I701);
  task505->add_dep(task300);
  densityq->add_task(task505);

  auto I702 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I705 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I707 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task510 = make_shared<Task510>(den2, I707);
  task510->add_dep(task300);
  densityq->add_task(task510);

  auto I708 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I711 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I713 = make_shared<TATensor<double,2>>({virt_, virt_});
  auto task515 = make_shared<Task515>(den2, I713);
  task515->add_dep(task300);
  densityq->add_task(task515);

  auto I714 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I717 = make_shared<TATensor<double,4>>({virt_, closed_, virt_, active_});
  ...
  auto I719 = make_shared<TATensor<double,2>>({active_, closed_});
  auto task520 = make_shared<Task520>(den2, I719);
  task520->add_dep(task300);
  densityq->add_task(task520);

  auto I720 = make_shared<TATensor<double,4>>({virt_, virt_, active_, active_});
