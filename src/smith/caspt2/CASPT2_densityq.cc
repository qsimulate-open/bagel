...
shared_ptr<Queue> CASPT2::CASPT2::make_densityq(const bool reset, const bool diagonal) {
  ...
  auto tensor297 = vector<shared_ptr<Tensor>>{den2};
  auto task297 = make_shared<Task297>(tensor297, reset);
  densityq->add_task(task297);

  vector<IndexRange> I360_index = {active_, active_};
  auto I360 = make_shared<Tensor>(I360_index);
  auto tensor298 = vector<shared_ptr<Tensor>>{den2, I360};
  auto task298 = make_shared<Task298>(tensor298, pindex);
  task298->add_dep(task297);
  ...
  auto tensor303 = vector<shared_ptr<Tensor>>{I360, Gamma172_(), I463};
  auto task303 = make_shared<Task303>(tensor303, pindex);
  task298->add_dep(task303);
  task303->add_dep(task297);
  densityq->add_task(task303);

  auto tensor304 = vector<shared_ptr<Tensor>>{I463, t2};
  auto task304 = make_shared<Task304>(tensor304, pindex);
  task303->add_dep(task304);
  task304->add_dep(task297);
  ...
  auto tensor326 = vector<shared_ptr<Tensor>>{I369, t2, I484};
  auto task326 = make_shared<Task326>(tensor326, pindex);
  task321->add_dep(task326);
  task326->add_dep(task297);
  densityq->add_task(task326);

  auto tensor327 = vector<shared_ptr<Tensor>>{I484, Gamma32_(), t2};
  auto task327 = make_shared<Task327>(tensor327, pindex);
  task326->add_dep(task327);
  task327->add_dep(task297);
  ...
  auto tensor328 = vector<shared_ptr<Tensor>>{I369, t2, I523};
  auto task328 = make_shared<Task328>(tensor328, pindex);
  task321->add_dep(task328);
  task328->add_dep(task297);
  densityq->add_task(task328);

  auto tensor329 = vector<shared_ptr<Tensor>>{I523, Gamma35_(), t2};
  auto task329 = make_shared<Task329>(tensor329, pindex);
  task328->add_dep(task329);
  task329->add_dep(task297);
  ...
  auto tensor402 = vector<shared_ptr<Tensor>>{I429, t2, I430};
  auto task402 = make_shared<Task402>(tensor402, pindex);
  task401->add_dep(task402);
  task402->add_dep(task297);
  ...
  auto tensor417 = vector<shared_ptr<Tensor>>{I447, t2, I490};
  auto task417 = make_shared<Task417>(tensor417, pindex);
  task412->add_dep(task417);
  task417->add_dep(task297);
  densityq->add_task(task417);

  auto tensor418 = vector<shared_ptr<Tensor>>{I490, Gamma7_(), t2};
  auto task418 = make_shared<Task418>(tensor418, pindex);
  task417->add_dep(task418);
  task418->add_dep(task297);
  ...
  if (diagonal) {
    auto tensor474 = vector<shared_ptr<Tensor>>{den2, I573};
    task474 = make_shared<Task474>(tensor474, pindex);
    task474->add_dep(task297);
  ...
  if (diagonal) {
    auto tensor477 = vector<shared_ptr<Tensor>>{den2, I577};
    task477 = make_shared<Task477>(tensor477, pindex);
    task477->add_dep(task297);
  ...
  auto tensor485 = vector<shared_ptr<Tensor>>{I587, t2, I588};
  auto task485 = make_shared<Task485>(tensor485, pindex);
  task484->add_dep(task485);
  task485->add_dep(task297);
