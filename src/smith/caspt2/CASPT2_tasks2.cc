...
void Task50::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x5, x4, x1, x3, x2, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x5, x4, x1, x3, x2, x0), 0.0);
  {
    if (x2 == x4 && x1 == x3) {
  ...
  out()->add_block(odata, ci0, x5, x4, x1, x3, x2, x0);
}
...
void Task51::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x1, x3, x2, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x1, x3, x2, x0), 0.0);
  {
    if (x1 == x3) {
  ...
  out()->add_block(odata, ci0, x1, x3, x2, x0);
}
...
void Task52::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x5, x0, x1, x4)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x5, x0, x1, x4), 0.0);
  ...
  out()->add_block(odata, ci0, x5, x0, x1, x4);
}
...
void Task53::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x3, x0, x1, x2)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x3, x0, x1, x2), 0.0);
  {
    if (x1 == x2) {
  ...
  out()->add_block(odata, ci0, x3, x0, x1, x2);
}
...
void Task54::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x5, x4, x1, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x5, x4, x1, x0), 0.0);
  // associated with merged
  std::unique_ptr<double[]> fdata = in(3)->get_block(x3, x2);
  if (x1 == x4) {
    std::unique_ptr<double[]> i0data = in(1)->get_block(ci0, x5, x0, x3, x2);
  ...
  out()->add_block(odata, ci0, x5, x4, x1, x0);
}
...
void Task55::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x3, x2, x1, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x3, x2, x1, x0), 0.0);
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(ci0, x3, x0);
      for (int ix0 = 0; ix0 != x0.size(); ++ix0) {
  ...
  out()->add_block(odata, ci0, x3, x2, x1, x0);
}
...
void Task56::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x5, x0, x4, x3, x1, x2)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x5, x0, x4, x3, x1, x2), 0.0);
  {
    if (x1 == x2) {
  ...
  out()->add_block(odata, ci0, x5, x0, x4, x3, x1, x2);
}
...
void Task57::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x1, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x1, x0), 0.0);
  {
    std::unique_ptr<double[]> i0data = in(0)->get_block(ci0, x1, x0);
    sort_indices<0,1,2,1,1,1,1>(i0data, odata, ci0.size(), x1.size(), x0.size());
  }
  out()->add_block(odata, ci0, x1, x0);
}
...
void Task58::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata(new double[out()->get_size(ci0, x5, x2, x4, x3, x1, x0)]);
  std::fill_n(odata.get(), out()->get_size(ci0, x5, x2, x4, x3, x1, x0), 0.0);
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(ci0, x5, x0, x4, x3);
      for (int ix0 = 0; ix0 != x0.size(); ++ix0) {
  ...
  out()->add_block(odata, ci0, x5, x2, x4, x3, x1, x0);
}
...
void Task84::Task_local::compute() {
  ...
  for (auto& c2 : *range_[0]) {
    ...
    // tensor label: I17
    std::unique_ptr<double[]> i1data = in(1)->get_block(c2, x2, x1, x0);
    std::unique_ptr<double[]> i1data_sorted(new double[in(1)->get_size(c2, x2, x1, x0)]);
...
void Task85::Task_local::compute() {
  ...
  const Index x0 = b(3);
  // tensor label: I17
  std::unique_ptr<double[]> odata(new double[out()->get_size(c2, x2, x1, x0)]);
  std::fill_n(odata.get(), out()->get_size(c2, x2, x1, x0), 0.0);
  std::unique_ptr<double[]> odata_sorted(new double[out()->get_size(c2, x2, x1, x0)]);
  ...
  for (auto& x5 : *range_[1]) {
    for (auto& x4 : *range_[1]) {
      for (auto& x3 : *range_[1]) {
        ...
        dgemm_("T", "N", x2.size()*x1.size()*x0.size(), c2.size(), x5.size()*x4.size()*x3.size(),
               1.0, i0data_sorted, x5.size()*x4.size()*x3.size(), i1data_sorted, x5.size()*x4.size()*x3.size(),
               1.0, odata_sorted, x2.size()*x1.size()*x0.size());
      }
    }
