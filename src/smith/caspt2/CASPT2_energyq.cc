...
shared_ptr<Queue> CASPT2::CASPT2::make_energyq(const bool reset, const bool diagonal) {
  ...
  auto task244 = make_shared<Task244>(I338, Gamma105_(), t2);
  ...
  auto task246 = make_shared<Task246>(I341, Gamma6_(), v2_);
  ...
  auto task249 = make_shared<Task249>(I344, v2_, t2);
  ...
  auto task255 = make_shared<Task255>(I350, v2_, t2);
  ...
  auto task257 = make_shared<Task257>(I353, v2_, t2);
  ...
  auto task259 = make_shared<Task259>(I356, v2_, t2);
  ...
  auto task261 = make_shared<Task261>(I365, v2_, t2);
  ...
  auto task263 = make_shared<Task263>(I374, v2_, t2);
  ...
  auto task265 = make_shared<Task265>(I377, v2_, t2);
  ...
  if (diagonal) {
    task267 = make_shared<Task267>(v2_, t2);
  ...
  auto task270 = make_shared<Task270>(I384, v2_, t2);
  ...
  auto task272 = make_shared<Task272>(I384, h1_, t2);
  ...
  auto task274 = make_shared<Task274>(I390, v2_, t2);
  task273->add_dep(task274);
  energyq->add_task(task274);

  auto task275 = make_shared<Task275>(I390, h1_, t2);
  ...
  auto task277 = make_shared<Task277>(I393, Gamma7_(), t2);
  task276->add_dep(task277);
  energyq->add_task(task277);
