...
shared_ptr<Queue> MSCASPT2::MSCASPT2::make_deci4q(const bool reset, const bool diagonal) {
  ...
  if (diagonal) {
    ...
    task564 = make_shared<Task564>(tensor564, cindex);
  ...
  if (diagonal) {
    ...
    task565 = make_shared<Task565>(tensor565, cindex);
  ...
  if (diagonal) {
    ...
    task566 = make_shared<Task566>(tensor566, cindex);
  ...
  if (diagonal) {
    ...
    task567 = make_shared<Task567>(tensor567, cindex);
