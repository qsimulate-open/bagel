...
shared_ptr<Queue> CASPT2::CASPT2::contract_rdm_deriv(shared_ptr<const CIWfn> ciwfn, shared_ptr<VectorB> bdata, int offset, int size, const bool reset, const bool diagonal) {
  ...
  auto tensor915 = vector<shared_ptr<Tensor>>{I900, rdm2deriv_, den3cit, I903, deci};
  ...
  auto tensor918 = vector<shared_ptr<Tensor>>{I901, rdm3fderiv_, den4cit, deci};
