...
shared_ptr<Queue> CASPT2::CASPT2::make_deciq(const bool reset, const bool diagonal) {
  ...
  auto task526 = make_shared<Task526>(tensor526, cindex, this->e0_);
  ...
  auto task603 = make_shared<Task603>(tensor603, cindex, this->e0_);
  ...
  auto task627 = make_shared<Task627>(tensor627, cindex, this->e0_);
  ...
  auto task655 = make_shared<Task655>(tensor655, cindex, this->e0_);
  ...
  auto task709 = make_shared<Task709>(tensor709, cindex, this->e0_);
  ...
  auto task735 = make_shared<Task735>(tensor735, cindex, this->e0_);
  ...
  auto task753 = make_shared<Task753>(tensor753, cindex, this->e0_);
  ...
  if (diagonal) {
    ...
    task762 = make_shared<Task762>(tensor762, cindex);
  ...
  if (diagonal) {
    ...
    task763 = make_shared<Task763>(tensor763, cindex);
  ...
  if (diagonal) {
    ...
    task764 = make_shared<Task764>(tensor764, cindex);
  ...
  if (diagonal) {
    ...
    task765 = make_shared<Task765>(tensor765, cindex);
  ...
  if (diagonal) {
    ...
    task766 = make_shared<Task766>(tensor766, cindex);
  ...
  if (diagonal) {
    ...
    task767 = make_shared<Task767>(tensor767, cindex);
  ...
  if (diagonal) {
    ...
    task768 = make_shared<Task768>(tensor768, cindex);
  ...
  if (diagonal) {
    ...
    task769 = make_shared<Task769>(tensor769, cindex);
  ...
  if (diagonal) {
    ...
    task770 = make_shared<Task770>(tensor770, cindex);
  ...
  if (diagonal) {
    ...
    task771 = make_shared<Task771>(tensor771, cindex);
  ...
  if (diagonal) {
    ...
    task772 = make_shared<Task772>(tensor772, cindex, this->e0_);
  ...
  if (diagonal) {
    ...
    task773 = make_shared<Task773>(tensor773, cindex);
  ...
  if (diagonal) {
    ...
    task774 = make_shared<Task774>(tensor774, cindex);
  ...
  if (diagonal) {
    ...
    task775 = make_shared<Task775>(tensor775, cindex);
  ...
  if (diagonal) {
    ...
    task781 = make_shared<Task781>(tensor781, cindex);
  ...
  if (diagonal) {
    ...
    task782 = make_shared<Task782>(tensor782, cindex, this->e0_);
  ...
  if (diagonal) {
    ...
    task787 = make_shared<Task787>(tensor787, cindex);
  ...
  if (diagonal) {
    ...
    task788 = make_shared<Task788>(tensor788, cindex);
