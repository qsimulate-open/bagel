...
#ifndef __SRC_SMITH_SPCASPT2_TASKS6_H
#define __SRC_SMITH_SPCASPT2_TASKS6_H
...
class Task260 : public Task {
  ...
  public:
    Task260(std::vector<std::shared_ptr<Tensor>> t, const bool reset);
    ~Task260() {}
};
