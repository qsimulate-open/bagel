...
class Task636 : public Task {
  ...
  public:
    Task636(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task636() {}
};
...
class Task637 : public Task {
  ...
  public:
    Task637(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task637() {}
};
