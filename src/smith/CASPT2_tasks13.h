...
class Task610 : public AccTask {
  ...
  public:
    Task610(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task610() {}
};
...
class Task618 : public AccTask {
  ...
  public:
    Task618(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task618() {}
};
