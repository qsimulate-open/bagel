  ...
  for (int ist = 0; ist != t->nref(); ++ist) {
    ...
    for (int jst = 0; jst != t->nref(); ++jst) {
      ...
      { // AAXX
        ...
        (*tjst)("x0,a1,x2,a3") -= i0("o4,a1,a3") * 0.5 * (*s)("o4,x0,x2").conj();
      }
      { // AACX
        ...
        (*tjst)("x0,a1,c2,a3") -=  i0("o4,a1,a3,c2") * (*s)("o4,x0").conj();
      }
      { // AXCC
        ...
        (*tjst)("c0,a1,c2,x3") -= i0("o4,a1,c0,c2") * (*s)("o4,x3").conj();
      }
      { // XXCC
        ...
        (*tjst)("c0,x1,c2,x3") -= i0("o4,c0,c2") * (*s)("o4,x1,x3").conj();
      }
      { // XXCX
        ...
        (*tjst)("x0,x1,c2,x3") -= i0("o4,c2") * (*s)("o4,x0,x1,x3").conj();
      }
      { // AXXX
        ...
        (*tjst)("x0,a1,x2,x3") -= i0("o4,a1") * (*s)("o4,x0,x2,x3").conj();
      }
      { // XXCA
        ...
        if (is_same<DataType,double>::value) {
          ...
          foreach_inplace(i0, lambda);
          (*tjst)("c0,a1,x2,x3") -= i0("o4,a1,c0") * (*s)("o4,x2,x3").conj();
        }
      }
    } // jst loop
  } // ist loop
