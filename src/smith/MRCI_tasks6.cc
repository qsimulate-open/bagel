...
void Task254::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, x0, x2, x1") += (*ta1_)("x5, x4, x0, x3, x2, x1") * (*ta2_)("x5, x4, c3, x3");
}
...
void Task272::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c4, x0") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("x3, x2, c4, x1") * (-2);
}
...
void Task275::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c4, x2, x1") += (*ta1_)("c1, c4, x2, x1") * (-1)
...
void Task294::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c3, c4, x2, x1") += (*ta1_)("c3, c4, x2, x1") * (-1)
     + (*ta1_)("x2, x1, c3, c4") * (-1);
}
...
void Task295::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, c4, x0, x3") += (*ta1_)("x1, x3, x0, x2") * (*ta2_)("c3, x2, x1, c4") * (-1);
}
...
void Task296::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, c4, x0, x3") += (*ta1_)("x2, x3, x0, x1") * (*ta2_)("x2, c4, c3, x1");
}
...
void Task299::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("a4, a2, x2, x1") += (*ta1_)("a4, a2, x2, x1")
