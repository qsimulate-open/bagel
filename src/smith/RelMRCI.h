...
class RelMRCI : public SpinFreeMethod<std::complex<double>> {
  protected:
    ...
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma414_();
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma415_();
    ...
    std::shared_ptr<FutureTATensor<std::complex<double>,2>> Gamma416_();
    std::shared_ptr<FutureTATensor<std::complex<double>,2>> Gamma418_();
    ...
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma420_();
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma421_();
    ...
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma422_();
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma423_();
    ...
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma391_();
    std::shared_ptr<FutureTATensor<std::complex<double>,2>> Gamma428_();
    std::shared_ptr<FutureTATensor<std::complex<double>,2>> Gamma430_();
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma396_();
    std::shared_ptr<FutureTATensor<std::complex<double>,8>> Gamma397_();
    std::shared_ptr<FutureTATensor<std::complex<double>,6>> Gamma409_();
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma412_();
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma413_();
    std::shared_ptr<FutureTATensor<std::complex<double>,0>> Gamma424_();
    std::shared_ptr<FutureTATensor<std::complex<double>,0>> Gamma426_();
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma432_();
    std::shared_ptr<FutureTATensor<std::complex<double>,4>> Gamma433_();
