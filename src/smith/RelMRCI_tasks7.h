...
class Task302 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task302(std::shared_ptr<TATensor<std::complex<double>,4>> I67, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> h1)
...
class Task310 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task310(std::shared_ptr<TATensor<std::complex<double>,4>> I67, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I67), ta1_(t2), ta2_(v2) { }
};
...
class Task315 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task315(std::shared_ptr<TATensor<std::complex<double>,4>> I73, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> h1)
   : ta0_(I73), ta1_(t2), ta2_(h1) { }
};
...
class Task317 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task317(std::shared_ptr<TATensor<std::complex<double>,4>> I73, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task323 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task323(std::shared_ptr<TATensor<std::complex<double>,4>> I73, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I73), ta1_(t2), ta2_(v2) { }
};
...
class Task329 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task329(std::shared_ptr<TATensor<std::complex<double>,4>> I73, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I73), ta1_(t2), ta2_(v2) { }
};
...
class Task334 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task334(std::shared_ptr<TATensor<std::complex<double>,2>> I82, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> h1)
...
class Task338 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task338(std::shared_ptr<TATensor<std::complex<double>,2>> I82, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I82), ta1_(t2), ta2_(v2) { }
};
