...
void Task300::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("x5, a2, c3, x4") * (*ta2_)("c1, x5, x0, x4");
}
...
void Task301::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c1, x5, x0, x4") += (*ta1_)("x5, x3, x0, x4, x2, x1") * (*ta2_)("c1, x3, x2, x1") * 0.5;
}
...
void Task302::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c1, x5, x0, x4") += (*ta1_)("x5, x1, x0, x4, x3, x2") * (*ta2_)("x3, x2, c1, x1") * 0.5;
}

void Task303::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("x5, a2, c1, x4") * (*ta2_)("c3, x5, x4, x0");
}
...
void Task306::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c3, x1, c1, c4") * (*ta2_)("a2, c4, x0, x1");
}
...
void Task307::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a2, c4, x0, x1") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("x3, a2, c4, x2");
}

void Task308::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("x3, a2, c4, x2") += (*ta1_)("x3, a2, c4, x2")
     + (*ta1_)("c4, a2, x3, x2") * (-2);
}
...
void Task309::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("a4, x1, c1, a2") * (*ta2_)("a4, c3, x1, x0");
}
...
void Task310::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c3, x1, x0") += (*ta1_)("x3, x1, x0, x2") * (*ta2_)("x3, a4, c3, x2") * (-2);
}
...
void Task311::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c3, x1, x0") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c3, a4, x3, x2") * 2;
}

void Task312::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c1, x1, c3, c4") * (*ta2_)("a2, c4, x1, x0");
}
...
void Task313::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a2, c4, x1, x0") += (*ta1_)("x3, x1, x0, x2") * (*ta2_)("x3, a2, c4, x2") * (-1);
}
...
void Task314::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a2, c4, x1, x0") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c4, a2, x3, x2");
}

void Task315::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c1, x1, a4, a2") * (*ta2_)("a4, c3, x1, x0");
}
...
void Task316::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c3, x1, x0") += (*ta1_)("x3, x1, x0, x2") * (*ta2_)("x3, a4, c3, x2");
}
...
void Task317::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c3, x1, x0") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c3, a4, x3, x2") * (-1);
}

void Task318::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("a4, x1, c3, a2") * (*ta2_)("a4, c1, x1, x0");
}
...
void Task319::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c1, x1, x0") += (*ta1_)("x3, x1, x0, x2") * (*ta2_)("x3, a4, c1, x2");
}
...
void Task320::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c1, x1, x0") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c1, a4, x3, x2") * (-1);
}

void Task321::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c3, x1, a4, a2") * (*ta2_)("a4, c1, x0, x1");
}
...
void Task322::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("a4, c1, x0, x1") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("x3, a4, c1, x2");
}

void Task323::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("x3, a4, c1, x2") += (*ta1_)("x3, a4, c1, x2") * (-1)
     + (*ta1_)("c1, a4, x3, x2") * 2;
}
...
void Task328::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, x5, x4, x0") += (*ta1_)("x5, x4, x0, x3, x2, x1") * (*ta2_)("c3, x3, x2, x1");
}
...
void Task329::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, x5, x4, x0") += (*ta1_)("x5, x4, x3, x2, x0, x1") * (*ta2_)("x3, x2, c3, x1");
}
...
void Task337::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, a4, x3, x0") += (*ta1_)("x3, x1, x0, x2") * (*ta2_)("c3, x2, a4, x1") * (-2);
}
