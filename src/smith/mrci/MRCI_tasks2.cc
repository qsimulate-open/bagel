...
void Task50::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x1, x5, x2, x4, x3, x0);
  {
    if (x2 == x5 && x1 == x4) {
...
void Task51::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x1, x5, x4, x0, x3, x2);
  {
    if (x3 == x6 && x1 == x5) {
...
void Task52::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x1, x5, x4, x3, x2, x0);
  {
    if (x2 == x6 && x1 == x5) {
...
void Task53::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x1, x5, x4, x0, x3, x2);
  {
    if (x1 == x5) {
...
void Task54::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x1, x5, x4, x3, x2, x0);
  {
    if (x2 == x5 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x4, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task55::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x4, x5, x3, x2, x1, x0);
  {
    if (x1 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x4, x0, x3, x2);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task57::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x0, x2, x4, x1, x3);
  {
    if (x2 == x4 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
...
void Task58::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x0, x3, x4, x1, x2);
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x0, x3, x2);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
...
void Task59::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x3, x1, x4, x2, x0);
  {
    if (x2 == x4 && x1 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task60::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x2, x1, x4, x3, x0);
  {
    if (x1 == x4) {
...
void Task62::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x4, x3, x0, x1, x2);
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x2, x3, x0);
      for (int i2 = 0; i2 != x2.size(); ++i2) {
...
void Task63::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x6, x5, x1, x4, x3, x2);
  {
    if (x3 == x4 && x1 == x2) {
...
void Task64::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x6, x5, x4, x3, x1, x2);
  {
    if (x1 == x5) {
...
void Task66::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x0, x4, x2, x1, x3);
  {
    if (x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x4, x3);
      for (int i3 = 0; i3 != x3.size(); ++i3) {
...
void Task69::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x1, x6);
  // associated with merged
...
void Task70::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x1, x0);
  // associated with merged
  std::unique_ptr<double[]> fdata = in(4)->get_block(x5, x4, x3, x2);
  if (x7 == x4 && x1 == x6) {
    std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x0, x3, x2);
...
void Task71::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x4, x5, x3, x2, x1, x0);
  {
    if (x3 == x6 && x1 == x5) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x7, x2, x4, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task72::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x2, x3, x4, x1, x0);
  {
    if (x1 == x4) {
      std::unique_ptr<double[]> i0data = in(1)->get_block(x5, x2, x3, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task73::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x4, x6, x5, x3, x2, x1, x0);
  {
    if (x3 == x4 && x1 == x2) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x7, x0, x6, x5);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task74::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x2, x6, x5, x4, x3, x1, x0);
  {
    if (x1 == x5) {
...
void Task75::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x3, x4, x2, x1, x0);
  {
    if (x1 == x2) {
...
void Task80::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x3, x5, x4, x0, x2, x1);
  {
    if (x3 == x6 && x2 == x5) {
...
void Task81::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x4, x5, x3, x0, x2, x1);
  {
    if (x2 == x5) {
...
void Task82::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x5, x6, x4, x3, x2, x1);
  {
    if (x2 == x6) {
...
void Task83::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x3, x6, x5, x4, x2, x1);
  {
    if (x3 == x6 && x2 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x7, x0, x5, x1);
      for (int i1 = 0; i1 != x1.size(); ++i1) {
...
void Task84::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x5, x0, x4, x3, x2, x1);
  {
    if (x2 == x6) {
...
void Task85::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x6, x5, x4, x3, x0, x2, x1);
  {
    if (x3 == x6 && x2 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x7, x0, x5, x1);
      for (int i1 = 0; i1 != x1.size(); ++i1) {
...
void Task87::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x4, x6, x5, x3, x0, x2, x1);
  {
    if (x3 == x5 && x2 == x4) {
...
void Task88::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x3, x6, x5, x4, x0, x2, x1);
  {
    if (x2 == x5) {
...
void Task89::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x3, x4, x0, x2, x1);
  {
    if (x2 == x3) {
...
void Task90::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x7, x0, x6, x3, x5, x4, x2, x1);
  {
    if (x2 == x3) {
...
void Task92::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x9, x0, x8, x7, x2, x1);
  // associated with merged
...
void Task93::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x5, x1, x4, x3, x2, x0);
  {
    if (x2 == x3) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x1, x4, x0);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
...
void Task97::Task_local::compute() {
  ...
  const Index x3 = b(4);
  const Index x4 = b(5);
  // tensor label: Gamma561
  std::unique_ptr<double[]> odata = out()->move_block(x5, x0);
  // associated with merged
...
void Task98::Task_local::compute() {
  ...
  const Index x0 = b(4);
  const Index x5 = b(5);
  // tensor label: Gamma529
  std::unique_ptr<double[]> odata = out()->move_block(x5, x0, x2, x4, x3, x1);
  {
    if (x2 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x3, x1);
      for (int i1 = 0; i1 != x1.size(); ++i1) {
...
void Task99::Task_local::compute() {
  ...
  const Index x4 = b(4);
  const Index x5 = b(5);
  // tensor label: Gamma530
  std::unique_ptr<double[]> odata = out()->move_block(x5, x4, x3, x1, x2, x0);
  {
    if (x2 == x4) {
      std::unique_ptr<double[]> i0data = in(0)->get_block(x5, x0, x3, x1);
      for (int i0 = 0; i0 != x0.size(); ++i0) {
