...
shared_ptr<Queue> CASA::CASA::make_residualq(const bool reset, const bool diagonal) {
  ...
  auto tensor62 = vector<shared_ptr<Tensor>>{r, I27};
  ...
  auto tensor63 = vector<shared_ptr<Tensor>>{I27, f1_, I28};
  ...
  auto tensor66 = vector<shared_ptr<Tensor>>{I27, f1_, I34};
  auto task66 = make_shared<Task66>(tensor66, pindex);
  task62->add_dep(task66);
  ...
  auto tensor72 = vector<shared_ptr<Tensor>>{I27, f1_, I43};
  auto task72 = make_shared<Task72>(tensor72, pindex);
  task62->add_dep(task72);
  ...
  auto tensor75 = vector<shared_ptr<Tensor>>{I27, f1_, I52};
  auto task75 = make_shared<Task75>(tensor75, pindex);
  task62->add_dep(task75);
  task75->add_dep(task40);
  residualq->add_task(task75);

  auto tensor76 = vector<shared_ptr<Tensor>>{I52, Gamma15_(), t2};
  ...
  auto tensor79 = vector<shared_ptr<Tensor>>{I27, t2, I58};
  auto task79 = make_shared<Task79>(tensor79, pindex);
  task62->add_dep(task79);
  task79->add_dep(task40);
  residualq->add_task(task79);

  auto tensor80 = vector<shared_ptr<Tensor>>{I58, Gamma9_(), f1_};
  ...
  auto tensor81 = vector<shared_ptr<Tensor>>{I27, t2, I61};
  auto task81 = make_shared<Task81>(tensor81, pindex);
  task62->add_dep(task81);
  task81->add_dep(task40);
  residualq->add_task(task81);

  auto tensor82 = vector<shared_ptr<Tensor>>{I61, Gamma9_(), f1_};
  ...
  auto tensor85 = vector<shared_ptr<Tensor>>{I27, f1_, I67};
  auto task85 = make_shared<Task85>(tensor85, pindex);
  task62->add_dep(task85);
  ...
  auto tensor92 = vector<shared_ptr<Tensor>>{r, I72};
  ...
  auto tensor98 = vector<shared_ptr<Tensor>>{I72, Gamma5_(), I82};
  auto task98 = make_shared<Task98>(tensor98, pindex);
  task92->add_dep(task98);
  task98->add_dep(task40);
  residualq->add_task(task98);

  auto tensor99 = vector<shared_ptr<Tensor>>{I82, f1_, t2};
  ...
  auto tensor102 = vector<shared_ptr<Tensor>>{I72, Gamma29_(), I88};
  auto task102 = make_shared<Task102>(tensor102, pindex);
  task92->add_dep(task102);
  ...
  auto tensor105 = vector<shared_ptr<Tensor>>{I72, Gamma25_(), I94};
  auto task105 = make_shared<Task105>(tensor105, pindex);
  task92->add_dep(task105);
  task105->add_dep(task40);
  residualq->add_task(task105);

  auto tensor106 = vector<shared_ptr<Tensor>>{I94, f1_, t2};
  ...
  auto tensor118 = vector<shared_ptr<Tensor>>{r, I108};
  ...
  auto tensor119 = vector<shared_ptr<Tensor>>{I108, f1_, I109};
  ...
  auto tensor120 = vector<shared_ptr<Tensor>>{I109, Gamma25_(), I110};
  ...
  auto tensor122 = vector<shared_ptr<Tensor>>{I108, Gamma5_(), I115};
  ...
  auto tensor125 = vector<shared_ptr<Tensor>>{I108, f1_, I121};
  auto task125 = make_shared<Task125>(tensor125, pindex);
  task118->add_dep(task125);
  task125->add_dep(task40);
  residualq->add_task(task125);

  auto tensor126 = vector<shared_ptr<Tensor>>{I121, Gamma40_(), t2};
  ...
  auto tensor127 = vector<shared_ptr<Tensor>>{I108, Gamma29_(), I124};
  auto task127 = make_shared<Task127>(tensor127, pindex);
  task118->add_dep(task127);
  ...
  auto tensor130 = vector<shared_ptr<Tensor>>{I108, Gamma25_(), I130};
  auto task130 = make_shared<Task130>(tensor130, pindex);
  task118->add_dep(task130);
  ...
  auto tensor133 = vector<shared_ptr<Tensor>>{I108, f1_, I136};
  auto task133 = make_shared<Task133>(tensor133, pindex);
  task118->add_dep(task133);
  task133->add_dep(task40);
  residualq->add_task(task133);

  auto tensor134 = vector<shared_ptr<Tensor>>{I136, Gamma3_(), t2};
  ...
  auto tensor135 = vector<shared_ptr<Tensor>>{I108, f1_, I139};
  auto task135 = make_shared<Task135>(tensor135, pindex);
  task118->add_dep(task135);
  ...
  auto tensor142 = vector<shared_ptr<Tensor>>{r, I144};
  ...
  auto tensor147 = vector<shared_ptr<Tensor>>{I144, Gamma50_(), I151};
  ...
  auto tensor150 = vector<shared_ptr<Tensor>>{I144, Gamma52_(), I157};
  auto task150 = make_shared<Task150>(tensor150, pindex);
  task142->add_dep(task150);
  task150->add_dep(task40);
  residualq->add_task(task150);

  auto tensor151 = vector<shared_ptr<Tensor>>{I157, f1_, t2};
  ...
  auto tensor156 = vector<shared_ptr<Tensor>>{r, I162};
  ...
  shared_ptr<Task157> task157;
  if (diagonal) {
    auto tensor157 = vector<shared_ptr<Tensor>>{I162, f1_, I163};
    task157 = make_shared<Task157>(tensor157, pindex);
  ...
  if (diagonal) {
    auto tensor158 = vector<shared_ptr<Tensor>>{I163, t2};
  ...
  auto tensor163 = vector<shared_ptr<Tensor>>{I162, f1_, I173};
  ...
  auto tensor166 = vector<shared_ptr<Tensor>>{I162, f1_, I176};
  auto task166 = make_shared<Task166>(tensor166, pindex);
  task156->add_dep(task166);
  ...
  auto tensor169 = vector<shared_ptr<Tensor>>{I162, t2, I185};
  auto task169 = make_shared<Task169>(tensor169, pindex);
  task156->add_dep(task169);
  task169->add_dep(task40);
  residualq->add_task(task169);

  auto tensor170 = vector<shared_ptr<Tensor>>{I185, Gamma9_(), f1_};
  ...
  auto tensor171 = vector<shared_ptr<Tensor>>{I162, t2, I188};
  auto task171 = make_shared<Task171>(tensor171, pindex);
  task156->add_dep(task171);
  task171->add_dep(task40);
  residualq->add_task(task171);

  auto tensor172 = vector<shared_ptr<Tensor>>{I188, Gamma9_(), f1_};
  ...
  shared_ptr<Task173> task173;
  if (diagonal) {
    auto tensor173 = vector<shared_ptr<Tensor>>{I162, f1_, I191};
    task173 = make_shared<Task173>(tensor173, pindex);
    task156->add_dep(task173);
    task173->add_dep(task40);
    residualq->add_task(task173);
  }

  shared_ptr<Task174> task174;
  if (diagonal) {
    auto tensor174 = vector<shared_ptr<Tensor>>{I191, t2};
    task174 = make_shared<Task174>(tensor174, pindex);
  ...
  auto tensor175 = vector<shared_ptr<Tensor>>{r, I194};
  ...
  auto tensor176 = vector<shared_ptr<Tensor>>{I194, f1_, I195};
  ...
  auto tensor179 = vector<shared_ptr<Tensor>>{I194, t2, I201};
  auto task179 = make_shared<Task179>(tensor179, pindex);
  task175->add_dep(task179);
  task179->add_dep(task40);
  residualq->add_task(task179);

  auto tensor180 = vector<shared_ptr<Tensor>>{I201, Gamma29_(), f1_};
  ...
  auto tensor181 = vector<shared_ptr<Tensor>>{I194, t2, I204};
  auto task181 = make_shared<Task181>(tensor181, pindex);
  task175->add_dep(task181);
  task181->add_dep(task40);
  residualq->add_task(task181);

  auto tensor182 = vector<shared_ptr<Tensor>>{I204, Gamma29_(), f1_};
  ...
  auto tensor183 = vector<shared_ptr<Tensor>>{I194, f1_, I207};
  auto task183 = make_shared<Task183>(tensor183, pindex);
  task175->add_dep(task183);
  task183->add_dep(task40);
  residualq->add_task(task183);

  auto tensor184 = vector<shared_ptr<Tensor>>{I207, Gamma50_(), t2};
  ...
  auto tensor185 = vector<shared_ptr<Tensor>>{I194, f1_, I210};
  auto task185 = make_shared<Task185>(tensor185, pindex);
  task175->add_dep(task185);
  task185->add_dep(task40);
  residualq->add_task(task185);

  auto tensor186 = vector<shared_ptr<Tensor>>{I210, Gamma50_(), t2};
  ...
  auto tensor187 = vector<shared_ptr<Tensor>>{I194, f1_, I213};
  auto task187 = make_shared<Task187>(tensor187, pindex);
  task175->add_dep(task187);
  task187->add_dep(task40);
  residualq->add_task(task187);

  auto tensor188 = vector<shared_ptr<Tensor>>{I213, Gamma50_(), t2};
  ...
  auto tensor189 = vector<shared_ptr<Tensor>>{I194, f1_, I216};
  auto task189 = make_shared<Task189>(tensor189, pindex);
  task175->add_dep(task189);
  ...
  auto tensor195 = vector<shared_ptr<Tensor>>{I194, f1_, I228};
  auto task195 = make_shared<Task195>(tensor195, pindex);
  task175->add_dep(task195);
  ...
  auto tensor198 = vector<shared_ptr<Tensor>>{I194, f1_, I234};
  auto task198 = make_shared<Task198>(tensor198, pindex);
  task175->add_dep(task198);
  ...
  auto tensor205 = vector<shared_ptr<Tensor>>{r, I239};
  ...
  auto tensor210 = vector<shared_ptr<Tensor>>{I239, f1_, I246};
  auto task210 = make_shared<Task210>(tensor210, pindex);
  task205->add_dep(task210);
  task210->add_dep(task40);
  residualq->add_task(task210);

  auto tensor211 = vector<shared_ptr<Tensor>>{I246, Gamma50_(), t2};
