...
shared_ptr<Queue> RelCASPT2::RelCASPT2::make_residualq(const bool reset, const bool diagonal) {
  ...
  auto task104 = make_shared<Task104>(I100, t2, f1_);
  ...
  auto task105 = make_shared<Task105>(I80, f1_, I106);
  task85->add_dep(task105);
  task105->add_dep(task31);
  residualq->add_task(task105);

  auto task106 = make_shared<Task106>(I106, Gamma37_(), t2);
  ...
  auto task107 = make_shared<Task107>(I80, Gamma38_(), I109);
  task85->add_dep(task107);
  task107->add_dep(task31);
  residualq->add_task(task107);

  auto task108 = make_shared<Task108>(I109, h1_);
  ...
  auto task111 = make_shared<Task111>(r, I120);
  ...
  auto task112 = make_shared<Task112>(I120, f1_, I121);
  task111->add_dep(task112);
  task112->add_dep(task31);
  residualq->add_task(task112);

  auto task113 = make_shared<Task113>(I121, Gamma6_(), t2);
  ...
  auto task114 = make_shared<Task114>(I120, Gamma7_(), I124);
  task111->add_dep(task114);
  task114->add_dep(task31);
  residualq->add_task(task114);

  auto task115 = make_shared<Task115>(I124, v2_);
  ...
  auto task118 = make_shared<Task118>(I120, Gamma34_(), I130);
  task111->add_dep(task118);
  task118->add_dep(task31);
  residualq->add_task(task118);

  auto task119 = make_shared<Task119>(I130, t2);
  ...
  auto task120 = make_shared<Task120>(I120, Gamma35_(), I132);
  task111->add_dep(task120);
  task120->add_dep(task31);
  residualq->add_task(task120);

  auto task121 = make_shared<Task121>(I132, t2, v2_, this->e0_);
  ...
  auto task128 = make_shared<Task128>(I120, f1_, I146);
  task111->add_dep(task128);
  task128->add_dep(task31);
  residualq->add_task(task128);

  auto task129 = make_shared<Task129>(I146, Gamma51_(), t2);
  ...
  auto task130 = make_shared<Task130>(I120, Gamma38_(), I149);
  task111->add_dep(task130);
  task130->add_dep(task31);
  residualq->add_task(task130);

  auto task131 = make_shared<Task131>(I149, h1_);
  ...
  auto task134 = make_shared<Task134>(r, I160);
  ...
  auto task135 = make_shared<Task135>(I160, Gamma56_(), I161);
  task134->add_dep(task135);
  task135->add_dep(task31);
  residualq->add_task(task135);

  auto task136 = make_shared<Task136>(I161, t2, f1_);
  ...
  auto task141 = make_shared<Task141>(I160, Gamma59_(), I169);
  task134->add_dep(task141);
  task141->add_dep(task31);
  residualq->add_task(task141);

  auto task142 = make_shared<Task142>(I169, t2, v2_, this->e0_);
  ...
  auto task145 = make_shared<Task145>(I160, Gamma60_(), I172);
  task134->add_dep(task145);
  task145->add_dep(task31);
  residualq->add_task(task145);

  auto task146 = make_shared<Task146>(I172, h1_);
  ...
  auto task149 = make_shared<Task149>(r, I180);
  ...
  auto task150 = make_shared<Task150>(I180, t2, I181);
  task149->add_dep(task150);
  task150->add_dep(task31);
  residualq->add_task(task150);

  auto task151 = make_shared<Task151>(I181, Gamma16_(), f1_);
  ...
  auto task152 = make_shared<Task152>(I180, t2, I184);
  task149->add_dep(task152);
  task152->add_dep(task31);
  residualq->add_task(task152);

  auto task153 = make_shared<Task153>(I184, Gamma16_(), f1_);
  ...
  auto task154 = make_shared<Task154>(I180, f1_, I187);
  ...
  auto task155 = make_shared<Task155>(I187, Gamma38_(), I188);
  task154->add_dep(task155);
  task155->add_dep(task31);
  residualq->add_task(task155);

  auto task156 = make_shared<Task156>(I188, t2);
  ...
  auto task157 = make_shared<Task157>(I180, f1_, I190);
  ...
  auto task158 = make_shared<Task158>(I190, Gamma38_(), I191);
  task157->add_dep(task158);
  task158->add_dep(task31);
  residualq->add_task(task158);

  auto task159 = make_shared<Task159>(I191, t2);
  ...
  if (diagonal) {
    task160 = make_shared<Task160>(I180, t2, f1_);
  ...
  auto task164 = make_shared<Task164>(I180, t2, I211);
  task149->add_dep(task164);
  task164->add_dep(task31);
  residualq->add_task(task164);

  auto task165 = make_shared<Task165>(I211, Gamma38_(), f1_);
  ...
  auto task166 = make_shared<Task166>(I180, t2, I214);
  task149->add_dep(task166);
  task166->add_dep(task31);
  residualq->add_task(task166);

  auto task167 = make_shared<Task167>(I214, Gamma38_(), f1_);
  ...
  auto task168 = make_shared<Task168>(r, I198);
  task168->add_dep(task31);
  residualq->add_task(task168);

  shared_ptr<Task169> task169;
  if (diagonal) {
    task169 = make_shared<Task169>(I198, t2, v2_, this->e0_);
  ...
  auto task170 = make_shared<Task170>(I198, Gamma69_(), I199);
  task168->add_dep(task170);
  task170->add_dep(task31);
  residualq->add_task(task170);

  auto task171 = make_shared<Task171>(I199, t2);
  ...
  auto task172 = make_shared<Task172>(r, I216);
  ...
  auto task173 = make_shared<Task173>(I216, f1_, I217);
  ...
  auto task174 = make_shared<Task174>(I217, Gamma35_(), I218);
  task173->add_dep(task174);
  task174->add_dep(task31);
  residualq->add_task(task174);

  auto task175 = make_shared<Task175>(I218, t2);
  ...
  auto task176 = make_shared<Task176>(I216, f1_, I220);
  task172->add_dep(task176);
  task176->add_dep(task31);
  residualq->add_task(task176);

  auto task177 = make_shared<Task177>(I220, Gamma32_(), t2);
  task176->add_dep(task177);
  task177->add_dep(task31);
  residualq->add_task(task177);

  auto task178 = make_shared<Task178>(I220, Gamma35_(), t2);
  ...
  auto task179 = make_shared<Task179>(I216, f1_, I229);
  task172->add_dep(task179);
  task179->add_dep(task31);
  residualq->add_task(task179);

  auto task180 = make_shared<Task180>(I229, Gamma60_(), t2);
  ...
  auto task181 = make_shared<Task181>(I216, f1_, I232);
  task172->add_dep(task181);
  task181->add_dep(task31);
  residualq->add_task(task181);

  auto task182 = make_shared<Task182>(I232, Gamma60_(), t2);
  ...
  auto task183 = make_shared<Task183>(I216, t2, I235);
  task172->add_dep(task183);
  task183->add_dep(task31);
  residualq->add_task(task183);

  auto task184 = make_shared<Task184>(I235, Gamma38_(), f1_);
  ...
  auto task185 = make_shared<Task185>(I216, t2, I238);
  task172->add_dep(task185);
  task185->add_dep(task31);
  residualq->add_task(task185);

  auto task186 = make_shared<Task186>(I238, Gamma38_(), f1_);
  ...
  auto task187 = make_shared<Task187>(I216, Gamma81_(), I241);
  task172->add_dep(task187);
  task187->add_dep(task31);
  residualq->add_task(task187);

  auto task188 = make_shared<Task188>(I241, t2);
  ...
  auto task189 = make_shared<Task189>(I216, Gamma38_(), I245);
  task172->add_dep(task189);
  task189->add_dep(task31);
  residualq->add_task(task189);

  auto task190 = make_shared<Task190>(I245, t2, v2_, this->e0_);
  task189->add_dep(task190);
  task190->add_dep(task31);
  residualq->add_task(task190);

  auto task191 = make_shared<Task191>(I245, t2, f1_);
  ...
  auto task197 = make_shared<Task197>(I216, f1_, I263);
  task172->add_dep(task197);
  task197->add_dep(task31);
  residualq->add_task(task197);

  auto task198 = make_shared<Task198>(I263, Gamma60_(), t2);
  ...
  auto task199 = make_shared<Task199>(r, I265);
  ...
  auto task200 = make_shared<Task200>(I265, f1_, I266);
  task199->add_dep(task200);
  task200->add_dep(task31);
  residualq->add_task(task200);

  auto task201 = make_shared<Task201>(I266, Gamma59_(), t2);
  ...
  auto task202 = make_shared<Task202>(I265, Gamma60_(), I269);
  task199->add_dep(task202);
  task202->add_dep(task31);
  residualq->add_task(task202);

  auto task203 = make_shared<Task203>(I269, t2, f1_);
  ...
  auto task205 = make_shared<Task205>(r, I271);
  task205->add_dep(task31);
  residualq->add_task(task205);

  auto task206 = make_shared<Task206>(I271, Gamma92_(), t2);
  ...
  auto task207 = make_shared<Task207>(I271, Gamma60_(), I301);
  task205->add_dep(task207);
  task207->add_dep(task31);
  residualq->add_task(task207);

  auto task208 = make_shared<Task208>(I301, t2, v2_, this->e0_);
