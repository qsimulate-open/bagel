...
#ifndef __SRC_SMITH_CAS_test_TASKS4_H
#define __SRC_SMITH_CAS_test_TASKS4_H
...
class Task160 : public Task {
  ...
  public:
    Task160(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task160() {}
};
...
class Task162 : public Task {
  ...
  public:
    Task162(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task162() {}
};
