...
#ifndef __SRC_SMITH_RelCASPT2_TASKS6_H
#define __SRC_SMITH_RelCASPT2_TASKS6_H
...
class Task267 : public Task {
  ...
  public:
    Task267(std::vector<std::shared_ptr<Tensor>> t, const bool reset);
    ~Task267() {}
};
