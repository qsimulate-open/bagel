...
class Task9 : public Task {  // associated with gamma
  ...
  public:
    Task9(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task9() {}
};
...
class Task10 : public Task {  // associated with gamma
  ...
  public:
    Task10(std::array<std::shared_ptr<Tensor>,5> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task10() {}
};
...
class Task11 : public Task {  // associated with gamma
  ...
  public:
    Task11(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task11() {}
};
...
class Task13 : public Task {  // associated with gamma
  ...
  public:
    Task13(std::array<std::shared_ptr<Tensor>,4> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task13() {}
};
...
class Task14 : public Task {  // associated with gamma
  ...
  public:
    Task14(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task14() {}
};
...
class Task15 : public Task {  // associated with gamma
  ...
  public:
    Task15(std::array<std::shared_ptr<Tensor>,5> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task15() {}
};
...
class Task16 : public Task {  // associated with gamma
  ...
  public:
    Task16(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task16() {}
};
...
class Task17 : public Task {  // associated with gamma
  ...
  public:
    Task17(std::array<std::shared_ptr<Tensor>,5> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task17() {}
};
...
class Task18 : public Task {  // associated with gamma
  ...
  public:
    Task18(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task18() {}
};
...
class Task20 : public Task {  // associated with gamma
  ...
  public:
    Task20(std::array<std::shared_ptr<Tensor>,2> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task20() {}
};
...
class Task21 : public Task {  // associated with gamma
  ...
  public:
    Task21(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task21() {}
};
...
class Task24 : public Task {  // associated with gamma
  ...
  public:
    Task24(std::array<std::shared_ptr<Tensor>,5> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task24() {}
};
...
class Task25 : public Task {  // associated with gamma
  ...
  public:
    Task25(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task25() {}
};
...
class Task26 : public Task {  // associated with gamma
  ...
  public:
    Task26(std::array<std::shared_ptr<Tensor>,2> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task26() {}
};
...
class Task27 : public Task {  // associated with gamma
  ...
  public:
    Task27(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task27() {}
};
...
class Task28 : public Task {  // associated with gamma
  ...
  public:
    Task28(std::array<std::shared_ptr<Tensor>,3> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task28() {}
};
...
class Task29 : public Task {  // associated with gamma
  ...
  public:
    Task29(std::array<std::shared_ptr<Tensor>,4> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task29() {}
};
...
class Task30 : public Task {
  ...
  public:
    Task30(std::shared_ptr<TATensor<std::complex<double>,4>> t, const bool reset) : tensor_(t), reset_(reset) { }
};
...
class Task31 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task31(std::shared_ptr<TATensor<std::complex<double>,4>> proj, std::shared_ptr<TATensor<std::complex<double>,4>> I0)
   : ta0_(proj), ta1_(I0) { }
};
...
class Task32 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task32(std::shared_ptr<TATensor<std::complex<double>,4>> I0, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma0, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
...
class Task33 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task33(std::shared_ptr<TATensor<std::complex<double>,4>> I0, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma92, std::shared_ptr<TATensor<std::complex<double>,4>> t2, const double e)
...
class Task34 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task34(std::shared_ptr<TATensor<std::complex<double>,4>> proj, std::shared_ptr<TATensor<std::complex<double>,4>> I2)
   : ta0_(proj), ta1_(I2) { }
};
...
class Task35 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task35(std::shared_ptr<TATensor<std::complex<double>,4>> I2, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma92, std::shared_ptr<TATensor<std::complex<double>,4>> I3)
...
class Task36 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task36(std::shared_ptr<TATensor<std::complex<double>,4>> I3, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> f1)
...
class Task37 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task37(std::shared_ptr<TATensor<std::complex<double>,4>> I2, std::shared_ptr<TATensor<std::complex<double>,2>> f1, std::shared_ptr<TATensor<std::complex<double>,4>> I6)
...
class Task38 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task38(std::shared_ptr<TATensor<std::complex<double>,4>> I6, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma2, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
...
class Task39 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task39(std::shared_ptr<TATensor<std::complex<double>,4>> I2, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma3, std::shared_ptr<TATensor<std::complex<double>,4>> I9)
...
class Task40 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task40(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> f1)
...
class Task41 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task41(std::shared_ptr<TATensor<std::complex<double>,4>> proj, std::shared_ptr<TATensor<std::complex<double>,4>> I11)
   : ta0_(proj), ta1_(I11) { }
};
...
class Task42 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task42(std::shared_ptr<TATensor<std::complex<double>,4>> I11, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma4, std::shared_ptr<TATensor<std::complex<double>,4>> I12)
...
class Task43 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task43(std::shared_ptr<TATensor<std::complex<double>,4>> I12, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> f1)
...
class Task44 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task44(std::shared_ptr<TATensor<std::complex<double>,4>> I11, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma5, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
...
class Task45 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task45(std::shared_ptr<TATensor<std::complex<double>,4>> I11, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma6, std::shared_ptr<TATensor<std::complex<double>,4>> I17)
...
class Task46 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task46(std::shared_ptr<TATensor<std::complex<double>,4>> I17, std::shared_ptr<TATensor<std::complex<double>,4>> t2, const double e)
...
class Task47 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task47(std::shared_ptr<TATensor<std::complex<double>,4>> I17, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> f1)
...
class Task48 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task48(std::shared_ptr<TATensor<std::complex<double>,4>> I17, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> f1)
   : ta0_(I17), ta1_(t2), ta2_(f1) { }
};
...
class Task49 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task49(std::shared_ptr<TATensor<std::complex<double>,4>> I11, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma7, std::shared_ptr<TATensor<std::complex<double>,2>> I20)
