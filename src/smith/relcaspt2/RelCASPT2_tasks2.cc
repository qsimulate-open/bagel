...
void Task53::Task_local::compute() {
  ...
  const Index x4 = b(3);
  // tensor label: I26
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(x3, x5, c1, x4)]);
...
void Task85::Task_local::compute() {
  ...
  const Index x3 = b(3);
  // tensor label: I84
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(x2, a1, c2, x3)]);
...
void Task87::Task_local::compute() {
  ...
  const Index x3 = b(3);
  // tensor label: I87
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(x2, c2, a1, x3)]);
...
void Task90::Task_local::compute() {
  ...
  const Index x2 = b(3);
  // tensor label: I92
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(c2, x3, a1, x2)]);
