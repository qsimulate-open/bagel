...
void Task114::Task_local::compute() {
  ...
  const Index x2 = b(3);
  // tensor label: I132
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(c1, x3, a2, x2)]);
...
void Task128::Task_local::compute() {
  ...
  const Index x4 = b(3);
  // tensor label: I161
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(x3, x5, a1, x4)]);
...
void Task130::Task_local::compute() {
  ...
  const Index x4 = b(3);
  // tensor label: I164
  std::unique_ptr<std::complex<double>[]> odata(new std::complex<double>[out()->get_size(x3, a1, x5, x4)]);
