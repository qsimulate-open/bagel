...
class RelCASA : public SpinFreeMethod<std::complex<double>> {
  protected:
    ...
    std::shared_ptr<FutureTensor> Gamma70_();
    std::shared_ptr<FutureTensor> Gamma71_();
    std::shared_ptr<FutureTensor> Gamma7_();
    std::shared_ptr<FutureTensor> Gamma9_();
    std::shared_ptr<FutureTensor> Gamma13_();
    std::shared_ptr<FutureTensor> Gamma72_();
    std::shared_ptr<FutureTensor> Gamma74_();
    std::shared_ptr<FutureTensor> Gamma18_();
    std::shared_ptr<FutureTensor> Gamma20_();
    std::shared_ptr<FutureTensor> Gamma21_();
    std::shared_ptr<FutureTensor> Gamma23_();
