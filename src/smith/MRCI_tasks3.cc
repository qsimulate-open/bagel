...
void Task103::Task_local::compute() {
  ...
  // rdm0 merged case
  if (x0 == x2 && x3 == x6 && x1 == x4 && x5 == x7) {
    for (int i2 = 0; i2 != x2.size(); ++i2) {
      for (int i6 = 0; i6 != x6.size(); ++i6) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i7 = 0; i7 != x7.size(); ++i7) {
            odata[i2+x0.size()*(i7+x7.size()*(i4+x1.size()*(i6)))]  += 2.0 * fdata[i7+x5.size()*(i4+x4.size()*(i6+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x0 == x2 && x3 == x7 && x1 == x4 && x5 == x6) {
    for (int i2 = 0; i2 != x2.size(); ++i2) {
      for (int i7 = 0; i7 != x7.size(); ++i7) {
        for (int i4 = 0; i4 != x4.size(); ++i4) {
          for (int i6 = 0; i6 != x6.size(); ++i6) {
            odata[i2+x0.size()*(i7+x7.size()*(i4+x1.size()*(i6)))]  += -4.0 * fdata[i6+x5.size()*(i4+x4.size()*(i7+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x1 == x6 && x0 == x2 && x5 == x7 && x3 == x4) {
    for (int i6 = 0; i6 != x6.size(); ++i6) {
      for (int i2 = 0; i2 != x2.size(); ++i2) {
        for (int i7 = 0; i7 != x7.size(); ++i7) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            odata[i2+x0.size()*(i7+x7.size()*(i6+x1.size()*(i6)))]  += -4.0 * fdata[i7+x5.size()*(i4+x4.size()*(i4+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x5 == x6 && x3 == x4 && x1 == x7 && x0 == x2) {
    for (int i6 = 0; i6 != x6.size(); ++i6) {
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i7 = 0; i7 != x7.size(); ++i7) {
          for (int i2 = 0; i2 != x2.size(); ++i2) {
            odata[i2+x0.size()*(i7+x7.size()*(i7+x1.size()*(i6)))]  += 2.0 * fdata[i6+x5.size()*(i4+x4.size()*(i4+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x5 == x7 && x3 == x6 && x1 == x2 && x0 == x4) {
    for (int i7 = 0; i7 != x7.size(); ++i7) {
      for (int i6 = 0; i6 != x6.size(); ++i6) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            odata[i4+x0.size()*(i7+x7.size()*(i2+x1.size()*(i6)))]  += -4.0 * fdata[i7+x5.size()*(i4+x4.size()*(i6+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x5 == x6 && x3 == x7 && x1 == x2 && x0 == x4) {
    for (int i6 = 0; i6 != x6.size(); ++i6) {
      for (int i7 = 0; i7 != x7.size(); ++i7) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i4 = 0; i4 != x4.size(); ++i4) {
            odata[i4+x0.size()*(i7+x7.size()*(i2+x1.size()*(i6)))]  += 2.0 * fdata[i6+x5.size()*(i4+x4.size()*(i7+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x5 == x7 && x3 == x4 && x1 == x2 && x0 == x6) {
    for (int i7 = 0; i7 != x7.size(); ++i7) {
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i6 = 0; i6 != x6.size(); ++i6) {
            odata[i6+x0.size()*(i7+x7.size()*(i2+x1.size()*(i6)))]  += 2.0 * fdata[i7+x5.size()*(i4+x4.size()*(i4+x3.size()*(i2)))];
          }
        }
      }
    }
  ...
  if (x5 == x6 && x3 == x4 && x1 == x2 && x0 == x7) {
    for (int i6 = 0; i6 != x6.size(); ++i6) {
      for (int i4 = 0; i4 != x4.size(); ++i4) {
        for (int i2 = 0; i2 != x2.size(); ++i2) {
          for (int i7 = 0; i7 != x7.size(); ++i7) {
            odata[i7+x0.size()*(i7+x7.size()*(i2+x1.size()*(i6)))]  += -4.0 * fdata[i6+x5.size()*(i4+x4.size()*(i4+x3.size()*(i2)))];
          }
        }
      }
    }
...
void Task111::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I1
  std::unique_ptr<double[]> odata = out()->move_block(c1, c3, x0, x1);
  ...
  out()->put_block(odata, c1, c3, x0, x1);
}
...
void Task121::Task_local::compute() {
  ...
  sort_indices<3,0,1,2,1,1,1,1>(odata_sorted, odata, x0.size(), x1.size(), c2.size(), c1.size());
  out()->put_block(odata, c1, x0, x1, c2);
}
...
void Task126::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(c2, x3, x2, c3);
  {
    ...
    sort_indices<0,1,2,3,1,1,-1,1>(i0data, odata, c2.size(), x3.size(), x2.size(), c3.size());
  }
...
void Task128::Task_local::compute() {
  ...
  const Index x4 = b(5);
  // tensor label: I255
  std::unique_ptr<double[]> odata = out()->move_block(x3, c2, x2, c1, x5, x4);
...
void Task129::Task_local::compute() {
  ...
  std::unique_ptr<double[]> odata = out()->move_block(x3, c3, c2, x2);
  {
    ...
    sort_indices<0,1,2,3,1,1,1,1>(i0data, odata, x3.size(), c3.size(), c2.size(), x2.size());
  }
...
void Task130::Task_local::compute() {
  ...
  sort_indices<0,2,3,1,1,1,1,1>(odata_sorted, odata, c1.size(), c2.size(), x0.size(), x1.size());
  out()->put_block(odata, c1, x0, x1, c2);
}
...
void Task131::Task_local::compute() {
  ...
  const Index x1 = b(5);
  // tensor label: I264
  std::unique_ptr<double[]> odata = out()->move_block(c2, x7, x6, x0, x5, x1);
...
void Task135::Task_local::compute() {
  ...
  sort_indices<0,3,2,1,1,1,1,1>(odata_sorted, odata, c1.size(), c2.size(), x1.size(), x0.size());
  out()->put_block(odata, c1, x0, x1, c2);
}
...
void Task136::Task_local::compute() {
  ...
  const Index x2 = b(3);
  // tensor label: I270
  std::unique_ptr<double[]> odata = out()->move_block(c3, x1, x0, x2);
...
void Task139::Task_local::compute() {
  ...
  const Index x0 = b(3);
  // tensor label: I273
  std::unique_ptr<double[]> odata = out()->move_block(a3, x1, x5, x0);
...
void Task143::Task_local::compute() {
  ...
  for (auto& x3 : *range_[1]) {
    for (auto& x2 : *range_[1]) {
      ...
      sort_indices<1,3,0,2,0,1,1,1>(i0data, i0data_sorted, x0.size(), x3.size(), x1.size(), x2.size());
      // tensor label: I279
      std::unique_ptr<double[]> i1data = in(1)->get_block(x2, c2, c1, x3);
      std::unique_ptr<double[]> i1data_sorted(new double[in(1)->get_size(x2, c2, c1, x3)]);
      sort_indices<3,0,1,2,0,1,1,1>(i1data, i1data_sorted, x2.size(), c2.size(), c1.size(), x3.size());
      dgemm_("T", "N", x0.size()*x1.size(), c2.size()*c1.size(), x2.size()*x3.size(),
             1.0, i0data_sorted, x2.size()*x3.size(), i1data_sorted, x2.size()*x3.size(),
             1.0, odata_sorted, x0.size()*x1.size());
    }
  }
...
void Task144::Task_local::compute() {
  ...
  const Index x3 = b(3);
  // tensor label: I279
  std::unique_ptr<double[]> odata = out()->move_block(x2, c2, c1, x3);
  std::unique_ptr<double[]> odata_sorted(new double[out()->get_size(x2, c2, c1, x3)]);
  std::fill_n(odata_sorted.get(), out()->get_size(x2, c2, c1, x3), 0.0);
  for (auto& c3 : *range_[0]) {
    for (auto& a4 : *range_[2]) {
      // tensor label: t2
  ...
  sort_indices<2,3,0,1,1,1,1,1>(odata_sorted, odata, c1.size(), x3.size(), x2.size(), c2.size());
  out()->put_block(odata, x2, c2, c1, x3);
}
...
void Task146::Task_local::compute() {
  ...
  sort_indices<3,2,0,1,1,1,1,1>(odata_sorted, odata, c1.size(), x3.size(), c2.size(), x2.size());
  out()->put_block(odata, x2, c2, c1, x3);
}
...
void Task149::Task_local::compute() {
  ...
  const Index x4 = b(5);
  // tensor label: I291
  std::unique_ptr<double[]> odata = out()->move_block(c2, x3, x2, x5, c1, x4);
