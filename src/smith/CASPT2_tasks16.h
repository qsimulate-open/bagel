...
class Task769 : public Task {
  ...
  public:
    Task769(std::vector<std::shared_ptr<Tensor>> t, const bool reset);
    ~Task769() {}
};
...
class Task779 : public Task {
  ...
  public:
    Task779(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task779() {}
};
