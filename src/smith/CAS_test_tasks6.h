...
#ifndef __SRC_SMITH_CAS_test_TASKS6_H
#define __SRC_SMITH_CAS_test_TASKS6_H
...
class Task254 : public Task {
  ...
  public:
    Task254(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task254() {}
};
...
class Task256 : public Task {
  ...
  public:
    Task256(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task256() {}
};
...
class Task287 : public Task {
  ...
  public:
    Task287(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task287() {}
};
