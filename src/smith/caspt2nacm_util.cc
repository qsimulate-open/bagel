...
shared_ptr<Matrix> CASPT2Nacm::diagonal_D1() const {
#ifdef COMPILE_SMITH
...
shared_ptr<DFFullDist> CASPT2Nacm::contract_D1(shared_ptr<const DFFullDist> full) const {
#ifdef COMPILE_SMITH
