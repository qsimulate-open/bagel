...
#ifndef __SRC_SMITH_MRCI_TASKS30_H
#define __SRC_SMITH_MRCI_TASKS30_H
...
class Task1450 : public Task {
  ...
  public:
    Task1450(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task1450() {}
};
...
class Task1451 : public Task {
  ...
  public:
    Task1451(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task1451() {}
};
...
class Task1452 : public Task {
  ...
  public:
    Task1452(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task1452() {}
};
...
class Task1453 : public Task {
  ...
  public:
    Task1453(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task1453() {}
};
...
class Task1454 : public Task {
  ...
  public:
    Task1454(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range);
    ~Task1454() {}
};
