...
void Task206::Task_local::compute() {
  ...
  const Index x4 = b(3);
  // tensor label: I306
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(a2, x5, x0, x4);
...
void Task209::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I312
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c3, c4, x0, x1);
...
void Task213::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I318
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, c4, x0, x1);
...
void Task215::Task_local::compute() {
  ...
  const Index x0 = b(3);
  // tensor label: I321
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, c4, x1, x0);
...
void Task217::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I324
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c3, x0, x2, x1);
...
void Task219::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I327
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, x0, x2, x1);
...
void Task221::Task_local::compute() {
  ...
  const Index x2 = b(3);
  // tensor label: I330
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c3, x0, x1, x2);
...
void Task223::Task_local::compute() {
  ...
  const Index x2 = b(3);
  // tensor label: I333
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, x1, x0, x2);
...
void Task237::Task_local::compute() {
  ...
  const Index x3 = b(3);
  // tensor label: I354
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, c4, x0, x3);
...
void Task238::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I355
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, c4, x2, x1);
  {
    // tensor label: v2
