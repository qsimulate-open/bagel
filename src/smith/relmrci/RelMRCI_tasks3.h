...
class Task118 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task118(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma4, std::shared_ptr<TATensor<std::complex<double>,4>> I13)
...
class Task120 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task120(std::shared_ptr<TATensor<std::complex<double>,4>> I13, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> h1)
   : ta0_(I13), ta1_(t2), ta2_(h1) { }
};
...
class Task121 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task121(std::shared_ptr<TATensor<std::complex<double>,4>> I13, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> I289)
...
class Task122 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task122(std::shared_ptr<TATensor<std::complex<double>,4>> I289, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I289), ta1_(v2) { }
};
...
class Task123 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task123(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma5, std::shared_ptr<TATensor<std::complex<double>,2>> I16)
...
class Task125 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task125(std::shared_ptr<TATensor<std::complex<double>,2>> I16, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,2>> h1)
   : ta0_(I16), ta1_(t2), ta2_(h1) { }
};
...
class Task129 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task129(std::shared_ptr<TATensor<std::complex<double>,2>> I16, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I16), ta1_(t2), ta2_(v2) { }
};
...
class Task130 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task130(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,8>> Gamma74, std::shared_ptr<TATensor<std::complex<double>,6>> I231)
...
class Task131 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task131(std::shared_ptr<TATensor<std::complex<double>,6>> I231, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task132 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task132(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,8>> Gamma75, std::shared_ptr<TATensor<std::complex<double>,6>> I234)
...
class Task133 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task133(std::shared_ptr<TATensor<std::complex<double>,6>> I234, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task134 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task134(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,8>> Gamma77, std::shared_ptr<TATensor<std::complex<double>,6>> I240)
...
class Task135 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task135(std::shared_ptr<TATensor<std::complex<double>,6>> I240, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> I241)
...
class Task136 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task136(std::shared_ptr<TATensor<std::complex<double>,4>> I241, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I241), ta1_(v2) { }
};
...
class Task137 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task137(std::shared_ptr<TATensor<std::complex<double>,6>> I240, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task138 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task138(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,8>> Gamma78, std::shared_ptr<TATensor<std::complex<double>,6>> I243)
...
class Task139 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task139(std::shared_ptr<TATensor<std::complex<double>,6>> I243, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task140 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task140(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,8>> Gamma79, std::shared_ptr<TATensor<std::complex<double>,6>> I246)
...
class Task141 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task141(std::shared_ptr<TATensor<std::complex<double>,6>> I246, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task142 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task142(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma81, std::shared_ptr<TATensor<std::complex<double>,4>> I252)
...
class Task143 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task143(std::shared_ptr<TATensor<std::complex<double>,4>> I252, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> I253)
...
class Task144 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task144(std::shared_ptr<TATensor<std::complex<double>,4>> I253, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I253), ta1_(v2) { }
};
...
class Task145 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task145(std::shared_ptr<TATensor<std::complex<double>,4>> I252, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> I256)
...
class Task146 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task146(std::shared_ptr<TATensor<std::complex<double>,4>> I256, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
   : ta0_(I256), ta1_(v2) { }
};
...
class Task147 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task147(std::shared_ptr<TATensor<std::complex<double>,4>> I252, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
...
class Task148 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task148(std::shared_ptr<TATensor<std::complex<double>,4>> I9, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma84, std::shared_ptr<TATensor<std::complex<double>,4>> I261)
...
class Task149 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task149(std::shared_ptr<TATensor<std::complex<double>,4>> I261, std::shared_ptr<TATensor<std::complex<double>,4>> t2, std::shared_ptr<TATensor<std::complex<double>,4>> v2)
