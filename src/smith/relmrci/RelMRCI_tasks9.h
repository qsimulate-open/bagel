...
class Task424 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task424(std::shared_ptr<TATensor<std::complex<double>,4>> I93, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma419, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
...
class Task425 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task425(std::shared_ptr<TATensor<std::complex<double>,4>> I93, std::shared_ptr<TATensor<std::complex<double>,6>> Gamma420, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
