...
class SpinFreeMethod {
  ...
  public:
    ...
    // it can do only to up to RDM3 derivatives
    static std::tuple<IndexRange, std::shared_ptr<const IndexRange>, IndexRange, std::shared_ptr<const IndexRange>,
      ...
      feed_rdm_deriv_3(std::shared_ptr<const SMITH_Info<DataType>> info, const IndexRange& active,
                     std::shared_ptr<const MatType> fockact, const int istate, const size_t offset, const size_t size, const size_t fullsize);
...
template<>
std::tuple<IndexRange, std::shared_ptr<const IndexRange>, IndexRange, std::shared_ptr<const IndexRange>, std::shared_ptr<Tensor_<double>>,
                        std::shared_ptr<Tensor_<double>>, std::shared_ptr<Tensor_<double>>, std::shared_ptr<Tensor_<double>>>
...
template<>
std::tuple<IndexRange, std::shared_ptr<const IndexRange>, IndexRange, std::shared_ptr<const IndexRange>, std::shared_ptr<Tensor_<std::complex<double>>>,
          std::shared_ptr<Tensor_<std::complex<double>>>,std::shared_ptr<Tensor_<std::complex<double>>>, std::shared_ptr<Tensor_<std::complex<double>>>>
