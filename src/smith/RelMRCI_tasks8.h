...
class Task379 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task379(std::shared_ptr<TATensor<std::complex<double>,4>> I63, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma417, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
...
class Task380 : public Task {
  protected:
    ...
    void compute_() override;
  public:
    Task380(std::shared_ptr<TATensor<std::complex<double>,4>> I63, std::shared_ptr<TATensor<std::complex<double>,4>> Gamma418, std::shared_ptr<TATensor<std::complex<double>,4>> t2)
