...
#ifndef __SRC_SMITH_CASPT2_TASKS30_H
#define __SRC_SMITH_CASPT2_TASKS30_H
...
class Task1461 : public Task {
  ...
  public:
    Task1461(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task1461() {}
};
...
class Task1472 : public Task {
  ...
  public:
    Task1472(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1472() {}
};
...
class Task1476 : public Task {
  ...
  public:
    Task1476(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1476() {}
};
...
class Task1478 : public Task {
  ...
  public:
    Task1478(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1478() {}
};
...
class Task1480 : public Task {
  ...
  public:
    Task1480(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1480() {}
};
...
class Task1482 : public Task {
  ...
  public:
    Task1482(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1482() {}
};
