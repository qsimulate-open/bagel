...
#ifndef __SRC_SMITH_CAS_test_TASKS8_H
#define __SRC_SMITH_CAS_test_TASKS8_H
...
class Task371 : public Task {
  ...
  public:
    Task371(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task371() {}
};
...
class Task373 : public Task {
  ...
  public:
    Task373(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task373() {}
};
...
class Task392 : public Task {
  ...
  public:
    Task392(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task392() {}
};
