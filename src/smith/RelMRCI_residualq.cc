...
shared_ptr<Queue> RelMRCI::RelMRCI::make_residualq(const bool reset, const bool diagonal) {
  ...
  vector<IndexRange> I1_index = {active_, active_, closed_, closed_};
  auto I1 = make_shared<Tensor>(I1_index);
  auto tensor85 = vector<shared_ptr<Tensor>>{I0, h1_, I1};
  auto task85 = make_shared<Task85>(tensor85, pindex);
  task84->add_dep(task85);
  task85->add_dep(task83);
  residualq->add_task(task85);

  auto tensor86 = vector<shared_ptr<Tensor>>{I1, t2, Gamma0_()};
  ...
  auto tensor92 = vector<shared_ptr<Tensor>>{I0, Gamma58_(), I183};
  ...
  auto tensor113 = vector<shared_ptr<Tensor>>{r, I9};
  ...
  auto tensor117 = vector<shared_ptr<Tensor>>{I10, t2, v2_};
  ...
  auto tensor118 = vector<shared_ptr<Tensor>>{I9, Gamma4_(), I13};
  ...
  auto tensor120 = vector<shared_ptr<Tensor>>{I13, t2, h1_};
  ...
  auto tensor123 = vector<shared_ptr<Tensor>>{I9, Gamma5_(), I16};
  ...
  auto tensor125 = vector<shared_ptr<Tensor>>{I16, t2, h1_};
  ...
  auto tensor129 = vector<shared_ptr<Tensor>>{I16, t2, v2_};
  ...
  auto tensor134 = vector<shared_ptr<Tensor>>{I9, Gamma77_(), I240};
  ...
  auto tensor142 = vector<shared_ptr<Tensor>>{I9, Gamma81_(), I252};
  ...
  auto tensor144 = vector<shared_ptr<Tensor>>{I253, v2_};
  ...
  auto tensor160 = vector<shared_ptr<Tensor>>{r, I24};
  ...
  auto tensor167 = vector<shared_ptr<Tensor>>{I24, Gamma11_(), I34};
  ...
  auto tensor173 = vector<shared_ptr<Tensor>>{I34, t2, h1_};
  ...
  auto tensor183 = vector<shared_ptr<Tensor>>{I34, t2, v2_};
  ...
  auto tensor193 = vector<shared_ptr<Tensor>>{I34, t2, v2_};
  ...
  auto tensor237 = vector<shared_ptr<Tensor>>{I24, t2, I354};
  ...
  auto tensor241 = vector<shared_ptr<Tensor>>{I24, t2, I357};
  ...
  auto tensor246 = vector<shared_ptr<Tensor>>{I24, t2, I360};
  ...
  auto tensor251 = vector<shared_ptr<Tensor>>{I24, t2, I363};
  ...
  auto tensor256 = vector<shared_ptr<Tensor>>{I24, t2, I366};
  ...
  auto tensor261 = vector<shared_ptr<Tensor>>{I24, t2, I369};
  ...
  auto tensor315 = vector<shared_ptr<Tensor>>{I73, t2, h1_};
  ...
  auto tensor383 = vector<shared_ptr<Tensor>>{I94, t2, h1_};
  ...
  auto tensor398 = vector<shared_ptr<Tensor>>{I100, t2, h1_};
  ...
  auto tensor404 = vector<shared_ptr<Tensor>>{I699, Gamma230_(), t2};
  ...
  auto tensor450 = vector<shared_ptr<Tensor>>{I108, t2, I127};
  ...
  if (diagonal) {
    auto tensor451 = vector<shared_ptr<Tensor>>{I127, h1_};
  ...
  auto tensor469 = vector<shared_ptr<Tensor>>{I108, t2, I795};
  ...
  auto tensor472 = vector<shared_ptr<Tensor>>{I108, t2, I798};
  ...
  auto tensor475 = vector<shared_ptr<Tensor>>{I108, t2, I807};
  ...
  auto tensor478 = vector<shared_ptr<Tensor>>{I108, t2, I810};
  ...
  auto tensor485 = vector<shared_ptr<Tensor>>{I108, t2, I825};
  ...
  auto tensor489 = vector<shared_ptr<Tensor>>{I108, t2, I828};
  ...
  auto tensor674 = vector<shared_ptr<Tensor>>{r, I173};
  ...
  auto tensor680 = vector<shared_ptr<Tensor>>{I177, t2, v2_};
  ...
  auto tensor702 = vector<shared_ptr<Tensor>>{r, I194};
  ...
  auto tensor708 = vector<shared_ptr<Tensor>>{r, I773};
  ...
  if (diagonal) {
    auto tensor711 = vector<shared_ptr<Tensor>>{I773, t2, v2_};
    task711 = make_shared<Task711>(tensor711, pindex);
  ...
  if (diagonal) {
    auto tensor714 = vector<shared_ptr<Tensor>>{I773, t2, v2_};
    task714 = make_shared<Task714>(tensor714, pindex);
    task708->add_dep(task714);
    task714->add_dep(task83);
    residualq->add_task(task714);
  }

  vector<IndexRange> I981_index = {closed_, closed_, active_, active_};
  auto I981 = make_shared<Tensor>(I981_index);
  auto tensor715 = vector<shared_ptr<Tensor>>{I773, t2, I981};
  auto task715 = make_shared<Task715>(tensor715, pindex);
  task708->add_dep(task715);
  task715->add_dep(task83);
  residualq->add_task(task715);

  auto tensor716 = vector<shared_ptr<Tensor>>{I981, Gamma368_(), v2_};
