...
class MRCI : public SpinFreeMethod<double> {
  protected:
    ...
    std::shared_ptr<FutureTATensor<double,6>> Gamma550_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma551_();
    ...
    std::shared_ptr<FutureTATensor<double,2>> Gamma552_();
    std::shared_ptr<FutureTATensor<double,2>> Gamma554_();
    ...
    std::shared_ptr<FutureTATensor<double,4>> Gamma568_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma569_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma572_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma573_();
    ...
    std::shared_ptr<FutureTATensor<double,6>> Gamma556_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma557_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma471_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma503_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma526_();
    std::shared_ptr<FutureTATensor<double,2>> Gamma562_();
    std::shared_ptr<FutureTATensor<double,2>> Gamma564_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma531_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma532_();
    std::shared_ptr<FutureTATensor<double,8>> Gamma533_();
    std::shared_ptr<FutureTATensor<double,6>> Gamma545_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma548_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma549_();
    std::shared_ptr<FutureTATensor<double,0>> Gamma558_();
    std::shared_ptr<FutureTATensor<double,0>> Gamma560_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma566_();
    std::shared_ptr<FutureTATensor<double,4>> Gamma567_();
