...
class Task6 : public Task {  // associated with gamma
  ...
  public:
    Task6(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task6() {}
};
...
class Task18 : public Task {
  ...
  public:
    Task18(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task18() {}
};
...
class Task32 : public AccTask {
  ...
  public:
    Task32(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task32() {}
};
...
class Task42 : public Task {
  ...
  public:
    Task42(std::vector<std::shared_ptr<Tensor>> t);
    ~Task42() {};
};
...
class Task51 : public Task {
  ...
  public:
    Task51(std::vector<std::shared_ptr<Tensor>> t);
    ~Task51() {}
};
...
class Task55 : public Task {
  ...
  public:
    Task55(std::vector<std::shared_ptr<Tensor>> t);
    ~Task55() {}
};
...
class Task68 : public Task {
  ...
  public:
    Task68(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range, double e);
    ~Task68() {}
};
...
class Task70 : public Task {
  ...
  public:
    Task70(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task70() {}
};
...
class Task83 : public Task {
  ...
  public:
    Task83(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range, double e);
    ~Task83() {}
};
...
class Task85 : public Task {
  ...
  public:
    Task85(std::vector<std::shared_ptr<Tensor>> t, std::array<std::shared_ptr<const IndexRange>,4> range);
    ~Task85() {}
};
