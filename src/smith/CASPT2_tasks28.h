...
#ifndef __SRC_SMITH_CASPT2_TASKS28_H
#define __SRC_SMITH_CASPT2_TASKS28_H
...
class Task1371 : public Task {
  ...
  public:
    Task1371(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1371() {}
};
...
class Task1384 : public Task {
  ...
  public:
    Task1384(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,4> range, const double e);
    ~Task1384() {}
};
