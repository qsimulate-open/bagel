...
#ifndef __SRC_SMITH_CAS_test_TASKS3_H
#define __SRC_SMITH_CAS_test_TASKS3_H
...
class Task108 : public Task {
  ...
  public:
    Task108(std::vector<std::shared_ptr<Tensor>> t,  std::array<std::shared_ptr<const IndexRange>,3> range, const double e);
    ~Task108() {}
};
