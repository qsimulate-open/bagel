...
void Task156::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c1, x2, x1, x0") += (*ta1_)("x5, x3, x2, x4, x1, x0") * (*ta2_)("x4, x3, x5, c1");
}

void Task157::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("x4, x3, x5, c1") += (*ta1_)("x5, a2, c1, a3") * (*ta2_)("a3, x4, a2, x3") * (-1);
}
...
void Task174::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c5, a2, c4, x1") * (*ta2_)("c1, c5, c3, c4");
}
...
void Task176::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c5, a4, c3, x1") * (*ta2_)("c1, c5, a4, a2") * (-1);
}

void Task177::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c4, a5, c3, x1") * (*ta2_)("c1, a2, a5, c4");
}
...
void Task179::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c3, a5, c4, x1") * (*ta2_)("c1, a2, a5, c4") * (-1);
}
...
void Task181::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c4, a5, c1, x1") * (*ta2_)("c3, a2, a5, c4") * (-1);
}

void Task182::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c1, a4, c5, x1") * (*ta2_)("c3, c5, a4, a2") * (-1);
}
...
void Task193::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, a2, c3, x1") += (*ta1_)("c1, a4, c3, a5") * (*ta2_)("a5, x1, a4, a2") * 2;
}

void Task194::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c1, x1") * (*ta2_)("c3, a2, x0, x1");
}
...
void Task195::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c3, a2, x0, x1") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c3, a2, x3, x2") * (-1);
}

void Task196::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  (*ta0_)("c1, c3, x0, a2") += (*ta1_)("c3, x1") * (*ta2_)("c1, a2, x0, x1");
}
...
void Task197::compute_() {
  if (!ta0_->initialized())
    ta0_->fill_local(0.0);
  ta1_->init();
  (*ta0_)("c1, a2, x0, x1") += (*ta1_)("x3, x2, x0, x1") * (*ta2_)("c1, a2, x3, x2");
}
