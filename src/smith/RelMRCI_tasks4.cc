...
void Task157::Task_local::compute() {
  ...
  const Index c1 = b(3);
  // tensor label: I303
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(x4, x3, x5, c1);
  ...
  out()->put_block(odata, x4, x3, x5, c1);
}
...
void Task185::Task_local::compute() {
  ...
  const Index c4 = b(3);
  // tensor label: I502
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(a5, x1, c1, c4);
  {
    // tensor label: v2
...
void Task189::Task_local::compute() {
  ...
  const Index c4 = b(3);
  // tensor label: I514
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(a5, x1, c3, c4);
  {
    // tensor label: v2
...
void Task195::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I52
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c3, a2, x0, x1);
  ...
  out()->put_block(odata, c3, a2, x0, x1);
}
...
void Task197::Task_local::compute() {
  ...
  const Index x1 = b(3);
  // tensor label: I55
  std::unique_ptr<std::complex<double>[]> odata = out()->move_block(c1, a2, x0, x1);
  ...
  out()->put_block(odata, c1, a2, x0, x1);
}
