...
tuple<shared_ptr<Queue>, shared_ptr<Queue>, shared_ptr<Queue>,  shared_ptr<Queue>,  shared_ptr<Queue>, shared_ptr<Queue>, shared_ptr<Queue>>
  ...
  vector<shared_ptr<Tensor>> tensor1 = {Gamma0, rdm2_, rdm3_, rdm4_, f1_};
  ...
  vector<shared_ptr<Tensor>> tensor2 = {Gamma1, rdm2_, rdm3_};
  ...
  vector<shared_ptr<Tensor>> tensor3 = {Gamma4, rdm2_, rdm3_};
  ...
  vector<shared_ptr<Tensor>> tensor4 = {Gamma5, rdm2_};
  ...
  vector<shared_ptr<Tensor>> tensor5 = {Gamma13, rdm2_, rdm3_, rdm4_};
  ...
  vector<shared_ptr<Tensor>> tensor6 = {Gamma17, rdm2deriv_, rdm3deriv_, rdm4deriv_, f1_};
  auto task6 = make_shared<Task6>(tensor6, cindex);
  task6->add_dep(task0);
  ...
  vector<shared_ptr<Tensor>> tensor7 = {Gamma18, rdm2deriv_, rdm3deriv_};
  auto task7 = make_shared<Task7>(tensor7, cindex);
  task7->add_dep(task0);
  queue_->add_task(task7);

  vector<IndexRange> Gamma24_index = {ci_, active_, active_, active_, active_, active_, active_};
  auto Gamma24 = make_shared<Tensor>(Gamma24_index, false);
  vector<shared_ptr<Tensor>> tensor8 = {Gamma24, rdm2deriv_, rdm3deriv_};
  ...
  vector<shared_ptr<Tensor>> tensor9 = {Gamma27, rdm2deriv_};
  auto task9 = make_shared<Task9>(tensor9, cindex);
  task9->add_dep(task0);
  queue_->add_task(task9);

  vector<IndexRange> Gamma26_index = {ci_, active_, active_, active_, active_, active_, active_};
  auto Gamma26 = make_shared<Tensor>(Gamma26_index, false);
  vector<shared_ptr<Tensor>> tensor10 = {Gamma26, rdm2deriv_, rdm3deriv_};
  auto task10 = make_shared<Task10>(tensor10, cindex);
  task10->add_dep(task0);
  queue_->add_task(task10);

  vector<IndexRange> I0_index = {active_, active_, active_, virt_};
  auto I0 = make_shared<Tensor>(I0_index, false);
  vector<shared_ptr<Tensor>> tensor11 = {r, I0};
  ...
  vector<shared_ptr<Tensor>> tensor12 = {I0, t2, I1};
  ...
  vector<shared_ptr<Tensor>> tensor15 = {I3, t2, I4};
  ...
  vector<shared_ptr<Tensor>> tensor16 = {I4, Gamma1};
  ...
  vector<shared_ptr<Tensor>> tensor17 = {I0, t2, I6};
  auto task17 = make_shared<Task17>(tensor17, pindex);
  task11->add_dep(task17);
  task17->add_dep(task0);
  queue_->add_task(task17);


  vector<shared_ptr<Tensor>> tensor18 = {I6, Gamma1};
  auto task18 = make_shared<Task18>(tensor18, pindex, this->e0_);
  ...
  vector<shared_ptr<Tensor>> tensor19 = {I0, v2_, I8};
  auto task19 = make_shared<Task19>(tensor19, pindex);
  task11->add_dep(task19);
  task19->add_dep(task0);
  queue_->add_task(task19);


  vector<shared_ptr<Tensor>> tensor20 = {I8, Gamma1};
  ...
  vector<shared_ptr<Tensor>> tensor21 = {I0, v2_, I10};
  auto task21 = make_shared<Task21>(tensor21, pindex);
  task11->add_dep(task21);
  task21->add_dep(task0);
  queue_->add_task(task21);


  vector<shared_ptr<Tensor>> tensor22 = {I10, Gamma4};
  ...
  vector<shared_ptr<Tensor>> tensor23 = {I0, h1_, I12};
  auto task23 = make_shared<Task23>(tensor23, pindex);
  task11->add_dep(task23);
  task23->add_dep(task0);
  queue_->add_task(task23);


  vector<shared_ptr<Tensor>> tensor24 = {I12, Gamma5};
  ...
  vector<IndexRange> I14_index = {active_, active_, active_, virt_};
  auto I14 = make_shared<Tensor>(I14_index, false);
  vector<shared_ptr<Tensor>> tensor25 = {I13, t2, I14};
  ...
  vector<shared_ptr<Tensor>> tensor31 = {I14, t2, I22};
  auto task31 = make_shared<Task31>(tensor31, pindex);
  task25->add_dep(task31);
  energy_->add_task(task31);


  vector<shared_ptr<Tensor>> tensor32 = {I22, Gamma1};
  auto task32 = make_shared<Task32>(tensor32, pindex, this->e0_);
  ...
  vector<shared_ptr<Tensor>> tensor37 = {I14, h1_, I31};
  auto task37 = make_shared<Task37>(tensor37, pindex);
  task25->add_dep(task37);
  energy_->add_task(task37);


  vector<shared_ptr<Tensor>> tensor38 = {I31, Gamma5};
  ...
  vector<shared_ptr<Tensor>> tensor43 = {den2, I35};
  auto task43 = make_shared<Task43>(tensor43, pindex);
  task43->add_dep(task42);
  density_->add_task(task43);


  vector<IndexRange> I36_index = {active_, active_, active_, active_, active_, virt_};
  auto I36 = make_shared<Tensor>(I36_index, false);
  vector<shared_ptr<Tensor>> tensor44 = {I35, t2, I36};
  ...
  vector<shared_ptr<Tensor>> tensor45 = {I36, t2, I37};
  ...
  vector<shared_ptr<Tensor>> tensor49 = {I39, t2, I40};
  ...
  vector<shared_ptr<Tensor>> tensor50 = {I40, Gamma1};
  ...
  vector<shared_ptr<Tensor>> tensor51 = {den1};
  auto task51 = make_shared<Task51>(tensor51);
  density1_->add_task(task51);

  vector<IndexRange> I41_index = {active_, virt_};
  auto I41 = make_shared<Tensor>(I41_index, false);
  vector<shared_ptr<Tensor>> tensor52 = {den1, I41};
  auto task52 = make_shared<Task52>(tensor52, pindex);
  task52->add_dep(task51);
  density1_->add_task(task52);


  vector<IndexRange> I42_index = {active_, active_, active_, active_};
  auto I42 = make_shared<Tensor>(I42_index, false);
  vector<shared_ptr<Tensor>> tensor53 = {I41, t2, I42};
  auto task53 = make_shared<Task53>(tensor53, pindex);
  task52->add_dep(task53);
  task53->add_dep(task51);
  density1_->add_task(task53);


  vector<shared_ptr<Tensor>> tensor54 = {I42, Gamma5};
  auto task54 = make_shared<Task54>(tensor54, pindex);
  task53->add_dep(task54);
  task54->add_dep(task51);
  density1_->add_task(task54);

  task54->add_dep(task4);

  auto density2_ = make_shared<Queue>();
  vector<shared_ptr<Tensor>> tensor55 = {Den1};
  auto task55 = make_shared<Task55>(tensor55);
  density2_->add_task(task55);

  vector<IndexRange> I43_index = {active_, active_, active_, virt_};
  auto I43 = make_shared<Tensor>(I43_index, false);
  vector<shared_ptr<Tensor>> tensor56 = {Den1, I43};
  auto task56 = make_shared<Task56>(tensor56, pindex);
  task56->add_dep(task55);
  density2_->add_task(task56);


  vector<IndexRange> I44_index = {active_, active_, active_, active_, active_, active_};
  auto I44 = make_shared<Tensor>(I44_index, false);
  vector<shared_ptr<Tensor>> tensor57 = {I43, t2, I44};
  ...
  vector<shared_ptr<Tensor>> tensor58 = {I44, Gamma1};
  ...
  vector<shared_ptr<Tensor>> tensor59 = {deci};
  ...
  vector<shared_ptr<Tensor>> tensor60 = {deci, I45};
  auto task60 = make_shared<Task60>(tensor60, cindex);
  task60->add_dep(task59);
  dedci_->add_task(task60);


  vector<IndexRange> I46_index = {ci_, active_, active_, active_, virt_};
  auto I46 = make_shared<Tensor>(I46_index, false);
  vector<shared_ptr<Tensor>> tensor61 = {I45, t2, I46};
  ...
  vector<shared_ptr<Tensor>> tensor67 = {I46, t2, I61};
  auto task67 = make_shared<Task67>(tensor67, cindex);
  task61->add_dep(task67);
  task67->add_dep(task59);
  dedci_->add_task(task67);


  vector<shared_ptr<Tensor>> tensor68 = {I61, Gamma18};
  auto task68 = make_shared<Task68>(tensor68, cindex, this->e0_);
  task67->add_dep(task68);
  task68->add_dep(task59);
  dedci_->add_task(task68);

  task68->add_dep(task7);
  ...
  vector<shared_ptr<Tensor>> tensor69 = {I46, v2_, I67};
  auto task69 = make_shared<Task69>(tensor69, cindex);
  task61->add_dep(task69);
  task69->add_dep(task59);
  dedci_->add_task(task69);


  vector<shared_ptr<Tensor>> tensor70 = {I67, Gamma18};
  auto task70 = make_shared<Task70>(tensor70, cindex);
  task69->add_dep(task70);
  task70->add_dep(task59);
  dedci_->add_task(task70);

  task70->add_dep(task7);
  ...
  vector<shared_ptr<Tensor>> tensor76 = {I53, t2, I54};
  auto task76 = make_shared<Task76>(tensor76, cindex);
  task75->add_dep(task76);
  task76->add_dep(task59);
  dedci_->add_task(task76);


  vector<shared_ptr<Tensor>> tensor77 = {I54, Gamma17};
  auto task77 = make_shared<Task77>(tensor77, cindex);
  task76->add_dep(task77);
  task77->add_dep(task59);
  dedci_->add_task(task77);

  task77->add_dep(task6);

  vector<IndexRange> I56_index = {ci_, active_, active_, active_, virt_};
  auto I56 = make_shared<Tensor>(I56_index, false);
  vector<shared_ptr<Tensor>> tensor78 = {I45, t2, I56};
  auto task78 = make_shared<Task78>(tensor78, cindex);
  task60->add_dep(task78);
  task78->add_dep(task59);
  dedci_->add_task(task78);


  vector<IndexRange> I57_index = {ci_, active_, active_, active_, virt_};
  auto I57 = make_shared<Tensor>(I57_index, false);
  vector<shared_ptr<Tensor>> tensor79 = {I56, f1_, I57};
  auto task79 = make_shared<Task79>(tensor79, cindex);
  task78->add_dep(task79);
  task79->add_dep(task59);
  ...
  vector<shared_ptr<Tensor>> tensor82 = {I56, t2, I64};
  auto task82 = make_shared<Task82>(tensor82, cindex);
  task78->add_dep(task82);
  task82->add_dep(task59);
  dedci_->add_task(task82);


  vector<shared_ptr<Tensor>> tensor83 = {I64, Gamma18};
  auto task83 = make_shared<Task83>(tensor83, cindex, this->e0_);
  task82->add_dep(task83);
  task83->add_dep(task59);
  dedci_->add_task(task83);

  task83->add_dep(task7);
  ...
  vector<shared_ptr<Tensor>> tensor84 = {I56, v2_, I73};
  auto task84 = make_shared<Task84>(tensor84, cindex);
  task78->add_dep(task84);
  task84->add_dep(task59);
  dedci_->add_task(task84);


  vector<shared_ptr<Tensor>> tensor85 = {I73, Gamma18};
  auto task85 = make_shared<Task85>(tensor85, cindex);
  task84->add_dep(task85);
  task85->add_dep(task59);
  dedci_->add_task(task85);

  task85->add_dep(task7);
  ...
  vector<shared_ptr<Tensor>> tensor86 = {I56, v2_, I76};
  auto task86 = make_shared<Task86>(tensor86, cindex);
  task78->add_dep(task86);
  task86->add_dep(task59);
  dedci_->add_task(task86);


  vector<shared_ptr<Tensor>> tensor87 = {I76, Gamma26};
  auto task87 = make_shared<Task87>(tensor87, cindex);
  task86->add_dep(task87);
  task87->add_dep(task59);
  dedci_->add_task(task87);

  task87->add_dep(task10);

  vector<IndexRange> I81_index = {ci_, active_, active_, active_, virt_};
  auto I81 = make_shared<Tensor>(I81_index, false);
  vector<shared_ptr<Tensor>> tensor88 = {I45, t2, I81};
  auto task88 = make_shared<Task88>(tensor88, cindex);
  task60->add_dep(task88);
  task88->add_dep(task59);
