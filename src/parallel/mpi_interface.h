...
class MPI_Interface {
  ...
  public:
    ...
    int request_recv(double* rbuf, const size_t size, const int source, const int tag = -1);
    int request_recv(size_t* rbuf, const size_t size, const int source, const int tag = -1);
