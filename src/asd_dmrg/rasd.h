...
class RASD : public ASD_DMRG {
  protected:
    std::shared_ptr<DMRG_Block> compute_first_block(std::shared_ptr<PTree> input, std::shared_ptr<const Reference> ref) override;
    std::shared_ptr<DMRG_Block> grow_block(std::shared_ptr<PTree> input, std::shared_ptr<const Reference> ref, std::shared_ptr<DMRG_Block> left) override;
