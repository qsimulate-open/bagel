...
shared_ptr<const ZCoeff_Striped> ZCoeff_Striped::init_kramers_coeff(shared_ptr<const Geometry> geom, shared_ptr<const ZMatrix> overlap,
                                         shared_ptr<const ZMatrix> hcore, const int nele, const bool gaunt, const bool breit, const int batchsize) const {
  ...
  shared_ptr<const ZMatrix> focktmp = make_shared<DFock>(geom, hcore, slice_copy(0, nele), gaunt, breit, /*store_half*/false, /*robust*/breit, 1.0, 1.0, false, batchsize);
