...
Reference::Reference(shared_ptr<const Geometry> g, shared_ptr<const Coeff> c,
 ...
 : geom_(g), noccA_(0), noccB_(0), energy_(en), hcore_(make_shared<Hcore>(geom_,!geom_->mat1ecorr()->dkh())), nclosed_(_nclosed), nact_(_nact), nvirt_(_nvirt), nstate_(1), ciwfn_(ci), rdm1_(_rdm1), rdm2_(_rdm2),
