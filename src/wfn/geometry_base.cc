...
BOOST_CLASS_EXPORT_IMPLEMENT(Geometry_base)

Geometry_base::Geometry_base(const shared_ptr<const PTree> geominfo) {
...
Geometry_base::Geometry_base(const vector<shared_ptr<const Atom>> atoms, const shared_ptr<const PTree> geominfo) {
...
const shared_ptr<const Matrix> Geometry_base::compute_grad_vnuc() const {
...
vector<double> Geometry_base::schwarz() const {
...
void Geometry_base::get_electric_field(const shared_ptr<const PTree> geominfo) {
